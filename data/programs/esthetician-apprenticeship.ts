...
export const ESTHETICIAN_APPRENTICESHIP: ProgramSchema = {
  ...
  subtitle:
    'Earn your Indiana esthetician license through a registered apprenticeship. 700 hours of supervised training in a licensed spa or salon.',
  ...
  hoursPerWeekMin: 25,
  hoursPerWeekMax: 30,
  hoursBreakdown: { onlineInstruction: 70, handsOnLab: 530, examPrep: 50, careerPlacement: 50 },
  schedule: 'Mon–Fri, varies by host site (25–30 hrs/week)',
