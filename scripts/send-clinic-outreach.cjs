...
const RECIPIENTS = [
  {
    ...
    to: 'community@franciscanalliance.org',
    toName: 'Franciscan Health Community Team',
  },
...
const MANUAL = [
  {
    org: 'MedExpress Urgent Care',
    note: 'Call (888) 345-4687 | medexpress.com — ask for Regional HR or Workforce Partnerships',
  },
  {
    org: 'NextCare Urgent Care',
    note: 'Call (888) 381-4858 | nextcare.com — ask for Regional HR or Workforce Partnerships',
  },
  {
    org: 'DaVita',
    note: 'Call (800) 400-8331 | davita.com — ask for Regional Recruiting or Workforce Partnerships',
  },
  {
    org: 'Fresenius Medical Care',
    note: 'Call (800) 881-5101 | freseniusmedicalcare.com — ask for Regional HR',
  },
];
