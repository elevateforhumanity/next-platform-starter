...
const NO_EMAIL = [
  {
    ...
    note: 'No public email — use contact form at messer.com or call (317) 576-9250',
  },
  {
    org: 'IEC Indy',
    note: 'No public email — use contact form at iec-indy.org or call (317) 562-1102',
  },
  {
    org: 'Bricklayers & Allied Craftworkers Local 4',
    note: 'No public email — call (800) 322-2830',
  },
  {
    org: 'Indiana State Building & Construction Trades Council',
    note: 'No public email — use contact form at isbctc.org',
  },
];
