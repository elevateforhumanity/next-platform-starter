...
const RECIPIENTS = [
  {
    org: 'Mechanical Contractors Association of Indiana',
    to: 'info@mcaindiana.org',
    toName: 'MCA Indiana Team',
  },
  {
    org: 'Indiana HVAC Association',
    to: 'info@inhvacr.org',
    toName: 'Indiana HVAC Association Team',
  },
];

const MANUAL = [
  {
    org: 'Plumbers and Steamfitters Local 440',
    note: 'No public email — call (317) 872-1622 | 7920 E 30th St, Indianapolis',
  },
  {
    org: 'Williams Comfort Air',
    note: 'No public email — call (317) 268-5900 | williamscomfortair.com',
  },
  {
    org: 'Service Plus Heating Cooling & Plumbing',
    note: 'No public email — call (317) 434-2627 | serviceplusnow.com',
  },
];
