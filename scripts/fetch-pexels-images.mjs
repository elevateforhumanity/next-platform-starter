...
const IMAGES = {
  ...
  'images/pages/supersonic-page-1.jpg':              { q: 'tax preparation professional accountant', size: 'hero_full' },
  'images/pages/supersonic-page-4.jpg':              { q: 'tax software computer professional', size: 'hero_full' },
  'images/pages/supersonic-page-5.jpg':              { q: 'enrolled agent tax professional office', size: 'hero_full' },
  'images/pages/supersonic-tax-cert.jpg':            { q: 'tax certification professional credential', size: 'hero_full' },
  'images/pages/supersonic-tax-prep.jpg':            { q: 'tax preparation filing documents', size: 'hero_full' },
