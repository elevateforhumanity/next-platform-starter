...
const RECIPIENTS = [
  ...
  {
    org: 'Indiana Manufacturers Association',
    to: 'ima@indianamfg.com',
    toName: 'Indiana Manufacturers Association Team',
  },
];
...
const MANUAL = [
  {
    ...
    note: 'Contact form: allisontransmission.com/contact | (317) 242-5000',
  },
  {
    org: 'Rolls-Royce North America',
    note: 'Contact form: rolls-royce.com/contact.aspx | 450 S Meridian St, Indianapolis',
  },
  {
    org: 'Eli Lilly and Company',
    note: 'Contact form: lilly.com/contact | Multiple Indianapolis facilities',
  },
];
