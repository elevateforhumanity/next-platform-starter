  ...
  modules: [
    {
      ...
      description: 'Understand the peer recovery specialist role and principles.',
      lessons: [
        {
          id: 'peer-1-1',
    ...
    },
    {
      ...
      description: 'Learn ethical standards and professional conduct for peer specialists.',
      lessons: [
        {
          id: 'peer-2-1',
    ...
    },
    {
      ...
      description: 'Understand recovery models and wellness principles.',
      lessons: [
        {
          id: 'peer-3-1',
    ...
    },
    {
      ...
      description: 'Develop core peer support and communication skills.',
      lessons: [
        {
          id: 'peer-4-1',
    ...
    },
    {
      ...
      description: 'Learn advocacy skills and empowerment strategies.',
      lessons: [
        {
          id: 'peer-5-1',
    ...
    },
    {
      ...
      description: 'Connect individuals to community resources and services.',
      lessons: [
        {
          id: 'peer-6-1',
    ...
    },
    {
      ...
      description: 'Respond to crisis situations and ensure safety.',
      lessons: [
        {
          id: 'peer-7-1',
    ...
    },
    {
      ...
      description: 'Complete supervised field experience and prepare for certification.',
      lessons: [
        {
          id: 'peer-8-1',
