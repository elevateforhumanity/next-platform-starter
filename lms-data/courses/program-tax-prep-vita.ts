...
export const taxPrepVitaCourse: Course = {
  ...
  title: 'Tax Preparation & Financial Services Career Certificate (IRS VITA Track)',
  ...
  hoursTotal: 150,
  deliveryMode: 'HYBRID',
  locationLabel: 'Elevate for Humanity Training Center + Online + IRS VITA Site',
  fundingEligible: ['WRG', 'WIOA_ADULT', 'WIOA_DW', 'JRI', 'WEX', 'OJT', 'ETG', 'SELF_PAY'],
  targetAudience: [
      ...
      lessons: [
        {
          ...
          type: 'reading',
          durationMinutes: 120,
          description: 'Review all tax topics. Practice questions. Common exam pitfalls.',
        },
        {
          id: 'vita-w10-02',
        ...
        },
        {
          ...
          type: 'assessment',
          durationMinutes: 90,
          externalUrl: 'https://quickbooks.intuit.com/accountants/training-certification/',
          partnerTag: 'Intuit',
          checkpoint: true,
          description:
        ...
        },
        {
          ...
          checkpoint: true,
          description: 'Complete the MS-900 exam at the Certiport Authorized Testing Center.',
        },
        {
          id: 'vita-w10-05',
          ...
          checkpoint: true,
          description: 'Complete the NRF RISE Up assessment. Passing score: 70%.',
        },
        {
          id: 'vita-w10-06',
  ...
  externalPlatforms: [
    ...
    },
    {
      ...
      purpose: 'Financial literacy curriculum: budgeting, credit, saving, investing, taxes',
      cost: 'Free',
      accountRequired: true,
      whitelistDomains: ['education.intuit.com', 'cdn.intuit4education.a.intuit.com'],
    },
    {
      id: 'quickbooks-proadvisor',
