  ...
  modules: [
    {
      ...
      description: 'Understand the tax preparation profession and IRS requirements.',
      lessons: [
        {
          id: 'tax-1-1',
    ...
    },
    {
      ...
      description: 'Learn Form 1040 and individual income tax basics.',
      lessons: [
        {
          id: 'tax-2-1',
    ...
    },
    {
      ...
      description: 'Master common tax credits and deductions for individuals.',
      lessons: [
        {
          id: 'tax-3-1',
    ...
    },
    {
      ...
      description: 'Learn Schedule C and self-employment tax preparation.',
      lessons: [
        {
          id: 'tax-4-1',
    ...
    },
    {
      ...
      description: 'Master professional tax preparation software and e-filing.',
      lessons: [
        {
          id: 'tax-5-1',
    ...
    },
    {
      ...
      description: 'Develop client interview and service skills for tax preparation.',
      lessons: [
        {
          id: 'tax-6-1',
    ...
    },
    {
      ...
      description: 'Learn state income tax preparation for Indiana.',
      lessons: [
        {
          id: 'tax-7-1',
    ...
    },
    {
      ...
      description: 'Start your tax business and complete IRS certification requirements.',
      lessons: [
        {
          id: 'tax-8-1',
