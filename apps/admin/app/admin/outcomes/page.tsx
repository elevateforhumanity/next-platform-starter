...
export default async function OutcomesPage() {
  ...
  const outcomeUserIds = [
    ...new Set((recentOutcomesRes.data ?? []).map((o: any) => o.user_id).filter(Boolean)),
  ];
  ...
  const recentOutcomes = (recentOutcomesRes.data ?? []).map((o: any) => ({
    ...o,
    profiles: outcomeProfileMap[o.user_id] ?? null,
  }));
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-5">
            ...
            <p className="text-xs text-slate-700 mt-1">
              {totalCerts || 0} of {totalEnrollments || 0} enrolled
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border p-5">
                      ...
                      <tr key={o.id} className="hover:bg-slate-50">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-slate-900">
                              {o.profiles?.full_name || 'Participant'}
                            </span>
                          </div>
                        </td>
