...
export const metadata: Metadata = {
  title: 'Course Template Records | Admin',
};
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mt-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Course Template Records</h1>
            <p className="text-slate-600 text-sm mt-1">{total ?? 0} saved templates in the database</p>
          </div>
          <Link
        ...
        <div className="bg-white rounded-xl border overflow-hidden">
          ...
          {templates && templates.length > 0 ? (
            ...
            <div className="px-6 py-12 text-center text-slate-500 text-sm">
              ...
              <Link href="/admin/course-builder/templates" className="text-brand-blue-600 hover:underline">
                Blueprint Gallery
              </Link>{' '}
              to seed a course from a template, which saves a record here.
            </div>
          )}
        </div>
      </div>
