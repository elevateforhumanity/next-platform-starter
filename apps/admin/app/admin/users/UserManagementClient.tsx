                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      {user.is_active !== false ? (
                        <button
                          ...
                          className="px-3 py-1 text-sm text-brand-orange-600 border border-brand-orange-200 rounded hover:bg-brand-orange-50"
                        >
                          Deactivate
                        </button>
                      ) : (
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-lg w-full mx-4">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                />
                {editingUser && (
                  <p className="text-xs text-slate-700 mt-1">Email cannot be changed</p>
                )}
              </div>
              <div>
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="is_active" className="text-sm text-slate-900">
                  Active user
                </label>
              </div>
