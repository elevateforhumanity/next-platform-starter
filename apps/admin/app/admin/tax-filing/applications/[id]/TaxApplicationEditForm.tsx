...
const STATUSES = ['pending', 'under_review', 'in_progress', 'completed', 'rejected', 'on_hold'];
...
export default function TaxApplicationEditForm({ applicationId, currentStatus, currentNotes }: Props) {
