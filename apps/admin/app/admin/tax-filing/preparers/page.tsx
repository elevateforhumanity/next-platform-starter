    ...
    <div className="min-h-screen bg-white py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-black">Manage tax preparers, certifications, and assignments.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="text-3xl font-bold text-brand-blue-600">{preparers?.length || 0}</div>
            <div className="text-black text-sm">Total Preparers</div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="text-3xl font-bold text-brand-green-600">
              {preparers?.filter((p: Record<string, any>) => p.is_active).length || 0}
            </div>
