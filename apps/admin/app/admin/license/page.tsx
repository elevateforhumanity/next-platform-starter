      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <nav className="text-sm mb-4">
            <ol className="flex items-center space-x-2 text-slate-700">
              ...
              <li>/</li>
              <li className="text-slate-900 font-medium">License</li>
            </ol>
          </nav>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-3 py-1 bg-brand-green-100 text-brand-green-800 rounded-full text-sm font-medium">
              Active
            </span>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-slate-700">License Type</p>
              <p className="font-medium">Enterprise</p>
            </div>
            <div>
              <p className="text-sm text-slate-700">Valid Until</p>
              <p className="font-medium">Dec 31, 2025</p>
            </div>
            <div>
              <p className="text-sm text-slate-700">User Seats</p>
              <p className="font-medium">Unlimited</p>
            </div>
            <div>
              <p className="text-sm text-slate-700">Support Level</p>
