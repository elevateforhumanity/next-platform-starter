      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-6">
            {/* Grant Information */}
            <div>
              <label className="block text-sm font-medium text-black mb-2">Grant Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-2">Funding Agency</label>
              <input
                type="text"
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-black mb-2">Grant Amount</label>
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-2">Grant Description</label>
              <textarea
                rows={4}
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-2">Target Population</label>
              <textarea
                rows={3}
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-brand-blue-600" />
                  <span className="text-sm text-black">Budget Narrative</span>
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-brand-blue-600" />
                ...
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-brand-blue-600" />
                  <span className="text-sm text-black">Letters of Support</span>
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-brand-blue-600" />
                  <span className="text-sm text-black">Financial Statements</span>
                </label>
              </div>
            </div>
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  <div className="text-black">
                    ...
                    <p className="text-xs text-black mt-1">PDF, DOC, DOCX up to 10MB</p>
                  </div>
                </label>
              </div>
            </div>
