      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <nav className="text-sm mb-4">
            <ol className="flex items-center space-x-2 text-slate-700">
              ...
              <li>/</li>
              <li className="text-slate-900 font-medium">Progress</li>
            </ol>
          </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-3xl font-bold text-brand-blue-600 mt-2">{inProgress || 0}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <h3 className="text-sm font-medium text-slate-700">Completed</h3>
            <p className="text-3xl font-bold text-brand-green-600 mt-2">{completed || 0}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-3xl font-bold text-brand-blue-600 mt-2">
              {totalEnrollments ? Math.round(((completed || 0) / totalEnrollments) * 100) : 0}%
            </p>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h2 className="text-lg font-semibold mb-4">Progress Overview</h2>
          <p className="text-slate-700">Detailed progress tracking and analytics</p>
        </div>
      </div>
    </div>
  );
