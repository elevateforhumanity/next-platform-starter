...
export const communityServices: CommunityService[] = [
  {
    ...
    description:
      'IRS Volunteer Income Tax Assistance (VITA) site offering free federal and state tax return preparation for individuals and families earning under $67,000 annually.',
  ...
  },
  {
    ...
    description:
      'Access mental wellness resources, counseling referrals, and peer support through our partnership with Selfish Inc. Services are free or low-cost for qualifying participants.',
  ...
  },
  {
    ...
    description:
      'Workforce Innovation and Opportunity Act (WIOA) funding covers tuition, fees, and support services for eligible Indiana residents pursuing career training programs.',
    eligibility:
      'Indiana residents who meet WIOA income and eligibility requirements. Contact us to determine eligibility.',
  ...
  },
  {
    ...
    description:
      'Resume building, interview preparation, job search assistance, and direct employer connections for program graduates and community members.',
