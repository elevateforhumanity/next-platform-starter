...
export const programs: MarketingProgram[] = [
  {
    ...
    description:
      'Complete 2,000 hours of training (1,500 OJT + 500 RTI) to earn your Indiana Barber License.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'Haircutting, sanitation, client service, state-aligned skill development, and practical readiness.',
      },
      {
        heading: 'Who this is for',
        body: 'Learners seeking a structured pathway into barbering with clear progression and support.',
      },
    ],
  },
  {
    ...
    description:
      'EPA 608 Universal certification proctored on-site. 12 weeks. WIOA and Workforce Ready Grant funding available for eligible Indiana residents.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'Refrigeration fundamentals, electrical systems, EPA 608 certification prep, and hands-on equipment service.',
      },
      {
        heading: 'Funding available',
        body: 'WIOA and Indiana Workforce Ready Grant funding available for eligible residents.',
      },
    ],
  },
  {
    ...
    description:
      'Clinical rotations at licensed healthcare facilities. State exam proctored on-site. WIOA and Workforce Ready Grant funding available for eligible Indiana residents.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'Patient care, vital signs, infection control, and clinical skills required for Indiana CNA licensure.',
      },
      {
        heading: 'Funding available',
        body: 'WIOA and Indiana Workforce Ready Grant funding available for eligible residents.',
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Clinical procedures, EHR systems, medical billing basics, and patient communication.',
      },
  ...
  },
  {
    ...
    description:
      'Prepare for the NHA Certified Phlebotomy Technician (CPT) exam and enter healthcare within a month.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'Venipuncture, specimen handling, infection control, and clinical lab procedures.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Personal care, medication assistance, patient safety, and documentation for in-home care settings.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Hair cutting, coloring, chemical services, skin care, and salon business operations.',
      },
  ...
  },
  {
    ...
    description:
      'Skin analysis, facial treatments, hair removal, and business startup — WIOA funded.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'Skin science, facial treatments, hair removal, client services, and business fundamentals.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Nail care, gel and acrylic application, sanitation, and client services.',
      },
  ...
  },
  {
    ...
    description:
      'Prepare for AWS certifications and enter the skilled trades workforce in 10 weeks.',
    ctaLabel: 'Apply Now',
    ctaHref: 'https://learn.elevateforhumanity.org/apply',
    sections: [
      {
        heading: 'What you will learn',
        body: 'MIG, TIG, and stick welding techniques, blueprint reading, and workplace safety.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Electrical theory, NEC code, residential and commercial wiring, and safety practices.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Pipe fitting, fixture installation, drainage systems, and plumbing code.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Pre-trip inspection, backing maneuvers, road driving, and DOT regulations.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Network security, threat analysis, incident response, and security operations.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Hardware troubleshooting, OS support, networking basics, and customer service.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Python programming, databases, version control, and software development practices.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'HTML, CSS, JavaScript, responsive design, and WordPress development.',
      },
      {
        heading: 'Credentials earned',
        body: 'Meta Front-End Developer and WordPress certifications.',
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Individual and small business returns, IRS regulations, and professional tax software.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Accounts payable/receivable, payroll basics, financial reporting, and QuickBooks.',
      },
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What you will learn',
        body: 'Project planning, Agile/Scrum, risk management, and stakeholder communication.',
      },
