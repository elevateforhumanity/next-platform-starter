...
export const programs: MarketingProgram[] = [
  ...
  },
  {
    slug: 'hvac-technician',
    title: 'HVAC Technician',
    summary: 'Install, service, and repair heating, cooling, and refrigeration systems.',
    description: '12-week program. EPA 608 certification included.',
    ctaLabel: 'Apply Now',
    ctaHref: '/programs/hvac-technician/apply',
    sections: [
      { heading: 'What you will learn', body: 'HVAC fundamentals, refrigerant handling, electrical systems, and EPA 608 exam prep.' },
      { heading: 'Credential earned', body: 'EPA 608 Universal Certification.' },
    ],
  },
  {
    slug: 'cosmetology-apprenticeship',
  ...
  },
  {
    slug: 'nail-technician-apprenticeship',
    title: 'Nail Technician Apprenticeship',
    summary: 'Earn your Indiana Nail Technician License while getting paid to train.',
    ...
    sections: [
      { heading: 'What you will learn', body: 'Manicuring, pedicuring, nail enhancements, sanitation, and client services.' },
      { heading: 'Credential earned', body: 'Indiana Nail Technician License.' },
    ],
  },
  {
    slug: 'esthetician',
    title: 'Esthetician',
    summary: 'Earn your Indiana Esthetician License in 5 weeks.',
    description: '750-hour program covering skincare, facials, waxing, and makeup.',
    ctaLabel: 'Apply Now',
    ctaHref: '/programs/esthetician/apply',
    sections: [
      { heading: 'What you will learn', body: 'Skin analysis, facials, chemical exfoliation, waxing, makeup application, and business skills.' },
  ...
  },
  {
    ...
    summary: 'Earn while you train in a professional kitchen. ServSafe certification included.',
    description: 'DOL Registered Apprenticeship — 26 weeks. Wages from day one.',
    ctaLabel: 'Apply Now',
    ctaHref: '/programs/culinary-apprenticeship/apply',
    sections: [
      { heading: 'What you will learn', body: 'Knife skills, cooking techniques, food safety, menu planning, and kitchen management.' },
      { heading: 'Credential earned', body: 'ServSafe Food Handler and Manager certifications.' },
    ],
  },
  {
    slug: 'peer-recovery-specialist',
    title: 'Peer Recovery Specialist',
    summary: 'Help others overcome addiction and mental health challenges. Indiana CPRS certification in 8 weeks.',
    description: 'WIOA and FSSA IMPACT funding available for eligible Indiana residents.',
    ctaLabel: 'Apply Now',
