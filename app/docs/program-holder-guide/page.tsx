...
const sections = [
  {
    ...
    items: ['Add new students', 'Track enrollment status', 'Monitor progress', 'Generate reports'],
  },
  {
    icon: FileText,
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-xl p-6 mb-8">
          ...
          <p className="text-brand-blue-800 mb-4">
            Welcome to the Elevate Program Holder Portal. This guide will help you manage your
          ...
          <div className="flex gap-4">
            ...
            <Link
              ...
              className="px-4 py-2 border border-brand-blue-600 text-brand-blue-600 rounded-lg hover:bg-brand-blue-50"
            >
              Quick Start
            </Link>
          </div>
