...
const steps = [
  ...
  },
  {
    ...
    desc: 'Add your organization details and contact information.',
    link: '/settings/profile',
  },
  {
    num: 3,
    title: 'Add Your Programs',
    desc: 'Set up your training programs with curriculum and schedules.',
    link: '/program-holder/programs',
  },
  {
    num: 4,
    title: 'Invite Your Team',
    desc: 'Add instructors and staff members to your organization.',
    link: '/settings/team',
  },
  {
    num: 5,
    title: 'Enroll Students',
    desc: 'Start enrolling students in your programs.',
    link: '/program-holder/students',
  },
  {
    num: 6,
    title: 'Track Progress',
    desc: 'Monitor student progress and generate reports.',
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-4">
          {steps.map((step) => (
            <div
              key={step.num}
              className="bg-white rounded-xl shadow-sm border p-6 flex items-center gap-6"
            >
        ...
        <div className="mt-8 bg-brand-green-50 border border-brand-green-200 rounded-xl p-6">
          ...
          <p className="text-brand-green-800">
            Once you complete these steps, you will have a fully functional training program ready
            to accept students.
          </p>
        </div>
      </div>
