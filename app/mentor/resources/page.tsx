  ...
  const resources = [
    {
      ...
      type: 'pdf',
      category: 'Training',
      url: '/documents/mentor-best-practices.pdf',
    },
    {
      id: '2',
          ...
          {resources.map((resource) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 rounded-lg ${resource.type === 'video' ? 'bg-brand-blue-100' : 'bg-brand-blue-100'}`}
                >
                  {resource.type === 'video' ? (
                ...
                <div className="flex-1">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 text-brand-blue-600 hover:text-brand-blue-700 text-sm"
                  >
                    {resource.type === 'video' ? (
                      <>
