...
export default function LoginForm() {
  ...
  const redirectParam = validateRedirect(
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        window.location.href = 'https://admin.elevateforhumanity.org/admin/dashboard';
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-8">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center">
            <input
              type="checkbox"
              className="h-4 w-4 text-brand-blue-600 focus:ring-brand-blue-500 border-slate-300 rounded"
            />
      ...
      <p className="mt-6 text-center text-sm text-black">
        ...
        <Link href="/signup" className="text-brand-blue-600 hover:text-brand-blue-700 font-medium">
          Sign up
        </Link>
      </p>
    </div>
