...
export const metadata: Metadata = {
  ...
  description:
    'How we collect, use, protect, and share your personal information and educational records.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              Elevate for Humanity ("we," "us," "our") is committed to protecting your privacy. This
              Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you use our website, learning management system, and services. We comply with
              FERPA, GDPR, CCPA, and other applicable privacy laws.
            </p>
            ...
            <p className="text-black mb-4">We collect information you provide directly:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              ...
              <li>
                <strong>Identification:</strong> Date of birth, Social Security number (for
                enrollment), government ID
              </li>
              <li>
                <strong>Demographic Information:</strong> Gender, race/ethnicity (optional, for
                reporting)
              </li>
              <li>
                <strong>Emergency Contacts:</strong> Names and contact information
              </li>
              <li>
                <strong>Employment Information:</strong> Work history, employer details
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Educational Records</h3>
            <p className="text-black mb-4">Protected under FERPA:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Automatically collected:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              ...
              (Stripe). We do not store full credit card numbers. We retain transaction records and
              payment history.
            </p>
            ...
            <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Provide Services:</strong> Deliver educational programs, process
                  enrollments, issue credentials
                </li>
                <li>
                  <strong>Communication:</strong> Send important updates, announcements, and support
                  responses
                </li>
                <li>
                  <strong>Improvement:</strong> Analyze usage to improve platform and services
                </li>
                <li>
                  <strong>Compliance:</strong> Meet legal and regulatory requirements
                </li>
                <li>
                  <strong>Safety:</strong> Protect against fraud, abuse, and security threats
                </li>
                <li>
                  <strong>Research:</strong> Conduct educational research (anonymized data)
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-6">
              We share information when you authorize us to do so, such as sharing credentials with
              employers or transcripts with other institutions.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Service Providers</h3>
            <p className="text-black mb-4">We share with third parties who help us operate:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">We disclose information when required by law:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              For government-funded programs, we share required information with funding agencies
              (WIOA, Vocational Rehabilitation, VA, etc.) for eligibility verification and
              reporting.
            </p>
            ...
            <div className="bg-green-50 rounded-xl p-6 border-2 border-green-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                ...
                <li>
                  <strong>Correct:</strong> Request correction of inaccurate information
                </li>
                <li>
                  <strong>Delete:</strong> Request deletion (subject to legal requirements)
                </li>
                <li>
                ...
                <li>
                  <strong>Portability:</strong> Receive your data in portable format
                </li>
                <li>
                  <strong>Opt-Out:</strong> Unsubscribe from marketing communications
                </li>
                <li>
                  <strong>Complain:</strong> File complaints with supervisory authorities
                </li>
              </ul>
            </div>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">FERPA Rights</h3>
            <p className="text-black mb-4">Under FERPA, students have the right to:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">We protect your information through:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              In the event of a data breach affecting your information, we will notify you and
              relevant authorities as required by law, typically within 72 hours of discovery.
            </p>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              <ul className="space-y-3 text-black">
                ...
                <li>
                  <strong>Performance Cookies:</strong> Help us understand usage patterns
                </li>
                <li>
                  <strong>Functional Cookies:</strong> Remember your preferences
                </li>
                <li>
                  <strong>Marketing Cookies:</strong> Track effectiveness of campaigns
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">We retain information as follows:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Transcripts:</strong> Permanent
              </li>
              <li>
                <strong>Student Records:</strong> 7 years after last enrollment
              </li>
              <li>
                <strong>Financial Records:</strong> 7 years
              </li>
              <li>
                <strong>Application Data:</strong> 2-3 years
              </li>
              <li>
            ...
            <p className="text-black mb-6">
              See our{' '}
              <a href="/policies/data-retention" className="text-blue-600 hover:underline">
            ...
            <p className="text-black mb-6">
              Our services are not directed to children under 16. Students aged 16-17 require
              parental consent for enrollment. We do not knowingly collect information from children
              under 16 without parental consent.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">International Users</h2>
            <p className="text-black mb-6">
              Our services are based in the United States. If you access from outside the U.S., your
              information will be transferred to and processed in the U.S. By using our services,
            ...
            <p className="text-black mb-6">
              ...
              email or prominent notice on our website. Continued use after changes constitutes
              acceptance.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">Contact Us</h2>
            <p className="text-black mb-4">For privacy questions or to exercise your rights:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              <li>
                <strong>Privacy Officer:</strong> privacy@www.elevateforhumanity.org
              </li>
              <li>
            ...
            <p className="text-black mb-4">To file a FERPA complaint:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              <li>
                <strong>Family Policy Compliance Office</strong>
              </li>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mt-8">
              ...
              <ul className="list-disc pl-6 text-black space-y-1">
                <li>
                  <a href="/policies/ferpa" className="text-blue-600 hover:underline">
                    FERPA Policy
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/policies/acceptable-use" className="text-blue-600 hover:underline">
