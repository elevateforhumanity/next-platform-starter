...
export const metadata: Metadata = {
  ...
  description:
    'Legal terms for using our platform and services, user responsibilities, and limitations of liability.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              These Terms of Service ("Terms") govern your access to and use of Elevate for
              Humanity's website, learning management system, and related services (collectively,
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>"We," "Us," "Our":</strong> Elevate for Humanity
              </li>
              <li>
                <strong>"You," "Your":</strong> The user of the Platform
              </li>
              <li>
                <strong>"Platform":</strong> Our website, LMS, and all related services
              </li>
              <li>
                <strong>"Content":</strong> All materials, information, and data on the Platform
              </li>
              <li>
                <strong>"Services":</strong> Educational programs, training, and related offerings
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">Eligibility</h2>
            <p className="text-black mb-4">To use the Platform, you must:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">When creating an account:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              ...
              for any loss or damage from unauthorized use of your account.
            </p>
            ...
            <p className="text-black mb-6">
              ...
              and use the Platform for personal, educational purposes in accordance with these
              Terms.
            </p>
            ...
            <p className="text-black mb-6">
              All Platform content, including text, graphics, logos, images, software, and course
              materials, is owned by or licensed to Elevate for Humanity and protected by copyright,
              trademark, and other intellectual property laws.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Your Content</h3>
            <p className="text-black mb-4">When you post content on the Platform:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">For paid services:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              Refund policies vary by program. See specific program terms or contact admissions for
              details. Generally, refunds are prorated based on completion percentage and timing of
              withdrawal.
            </p>
            ...
            <p className="text-black mb-4">We may suspend or terminate your access:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-6 mb-6">
              <p className="text-black mb-4">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, ELEVATE FOR HUMANITY SHALL NOT BE LIABLE
                FOR:
              </p>
              <ul className="list-disc pl-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              You agree to indemnify, defend, and hold harmless Elevate for Humanity, its officers,
              directors, employees, and agents from any claims, damages, losses, liabilities, and
              expenses (including attorney fees) arising from your use of the Platform or violation
              of these Terms.
            </p>
            ...
            <p className="text-black mb-6">
              Before filing a claim, contact us at legal@www.elevateforhumanity.org to attempt
              informal resolution.
            </p>
            ...
            <p className="text-black mb-6">
              ...
              accordance with the American Arbitration Association rules. Arbitration shall take
              place in Indianapolis, Indiana.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Class Action Waiver</h3>
            <p className="text-black mb-6">
              You agree to bring claims only in your individual capacity and not as part of any
            ...
            <p className="text-black mb-6">
              We may modify these Terms at any time. Changes effective upon posting. Continued use
              constitutes acceptance of modified Terms. Material changes will be notified via email
              or Platform notice.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Severability</h3>
            <p className="text-black mb-6">
              If any provision is found invalid or unenforceable, remaining provisions remain in
              full effect.
            </p>
            ...
            <p className="text-black mb-6">
              ...
              constitute the entire agreement between you and Elevate for Humanity.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">Contact Information</h2>
            <p className="text-black mb-4">For questions about these Terms:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              <li>
                <strong>Email:</strong> legal@www.elevateforhumanity.org
              </li>
              <li>
                <strong>Phone:</strong> (317) 314-3757
              </li>
              <li>
                <strong>Mail:</strong> Elevate for Humanity
              </li>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mt-8">
              ...
              <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <li>
                  <a href="/policies/copyright" className="text-blue-600 hover:underline">
                    Copyright Policy
                  </a>
                </li>
                <li>
                  <a href="/policies/student-code" className="text-blue-600 hover:underline">
