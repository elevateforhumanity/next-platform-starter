...
export const metadata: Metadata = {
  ...
  description:
    'Protection of intellectual property, fair use guidelines, and DMCA compliance procedures.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This Copyright Policy explains the intellectual property rights related to content on
              Elevate for Humanity platforms, including our materials, user-generated content, and
              third-party content. We respect intellectual property rights and expect our community
              to do the same.
            </p>
            ...
            <div className="bg-brand-blue-50 rounded-xl p-6 border-2 border-brand-blue-200 mb-6">
              ...
              <p className="text-black mb-4">
                Unless otherwise noted, all content on Elevate for Humanity platforms is owned by or
                licensed to us:
              </p>
            ...
            <p className="text-black mb-4">Students and authorized users may:</p>
            ...
            <div className="bg-brand-red-50 rounded-lg p-6 border-2 border-brand-red-200 mb-6">
              <p className="text-black mb-4">You may NOT:</p>
              <ul className="list-disc pl-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">When you create and post content on our platforms:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>You retain copyright ownership</strong> of your original work
              </li>
              <li>
                <strong>You control</strong> how your work is used outside our platforms
              </li>
              <li>
                <strong>You can delete</strong> your content at any time (subject to backups)
              </li>
              <li>
                <strong>You receive credit</strong> for your work when displayed
              </li>
            </ul>
            ...
            <div className="bg-slate-50 rounded-lg p-6 border-2 border-slate-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Non-exclusive license:</strong> We don't own your content exclusively
                </li>
                <li>
                  <strong>Worldwide license:</strong> Can be displayed globally
                </li>
                <li>
                  <strong>Royalty-free license:</strong> No payment required for use
                </li>
                <li>
                  <strong>Sublicensable license:</strong> Can allow others to view/use
                </li>
                <li>
                  <strong>Transferable license:</strong> Continues if platform ownership changes
                </li>
              </ul>
              <p className="text-black mt-4">This license allows us to:</p>
              <ul className="list-disc pl-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">When posting content, you represent that:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              These materials are subject to their own copyright and licensing terms. Use only as
              authorized.
            </p>
            ...
            <p className="text-black mb-6">
              We use some openly licensed educational materials. These are typically licensed under
              Creative Commons or similar licenses. Check individual materials for specific
              licensing terms.
            </p>
            ...
            <div className="bg-brand-green-50 rounded-xl p-6 border-2 border-brand-green-200 mb-6">
              ...
              <p className="text-black mb-4">
                Fair use allows limited use of copyrighted materials for educational purposes
                without permission. Factors considered:
              </p>
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Purpose:</strong> Nonprofit educational use favors fair use
                </li>
                <li>
                  <strong>Nature:</strong> Factual works more likely fair use than creative works
                </li>
                <li>
                  <strong>Amount:</strong> Using small portions favors fair use
                </li>
                <li>
                  <strong>Effect:</strong> Not harming market for original favors fair use
                </li>
              </ul>
            </div>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Fair Use Guidelines</h3>
            <p className="text-black mb-4">When using copyrighted materials under fair use:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              We comply with the DMCA and respond to valid copyright infringement notices. We also
              respect the DMCA safe harbor provisions for user-generated content.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Filing a DMCA Notice</h3>
            <p className="text-black mb-4">
              If you believe content on our platform infringes your copyright, send a written notice
              to our DMCA agent including:
            </p>
            <ol className="list-decimal pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Your contact information:</strong> Name, address, phone, email
              </li>
              <li>
                <strong>Identification of copyrighted work:</strong> Describe the work being
                infringed
              </li>
              <li>
              ...
              <li>
                <strong>Good faith statement:</strong> State you believe use is not authorized
              </li>
              <li>
                <strong>Accuracy statement:</strong> Declare information is accurate under penalty
                of perjury
              </li>
              <li>
                <strong>Authorization:</strong> Physical or electronic signature of copyright owner
                or agent
              </li>
            </ol>
            ...
            <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200 mb-6">
              ...
              <ul className="list-none text-black space-y-2">
                ...
                <li>
                  <strong>Mail:</strong> DMCA Agent, Elevate for Humanity
                </li>
            ...
            <p className="text-black mb-4">
              If your content was removed due to a DMCA notice and you believe it was removed in
              error, you may file a counter-notice including:
            </p>
            <ol className="list-decimal pl-6 mb-6 text-black space-y-2">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                ...
                <li>
                  <strong>Second offense:</strong> Temporary suspension (30 days)
                </li>
                <li>
            ...
            <p className="text-black mb-4">Elevate for Humanity trademarks include:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              Use of our trademarks requires written permission. Contact our contact form for
            ...
            <p className="text-black mb-4">When citing Elevate for Humanity materials:</p>
            <div className="bg-slate-50 rounded-lg p-4 border-2 border-slate-200 mb-6">
            ...
            <p className="text-black mb-4">For copyright questions or permission requests:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              <li>
                <strong>General Questions:</strong> our contact form
              </li>
              <li>
                <strong>DMCA Notices:</strong> our contact form
              </li>
              <li>
                <strong>Permission Requests:</strong> our contact form
              </li>
              <li>
                <strong>Trademark Licensing:</strong> our contact form
              </li>
              <li>
                <strong>Phone:</strong> (317) 314-3757
              </li>
            ...
            <div className="bg-brand-blue-50 border-l-4 border-brand-blue-400 p-6 mt-8">
              ...
              <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <li>
                  <a href="/policies/terms" className="text-brand-blue-600 hover:underline">
                    Terms of Service
                  </a>
                </li>
              </ul>
