...
export const metadata: Metadata = {
  ...
  description:
    'Disaster recovery procedures and business continuity practices for the Elevate platform.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12 mt-6">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-bold text-black m-0">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <ul className="space-y-3 text-black m-0 list-none p-0">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Automated daily backups</strong> via Supabase infrastructure
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Point-in-time recovery (PITR)</strong> capability
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>7-day retention</strong> for backup snapshots
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Encrypted at rest</strong> using AES-256
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <ul className="space-y-3 text-black m-0 list-none p-0">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Version controlled</strong> in GitHub with full history
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Immutable deployments</strong> via Netlify
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Instant rollback</strong> to previous deployments
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <ul className="space-y-3 text-black m-0 list-none p-0">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Redundant storage</strong> via Supabase Storage (S3-compatible)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    <strong>Multi-region replication</strong> for uploaded files
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-black m-0">
                  <strong>Expected Recovery:</strong> 15-30 minutes
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-black mb-2">
                  <strong>Response:</strong> Instant rollback to previous stable deployment
                </p>
                <p className="text-black m-0">
                  <strong>Expected Recovery:</strong> &lt; 5 minutes
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-black mb-2">
                  <strong>Response:</strong> Monitor provider status, communicate with users,
                  restore when available
                </p>
                <p className="text-black m-0">
                  <strong>Expected Recovery:</strong> Dependent on provider
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-black m-0">
                  <strong>Expected Recovery:</strong> 30-60 minutes
                </p>
              </div>
            </div>
            ...
            <ol className="list-decimal pl-6 mb-6 text-black space-y-3">
              <li>
                <strong>Detection:</strong> Automated monitoring alerts team to incident
              </li>
              <li>
                <strong>Assessment:</strong> Determine scope and impact of the incident
              </li>
              <li>
                <strong>Communication:</strong> Notify affected users via status page and email
              </li>
              <li>
                <strong>Recovery:</strong> Execute appropriate recovery procedure
              </li>
              <li>
                <strong>Validation:</strong> Verify system functionality and data integrity
              </li>
              <li>
            ...
            <p className="text-black mb-4">
              Disaster recovery procedures are tested quarterly to ensure effectiveness and identify
              areas for improvement. Tests are conducted in isolated environments without impacting
              production systems.
            </p>
            ...
            <div className="bg-brand-green-50 border-2 border-brand-green-200 rounded-lg p-6 mb-6">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-slate-400 flex-shrink-0">•</span>
                <h3 className="text-lg font-bold text-brand-green-800 m-0">
                  Latest DR Test: Passed
                </h3>
              </div>
              <p className="text-black mb-3">
                Our most recent disaster recovery drill was completed successfully on January 24,
                2026.
              </p>
              <Link
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <ul className="space-y-2 text-black m-0">
                ...
                <li>
                  <strong>Operations:</strong> Monitor systems, coordinate incident response
                </li>
                <li>
                  <strong>Communications:</strong> Notify users and stakeholders during incidents
                </li>
              </ul>
            </div>
