        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This Service Level Agreement (SLA) establishes expected response times for various
              types of inquiries and support requests. We are committed to providing timely, helpful
              responses to students, applicants, employers, and other stakeholders.
            </p>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <ul className="space-y-2 text-black">
                ...
                <li>
                  <strong>Application status:</strong> 2-3 business days
                </li>
                <li>
                  <strong>Document verification:</strong> 3-5 business days
                </li>
                <li>
                  <strong>Enrollment questions:</strong> Same business day
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <ul className="space-y-2 text-black">
                <li>
                  <strong>Academic advising:</strong> 24-48 hours
                </li>
                <li>
                  <strong>Technical support:</strong> 4-8 hours
                </li>
                <li>
                  <strong>Financial aid:</strong> 2-3 business days
                </li>
                <li>
                  <strong>Career services:</strong> 48 hours
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <ul className="space-y-2 text-black">
                <li>
                  <strong>Transcript requests:</strong> 3-5 business days
                </li>
                <li>
                  <strong>Credential verification:</strong> 1-2 business days
                </li>
                <li>
                  <strong>Enrollment verification:</strong> Same business day
                </li>
                <li>
                  <strong>Grade inquiries:</strong> 24-48 hours
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <ul className="space-y-2 text-black">
                <li>
                  <strong>Critical system issues:</strong> 1 hour
                </li>
                <li>
                  <strong>Login/access problems:</strong> 4 hours
                </li>
                <li>
                  <strong>General tech support:</strong> 8-24 hours
                </li>
                <li>
                  <strong>Feature requests:</strong> 5 business days
                </li>
              </ul>
            </div>
            ...
            <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200 mb-6">
              <ul className="space-y-2 text-black">
                ...
                <li>
                  <strong>Saturday:</strong> 9:00 AM - 1:00 PM EST (limited services)
                </li>
                <li>
                  <strong>Sunday:</strong> Closed
                </li>
                <li>
                  <strong>Holidays:</strong> Closed (see holiday schedule)
                </li>
              </ul>
              <p className="text-black mt-4">
                Response times are calculated based on business hours. Requests received outside
                business hours will be addressed on the next business day.
              </p>
            </div>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">Exceptions</h2>
            <p className="text-black mb-4">Response times may be extended during:</p>
            ...
            <p className="text-black mb-4">All responses will:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">For inquiries and support:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              ...
              <li>
                <strong>Emergency:</strong> (317) 314-3757 ext. 911
              </li>
            </ul>
