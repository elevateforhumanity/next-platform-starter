...
export const metadata: Metadata = {
  ...
  description:
    'Standards for honest academic work, prohibited behaviors, and consequences for violations of academic integrity.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              Elevate for Humanity is committed to maintaining the highest standards of academic
              integrity. This policy establishes expectations for honest academic work and outlines
              consequences for violations. Academic integrity is fundamental to the educational
              process and essential for the value of credentials we issue.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              ...
              <li>
                Maintain honesty in all academic activities including exams, assignments, and
                assessments
              </li>
            ...
            <p className="text-black mb-4">
              Students, instructors, and staff who suspect academic integrity violations should
            ...
            <p className="text-black mb-6">
              All reports are investigated confidentially. Retaliation against individuals who
              report violations is prohibited.
            </p>
            ...
            <div className="bg-brand-blue-50 border-l-4 border-brand-blue-400 p-6 mt-8">
              ...
              <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <li>
                  <a href="/policies/ai-usage" className="text-brand-blue-600 hover:underline">
                    AI Usage Policy
                  </a>
                </li>
                <li>
