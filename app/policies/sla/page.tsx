        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12 mt-6">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              ...
              commitments, and remedies for the Elevate for Humanity platform. It applies to all
              paying customers and institutional partners.
            </p>
            ...
            <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-2xl font-bold text-brand-blue-800 m-0">
            ...
            <div className="bg-brand-green-50 rounded-lg p-6 border-2 border-brand-green-200 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-brand-green-800 m-0">
            ...
            <div className="bg-slate-50 rounded-lg p-6 mb-6">
              <ul className="space-y-3 text-black m-0 list-none p-0">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Credits apply <strong>only to future invoices</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    Credits are <strong>non-cumulative</strong> and capped at 10% per billing cycle
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    Credits must be <strong>requested within 30 days</strong> of the affected period
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span>
                    Credits do <strong>not apply to one-time fees</strong> or third-party services
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 overflow-hidden mb-6">
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-slate-200">
                  <tr>
                    <td className="px-4 py-3 text-black font-semibold text-brand-red-600">
                      Critical
                    </td>
                    <td className="px-4 py-3 text-black">
                      Platform down, data breach, security incident
                    </td>
                    <td className="px-4 py-3 text-black">4 hours</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 text-black font-semibold text-brand-orange-600">
                      High
                    </td>
                    <td className="px-4 py-3 text-black">
                      Major feature unavailable, payment issues
                    </td>
            ...
            <p className="text-black mb-6">
              Response times are measured during business hours: Monday–Friday, 8:00 AM – 6:00 PM
              EST.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Maintenance Window:</strong> Sundays, 2:00 AM – 6:00 AM EST
              </li>
              <li>
                <strong>Advance Notice:</strong> 48 hours minimum for planned maintenance
              </li>
              <li>
            ...
            <ol className="list-decimal pl-6 mb-6 text-black space-y-2">
              <li>
                Email <strong>Contact Us</strong> within 30 days of the incident
              </li>
            ...
            <ul className="list-none mb-6 text-black space-y-2 p-0">
              <li>
                <strong>General Support:</strong> our contact form
              </li>
              <li>
                <strong>Billing Questions:</strong> our contact form
              </li>
              <li>
