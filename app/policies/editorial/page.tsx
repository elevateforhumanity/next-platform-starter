...
export const metadata: Metadata = {
  ...
  description:
    'Standards for published content, editorial review processes, and content quality guidelines.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This Editorial Policy establishes standards for content published by Elevate for
              Humanity, including website content, blog posts, course materials, communications, and
              marketing materials. These guidelines ensure accuracy, clarity, consistency, and
              professionalism in all published content.
            </p>
            ...
            <div className="bg-brand-blue-50 rounded-xl p-6 border-2 border-brand-blue-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Accuracy:</strong> All information must be factually correct and verified
                </li>
                <li>
                  <strong>Clarity:</strong> Content should be clear, concise, and easily understood
                </li>
                <li>
                  <strong>Accessibility:</strong> Written for diverse audiences with varying
                  literacy levels
                </li>
                <li>
                  <strong>Integrity:</strong> Honest, transparent, and ethical in all communications
                </li>
                <li>
                  <strong>Respect:</strong> Inclusive language that respects all individuals and
                  groups
                </li>
                <li>
                  <strong>Professionalism:</strong> Maintains institutional reputation and
                  credibility
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">Promotional materials must:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Blog posts and news articles must:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Professional yet approachable:</strong> Maintain credibility while being
                accessible
              </li>
              <li>
                <strong>Active voice:</strong> Use active voice for clarity and directness
              </li>
              <li>
                <strong>Positive and encouraging:</strong> Focus on opportunities and solutions
              </li>
              <li>
                <strong>Inclusive:</strong> Use language that welcomes all individuals
              </li>
              <li>
                <strong>Consistent:</strong> Maintain consistent voice across all content
              </li>
            </ul>
            ...
            <p className="text-black mb-4">All factual claims must be verified through:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              Properly cite all sources using appropriate citation style (APA, MLA, Chicago).
              Include links to online sources. Give credit to original authors and creators.
            </p>
            ...
            <p className="text-black mb-4">When errors are discovered:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">
              Content should be reviewed and updated regularly to ensure accuracy and relevance.
            ...
            <p className="text-black mb-6">
              Respect intellectual property rights. Only use copyrighted material with permission or
              under fair use. See our Copyright Policy for details.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Privacy and Confidentiality</h3>
            <p className="text-black mb-6">
              Protect student and employee privacy. Do not publish personally identifiable
              information without consent. Follow FERPA and privacy regulations.
            </p>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Conflicts of Interest</h3>
            <p className="text-black mb-6">
              Disclose any conflicts of interest. Maintain editorial independence from commercial
              interests.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">Contact Editorial Team</h2>
            <p className="text-black mb-4">For editorial questions or submissions:</p>
