...
export const metadata: Metadata = {
  ...
  description:
    'Privacy notice for Elevate for Humanity learners, partners, and visitors. Learn how we collect, use, protect, and share your personal information.',
  keywords: [
    'privacy notice',
    'data collection',
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumbs
          items={[{ label: 'Policies', href: '/policies' }, { label: 'Privacy Notice' }]}
        />
        <article className="prose prose-lg max-w-none mt-6">
          ...
          <div className="bg-brand-blue-50 border-l-4 border-brand-blue-500 p-6 mb-8">
            ...
            <p className="text-brand-blue-800">
              Elevate for Humanity is committed to protecting your privacy and handling your
              personal information with care and transparency. This notice explains what information
          ...
          <section className="mb-12">
            ...
            <p>
              This Privacy Notice describes how Elevate for Humanity ("we," "us," or "our")
              collects, uses, discloses, and protects personal information from:
            </p>
            <ul>
              <li>
                <strong>Learners:</strong> Students enrolled in our programs
              </li>
              <li>
                <strong>Prospective Learners:</strong> Individuals inquiring about our programs
              </li>
              <li>
                <strong>Partners:</strong> Employers, instructors, and organizational partners
              </li>
              <li>
                <strong>Visitors:</strong> Users of our website and platforms
              </li>
            </ul>
            <p>
              This notice supplements our comprehensive{' '}
              <Link
              ...
              and provides specific information about data practices.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul>
              <li>
                <strong>Application Forms:</strong> Information you provide when applying to
                programs
              </li>
              <li>
                <strong>Enrollment Process:</strong> Data collected during registration and
                onboarding
              </li>
              <li>
                <strong>Account Creation:</strong> Information provided when creating user accounts
              </li>
              <li>
                <strong>Course Activities:</strong> Data from assignments, assessments, and
                participation
              </li>
              <li>
                <strong>Communications:</strong> Information from emails, chats, and support
                requests
              </li>
            </ul>
            ...
            <ul>
              <li>
                <strong>Platform Usage:</strong> Automatic logging of system interactions
              </li>
              <li>
                <strong>Cookies:</strong> Browser cookies for functionality and analytics
              </li>
              <li>
                <strong>Analytics Tools:</strong> Usage patterns and performance metrics
              </li>
              <li>
                <strong>Learning Management System:</strong> Course progress and engagement data
              </li>
            </ul>
            ...
            <ul>
              <li>
                <strong>Educational Institutions:</strong> Transcripts and verification
              </li>
              <li>
                <strong>Employers:</strong> Employment verification and referrals
              </li>
              <li>
                <strong>Government Agencies:</strong> Eligibility verification for funding programs
              </li>
              <li>
                <strong>Background Check Providers:</strong> When required for program participation
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>We share information when you explicitly authorize us to do so, such as:</p>
            <ul>
            ...
            <p>
              All service providers are contractually required to protect your information and use
            ...
            <ul>
              <li>
                <strong>Instructors:</strong> Course-related information for teaching purposes
              </li>
              <li>
                <strong>Employers:</strong> Program completion and credential verification (with
                consent)
              </li>
              <li>
                <strong>Partner Organizations:</strong> Referral and co-enrollment information
              </li>
            </ul>

            <h3>Government Agencies</h3>
            <p>We share information as required by law with:</p>
            <ul>
          ...
          <section className="mb-12">
            ...
            <ul>
              ...
              <li>
                <strong>Monitoring:</strong> Continuous security monitoring and threat detection
              </li>
              <li>
                <strong>Audits:</strong> Regular security assessments and penetration testing
              </li>
              <li>
                <strong>Training:</strong> Staff trained on data protection and privacy practices
              </li>
              <li>
                <strong>Incident Response:</strong> Procedures for detecting and responding to
                breaches
              </li>
            </ul>
            ...
            <p>
              We collect only the information necessary for legitimate educational and operational
              purposes. We regularly review data holdings and delete information that is no longer
              needed.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              Under the Family Educational Rights and Privacy Act (FERPA), eligible students have
              the right to:
            </p>
            <ul>
            ...
            <ul>
              ...
              <li>
                <strong>Deletion:</strong> Request deletion of information (subject to retention
                requirements)
              </li>
              <li>
                <strong>Portability:</strong> Receive your information in a portable format
              </li>
              <li>
                <strong>Opt-Out:</strong> Opt out of marketing communications
              </li>
              <li>
                <strong>Restriction:</strong> Request restrictions on processing
              </li>
            </ul>

            <h3>State-Specific Rights</h3>
            <p>Residents of certain states have additional rights:</p>
            <ul>
              <li>
                <strong>California (CCPA/CPRA):</strong> Right to know, delete, and opt-out of sale
              </li>
              <li>
                <strong>Virginia (VCDPA):</strong> Right to access, correct, delete, and opt-out
              </li>
              <li>
                <strong>Colorado (CPA):</strong> Right to access, correct, delete, and opt-out
              </li>
              <li>
                <strong>Connecticut (CTDPA):</strong> Right to access, correct, delete, and opt-out
              </li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <ul>
              ...
              <li>
                <strong>Analytics Cookies:</strong> Understand user behavior and engagement
              </li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <p>
              For learners aged 13-17, we require parental consent for enrollment and comply with
              applicable laws regarding minors' privacy.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              Our services are based in the United States. If you access our services from outside
              the U.S., your information will be transferred to and processed in the United States.
            </p>
            <p>
          ...
          <section className="mb-12">
            ...
            <p>
              We may update this Privacy Notice periodically to reflect changes in our practices or
          ...
          <section className="mb-12">
            ...
            <p>
              For questions about data protection and privacy compliance, contact our Data
            ...
            <ul>
              <li>
                <strong>FERPA Complaints:</strong> Family Policy Compliance Office, U.S. Department
                of Education
              </li>
              <li>
