    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <article className="prose prose-lg max-w-none mt-6">
          ...
          <h2>Overview</h2>
          <p>
            The Workforce Innovation and Opportunity Act (WIOA) provides funding for workforce
            development and training programs. This policy outlines eligibility requirements and our
          ...
          <h2>Contact</h2>
          <p>For WIOA eligibility questions:</p>
          <p>
            <strong>WorkOne Career Center</strong>
            <br />
            Email:{' '}
