...
export const metadata: Metadata = {
  ...
  description:
    'Requirements, procedures, and guidelines for program enrollment and admission to Elevate for Humanity training programs.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This Admissions Policy outlines the requirements, procedures, and guidelines for
              enrollment in Elevate for Humanity training programs. We are committed to providing
              equal access to education while ensuring students are prepared for success in their
              chosen programs.
            </p>
            ...
            <p className="text-black mb-6">
              Elevate for Humanity does not discriminate on the basis of race, color, national
              origin, sex, disability, age, religion, sexual orientation, gender identity, veteran
              status, or any other protected characteristic. We provide equal access to programs,
            ...
            <div className="bg-brand-blue-50 rounded-xl p-6 border-2 border-brand-blue-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Age:</strong> 18 years or older (16-17 with parental consent for select
                  programs)
                </li>
                <li>
                  <strong>Education:</strong> High school diploma, GED, or equivalent
                </li>
                <li>
                  <strong>Identification:</strong> Valid government-issued photo ID
                </li>
                <li>
                  <strong>Eligibility:</strong> Eligible to work in the United States
                </li>
                <li>
                  <strong>Funding:</strong> Verified funding source or payment plan
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black mb-2">
                      Complete the online application or visit our office to apply in person.
                      Provide:
                    </p>
                    <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black mb-2">Submit required documentation:</p>
                    <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black mb-2">Meet with an admissions advisor to:</p>
                    <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black mb-2">Confirm your funding source:</p>
                    <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black mb-2">Once approved:</p>
                    <ul className="list-disc pl-6 text-black space-y-1">
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-slate-200 mb-6">
              <ul className="space-y-3 text-black">
                ...
                <li>
                  <strong>Document Verification:</strong> 2-5 business days
                </li>
                <li>
                  <strong>Advisor Interview:</strong> Scheduled within 1 week of application
                </li>
                <li>
                  <strong>Funding Verification:</strong> 1-2 weeks (varies by funding source)
                </li>
                <li>
                  <strong>Enrollment Decision:</strong> Within 2 weeks of complete application
                </li>
                <li>
                  <strong>Start Date:</strong> Next available class start (typically 2-4 weeks)
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">
              We welcome applications from justice-involved individuals. Some programs may have
              restrictions based on the nature of convictions (particularly healthcare and positions
              working with vulnerable populations). We evaluate each application individually and
            ...
            <p className="text-black mb-4">International students must provide:</p>
            ...
            <p className="text-black mb-6">
              We provide reasonable accommodations for students with disabilities. Contact our
              Disability Services office during the application process to discuss needed
              accommodations. Documentation of disability may be required for certain
              accommodations.
            </p>
            ...
            <p className="text-black mb-4">If your application is denied, you may appeal:</p>
            ...
            <p className="text-black mb-6">
              Denied applicants may re-apply after addressing the reasons for denial. There is no
              waiting period for re-application unless specified in the denial letter. Contact
              admissions to discuss steps needed for successful re-application.
            </p>
            ...
            <ul className="list-none mb-6 text-black space-y-2">
              ...
              <li>
                <strong>Location:</strong> 3737 N Meridian St, Suite 200, Indianapolis, IN 46208
              </li>
              <li>
                <strong>Apply Online:</strong>{' '}
                <a href="/apply" className="text-brand-blue-600 hover:underline">
                  www.elevateforhumanity.org/apply
                </a>
              </li>
            </ul>
