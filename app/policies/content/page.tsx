...
export const metadata: Metadata = {
  ...
  description:
    'Guidelines for user-generated content, intellectual property rights, and content standards on our platforms.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This Content Policy governs user-generated content on Elevate for Humanity platforms,
              including discussion forums, social media, course submissions, and any other content
              created or shared by users. These guidelines ensure our platforms remain educational,
            ...
            <div className="bg-brand-green-50 rounded-xl p-6 border-2 border-brand-green-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Educational:</strong> Shares knowledge, insights, or learning resources
                </li>
                <li>
                  <strong>Supportive:</strong> Encourages and helps fellow community members
                </li>
                <li>
                  <strong>Constructive:</strong> Offers helpful feedback and suggestions
                </li>
                <li>
                  <strong>Relevant:</strong> Relates to education, career development, or community
                  topics
                </li>
                <li>
                  <strong>Original:</strong> Your own work or properly attributed content
                </li>
                <li>
                  <strong>Respectful:</strong> Maintains professional and courteous tone
                </li>
                <li>
                  <strong>Accurate:</strong> Factual and truthful information
                </li>
                <li>
                  <strong>Inclusive:</strong> Welcomes diverse perspectives and experiences
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">When you post content on our platforms:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>You retain ownership</strong> of your original content
              </li>
              <li>
                <strong>You grant us a license</strong> to display, distribute, and use your content
                on our platforms
              </li>
              <li>
                <strong>You represent</strong> that you have the right to post the content
              </li>
              <li>
                <strong>You are responsible</strong> for ensuring your content doesn't infringe
                others' rights
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Others' Content</h3>
            <p className="text-black mb-4">When using content created by others:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <p className="text-black mt-4">
                This license ends when you delete your content, except for content that has been
                shared or copied by others.
              </p>
            </div>
            ...
            <p className="text-black mb-4">Content should meet these quality standards:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Clear and Readable:</strong> Use proper grammar, spelling, and formatting
              </li>
              <li>
                <strong>Relevant:</strong> Stay on topic and contribute meaningfully
              </li>
              <li>
                <strong>Accurate:</strong> Verify facts and cite sources
              </li>
              <li>
                <strong>Complete:</strong> Provide sufficient context and information
              </li>
              <li>
                <strong>Appropriate:</strong> Suitable for educational environment
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Accessibility</h3>
            <p className="text-black mb-4">When creating content, consider accessibility:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Elevate for Humanity reserves the right to:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200 mb-6">
              <p className="text-black mb-4">Content may be moderated through:</p>
              <ul className="list-disc pl-6 text-black space-y-2">
                <li>
                  <strong>Automated Systems:</strong> AI and filters detect prohibited content
                </li>
                <li>
                  <strong>User Reports:</strong> Community members flag concerning content
                </li>
                <li>
                  <strong>Staff Review:</strong> Human moderators review flagged content
                </li>
                <li>
                  <strong>Proactive Monitoring:</strong> Regular review of high-traffic areas
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">If you encounter content that violates this policy:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">After you report content:</p>
            ...
            <p className="text-black mb-4">
              We comply with the Digital Millennium Copyright Act (DMCA). If you believe content
            ...
            <p className="text-black mb-4">If your content is removed or you face consequences:</p>
            <ol className="list-decimal pl-6 mb-6 text-black space-y-2">
