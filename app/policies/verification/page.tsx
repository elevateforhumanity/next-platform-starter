...
export const metadata: Metadata = {
  ...
  description:
    'Identity and eligibility verification procedures for students, credentials, and employment.',
  alternates: {
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This policy establishes procedures for verifying student identity, eligibility,
              credentials, and employment. Verification protects the integrity of our programs,
              ensures compliance with regulations, and provides reliable information to employers
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-brand-blue-50 rounded-lg p-6 border-2 border-brand-blue-200">
                ...
                <p className="text-black">
                  Confirming student identity during enrollment and throughout program
                  participation.
                </p>
              </div>
            ...
            <p className="text-black mb-4">All students must verify identity by providing:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Government-Issued Photo ID:</strong> Driver's license, state ID, passport,
                or military ID
              </li>
              <li>
                <strong>Social Security Card or Work Authorization:</strong> For employment
                eligibility
              </li>
              <li>
                <strong>Proof of Address:</strong> Utility bill, lease agreement, or official mail
              </li>
              <li>
                <strong>Educational Documents:</strong> High school diploma, GED, or transcripts
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Ongoing Verification</h3>
            <p className="text-black mb-4">Identity may be re-verified:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">For online students:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">We verify eligibility for program enrollment:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Age Requirements:</strong> 18+ or 16-17 with parental consent
              </li>
              <li>
                <strong>Educational Prerequisites:</strong> High school diploma or GED
              </li>
              <li>
                <strong>Program-Specific Requirements:</strong> Background checks, drug screening,
                etc.
              </li>
              <li>
                <strong>Work Authorization:</strong> Eligible to work in United States
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Funding Eligibility</h3>
            <p className="text-black mb-4">For government-funded programs, we verify:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>WIOA Eligibility:</strong> Income, employment status, barriers to employment
              </li>
              <li>
                <strong>Vocational Rehabilitation:</strong> Disability documentation and eligibility
              </li>
              <li>
                <strong>Veterans Benefits:</strong> Military service and benefit eligibility
              </li>
              <li>
                <strong>TANF:</strong> Public assistance eligibility
              </li>
              <li>
                <strong>Trade Adjustment Assistance:</strong> Job loss due to trade
              </li>
            </ul>
            ...
            <p className="text-black mb-4">Employers may verify credentials through:</p>
            ...
            <div className="bg-brand-green-50 rounded-xl p-6 border-2 border-brand-green-200 mb-6">
              ...
              <ul className="list-disc pl-6 text-black space-y-2">
                ...
                <li>
                  <strong>Fax:</strong> (317) 314-3758
                </li>
                <li>
            ...
            <p className="text-black mb-6">
              Under FERPA, we may verify credentials without student consent as directory
              information. Students may request privacy flag to require consent for verification.
            </p>
            ...
            <p className="text-black mb-4">We verify employment for:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <h3 className="text-xl font-bold text-black mt-6 mb-3">Information Provided</h3>
            <p className="text-black mb-4">With employee consent, we verify:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Verification requests must include:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Online Verification:</strong> Instant
              </li>
              <li>
                <strong>Email Requests:</strong> 1-2 business days
              </li>
              <li>
                <strong>Phone Requests:</strong> Same day if during business hours
              </li>
              <li>
                <strong>Mail/Fax Requests:</strong> 3-5 business days
              </li>
              <li>
                <strong>Rush Requests:</strong> Same day ($25 fee)
              </li>
            </ul>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 mb-6">
              ...
              <ul className="space-y-3 text-black">
                <li>
                  <strong>Online Credential Verification:</strong> Free
                </li>
                <li>
                  <strong>Standard Verification (email/phone):</strong> Free
                </li>
                <li>
                  <strong>Official Verification Letter:</strong> $10
                </li>
                <li>
                  <strong>Rush Processing:</strong> $25 additional
                </li>
                <li>
                  <strong>International Verification:</strong> $15
                </li>
              </ul>
            </div>
            ...
            <p className="text-black mb-4">We protect verification information through:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-6">Students have the right to:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <div className="bg-brand-red-50 border-l-4 border-brand-red-400 p-6 mb-6">
              ...
              <p className="text-black mb-4">We investigate requests that:</p>
            ...
            <p className="text-black mb-4">For verification services:</p>
            <ul className="list-none mb-6 text-black space-y-2">
              <li>
                <strong>Online Portal:</strong> www.elevateforhumanity.org/verify
              </li>
              <li>
                <strong>Email:</strong>{' '}
                <a href="/contact" className="text-brand-blue-600 hover:underline">
              ...
              <li>
                <strong>Mail:</strong> Registrar Office, Elevate for Humanity
              </li>
            ...
            <div className="bg-brand-blue-50 border-l-4 border-brand-blue-400 p-6 mt-8">
              ...
              <ul className="list-disc pl-6 text-black space-y-1">
                ...
                <li>
                  <a href="/policies/admissions" className="text-brand-blue-600 hover:underline">
                    Admissions Policy
                  </a>
                </li>
              </ul>
