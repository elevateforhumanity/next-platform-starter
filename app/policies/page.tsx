...
const POLICIES = [
  ...
  { title: 'Attendance Policy', href: '/disclosures#attendance', desc: 'Attendance requirements by program type.' },
  { title: 'Code of Conduct', href: '/disclosures#conduct', desc: 'Student and participant conduct standards.' },
