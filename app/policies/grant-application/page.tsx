...
export const metadata: Metadata = {
  ...
  description:
    'Process and requirements for applying for grants and external funding opportunities.',
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Policies', href: '/policies' }, { label: 'Grant Application' }]}
        />
      </div>
        ...
        <article className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-black mb-6">
              This policy establishes procedures for identifying, applying for, and managing grants
              and external funding opportunities. Grants support program development, student
              services, facilities, and institutional growth while ensuring compliance with funder
              requirements.
            </p>
              ...
              <div className="space-y-6">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black">
                      Grants office monitors funding opportunities and alerts relevant departments.
                      Staff may also identify opportunities aligned with institutional priorities.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black">
                      Review eligibility criteria, funding priorities, and alignment with
                      institutional mission. Assess capacity to meet requirements and manage grant
                      if awarded.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black">
                      Develop project concept, goals, activities, and budget. Consult with
                      stakeholders and subject matter experts. Submit concept for internal approval.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black">
                      Write proposal narrative, develop detailed budget, gather supporting
                      documents, and complete all required forms. Allow time for internal review and
                      revisions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-black">
                      Submit complete application by deadline through required portal or method.
                      Retain confirmation of submission and all application materials.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <p className="text-black mb-4">Most grant applications require:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Cover Letter:</strong> Introduction and summary of request
              </li>
              <li>
                <strong>Proposal Narrative:</strong> Detailed project description, goals, methods,
                evaluation
              </li>
              <li>
                <strong>Budget:</strong> Detailed line-item budget with justification
              </li>
              <li>
                <strong>Organizational Information:</strong> Mission, history, capacity, governance
              </li>
              <li>
                <strong>Supporting Documents:</strong> IRS determination letter, audited financials,
                etc.
              </li>
              <li>
                <strong>Letters of Support:</strong> From partners, community members, stakeholders
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Institutional Documents</h3>
            <p className="text-black mb-4">Maintained by grants office:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">All grant applications require approval from:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Department Head:</strong> For departmental projects
              </li>
              <li>
                <strong>Grants Director:</strong> For budget and compliance review
              </li>
              <li>
                <strong>Finance Director:</strong> For financial commitments
              </li>
              <li>
                <strong>Executive Director:</strong> For grants over $50,000 or multi-year
                commitments
              </li>
              <li>
                <strong>Board of Directors:</strong> For grants over $250,000
              </li>
            </ul>

            <h3 className="text-xl font-bold text-black mt-6 mb-3">Timeline</h3>
            <p className="text-black mb-6">
              Submit for internal approval at least 2 weeks before grant deadline to allow adequate
              review time.
            </p>
            ...
            <p className="text-black mb-4">Upon grant award:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Grant recipients must:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">Typical reporting requirements:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Progress Reports:</strong> Quarterly or semi-annual updates on activities
              </li>
              <li>
                <strong>Financial Reports:</strong> Expenditure reports with supporting
                documentation
              </li>
              <li>
                <strong>Final Report:</strong> Comprehensive summary of outcomes and impact
              </li>
              <li>
                <strong>Evaluation Reports:</strong> Assessment of project effectiveness
              </li>
            </ul>
            ...
            <p className="text-black mb-4">At grant end:</p>
            ...
            <p className="text-black mb-4">For grant opportunities or assistance:</p>
