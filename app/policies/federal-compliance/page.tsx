...
export const metadata: Metadata = {
  ...
  description:
    'Our commitment to compliance with FERPA, Title IX, ADA, WIOA, and other federal regulations.',
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Policies', href: '/policies' }, { label: 'Federal Compliance' }]}
        />
      </div>
      {/* Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-brand-blue-100">
              Elevate for Humanity maintains full compliance with all applicable federal laws
              governing educational institutions and workforce development programs.
            </p>
            <p className="text-sm text-brand-blue-200 mt-4">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p>
              ...
              institutions and workforce development programs. As a recipient of federal funding
              through the Workforce Innovation and Opportunity Act (WIOA) and other federal
              programs, we recognize our responsibility to uphold the highest standards of legal and
              ethical conduct.
            </p>
            <p>
              This policy establishes our framework for ensuring compliance with key federal
              statutes including the Family Educational Rights and Privacy Act (FERPA), Title IX of
              the Education Amendments of 1972, the Americans with Disabilities Act (ADA), Section
              504 of the Rehabilitation Act, and the Workforce Innovation and Opportunity Act
              (WIOA). All employees, contractors, and partners are required to understand and adhere
        ...
        <section className="mb-12 bg-brand-blue-50 rounded-2xl p-8 border-2 border-brand-blue-200">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p>
              ...
              funds under an applicable program of the U.S. Department of Education. Elevate for
            ...
            <p>
              <strong>Right to Inspect and Review:</strong> Students have the right to inspect and
              review their education records maintained by the Institution. The Institution will
              comply with requests within 45 days of receiving a written request. Students should
              submit written requests to the Registrar identifying the records they wish to inspect.
            </p>
            <p>
              <strong>Right to Request Amendment:</strong> Students have the right to request
              amendment of education records they believe are inaccurate, misleading, or in
              violation of their privacy rights. Students should submit a written request to the
              Registrar clearly identifying the part of the record they want changed and specifying
              why it should be changed.
            </p>
            <p>
              <strong>Right to Consent to Disclosures:</strong> Students have the right to consent
              to disclosures of personally identifiable information contained in their education
              records, except to the extent that FERPA authorizes disclosure without consent. One
              exception permits disclosure to school officials with legitimate educational
              interests.
            </p>
            <p>
              <strong>Right to File a Complaint:</strong> Students have the right to file a
              complaint with the U.S. Department of Education concerning alleged failures by the
              Institution to comply with FERPA requirements. Complaints may be filed with the Family
            ...
            <p>
              ...
              telephone number, email address, photograph, program of study, enrollment status,
              dates of attendance, degrees and certificates awarded, and honors received. Students
              may opt out of directory information disclosure by submitting a written request to the
              Registrar within 14 days of enrollment.
            </p>
          </div>

          <Link
            href="/policies/ferpa"
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-brand-blue-600 text-white font-semibold rounded-lg hover:bg-brand-blue-700 transition"
          >
        ...
        <section className="mb-12 bg-brand-blue-50 rounded-2xl p-8 border-2 border-brand-blue-200">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p>
              ...
              Elevate for Humanity does not discriminate on the basis of sex in its educational
            ...
            <p>
              ...
              femininity. Title IX also prohibits sexual harassment, which includes sexual violence,
            ...
            <p>
              ...
              physical conduct of a sexual nature. This includes conduct that is sufficiently
            ...
            <p>
              <strong>Sexual Violence:</strong> Physical sexual acts perpetrated against a person's
              will or where a person is incapable of giving consent. This includes rape, sexual
              assault, sexual battery, sexual abuse, and sexual coercion.
            </p>
            <p>
              <strong>Gender-Based Harassment:</strong> Unwelcome conduct based on a student's sex,
              including harassment based on gender identity, gender expression, or nonconformity
            ...
            <p>
              ...
              Institution's efforts to comply with Title IX, including investigating complaints of
        ...
        <section className="mb-12 bg-brand-green-50 rounded-2xl p-8 border-2 border-brand-green-200">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p>
              ...
              committed to providing equal access to all programs, services, and activities for
            ...
            <p>
              ...
              opportunities. Reasonable accommodations are modifications or adjustments that enable
              individuals with disabilities to perform essential functions or enjoy equal benefits
              and privileges.
            </p>
            <p>
              Examples of reasonable accommodations include: extended time on examinations,
              alternative testing formats, note-taking assistance, sign language interpreters,
              accessible course materials, assistive technology, modified schedules, and physical
            ...
            <p>
              ...
              review and implementation. Documentation of the disability may be required to support
            ...
            <p>
              The Institution maintains physically accessible facilities in compliance with ADA
              Accessibility Guidelines. Our digital platforms, including the learning management
              system and website, are designed to meet Web Content Accessibility Guidelines (WCAG)
          ...
          <Link
            href="/accessibility"
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-brand-green-600 text-white font-semibold rounded-lg hover:bg-brand-green-700 transition"
          >
        ...
        <section className="mb-12 bg-brand-orange-50 rounded-2xl p-8 border-2 border-brand-orange-200">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p>
              ...
              Humanity complies with all WIOA requirements regarding program delivery, participant
            ...
            <p>
              WIOA Section 188 prohibits discrimination against individuals in any WIOA Title
              I-financially assisted program or activity on the basis of race, color, religion, sex,
              national origin, age, disability, political affiliation or belief, and for
              beneficiaries, applicants, and participants only, on the basis of citizenship status
            ...
            <p>
              The Institution collects participant data as required by WIOA for eligibility
              determination and performance reporting. All data is collected, stored, and
              transmitted in compliance with applicable privacy laws and WIOA data security
              requirements. Participant information is used only for authorized purposes and is
            ...
            <p>
              The Institution tracks and reports performance outcomes as required by WIOA, including
              employment rates, median earnings, credential attainment, and measurable skill gains.
              Performance data is reported to the Indiana Department of Workforce Development and is
              publicly available on the Eligible Training Provider List.
            </p>
          </div>

          <Link
            href="/policies/wioa"
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-brand-orange-600 text-white font-semibold rounded-lg hover:bg-brand-orange-700 transition"
          >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/10 rounded-xl p-6">
              ...
              <Link
                ...
                className="inline-block mt-4 text-brand-orange-400 hover:text-brand-orange-300"
              >
