    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <article className="prose prose-lg max-w-none mt-6">
          ...
          <h2>Overview</h2>
          <p>
            Elevate for Humanity complies with the Family Educational Rights and Privacy Act
            (FERPA), which protects the privacy of student education records. This policy explains
            your rights and our responsibilities under FERPA.
          </p>
          ...
          <p>
            We may disclose "directory information" without consent unless you opt out. Directory
            information includes: name, enrollment status, program of study, dates of attendance,
          ...
          <h2>Data Security</h2>
          <p>
            We maintain physical, electronic, and procedural safeguards to protect education
            records. Access is limited to authorized personnel with legitimate educational interest.
          </p>

          <h2>Third-Party Services</h2>
          <p>
            We use third-party services (learning management systems, payment processors) that may
            access education records. These services are bound by contract to protect student
            privacy and use data only for authorized purposes.
          </p>

          <h2>Retention</h2>
          <p>
            We retain education records for 7 years after a student's last enrollment. Transcripts
            are maintained permanently.
          </p>

          <h2>Contact</h2>
          <p>For questions about FERPA or to exercise your rights:</p>
          <p>
          ...
          <p>You may file a complaint with the U.S. Department of Education:</p>
          <p>
