...
export default function PolicyAcknowledgmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch('/api/partners/barber-host-shop/policy-acknowledgment', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 pt-6">
        <Breadcrumbs items={[
          ...
          { label: 'Forms', href: '/partners/barber-host-shop/forms' },
      ...
      <section className="py-6 border-b">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/partners/barber-host-shop/forms" className="inline-flex items-center gap-1 text-black hover:text-brand-blue-700 text-sm mb-4">
