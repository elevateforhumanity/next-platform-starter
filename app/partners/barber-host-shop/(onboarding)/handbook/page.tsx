...
export const metadata: Metadata = {
  title: 'Partner Handbook | Barber Host Shop',
  description: 'Responsibilities, policies, and guidelines for barber host shop worksite partners.',
};
      ...
      <section className="py-8 border-b">
        <div className="max-w-6xl mx-auto px-4">
          <InstitutionalHeader
            ...
            title="Barber Host Shop — Worksite Partner Handbook"
            subtitle="Responsibilities, policies, and guidelines for barber host shop worksite partners."
            version="1.0"
          />
        </div>
      </section>
