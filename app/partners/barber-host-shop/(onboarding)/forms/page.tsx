    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
              <Image src="/images/pages/barber-tools.webp" alt="Sign MOU" fill className="object-cover group-hover:scale-105 transition-transform" sizes="33vw" placeholder="blur" />
            </div>
            <div className="p-4">
          ...
          >
            <div className="relative h-32">
              <Image src="/images/pages/admin-campaigns-new-hero.webp" alt="Partner Handbook" fill className="object-cover group-hover:scale-105 transition-transform" sizes="33vw" placeholder="blur" />
            </div>
            <div className="p-4">
          ...
          >
            <div className="relative h-32">
              <Image src="/images/pages/barber-shop-interior.webp" alt="Policy Forms" fill className="object-cover group-hover:scale-105 transition-transform" sizes="33vw" placeholder="blur" />
            </div>
            <div className="p-4">
              ...
              <div className="flex items-center gap-3 mb-4">
                {categoryPhotos[cat] ? (
                  <div className="relative w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                    <Image src={categoryPhotos[cat].src} alt={categoryPhotos[cat].alt} fill className="object-cover" sizes="40px" placeholder="blur" />
                  </div>
                ) : (
