      ...
      <div className="max-w-3xl mx-auto px-4 pb-16">
        <div className="mb-8">
          ...
          <p className="text-black">
            Complete this form to apply for approval as a training provider, workforce agency, or
            employer partner. Applications are reviewed by Elevate staff. You will receive an email
