  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-800 flex gap-3">
        ...
        <p>
          A complete profile is required before apprentices can be placed at your shop. All fields
          marked * are required by the U.S. Department of Labor.
        </p>
      </div>
      ...
      <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center">
        ...
        <p className="text-xs text-black mt-1">
          Upload full, clear photos of your Indiana Barber Shop License and all mentor/journeyperson
          barber licenses. Both front and back required.
        </p>
        <p className="text-xs text-red-600 mt-2 font-semibold">
          ⚠ Partial or cropped images will not be accepted
        </p>
...
function MOUStep({
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!agreed) {
      setError('You must agree to the MOU terms');
      return;
    }
    setSubmitting(true);
    setError('');
    ...
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-black text-sm">
          Your Memorandum of Understanding has been recorded. Continue to the Employer Agreement.
        </p>
        <button
          onClick={onNext}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors"
  ...
  return (
    <form onSubmit={submit} className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 max-h-96 overflow-y-auto text-sm text-slate-900 space-y-4">
        <div className="text-center border-b pb-4">
          ...
          <p className="text-xs text-black">
            Barber Apprenticeship Program · RAPIDS: 2025-IN-132301
          </p>
          <p className="text-xs text-black mt-1">
        ...
        <p>
          ...
          ("Sponsor") and <strong>{profileData.shop_name || 'Employer Training Site'}</strong>{' '}
          ("Employer"), governed by 29 CFR Parts 29 and 30.
        </p>
        <p>
          <strong>Employer agrees to:</strong>
        </p>
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Pay apprentices per the progressive wage schedule in the Standards of Apprenticeship
          </li>
        ...
        <p>
          <strong>Sponsor agrees to:</strong>
        </p>
        <ul className="list-disc pl-5 space-y-1">
        ...
        <p>
          <strong>Term:</strong> 1 year, auto-renewing. Either party may terminate with 30 days
          written notice. Sponsor may terminate immediately for cause.
        </p>
        <p>
          <strong>Incomplete profiles will result in suspension of apprentice placements.</strong>
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-black mt-1">
          By typing your name you are applying a legally binding digital signature
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-xl">
        ...
        <label htmlFor="agreed" className="text-sm text-slate-900">
          ...
          digital signature is legally binding and has the same effect as a handwritten signature. I
          confirm I am authorized to sign on behalf of{' '}
          <strong>{profileData.shop_name || 'my business'}</strong>.
        </label>
      </div>
      ...
      <button
        type="submit"
        disabled={submitting || !sig || !agreed}
...
function EmployerAgreementStep({
  profileData,
  onNext,
}: {
  profileData: Record<string, string>;
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!form.agreed) {
      setError('You must agree to the employer agreement terms');
      return;
    }
    if (!form.mentor_name || !form.mentor_license) {
      setError('Mentor name and license number are required');
      return;
    }
    setSubmitting(true);
    setError('');
  ...
  if (done)
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-black text-sm">
          Your employer agreement has been submitted and recorded for RAPIDS. Elevate will review
          and confirm your onboarding within 2 business days.
        </p>
        <button
          onClick={onNext}
  ...
  return (
    <form onSubmit={submit} className="space-y-6">
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
        ...
        <p>
          This Employer Agreement is required by the U.S. Department of Labor for all Registered
          Apprenticeship training sites. Information provided here will be submitted to RAPIDS
      ...
      <p className="text-xs text-black">
        Apprentice wages must increase progressively. Enter hourly rates for each year of the
        apprenticeship.
      </p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm text-slate-900 space-y-2">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            The business will comply with all DOL Standards of Apprenticeship (29 CFR Parts 29 & 30)
          </li>
          <li>
            The business will pay apprentices no less than the progressive wage schedule above
          </li>
      ...
      <div className="flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-xl">
        ...
        <label htmlFor="emp_agreed" className="text-sm text-slate-900">
          I certify that all information is accurate and I am authorized to enter into this Employer
          Agreement on behalf of <strong>{profileData.shop_name || 'my business'}</strong>. I
          understand this agreement will be submitted to the U.S. Department of Labor RAPIDS system.
        </label>
      </div>
      ...
      <button
        type="submit"
        disabled={submitting || !form.signature || !form.agreed}
        className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-40 text-white font-bold py-3 rounded-xl transition-colors"
      >
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <p className="text-xs text-black uppercase tracking-wide font-semibold mb-1">
            Barber Apprenticeship Program
          </p>
          <h1 className="text-2xl font-bold text-slate-900">Employer Training Site Onboarding</h1>
          <p className="text-sm text-black mt-1">
            2Exclusive LLC-S (DBA: Elevate for Humanity Technical and Career Institute) · RAPIDS:
            2025-IN-132301
          </p>
          ...
          <div className="flex items-center gap-2 mt-5">
            {STEPS.map((s, i) => (
              <div key={s.id} className="flex items-center gap-2 flex-1">
                ...
                <span
                  className={`text-xs font-semibold hidden sm:block ${i === stepIndex ? 'text-blue-600' : 'text-black'}`}
                >
                  {s.label}
                </span>
                {i < STEPS.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 ${i < stepIndex ? 'bg-green-400' : 'bg-gray-200'}`}
                  />
                )}
              </div>
            ))}
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <h2 className="text-lg font-bold text-slate-900 mb-5">{STEPS[stepIndex]?.label}</h2>
          ...
          {step === 'done' && (
            <div className="text-center space-y-4 py-8">
              ...
              <p className="text-black">
                Thank you, {profileData.owner_name}. Your profile, MOU, and Employer Agreement have
                been submitted. Elevate for Humanity will review and confirm within 2 business days.
                You will receive a confirmation email at {profileData.contact_email}.
              </p>
