      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[
            ...
            { label: 'Barbershop', href: '/partners/barbershop-apprenticeship' },
            { label: 'Apply' },
          ]}
        />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-black mb-2">
                    DOL Registered Apprenticeships require the apprentice to be an employee of the
                    host shop, regardless of compensation model (hourly or hybrid). Sole commission
                    is not permitted.
                  </p>
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:bg-white">
                      ...
                      <span className="text-slate-900">
                        Yes — apprentices will be on our payroll
                      </span>
                    </label>
                  </div>
                  ...
                  {formData.workersCompStatus === 'none' && (
                    <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                      ...
                      <p className="text-xs text-red-600 mt-1">
                        Elevate cannot register apprentices in the federal RAPIDS system under a
                        partner worksite that does not meet minimum insurance and compliance
                        standards.
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-4">
                <div className="p-4 bg-brand-blue-50 border border-brand-blue-200 rounded-lg">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-slate-900">
                      ...
                      and understand that signing it is required to participate as a partner. *
                    </span>
                  </label>
                </div>
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-sm text-slate-900">
                      I consent to be contacted regarding this application and acknowledge that my
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-sm text-black mb-4">
                Sign below to confirm that the information provided is accurate and complete.
              </p>
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <button
                  ...
                  className="text-sm text-black hover:text-slate-900 underline"
                >
                  Clear
                </button>
              </div>
              <p className="text-xs text-black mt-2">
                By signing, you agree that this electronic signature is legally binding under the
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/docs/Indiana-Barbershop-Apprenticeship-MOU"
                className="inline-flex items-center justify-center px-6 py-4 border border-gray-300 rounded-lg font-medium hover:bg-white"
                target="_blank"
              >
