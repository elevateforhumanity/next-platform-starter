...
const REQUIRED_FORMS: FormItem[] = [
  {
    ...
    description:
      'Partnership agreement between your shop and Elevate for Humanity. Must be signed before hosting apprentices.',
    required: true,
    category: 'legal',
    action: 'sign',
  ...
  },
  {
    ...
    description:
      "Copy of the licensed barber's Indiana barber license who will directly supervise the apprentice. Must have 2+ years experience.",
    required: true,
    category: 'compliance',
    action: 'upload',
    href: '/partners/barbershop-apprenticeship/documents',
  },
  {
    ...
    description:
      'Complete the workplace safety checklist confirming your shop meets health and safety standards.',
    required: true,
    category: 'training',
    action: 'complete',
    href: '/partners/barbershop-apprenticeship/policy-acknowledgment',
...
const categoryPhotos: Record<string, { src: string; alt: string }> = {
  ...
  compliance: {
    ...
    alt: 'Licensed barber performing a cut',
  },
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
          ...
          >
            <div className="relative h-32">
              <Image
                src="/images/pages/admin-campaigns-new-hero.jpg"
                alt="Partner Handbook"
                fill
                className="object-cover group-hover:scale-105 transition-transform"
                sizes="33vw"
              />
              ...
              <div className="flex items-center gap-3 mb-4">
                {categoryPhotos[cat] ? (
                  <div className="relative w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                    <Image
                      src={categoryPhotos[cat].src}
                      alt={categoryPhotos[cat].alt}
                      fill
