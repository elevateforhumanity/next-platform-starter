    ...
    <PublicLandingPage
      config={{
        ...
        hero: {
          ...
          subtitle:
            'Enrollment, learning management, career services, and compliance reporting — built specifically for WIOA-funded programs, apprenticeships, and career certification training.',
        },
        intro: {
          ...
          items: [
            {
              ...
              desc: 'Contact us for a 30-minute walkthrough of the platform tailored to your program type.',
            },
            {
              title: 'Scope Your Build',
              desc: 'We identify which modules you need and configure the platform for your programs and workflows.',
            },
            {
              title: 'Sign the License Agreement',
              desc: 'We execute a licensing agreement covering hosting, support, data ownership, and pricing.',
            },
            {
              title: 'Go Live',
              desc: 'Your branded platform is live within 2–4 weeks. We provide onboarding and ongoing technical support.',
            },
          ],
        },
        cta: {
          ...
          subtitle:
            'See the platform in action. Contact us for a walkthrough and pricing information.',
