...
const requirements = [
  ...
  { title: 'Supervising Nail Technician', desc: 'Designate a licensed Indiana nail technician to supervise apprentices, verify hours, and sign off on competencies.' },
...
const onboarding = [
  { n: '1', icon: BookOpen, label: 'Read the Partner Handbook', desc: 'Covers responsibilities, supervision requirements, hour tracking, and compensation rules.', href: '/login?redirect=/__partners/nail-technician-apprenticeship/handbook' },
  { n: '2', icon: ClipboardList, label: 'Acknowledge Policies', desc: 'Review and acknowledge program policies, wage requirements, and supervision standards.', href: '/login?redirect=/__partners/nail-technician-apprenticeship/policy-acknowledgment' },
  { n: '3', icon: FileText, label: 'Complete Required Forms', desc: "Submit your W-9, workers' comp certificate, and supervisor license documentation.", href: '/login?redirect=/__partners/nail-technician-apprenticeship/forms' },
  { n: '4', icon: PenLine, label: 'Sign the MOU', desc: 'Digitally sign the Memorandum of Understanding to finalize your partnership.', href: '/login?redirect=/__partners/nail-technician-apprenticeship/sign-mou' },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs items={[{ label: 'Partners', href: '/partners' }, { label: 'Nail Technician Apprenticeship' }]} />
      </div>
      ...
      <section className="relative w-full bg-slate-900 overflow-hidden" style={{ minHeight: '60vh' }}>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center px-6 py-24">
          <span className="inline-block bg-rose-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-5">DOL Registered Apprenticeship</span>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <p className="text-rose-600 text-xs font-bold uppercase tracking-widest text-center mb-2">Program Overview</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { n: '2', title: 'Host an Apprentice', desc: 'We match qualified apprentices to your salon. They complete 1,500 hours of on-the-job training under your supervision.' },
              { n: '3', title: 'Grow Your Team', desc: 'Apprentices complete theory through Elevate LMS, then sit for the Indiana State Board exam. You get a trained, licensed nail technician.' },
            ].map((s) => (
              <div key={s.n} className="text-center">
                <div className="w-14 h-14 bg-rose-100 rounded-full flex items-center justify-center mx-auto mb-4"><span className="text-rose-600 font-bold text-xl">{s.n}</span></div>
      ...
      <section className="py-16 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto">
          <p className="text-rose-600 text-xs font-bold uppercase tracking-widest text-center mb-2">Requirements</p>
      ...
      <section className="py-16 px-6 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto">
          <p className="text-rose-600 text-xs font-bold uppercase tracking-widest text-center mb-2">Timeline</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 text-center mb-10">Approval Timeline</h2>
          <div className="space-y-5">
            {timeline.map((s) => (
              <div key={s.n} className="flex items-start gap-4">
                <div className="w-10 h-10 bg-rose-100 rounded-full flex items-center justify-center shrink-0"><span className="text-rose-600 font-bold">{s.n}</span></div>
                <div>
      ...
      <section className="py-16 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-3xl mx-auto">
          <p className="text-rose-600 text-xs font-bold uppercase tracking-widest text-center mb-2">FAQ</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {onboarding.map(({ n, icon: Icon, label, desc, href }) => (
                <Link key={n} href={href} className="flex items-start gap-4 bg-white rounded-xl border border-slate-200 p-5 hover:border-rose-400 hover:shadow-sm transition group">
                  <div className="w-10 h-10 rounded-full bg-rose-100 text-rose-700 flex items-center justify-center shrink-0 font-bold text-lg group-hover:bg-rose-600 group-hover:text-white transition">{n}</div>
                  <div>
                    <div className="flex items-center gap-2 mb-1"><Icon className="w-4 h-4 text-rose-600" /><h3 className="font-bold text-slate-900 text-sm">{label}</h3></div>
