    ...
    <PublicLandingPage
      config={{
        ...
        hero: {
          ...
          title: 'Technology Partnership',
          subtitle:
            'Integrate with the Elevate platform. API access, data interoperability, and workforce system integrations for software vendors and workforce data platforms.',
        },
        intro: {
          ...
          items: [
            {
              ...
              desc: 'Contact us to discuss your system and what data or functionality you need to connect.',
            },
            {
              title: 'Technical Discovery Call',
              desc: 'A 30-minute call with our technical team to map out the integration scope and timeline.',
            },
            {
              title: 'Sign Data Agreement',
              desc: 'We execute a data sharing or licensing agreement that covers security, privacy, and use restrictions.',
            },
            {
              title: 'Build and Launch',
              desc: 'Our team supports your integration build and tests the connection before going live.',
            },
          ],
        },
        cta: {
