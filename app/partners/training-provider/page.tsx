...
export const metadata: Metadata = {
  ...
  description:
    'Become an approved training provider on the Elevate platform. Access funded student referrals, compliance tools, and outcome tracking.',
};
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Partners', href: '/partners' }, { label: 'Training Provider' }]}
          />
        </div>
      </div>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-lg text-black max-w-3xl">
            Join our network of approved training providers. We connect you with WIOA-funded
            students, handle compliance reporting, and support your ETPL listing.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {BENEFITS.map((item) => (
              <div
                key={item.title}
                className="flex gap-5 items-start border border-slate-200 rounded-xl overflow-hidden"
              >
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'Funded students are referred to your programs. We handle enrollment coordination and reporting.',
              ...
              >
                ...
                <div className="p-5">
                  <div className="w-8 h-8 bg-brand-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm mb-3">
                    {item.step}
                  </div>
                  <h3 className="font-bold text-slate-900 mb-1">{item.title}</h3>
      ...
      <section className="py-16 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-black mb-3">
            Apply to join our training provider network and start receiving funded student
            referrals.
          </p>
          <p className="text-black text-sm mb-8">
            Questions first? Call{' '}
            <a href="tel:317-314-3757" className="font-semibold text-brand-blue-600">
              (317) 314-3757
            </a>{' '}
            — most provider agreements are set up within a week.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border-2 border-slate-300 text-slate-700 px-8 py-4 rounded-lg font-bold hover:bg-white transition text-base"
            >
              Call (317) 314-3757
            </a>
          </div>
