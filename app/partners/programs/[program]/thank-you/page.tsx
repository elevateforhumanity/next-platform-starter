        ...
        {config.siteVisitRequired && (
          <div className="bg-orange-50 border border-orange-200 p-8 rounded-xl mb-8 text-center">
            ...
            <p className="text-black mb-4">
              Book your 15-minute Zoom site visit now. We&apos;ll walk through your{' '}
              {config.siteLabel} and answer any questions.
            </p>
            <a
              href={CALENDLY_URL}
              target="_blank"
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 mb-8">
          ...
          <ol className="space-y-2 text-sm text-black">
            <li className="flex gap-2">
              <span className="font-bold text-orange-500">1.</span> We verify your credentials (1-3
              business days)
            </li>
            {config.siteVisitRequired && (
              <li className="flex gap-2">
                <span className="font-bold text-orange-500">2.</span> Video site visit via Zoom (~15
                minutes)
              </li>
            )}
            <li className="flex gap-2">
              <span className="font-bold text-orange-500">
                {config.siteVisitRequired ? '3' : '2'}.
              </span>{' '}
              MOU review and signing
            </li>
            <li className="flex gap-2">
              <span className="font-bold text-orange-500">
                {config.siteVisitRequired ? '4' : '3'}.
              </span>{' '}
              Approval (~{config.approvalTimeline})
            </li>
          </ol>
        </div>
