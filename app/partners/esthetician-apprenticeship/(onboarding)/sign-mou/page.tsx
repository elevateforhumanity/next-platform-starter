...
const MOU_SECTIONS = [
  {
    ...
    content: `This Memorandum of Understanding ("MOU") is entered into between 2Exclusive LLC-S d/b/a Elevate for Humanity Career & Technical Institute ("Sponsor") and the spa/salon identified at execution ("Worksite Partner" or "Spa").

This MOU establishes the terms under which the Spa will serve as a worksite for the Indiana Esthetician Apprenticeship Program, a USDOL Registered Apprenticeship sponsored by Elevate for Humanity.
