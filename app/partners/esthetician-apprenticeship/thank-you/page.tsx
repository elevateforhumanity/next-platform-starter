...
export const metadata: Metadata = {
  title: 'Application Received | Esthetician Apprenticeship Partner',
  description: 'Thank you for applying to become a host spa for the Indiana Esthetician Apprenticeship program.',
  robots: { index: false, follow: false },
};

export default function EstheticianThankYouPage() {
  return (
      ...
      <section className="py-20">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-700 mb-8">
            Thank you for applying to become a host spa for the Elevate Esthetician Apprenticeship
            program. Our team will review your application and contact you within 3 business days.
          </p>

          <div className="bg-pink-50 border border-pink-200 rounded-2xl p-6 mb-8 text-left">
            <h2 className="font-bold text-pink-900 mb-4">What Happens Next</h2>
            <ol className="space-y-3">
              {[
                { step: 1, text: 'Our team reviews your application (1–3 business days)' },
                { step: 2, text: 'We schedule a brief onboarding call to verify your spa and discuss the program' },
                ...
                <li key={step} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-pink-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
                    {step}
                  </span>
                  <p className="text-sm text-pink-800">{text}</p>
                </li>
              ))}
            </ol>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-slate-50 rounded-xl p-4 text-center">
              ...
              <a href="mailto:partners@elevateforhumanity.org" className="text-xs text-pink-600 hover:underline">
          ...
          <Link
            href="/partners/esthetician-apprenticeship"
