...
export default function EstheticianPartnerPageClient({ isApproved = false, basePath = '/partners/esthetician-apprenticeship' }: Props) {
  const onboarding = [
    ...
    <div className="min-h-screen bg-white">
      ...
      <video autoPlay muted loop playsInline poster="/images/pages/cosmetology-hero.webp"
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center px-6 py-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`${basePath}/apply`} className="inline-flex items-center justify-center px-8 py-4 bg-pink-600 text-white rounded-xl font-extrabold text-base hover:bg-pink-700 transition-colors">Apply as a Host Location <ArrowRight className="w-5 h-5 ml-2" /></Link>
      ...
      <section className="bg-slate-900 py-16 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`${basePath}/apply`} className="inline-flex items-center justify-center px-8 py-4 bg-pink-600 text-white rounded-xl font-extrabold text-base hover:bg-pink-700 transition-colors">Start Your Application <ArrowRight className="w-5 h-5 ml-2" /></Link>
