...
export const metadata: Metadata = {
  ...
  description:
    'Partner with Elevate for Humanity as a training provider. Co-deliver programs, share facilities, and expand your reach.',
    ...
    <PublicLandingPage
      config={{
        ...
        hero: {
          ...
          subtitle:
            'Co-deliver workforce training programs and expand your reach through our enrollment pipeline and funding network.',
        },
        intro: {
        ...
        cta: {
          ...
          subtitle:
            "Let's discuss how we can work together to train the next generation of workers.",
