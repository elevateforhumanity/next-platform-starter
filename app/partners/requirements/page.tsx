    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <section className="prose prose-gray max-w-none">
          ...
          <div className="not-prose space-y-4 my-6">
            <div className="border border-slate-200 rounded-lg p-5">
              ...
              <p className="text-sm text-slate-900 mt-2">
                Must cover client injury, property damage, and incidents occurring at the shop
                location.
              </p>
            </div>
            ...
            <div className="border border-slate-200 rounded-lg p-5">
              ...
              <p className="text-sm text-slate-900 mt-2">
                Must explicitly cover barbering services performed by staff, trainees, or
                apprentices under supervision in a live service setting.
              </p>
            </div>
          ...
          <ul>
            <li>
              Insurance must be commercial business coverage tied to the licensed shop location
            </li>
            <li>
              Personal, booth renter, or individual stylist policies are{' '}
              <strong>not sufficient</strong> for apprenticeship training site approval
            </li>
            <li>
              Policy must allow hands-on training, apprentices, and instructional activities within
              the business
            </li>
          </ul>

          <h3>Documentation Requirement</h3>
          <p>A current Certificate of Insurance (COI) must be submitted prior to:</p>
          <ul>
          ...
          <div className="not-prose mt-8 p-5 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm text-red-800 font-medium">
              Failure to maintain active and appropriate insurance will result in suspension or
              denial of apprenticeship site approval.
            </p>
          </div>
          ...
          <ul>
            <li>
              A licensed barber must be on-site and available to supervise apprentices at all times
          ...
          <ul>
            <li>
              Partner shops must maintain accurate daily attendance and hour logs for all
              apprentices
            </li>
            <li>
            ...
            <li>
              Falsification of training hours is grounds for immediate partnership termination
            </li>
          </ul>
        </section>
