...
const DOC_SLOTS: DocSlot[] = [
  {
    ...
    description:
      'The IRS letter confirming your Employer Identification Number. This is the CP 575 or 147C letter issued by the IRS when your EIN was assigned.',
    required: true,
  ...
  },
  {
    ...
    description:
      'Current, valid Indiana salon license showing license number, expiration date, licensee name, and salon address.',
    required: true,
    accept: '.pdf,.jpg,.jpeg,.png',
  ...
  },
  {
    ...
    description:
      'Indiana IPLA cosmetology license for the licensed cosmetologist who will directly supervise the apprentice. Must have 2+ years of licensed experience.',
    required: true,
    accept: '.pdf,.jpg,.jpeg,.png',
      ...
      <div className="max-w-4xl mx-auto px-4 pt-6">
        <Breadcrumbs
          items={[
            ...
            { label: 'Required Forms', href: '/partners/cosmetology-host-shop/forms' },
