      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-slate-600 mb-6">
            Your salon application has been received. Our team will review it within 2–3 business
          ...
          <p className="text-sm text-slate-500 mt-4">
            ...
            <Link
              href="/signup?redirect=/partners/cosmetology-host-shop/sign-mou"
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[
            ...
            { label: 'Cosmetology Apprenticeship', href: '/partners/cosmetology-host-shop' },
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className={sectionCls}>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  required
                  className={inputCls}
                  value={formData.salonLegalName}
                  onChange={(e) => set('salonLegalName', e.target.value)}
              ...
              <div>
                ...
                <input
                  className={inputCls}
                  value={formData.salonDbaName}
                  onChange={(e) => set('salonDbaName', e.target.value)}
              ...
              <div>
                ...
                <input
                  required
                  className={inputCls}
                  value={formData.indianaSalonLicenseNumber}
                  onChange={(e) => set('indianaSalonLicenseNumber', e.target.value)}
            ...
            <div>
              ...
              <input
                required
                className={inputCls}
                value={formData.salonAddressLine1}
                onChange={(e) => set('salonAddressLine1', e.target.value)}
              />
            </div>
            <div>
              ...
              <input
                className={inputCls}
                value={formData.salonAddressLine2}
                onChange={(e) => set('salonAddressLine2', e.target.value)}
              />
            </div>
            <div className="grid grid-cols-3 gap-4">
              <div className="col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => set('salonCity', e.target.value)}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => set('salonZip', e.target.value)}
                  maxLength={10}
                />
              </div>
            </div>
          ...
          <div className={sectionCls}>
            ...
            <p className="text-slate-500 text-sm">
              The designated supervisor must hold a current Indiana cosmetology license and will be
              responsible for verifying apprentice hours and competencies.
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => set('compensationModel', e.target.value)}
                >
                  <option value="">Select...</option>
                  {COMPENSATION_MODELS.map((o) => (
              ...
              <div>
                ...
                <select
                  required
                  className={inputCls}
                  value={formData.workersCompStatus}
                  onChange={(e) => set('workersCompStatus', e.target.value)}
                >
                  <option value="">Select...</option>
                  {WORKERS_COMP_OPTIONS.map((o) => (
                    <option key={o.value} value={o.value}>
                      {o.label}
                    </option>
                  ))}
                ...
                {formData.workersCompStatus === 'none' && (
                  <p className="text-amber-600 text-xs mt-1">
                    ⚠️ Workers&apos; compensation coverage is required before apprentice placement
                    can begin.
                  </p>
                )}
              </div>
              <div>
                ...
                <select
                  required
                  className={inputCls}
                  value={formData.hasGeneralLiability}
                  onChange={(e) => set('hasGeneralLiability', e.target.value)}
                >
                  <option value="">Select...</option>
              ...
              <div>
                <label className={labelCls}>
                  Can you supervise and verify apprentice hours weekly? *
                </label>
                <select
                  required
                  className={inputCls}
                  value={formData.canSuperviseAndVerify}
                  onChange={(e) => set('canSuperviseAndVerify', e.target.value)}
                >
                  <option value="">Select...</option>
          ...
          <div className={sectionCls}>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-slate-700">
                ...
                false or misleading information may result in disqualification from the program.
              </span>
            </label>
          </div>
