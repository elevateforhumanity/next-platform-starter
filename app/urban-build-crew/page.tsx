    ...
    <div className="bg-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-brand-orange-50 rounded-xl p-6">
              ...
              <p className="text-slate-700 mb-4">
                Learn basic construction skills including framing, drywall, and finishing.
              </p>
              <Link href="/programs/skilled-trades" className="text-brand-orange-600 font-medium">
                Learn More →
              </Link>
            </div>
            <div className="bg-brand-orange-50 rounded-xl p-6">
              ...
              <p className="text-slate-700 mb-4">
                Prepare for union apprenticeships in various construction trades.
              </p>
              <Link href="/apprenticeships" className="text-brand-orange-600 font-medium">
                Learn More →
              </Link>
            </div>
            <div className="bg-brand-orange-50 rounded-xl p-6">
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/start"
            className="bg-white hover:bg-white text-brand-orange-600 px-8 py-4 rounded-lg text-lg font-bold transition inline-flex items-center"
          >
