...
export const metadata: Metadata = {
  ...
  description: 'Federal funding sources for workforce training in Indiana — WIOA, Pell Grants, SNAP E&T, and more. Check eligibility and apply.',
...
const PROGRAMS = [
  ...
  },
  {
    ...
    covers: 'Full tuition and supportive services at no cost. Elevate is a SNAP E&T approved provider.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-brand-red-400 text-xs font-bold uppercase tracking-widest mb-3">Federal Funding</p>
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-4">Federal Workforce Funding Programs</h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            Multiple federal programs fund workforce training for eligible Indiana residents. Many participants qualify for more than one source — we help you stack every dollar available.
          </p>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {PROGRAMS.map((p) => (
            <div key={p.name} className="border border-slate-200 rounded-xl p-6">
              ...
              <Link href={p.href} className="text-brand-red-600 hover:underline text-sm font-bold">Check eligibility →</Link>
            </div>
          ))}
        </div>
      </section>
