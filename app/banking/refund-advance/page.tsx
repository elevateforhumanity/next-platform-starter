  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Banking', href: '/banking' }, { label: 'Refund Advance' }]}
        />
      </div>
      {/* Breadcrumb */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-slate-700">
                    Complete your tax return with our professional preparers. We will calculate your
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-slate-700">
                    When the IRS releases your refund, the advance is automatically repaid. The
                    remaining balance is deposited to you.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-xs text-slate-700 mt-4">
                *0% APR advances available for qualifying returns. Some advances may have fees. See
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-700">
                  ...
                  actual refund. The loan must be repaid from your refund when it is received from
                  the IRS.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-700">
                  ...
                  the advance amount and your tax situation. All fees will be disclosed before you
                  accept.
                </p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-6">
                <p className="text-sm text-yellow-800">
                  <strong>Disclaimer:</strong> Refund advances are provided by EPS Financial, Member
                  FDIC. Approval and advance amounts are subject to underwriting criteria. Not all
                  applicants will qualify. See your tax professional for complete terms and
                  conditions.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-700">
                No. Refund advances do not require a credit check and are not reported to credit
                bureaus. Your credit score will not be affected.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-700">
                ...
                repaying the difference. This is why we carefully estimate your refund before
                approval.
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Cash Now?</h2>
