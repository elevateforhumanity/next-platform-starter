        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-slate-600">
              ...
              Career &amp; Technical Institute) (&quot;School,&quot; &quot;we,&quot;
              &quot;us&quot;), a registered limited liability company in the State of Indiana. We
              may collaborate with Selfish Inc. (d/b/a Rise Forward Foundation) to provide
              ...
              approved clinical training partners. These Terms govern your use of the Elevate for
              Humanity websites, portals, and services provided by the School. By accessing or using
              our website, learning management system, or any of our services, you agree to be bound
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600">
              Enrollment is subject to eligibility requirements, available funding, and program
              capacity.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600">
              All content, materials, courseware, and platform software are the property of
              2Exclusive LLC-S (d/b/a Elevate for Humanity Career &amp; Technical Institute) or our
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600">
              Services are provided &quot;as is.&quot; The Company does not guarantee employment
              outcomes, certification results, or specific program availability. Liability is
              limited to the fees paid for the specific service in question.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600">
              These Terms are governed by the laws of the State of Indiana. Any disputes shall be
          ...
          <section className="mb-12">
            ...
            <div className="bg-white rounded-xl p-6">
              <p className="text-slate-700">
                <strong>2Exclusive LLC-S</strong>
                <br />
                d/b/a Elevate for Humanity Career &amp; Technical Institute
                <br />
                Email:{' '}
                <a
