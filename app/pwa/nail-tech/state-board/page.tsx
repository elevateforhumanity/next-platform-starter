...
import { ArrowLeft, ExternalLink, FileText, Clock, Award, AlertCircle, Sparkles, BookOpen, TrendingUp } from 'lucide-react';
...
export default function NailTechStateBoardPage() {
  return (
    <div className="min-h-screen bg-slate-900 pb-20">
      <header className="bg-pink-700 px-4 pt-12 pb-6 safe-area-inset-top">
        ...
        <p className="text-pink-200 text-sm">Indiana IPLA Nail Technician Examination</p>
      </header>
      ...
      <main className="px-4 py-6 space-y-4">
        <div className="bg-slate-800 rounded-xl p-5">
          ...
          <ul className="space-y-2 text-slate-300 text-sm">
            <li className="flex items-start gap-2"><span className="text-pink-400 flex-shrink-0">•</span>Complete all 450 required apprenticeship hours</li>
            <li className="flex items-start gap-2"><span className="text-pink-400 flex-shrink-0">•</span>Pass all RTI coursework with a 70% or higher</li>
            <li className="flex items-start gap-2"><span className="text-pink-400 flex-shrink-0">•</span>Obtain program completion certificate from Elevate</li>
            <li className="flex items-start gap-2"><span className="text-pink-400 flex-shrink-0">•</span>Be at least 16 years of age</li>
          </ul>
        </div>
