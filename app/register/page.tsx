...
export const metadata: Metadata = {
  ...
  description:
    'Create your free Elevate for Humanity account to access career training programs, track your progress, and connect with career services.',
    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <p className="mt-2 text-slate-600">
          Students, staff, program partners, and employers all sign up here. Select your role when
          registering.
        </p>
        ...
        <div className="mt-6 flex flex-wrap gap-4 text-sm text-slate-600">
          ...
          <Link href="/start" className="underline hover:text-brand-blue-600">
            Not ready? Apply first
          </Link>
