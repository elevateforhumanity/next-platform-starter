...
export const metadata: Metadata = {
  ...
  description:
    'Standardized monthly on-the-job training evaluation form for barbershop supervisors. Structured checklist for technical skills, sanitation, client service, professionalism, and attendance.',
  alternates: {
    canonical:
      'https://www.elevateforhumanity.org/compliance/competency-verification/barber/monthly-ojt-evaluation',
  },
};
      ...
      <div className="print:hidden py-8 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-4">
            Standardized monthly evaluation form for barbershop supervisors. Print and complete for
            each apprentice every month.
          </p>
          <PrintButton />
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-8 print:px-6 print:pb-4">
            ...
            <table className="w-full border-collapse text-sm print:text-[10px]">
              <thead>
                <tr className="bg-white print:bg-white">
                  ...
                  <th className="text-center p-2 border font-semibold w-20 print:p-1">
                    Rating (1–4)
                  </th>
                  <th className="text-left p-2 border font-semibold w-40 print:p-1 print:w-28">
                    Comments
                  </th>
                </tr>
              </thead>
          ...
          <table className="w-full border-collapse text-sm print:text-[10px]">
            <thead>
              <tr className="bg-white print:bg-white">
                ...
                <th className="text-center p-2 border font-semibold w-24 print:p-1">
                  Hours This Month
                </th>
                <th className="text-center p-2 border font-semibold w-24 print:p-1">
                  Cumulative Hours
        ...
        <div className="border-t-2 border-gray-900 pt-6 print:pt-4 print:break-inside-avoid">
          ...
          <div className="space-y-4 print:space-y-3">
            {[
              {
                role: 'Barbershop Supervisor (Licensed Barber)',
                fields: ['Name', 'License #', 'Signature', 'Date'],
              },
              ...
              <div key={i} className="border rounded-lg p-3 print:p-2 print:border-gray-400">
                <p className="font-semibold text-sm mb-2 print:text-[10px] print:mb-1">
                  {signer.role}
                </p>
