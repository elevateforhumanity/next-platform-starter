...
export const metadata: Metadata = {
  ...
  description:
    'Tri-party final competency sign-off form for barber apprenticeship completion. RTI Instructor, Employer Supervisor, Program Holder, and Sponsor verification.',
  alternates: {
    canonical:
      'https://www.elevateforhumanity.org/compliance/competency-verification/barber/final-signoff',
  },
};
    ...
    <div className="bg-white min-h-screen print:bg-white print:text-[11px]">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-[10px] text-slate-700">
              Elevate for Humanity | RAPIDS ID: 2025-IN-132301 | Occupation: Barber (330.371-010)
            </p>
          </div>
      ...
      <div className="print:hidden py-8 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-slate-700 mb-4">
            Tri-party final verification form. All four parties must sign before apprenticeship
      ...
      <div className="max-w-4xl mx-auto px-4 pb-8 print:px-6 print:pb-4">
        ...
        <div className="border-2 rounded-lg p-4 mb-6 print:p-3 print:mb-4 print:border-gray-400">
          <h2 className="font-bold text-sm mb-3 print:text-[11px] print:mb-2">
            Apprentice Information
          </h2>
          ...
          <table className="w-full border-collapse text-sm print:text-[10px]">
            <thead>
              <tr className="bg-white print:bg-white">
                ...
                <th className="text-left p-2 border font-semibold w-32 print:p-1 print:w-24">
                  Verified By
                </th>
              </tr>
            </thead>
        ...
        <div className="border-2 border-gray-900 rounded-lg p-4 mb-6 print:p-3 print:mb-4">
          <h2 className="font-bold text-lg mb-3 print:text-sm print:mb-2">
            Completion Determination
          </h2>
        ...
        <div className="border-t-2 border-gray-900 pt-6 print:pt-4">
          <h2 className="font-bold text-lg mb-2 print:text-sm print:mb-1">
            Tri-Party Verification & Sponsor Sign-Off
          </h2>
          <p className="text-xs text-slate-700 mb-4 print:mb-3">
            All four parties must sign to complete the apprenticeship record. This form is filed
            with RAPIDS documentation.
          </p>

          <div className="space-y-5 print:space-y-3">
            {/* Party 1: RTI Instructor */}
            <div className="border-2 rounded-lg p-4 print:p-3 print:border-gray-400">
              <h3 className="font-bold text-sm mb-1 print:text-[11px]">
                1. Credential Partner — RTI Instructor (Licensed Barber)
              </h3>
              <p className="text-xs text-slate-700 mb-3 print:text-[9px] print:mb-2">
                I verify that the apprentice has completed all Related Technical Instruction
                requirements, demonstrated competency in all RTI-assessed areas (Sections 1–3, 5),
                and is prepared for the Indiana state board examination.
              </p>
            ...
            <div className="border-2 rounded-lg p-4 print:p-3 print:border-gray-400">
              ...
              <p className="text-xs text-slate-700 mb-3 print:text-[9px] print:mb-2">
                I verify that the apprentice has completed all required On-the-Job Training hours
                under my direct supervision at a licensed barbershop, demonstrated competency in all
                OJT-assessed areas (Sections 4–6), and is ready for independent practice.
              </p>
              <div className="grid grid-cols-2 gap-3 text-xs print:text-[9px] print:gap-2">
                <div>Supervisor Name: ________________________________</div>
                <div>Indiana Barber License #: ________________________________</div>
            ...
            <div className="border-2 rounded-lg p-4 print:p-3 print:border-gray-400">
              ...
              <p className="text-xs text-slate-700 mb-3 print:text-[9px] print:mb-2">
                I verify that all competency rubric sections have been completed and scored, all
                evaluation checkpoints (30-day, midpoint, final) have been conducted, and all
                documentation is recorded in the institutional LMS.
              </p>
              <div className="grid grid-cols-2 gap-3 text-xs print:text-[9px] print:gap-2">
            ...
            <div className="border-2 border-gray-900 rounded-lg p-4 print:p-3">
              ...
              <p className="text-xs text-slate-700 mb-3 print:text-[9px] print:mb-2">
                As the registered apprenticeship sponsor (RAPIDS ID: 2025-IN-132301), I verify that
                all program requirements have been met, all tri-party verifications are complete,
                and the apprentice is approved for completion documentation and credential pursuit.
              </p>
              <div className="grid grid-cols-2 gap-3 text-xs print:text-[9px] print:gap-2">
