...
export const metadata: Metadata = {
  ...
  description:
    'Formal apprenticeship agreement for workplace-based barber training. Defines RTI, OJT, supervision, competency evaluation, roles, and completion requirements. RAPIDS ID: 2025-IN-132301.',
  alternates: {
    canonical:
      'https://www.elevateforhumanity.org/compliance/competency-verification/barber/apprenticeship-agreement',
  },
};
    ...
    <div className="bg-white min-h-screen print:bg-white print:text-[11px]">
      ...
      <div className="print:hidden py-8 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">
            Barbering Apprenticeship Agreement
          </h1>
          <p className="text-slate-700 mb-4">
            Formal agreement for each barber apprentice enrollment. Print, complete, and store
            signed copies in the compliance folder.
          </p>
          <PrintButton />
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-12 print:px-8 print:pb-0 print:max-w-none">
        ...
        <div className="text-center border-b-2 border-gray-900 pb-6 mb-6 print:pb-4 print:mb-4">
          <p className="text-xs uppercase tracking-widest text-slate-700 mb-2 print:text-[9px]">
            Elevate for Humanity Career & Technical Institute
          </p>
          <h2 className="text-2xl font-bold text-slate-900 print:text-xl">
            BARBERING APPRENTICESHIP AGREEMENT
          </h2>
          <p className="text-sm text-slate-700 mt-1 print:text-[10px]">
            Workplace-Based Apprenticeship Program
          </p>
          <p className="text-xs text-slate-700 mt-1 print:text-[9px]">
            RAPIDS Registration: 2025-IN-132301 | Occupation: Barber (DOT 330.371-010)
          </p>
        </div>
          ...
          <div className="space-y-3 text-sm print:text-[10px] print:space-y-2">
            ...
            <div className="grid grid-cols-[200px_1fr] gap-2 print:grid-cols-[160px_1fr]">
              <span className="font-semibold text-slate-900">
                Program Holder (RTI Coordinator):
              </span>
              <span className="border-b border-gray-400 min-w-[200px]">&nbsp;</span>
            </div>
            <div className="grid grid-cols-[200px_1fr] gap-2 print:grid-cols-[160px_1fr]">
              <span className="font-semibold text-slate-900">
                Credential Partner (RTI Provider):
              </span>
              <span className="border-b border-gray-400 min-w-[200px]">&nbsp;</span>
            </div>
            <div className="grid grid-cols-[200px_1fr] gap-2 print:grid-cols-[160px_1fr]">
        ...
        <div className="space-y-6 text-sm text-slate-900 leading-relaxed print:text-[10px] print:space-y-4 print:leading-snug">
          ...
          <section className="print:break-inside-avoid">
            <h3 className="font-bold text-slate-900 text-base mb-2 print:text-[11px] print:mb-1">
              1. PURPOSE
            </h3>
            <p>
              This agreement establishes a structured barbering apprenticeship combining Related
              Technical Instruction (RTI) and On-the-Job Training (OJT) in a licensed barbershop
              environment under supervised, competency-based training standards. The apprenticeship
              is registered with the U.S. Department of Labor under RAPIDS ID 2025-IN-132301 and
              aligned with Indiana Professional Licensing Agency (PLA) requirements for barber
              licensure.
            </p>
          </section>
          ...
          <section className="print:break-inside-avoid">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Related Technical Instruction (RTI) delivered by licensed credential partners and
                supervised curriculum modules through the institutional LMS
              </li>
              <li>
                On-the-Job Training (OJT) conducted at an approved licensed barbershop under the
                direct supervision of a licensed barber
              </li>
              <li>
                Competency tracking through the institutional LMS and standardized evaluation
                rubrics
              </li>
              <li>
                Oversight by Program Holders (RTI Coordinators) and Sponsor (2Exclusive LLC-S, DBA
                Elevate for Humanity Career & Technical Institute)
              </li>
            </ul>
          </section>
          ...
          <section className="print:break-inside-avoid">
            ...
            <div className="border rounded-lg p-4 print:p-2 print:border-gray-400">
              <div className="grid grid-cols-2 gap-3 print:gap-2">
                <div>
                  Total RTI Hours:{' '}
                  <span className="border-b border-gray-400 inline-block min-w-[80px]">&nbsp;</span>
                </div>
                <div>
                  Total OJT Hours:{' '}
                  <span className="border-b border-gray-400 inline-block min-w-[80px]">&nbsp;</span>
            ...
            <p className="mt-2">
              Training shall follow a mapped work process schedule aligned with barbering
              competencies including sanitation, cutting techniques, shaving, shop operations, and
              professional conduct. Hour requirements are fixed minimums regardless of delivery
              location.
            </p>
          </section>
          ...
          <section className="print:break-inside-avoid">
            <h3 className="font-bold text-slate-900 text-base mb-2 print:text-[11px] print:mb-1">
              4. RELATED TECHNICAL INSTRUCTION (RTI)
            </h3>
            <p className="mb-2">RTI will be provided through:</p>
            <ul className="list-disc pl-6 space-y-1 mb-3">
              <li>
                Licensed credential partners (state-approved barber schools or licensed instructors)
              </li>
          ...
          <section className="print:break-inside-avoid">
            ...
            <p className="mb-2">
              The Employer agrees to provide supervised workplace training including:
            </p>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <p className="mt-2">
              All OJT must occur under the direct supervision of a licensed barber at a licensed
              barbershop. OJT hours are logged by competency category and verified by the
              supervising barber.
            </p>
          </section>
          ...
          <section className="print:break-inside-avoid">
            ...
            <div className="border rounded-lg p-4 print:p-2 print:border-gray-400">
              ...
              <div className="grid grid-cols-2 gap-3 print:gap-2">
                ...
                <div>
                  Years Licensed:{' '}
                  <span className="border-b border-gray-400 inline-block min-w-[60px]">&nbsp;</span>
                </div>
                <div>
                  Shop License #:{' '}
                  <span className="border-b border-gray-400 inline-block min-w-[100px]">
          ...
          <section className="print:break-inside-avoid">
            ...
            <p className="mb-2">
              Apprentice progress will be evaluated using standardized competency rubrics covering
              six sections:
            </p>
            ...
            <p className="mb-2">
              Scoring scale: 0 (Not Demonstrated) through 5 (Independent Mastery). Minimum passing
              standard: score of 3 (Competent) in all core competencies.
            </p>
            <p>Evaluations will be conducted at the following checkpoints:</p>
            <ul className="list-disc pl-6 space-y-1 mt-1">
              <li>
                <strong>Monthly:</strong> OJT evaluation by barbershop supervisor
              </li>
              <li>
                <strong>Quarterly:</strong> Combined RTI + OJT review by instructor and supervisor
              </li>
              <li>
                <strong>Final:</strong> Tri-party competency sign-off (RTI Instructor + Employer +
                Program Holder + Sponsor)
              </li>
            </ul>
          </section>
          ...
          <section className="print:break-inside-avoid">
            <h3 className="font-bold text-slate-900 text-base mb-2 print:text-[11px] print:mb-1">
              8. PROGRESS TRACKING & DOCUMENTATION
            </h3>
            <p className="mb-2">
              All training hours, competencies, and assessments will be documented through:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Institutional LMS tracking system (RTI hours, module completion, assessment scores)
              </li>
              <li>Employer OJT logs (hours by competency category, supervisor verification)</li>
              <li>
                Instructor RTI assessments (technical and theoretical competency verification)
              </li>
              <li>Program Holder oversight reviews (rubric completion, checkpoint compliance)</li>
              <li>
                Monthly OJT evaluation forms (standardized, signed by supervisor and apprentice)
              </li>
            </ul>
            <p className="mt-2">
              The LMS serves as the single system of record. All parties have access to progress
          ...
          <section className="print:break-inside-avoid">
            ...
            <div className="space-y-3 print:space-y-2">
              {[
                {
                  role: 'Sponsor (2Exclusive LLC-S, DBA Elevate for Humanity Career & Technical Institute)',
                  duties:
                    'Program oversight, RAPIDS registration and documentation, LMS tracking, completion verification, credential coordination, funding navigation, career services',
                },
                {
                  role: 'Credential Partner (RTI Provider)',
                  duties:
                    'Classroom and module-based instruction, academic evaluation, technical competency verification, state board exam preparation, RTI attendance documentation',
                },
                {
                  role: 'Employer (Licensed Barbershop)',
                  duties:
                    'Hands-on workplace training, OJT supervision by licensed barber, monthly performance evaluations, safe training environment, OJT hour logging',
                },
                {
                  role: 'Program Holder (RTI Coordinator)',
                  duties:
                    'RTI scheduling and coordination, progress monitoring, rubric completion enforcement, LMS documentation oversight, evaluation checkpoint management',
                },
                {
                  role: 'Apprentice',
                  duties:
                    'Active participation in all RTI and OJT activities, consistent attendance, skill development, adherence to professional and safety standards, completion of all assessments and evaluations',
                },
              ].map((item, i) => (
          ...
          <section className="print:break-inside-avoid">
            <h3 className="font-bold text-slate-900 text-base mb-2 print:text-[11px] print:mb-1">
              10. CREDENTIAL & COMPLETION
            </h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                The Indiana Barber License is issued by the Indiana Professional Licensing Agency
                (PLA) upon successful completion of the state board examination. Elevate does not
                issue this credential.
              </li>
              <li>
                Elevate will issue a Certificate of Completion upon successful fulfillment of all
                RTI hours, OJT hours, and competency requirements.
              </li>
              <li>
                Upon completion of all registered apprenticeship requirements, a Certificate of
                Completion of Apprenticeship will be filed through the USDOL RAPIDS system.
              </li>
            </ul>
          </section>
          ...
          <section className="print:break-inside-avoid">
            ...
            <p className="mt-2">
              Any modification or termination will be documented and filed with the apprenticeship
              record. The apprentice retains credit for all verified hours and competencies
          ...
          <section className="print:break-before-page">
            <h3 className="font-bold text-slate-900 text-base mb-4 print:text-[11px] print:mb-3">
              13. SIGNATURES
            </h3>
            <p className="mb-4 print:mb-3">
              By signing below, all parties acknowledge and agree to the terms of this
            ...
            <div className="space-y-6 print:space-y-4">
              {[
                {
                  role: 'Apprentice',
                  fields: ['Print Name', 'Signature', 'Date', 'Phone', 'Email'],
                },
                {
                  role: 'Employer / Barbershop Representative',
                  fields: [
                    'Print Name',
                    'Title',
                    'Shop Name',
                ...
                {
                  role: 'Licensed Supervisor Barber',
                  fields: [
                    'Print Name',
                    'Indiana Barber License #',
                    'Years Licensed',
                ...
                {
                  role: 'Credential Partner Representative (RTI Provider)',
                  fields: [
                    'Print Name',
                    'Organization',
                ...
                {
                  role: 'Sponsor — 2Exclusive LLC-S (DBA Elevate for Humanity Career & Technical Institute)',
                  fields: ['Authorized Representative', 'Title', 'Signature', 'Date'],
                },
              ].map((signer, i) => (
                <div
                  key={i}
                  className="border-2 rounded-lg p-4 print:p-3 print:border-gray-400 print:break-inside-avoid"
                >
                  <p className="font-bold text-slate-900 mb-3 print:text-[11px] print:mb-2">
                    {signer.role}
                  </p>
                  <div className="grid grid-cols-2 gap-3 text-sm print:text-[10px] print:gap-2">
                    {signer.fields.map((field, fi) => (
                      <div key={fi} className={field === 'Signature' ? 'col-span-2' : ''}>
                        {field}:{' '}
                        <span className="border-b border-gray-400 inline-block min-w-[180px] print:min-w-[140px]">
                          &nbsp;
                        </span>
                      </div>
                    ))}
          ...
          <div className="border-t-2 border-gray-900 pt-4 mt-8 text-center text-xs text-slate-700 print:text-[9px] print:pt-3 print:mt-4">
            ...
            <p className="mt-1">
              This agreement is maintained in the apprentice compliance file and filed with RAPIDS
              documentation.
            </p>
          </div>
        </div>
      ...
      <div className="py-8 bg-white print:hidden">
        <div className="max-w-3xl mx-auto px-4 flex flex-wrap gap-3">
          ...
          <Link
            href="/compliance/competency-verification/barber/scoring-sheet"
          ...
          <Link
            href="/compliance/competency-verification/barber/final-signoff"
            className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-slate-900 rounded-lg text-sm font-medium hover:bg-white transition"
          >
            Final Sign-Off Form
          </Link>
