...
export const metadata: Metadata = {
  ...
  description:
    'Licensed barber supervisor verification form. Documents shop license, supervisor license, and training authority for apprenticeship compliance.',
  alternates: {
    canonical:
      'https://www.elevateforhumanity.org/compliance/competency-verification/barber/supervisor-verification',
  },
};
  ...
  return (
    <div className="bg-white min-h-screen print:bg-white print:text-[11px]">
      ...
      <div className="print:hidden py-8 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-slate-700 mb-4">
            Required for each barbershop training site. Verifies licensed supervisor authority
            before apprentice placement.
          </p>
          <PrintButton />
        </div>
      </div>
      ...
      <div className="hidden print:block px-8 pt-8 pb-4 border-b-2 border-gray-900">
        <p className="text-[9px] uppercase tracking-widest text-slate-700 mb-1">
          Elevate for Humanity Career & Technical Institute
        </p>
        <h1 className="text-lg font-bold">LICENSED BARBER SUPERVISOR VERIFICATION FORM</h1>
        <p className="text-[10px] text-slate-700">
          Barbering Apprenticeship Program | RAPIDS ID: 2025-IN-132301
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 print:px-8 print:py-6 print:max-w-none">
        ...
        <div className="border-2 rounded-lg p-5 mb-6 print:p-4 print:mb-5 print:border-gray-400">
          <h2 className="font-bold text-base mb-4 print:text-[12px] print:mb-3">
            Barbershop Information
          </h2>
          <div className="space-y-4 text-sm print:text-[10px] print:space-y-3">
            <div>
              Barbershop Name:{' '}
              <span className="border-b border-gray-400 inline-block min-w-[300px]">&nbsp;</span>
            </div>
            <div>
              Shop Address:{' '}
              <span className="border-b border-gray-400 inline-block min-w-[300px]">&nbsp;</span>
            ...
            <div className="grid grid-cols-2 gap-4 print:gap-3">
              ...
              <div>
                License Expiration:{' '}
                <span className="border-b border-gray-400 inline-block min-w-[100px]">&nbsp;</span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 print:gap-3">
              <div>
        ...
        <div className="border-2 rounded-lg p-5 mb-6 print:p-4 print:mb-5 print:border-gray-400">
          ...
          <div className="space-y-4 text-sm print:text-[10px] print:space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 print:gap-3">
              <div>
                State of Licensure:{' '}
                <span className="border-b border-gray-400 inline-block min-w-[80px]">Indiana</span>
              </div>
              <div>
                Years Licensed:{' '}
                <span className="border-b border-gray-400 inline-block min-w-[60px]">&nbsp;</span>
            ...
            <div className="grid grid-cols-2 gap-4 print:gap-3">
              ...
              <div>
                Email:{' '}
                <span className="border-b border-gray-400 inline-block min-w-[160px]">&nbsp;</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-2 border-gray-900 rounded-lg p-5 mb-6 print:p-4 print:mb-5">
          <h2 className="font-bold text-base mb-3 print:text-[12px] print:mb-2">
            Supervisor Confirmation
          </h2>
          <p className="text-sm text-slate-900 leading-relaxed print:text-[10px]">
            I confirm that I am a licensed barber in the State of Indiana and will directly
            supervise the above-named apprentice&apos;s on-the-job training at the above-named
            licensed barbershop. I agree to:
          </p>
        ...
        <div className="border-t-2 border-gray-900 pt-6 print:pt-4">
          ...
          <div className="space-y-6 print:space-y-4">
            <div className="border-2 rounded-lg p-4 print:p-3 print:border-gray-400">
              <p className="font-bold text-sm mb-3 print:text-[11px] print:mb-2">
                Supervising Barber
              </p>
        ...
        <div className="border-t pt-4 mt-8 text-center text-xs text-slate-700 print:text-[9px] print:pt-3 print:mt-4">
          <p>
            This form must be completed before apprentice placement and maintained in the compliance
            file.
          </p>
