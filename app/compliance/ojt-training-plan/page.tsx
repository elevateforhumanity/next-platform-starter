    ...
    <div className="min-h-screen bg-white">
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-6 py-3">
          <Breadcrumbs
            items={[{ label: 'Compliance', href: '/compliance' }, { label: 'OJT Training Plan' }]}
          />
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="text-slate-500 mb-4">
          WIOA-Aligned Work-Based Learning — Finance, Bookkeeping &amp; Accounting Credential
          Pathway
        </p>
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mb-8 text-sm text-brand-blue-800">
          ...
          <p>
            This OJT plan is designed for coordination with the local workforce development board
            through WorkOne Indianapolis (Region 5). OJT contracts, wage reimbursement rates, and
            participant eligibility are determined by the assigned WorkOne career advisor or case
            manager. Elevate submits this training plan as part of the OJT agreement package
        ...
        <div className="prose prose-slate max-w-none">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-slate-600">
                  ...
                  <br />
                  WIOA Case #: ___________________________
                  <br />
                  Credential Tier: ☐ 1 &nbsp; ☐ 2 &nbsp; ☐ 3
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  ...
                  <br />
                  SOC Code: ___________________________
                  <br />
                  Wage: $____/hr
                </p>
              </div>
          ...
          <p className="text-sm text-slate-700 mb-3">
            Each skill area includes specific competencies, target completion dates, and evaluation
            criteria.
          </p>
            ...
            {[
              {
                ...
                skills: [
                  'Office procedures and compliance protocols',
                  'Tax software setup and navigation',
                  'Client intake workflow and data security (IRS Pub 4557)',
              ...
              },
              {
                ...
                skills: [
                  ...
                  'Income documentation review (W-2, 1099)',
                  'Deduction and credit identification',
                  'Quality review process and e-filing',
                ],
              },
              {
                week: 'Weeks 5–6',
                ...
                skills: [
                  'QuickBooks transaction entry and categorization',
              ...
              },
              {
                ...
                skills: [
                  'Independent client consultations (supervised)',
                  'Small business return preparation (Schedule C)',
              ...
              <div key={phase.week} className="bg-white border border-slate-200 rounded-lg p-5">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-xs font-bold text-white px-2.5 py-1 rounded bg-slate-800">
                    {phase.week}
                  </span>
                ...
                <div className="mt-3 pt-3 border-t border-slate-100 text-xs text-slate-500">
                  Supervisor initials: ____ &nbsp; Date completed: ____ &nbsp; Competency met: ☐ Yes
                  ☐ Needs more time
                </div>
              </div>
            ))}
            ...
            <table className="w-full">
              ...
              <tbody className="text-slate-600">
                <tr className="border-b border-slate-100">
                  <td className="py-2">Initial skills assessment</td>
                  <td>Week 1</td>
                  <td>Site supervisor</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Midpoint evaluation</td>
                  <td>Week 4</td>
                  <td>Supervisor + Elevate coordinator</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Final competency evaluation</td>
                  <td>Week 8</td>
                  <td>Supervisor + Elevate coordinator</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr>
                  <td className="py-2">Employment transition review</td>
                  <td>Week 8</td>
                  <td>Elevate career services</td>
                  <td className="text-center">☐</td>
                </tr>
              </tbody>
            </table>
          ...
          <ul className="text-sm text-slate-700">
            <li>
              OJT participant is a W-2 employee of the host employer for the duration of training
            </li>
            <li>Reimbursement covers extraordinary costs of training — not productive labor</li>
            <li>
              Participant may not displace current employees or fill vacant positions without
              training justification
            </li>
            <li>
              Hours must be tracked and reported to the local workforce board per WIOA Sec.
              134(c)(3)(D)
            </li>
          ...
          <h2 className="text-lg font-bold text-slate-900 mt-8">
            WorkOne Coordination Requirements
          </h2>
          <ul className="text-sm text-slate-700">
            <li>
              OJT contract must be approved by the WorkOne career advisor before training begins
            </li>
            <li>
              Reimbursement rate (50–75%) is set by the local workforce development board policy —
              not by Elevate
            </li>
            <li>
              Participant must be registered in Indiana Career Connect with an active WIOA
              enrollment
            </li>
            <li>Weekly progress reports are sent to the assigned case manager</li>
            <li>
              Midpoint and final evaluations are shared with WorkOne for performance reporting
            </li>
            <li>
              Credential attainment is reported to the local board within 5 business days of exam
              completion
            </li>
            <li>
              Employment outcomes (hire date, wage, retention) are tracked for WIOA performance
              measures
            </li>
          </ul>
