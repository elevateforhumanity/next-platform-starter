    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 mb-2">
          Structured Internship Agreement
        </h1>
        ...
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mb-8 text-sm text-brand-blue-800">
          ...
          <p>
            For WIOA-funded participants, this agreement is submitted alongside the WorkOne OJT
            contract or work experience authorization. The assigned WorkOne career advisor or case
            manager must approve the placement before the internship begins. Wage structure and
            reimbursement terms are governed by local workforce development board policy (Region 5 /
            Indianapolis).
          </p>
        </div>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="text-sm text-slate-700">
            This agreement establishes a structured, supervised internship placement as part of the
            Finance, Bookkeeping &amp; Accounting Credential Pathway. The internship is designed to
            provide applied work experience that reinforces classroom instruction and credential
            attainment.
          </p>

          <h2 className="text-lg font-bold text-slate-900">2. Learning Objectives</h2>
          <p className="text-sm text-slate-700 mb-2">
            The participant will demonstrate competency in the following areas during the internship
            period:
          </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-200">
                  ...
                  <th className="text-center py-2 text-slate-700 font-semibold w-24">
                    Target Date
                  </th>
              ...
              <tbody className="text-slate-600">
                <tr className="border-b border-slate-100">
                  <td className="py-2">Prepare individual tax returns (Form 1040) with accuracy</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Process client intake and maintain data security</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Use professional tax software for e-filing</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Perform bookkeeping entries in QuickBooks</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-2">Reconcile bank accounts and generate reports</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
                <tr>
                  <td className="py-2">Demonstrate professional client communication</td>
                  <td className="text-center">____</td>
                  <td className="text-center">☐</td>
                </tr>
              </tbody>
          ...
          <div className="text-sm text-slate-700 space-y-1">
            <p>
              ☐ <strong>Workforce-Funded Work Experience</strong> — Stipend/wage paid by workforce
              board: $____/hr
            </p>
            <p>
              ☐ <strong>OJT Reimbursement Model</strong> — W-2 hire at $____/hr, workforce
              reimburses ____% for ____ weeks
            </p>
            <p>
              ☐ <strong>Employer-Funded Placement</strong> — Employer pays $____/hr directly, no
              reimbursement
            </p>
          </div>
          ...
          <ul className="text-sm text-slate-700">
            ...
            <li>
              For WIOA-funded placements: participant must be registered in Indiana Career Connect
              with active enrollment
            </li>
            <li>
              Weekly progress updates provided to assigned WorkOne career advisor or case manager
            </li>
          ...
          <p className="text-sm text-slate-700">
            Either party may terminate this agreement with 5 business days written notice. Grounds
            for immediate termination include violation of confidentiality, safety violations, or
