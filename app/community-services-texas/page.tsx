...
export const metadata: Metadata = {
  ...
  description:
    'Trusted community services in Texas. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: [
    'community services Texas',
    'job placement Texas',
    'family services Houston',
    'housing assistance Dallas',
  ],
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <p className="text-xl text-slate-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Texas families. We connect Texans with resources for
