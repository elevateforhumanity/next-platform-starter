...
export const metadata: Metadata = {
  title: 'Community Services & Support in Texas | Elevate for Humanity',
  description: 'Trusted community services in Texas. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: ['community services Texas', 'job placement Texas', 'family services Houston', 'housing assistance Dallas'],
}

export default function CommunityServicesTexasPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">
          Community Services in Texas
        </h1>
        <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Texas families. We connect Texans with resources
