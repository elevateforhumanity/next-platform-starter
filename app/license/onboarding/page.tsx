            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center">
                <div className={`flex items-center ${index < steps.length - 1 ? 'flex-1' : ''}`}>
                  ...
                  <div className="ml-3">
                    <p
                      className={`font-medium ${step.completed ? 'text-brand-green-600' : index === currentStep ? 'text-brand-blue-600' : 'text-slate-700'}`}
                    >
                      {step.title}
                    </p>
        ...
        {currentStep === 0 && !allAgreementsAccepted && (
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <p className="text-slate-700 mb-6">
              Please review and accept the following agreements to continue. These agreements govern
        ...
        {(currentStep === 1 || (currentStep === 0 && allAgreementsAccepted)) && (
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <p className="text-slate-700">
              Please contact support to complete your organization profile setup.
            </p>
          </div>
        )}
      </div>
