...
export const metadata: Metadata = {
  ...
  description:
    'Dr. Carlina Wilkes — Executive Director of Financial Operations & Organizational Compliance at Elevate for Humanity Career & Technical Institute.',
};
            ...
            <div className="lg:col-span-3">
              ...
              <div className="text-slate-800 space-y-4 text-[16px] leading-relaxed">
                <p>
                  ...
                  Accounting Service (DFAS), holding DoD Financial Management Certification Level
                  II. She oversees financial operations and compliance at Elevate for Humanity.
                </p>
                <p>
                  Her extensive background in federal financial management, audit readiness, and
                  regulatory compliance ensures that Elevate maintains the highest standards of
                  fiscal accountability across all funded programs including WIOA, WRG, and Job
                  Ready Indy.
                </p>
              </div>
            </div>
