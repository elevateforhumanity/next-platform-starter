          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="text-slate-800 space-y-4 text-[16px] leading-relaxed">
                ...
                <p>Elizabeth also leads Elevate tax operations and the RISE Foundation, a 501(c)(3) nonprofit providing philanthropic support for workforce development initiatives.</p>
              </div>
            </div>
          </div>
        </div>
