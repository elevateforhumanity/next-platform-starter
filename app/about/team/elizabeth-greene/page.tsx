          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="text-slate-800 space-y-4 text-[16px] leading-relaxed">
                ...
                <p>Under her leadership, Elevate for Humanity has secured approvals across federal, state, and local agencies. The organization is a U.S. Department of Labor Registered Apprenticeship Sponsor, listed on the Eligible Training Provider List (ETPL), and approved as a Workforce Ready Grant (WRG) provider. Elevate is WIOA and JRI funding approved, and partners with workforce and training organizations across Indiana.</p>
