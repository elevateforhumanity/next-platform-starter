        ...
        <div className="bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-lg text-slate-700 mb-6">
              These disclosures clarify what the Elevate For Humanity platform is and is not. Please
              read carefully before using the platform or purchasing a license.
            </p>
            ...
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-brand-red-700">
                <strong>We do not guarantee any outcomes.</strong> This includes but is not limited
                to: job placement, income levels, certification pass rates, funding approval,
                enrollment numbers, revenue, or business success. Your results depend entirely on
                how you implement and use the platform.
              </p>
            </div>

            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">1. What We Are</h2>
            <p className="text-slate-700 mb-4">
              Elevate For Humanity is a <strong>software platform</strong>. We provide technology
              tools for workforce development, learning management, and program administration.
            </p>
            <p className="text-slate-700 mb-4">
              We are a technology company. We license software. That is our business.
            </p>

            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">2. What We Are NOT</h2>
            <p className="text-slate-700 mb-4">We are NOT:</p>
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
              <li>
                <strong>A school or educational institution</strong> – We provide tools, not
                education
              </li>
              <li>
                <strong>An accrediting body</strong> – We do not grant accreditation
              </li>
              <li>
                <strong>A licensing authority</strong> – We do not issue professional licenses
              </li>
              <li>
                <strong>A staffing agency</strong> – We do not employ or place workers
              </li>
              <li>
                <strong>A consulting firm</strong> – We do not provide advisory services
              </li>
              <li>
                <strong>A law firm</strong> – We do not provide legal advice
              </li>
              <li>
                <strong>An accounting firm</strong> – We do not provide financial advice
              </li>
              <li>
                <strong>A compliance service</strong> – We do not ensure your compliance
              </li>
            </ul>

            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">3. No Professional Advice</h2>
            <p className="text-slate-700 mb-4">Nothing on this platform constitutes:</p>
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
              <li>
                <strong>Legal advice</strong> – Consult a licensed attorney
              </li>
              <li>
                <strong>Financial advice</strong> – Consult a licensed financial advisor
              </li>
              <li>
                <strong>Tax advice</strong> – Consult a licensed tax professional
              </li>
              <li>
                <strong>Compliance advice</strong> – Consult qualified compliance professionals
              </li>
              <li>
                <strong>Medical advice</strong> – Consult licensed healthcare providers
              </li>
            </ul>
            <p className="text-slate-700 mb-4">
              Any information, templates, or tools provided are for general informational purposes
              only and should not be relied upon as professional advice.
            </p>

            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">4. Your Responsibility</h2>
            <p className="text-slate-700 mb-4">You are solely responsible for:</p>
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">5. Results Disclaimer</h2>
            <p className="text-slate-700 mb-4">
              Any examples, case studies, or testimonials shown are for illustrative purposes only.
              They represent individual results and are not guarantees of future performance.
            </p>
            <p className="text-slate-700 mb-4">
            ...
            <p className="text-slate-700 mb-4">
              The platform may integrate with or link to third-party services. We are not
              responsible for:
            </p>
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">7. Platform Availability</h2>
            <p className="text-slate-700 mb-4">
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">8. Funding and Grants</h2>
            <p className="text-slate-700 mb-4">
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">9. No Partnership</h2>
            <p className="text-slate-700 mb-4">
              Using this platform does not make you a partner, affiliate, representative, or agent
            ...
            <div className="mt-12 pt-8 border-t border-slate-200 bg-slate-50 -mx-8 md:-mx-12 px-8 md:px-12 pb-8 -mb-8 md:-mb-12 rounded-b-xl">
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  You will seek qualified professional advice for legal, financial, and compliance
                  matters
                </li>
                <li>
