      ...
      >
        <DocumentSection heading="Purpose" number={1}>
          <p>
            ...
            education records. This consent authorizes Elevate for Humanity to disclose specific
        ...
        <DocumentSection heading="Authorized Recipients" number={4}>
          <p>
            By signing this consent, you authorize Elevate for Humanity to share the above records
            with:
          </p>
          <ul>
            <li>
        ...
        <DocumentSection heading="Directory Information" number={7}>
          <p>
            Elevate for Humanity may designate the following as directory information, which may be
