...
export const metadata: Metadata = {
  title: 'Employer Partnership Agreement | {PLATFORM_DEFAULTS.orgName}',
    ...
    <>
      ...
      >
        <DocumentSection heading="Parties" number={1}>
          <p>
            This Employer Partnership Agreement is entered into between <strong>2Exclusive LLC-S d/b/a {PLATFORM_DEFAULTS.orgName} Career &amp; Training Institute</strong> ("Elevate") and the employer identified at the time of execution ("Employer").
          </p>
        </DocumentSection>
