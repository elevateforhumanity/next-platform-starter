...
export const metadata = buildMetadata({
  title: 'Legal',
  description:
    'Legal documents including privacy policy, enrollment agreement, EULA, and partner agreements for Elevate for Humanity.',
  path: '/legal',
});
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16">
      ...
      <p className="mt-4 text-slate-700">
        Legal agreements, disclosures, and documents governing use of Elevate for Humanity programs
        and platforms.
      </p>
