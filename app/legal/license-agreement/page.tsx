...
export const metadata: Metadata = {
  ...
  description:
    'Software License Agreement for organizations licensing the Elevate For Humanity platform.',
};
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
              <p className="text-amber-800 font-medium">
                Important: This is a software license, not a partnership, joint venture, or service
                agreement. You are licensing technology. You are responsible for implementation,
            ...
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
              ...
              <li>
                <strong>Tier-limited</strong> – Subject to the limits of your subscription tier
                (users, programs, etc.)
              </li>
              <li>
                <strong>Organization-specific</strong> – For use by your organization only
              </li>
              <li>
                <strong>Commercial use permitted</strong> – You may charge fees for courses,
                training, and services you deliver through the platform
              </li>
              <li>
                <strong>Non-transferable</strong> – The license itself cannot be sold, assigned, or
            ...
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
              ...
              <li>
                Offer paid training programs, certifications, and workforce development services
              </li>
            ...
            <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
              ...
              <li>
                <strong>Content</strong> – Creating, uploading, and maintaining your courses and
                materials
              </li>
              <li>
                <strong>Compliance</strong> – Ensuring your use complies with all applicable laws
                and regulations
              </li>
              <li>
                <strong>Data accuracy</strong> – Maintaining accurate student and organizational
                records
              </li>
              <li>
                <strong>User management</strong> – Managing your staff and student accounts
              </li>
              <li>
                <strong>Training</strong> – Training your staff to use the platform
              </li>
              <li>
                <strong>Outcomes</strong> – Your results depend on how you implement and use the
                platform
              </li>
            </ul>
