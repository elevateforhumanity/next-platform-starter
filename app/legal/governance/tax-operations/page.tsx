    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          ...
          <a
            href="/docs/Tax_Preparation_Refund_Advance_Operations.pdf"
            download
            className="flex items-center gap-2 px-4 py-2 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700"
          >
        ...
        <nav className="bg-gray-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <a href="#purpose" className="text-brand-red-600 hover:underline">
                1. Purpose & Scope
              </a>
            </li>
            <li>
              <a href="#services" className="text-brand-red-600 hover:underline">
                2. Services Offered
              </a>
            </li>
            <li>
              <a href="#compliance" className="text-brand-red-600 hover:underline">
                3. IRS Compliance
              </a>
            </li>
            <li>
              <a href="#refund-advance" className="text-brand-red-600 hover:underline">
                4. Refund Advance Program
              </a>
            </li>
            <li>
              <a href="#fees" className="text-brand-red-600 hover:underline">
                5. Fee Structure & Disclosures
              </a>
            </li>
            <li>
              <a href="#data-security" className="text-brand-red-600 hover:underline">
                6. Data Security & Privacy
              </a>
            </li>
            <li>
              <a href="#quality" className="text-brand-red-600 hover:underline">
                7. Quality Assurance
              </a>
            </li>
            <li>
              <a href="#responsibilities" className="text-brand-red-600 hover:underline">
                8. Roles & Responsibilities
              </a>
            </li>
            <li>
              <a href="#versioning" className="text-brand-red-600 hover:underline">
                9. Versioning & Review
              </a>
            </li>
          </ol>
        ...
        <section id="services" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Basic Return (1040)</td>
              ...
              <tr>
                <td className="border p-3">Complex Return</td>
              ...
              <tr>
                <td className="border p-3">Amended Returns</td>
                <td className="border p-3">Corrections to prior filings</td>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Virtual Assisted:</strong> Video/phone consultation with tax preparer
            </li>
            <li>
              <strong>Drop-Off:</strong> Document upload, preparer completes return
            </li>
            <li>
              <strong>In-Person:</strong> Partner locations during tax season
            </li>
          </ul>
        </section>
        ...
        <section id="compliance" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">PTIN</td>
              ...
              <tr>
                <td className="border p-3">Background Check</td>
        ...
        <section id="refund-advance" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              ...
              <tr>
                <td className="border p-3">Funding Time</td>
                <td className="border p-3">Same day or next business day</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
            <p className="text-sm text-yellow-800">
              <strong>Important:</strong> All Refund Advance disclosures must be provided in writing
              before loan application, including: APR, total cost, repayment terms, risks if refund
        ...
        <section id="fees" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Basic Federal Return</td>
              ...
              <tr>
                <td className="border p-3">Complex Federal Return</td>
              ...
              <tr>
                <td className="border p-3">Amended Return</td>
                <td className="border p-3">$75 - $150</td>
                <td className="border p-3">Corrections to prior year</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Refund Advance</td>
              ...
              <tr>
                <td className="border p-3">Prepaid Card</td>
                <td className="border p-3">$0 - $10</td>
                <td className="border p-3">Optional card for refund</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="data-security" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Tax Documents:</strong> Encrypted storage, access logging, 7-year retention
            </li>
            <li>
              <strong>Bank Information:</strong> Tokenized, never stored in plain text
            </li>
            <li>
              <strong>Income Data:</strong> Encrypted, access restricted to assigned preparer
            </li>
          </ul>
        ...
        <section id="quality" className="mb-12">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Peer Review:</strong> Second preparer reviews complex returns
            </li>
            <li>
              <strong>Quality Review:</strong> Random sampling of all returns (10%)
            </li>
            <li>
              <strong>Manager Review:</strong> All returns over $10,000 refund
            </li>
          </ol>
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Minor (no financial impact)</td>
              ...
              <tr>
                <td className="border p-3">Major (significant impact)</td>
                <td className="border p-3">Amended return, penalty coverage</td>
                <td className="border p-3">Manager contact, remediation plan</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="responsibilities" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              ...
              <tr>
                <td className="border p-3">Tax Preparers</td>
                <td className="border p-3">
              ...
              <tr>
                <td className="border p-3">Compliance Officer</td>
                <td className="border p-3">
                  Regulatory compliance, audit response, policy updates
                </td>
              </tr>
            </tbody>
          </table>
