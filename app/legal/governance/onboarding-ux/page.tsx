    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          ...
          <a
            href="/docs/Onboarding_User_Experience_Standards.pdf"
            download
        ...
        <nav className="bg-gray-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <a href="#purpose" className="text-teal-600 hover:underline">
                1. Purpose & Scope
              </a>
            </li>
            <li>
              <a href="#onboarding" className="text-teal-600 hover:underline">
                2. Onboarding Flows
              </a>
            </li>
            <li>
              <a href="#accessibility" className="text-teal-600 hover:underline">
                3. Accessibility Standards
              </a>
            </li>
            <li>
              <a href="#design" className="text-teal-600 hover:underline">
                4. Design System
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#communication" className="text-teal-600 hover:underline">
                6. User Communication
              </a>
            </li>
            <li>
              <a href="#feedback" className="text-teal-600 hover:underline">
                7. Feedback & Improvement
              </a>
            </li>
            <li>
              <a href="#responsibilities" className="text-teal-600 hover:underline">
                8. Roles & Responsibilities
              </a>
            </li>
            <li>
              <a href="#versioning" className="text-teal-600 hover:underline">
                9. Versioning & Review
              </a>
            </li>
          </ol>
          ...
          <table className="w-full border-collapse border">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Primary Journey</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Student</td>
                <td className="border p-3">Course enrollment, learning, certification</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Instructor</td>
                <td className="border p-3">Course creation, student management</td>
              </tr>
              <tr>
                <td className="border p-3">Tax Client</td>
                <td className="border p-3">Tax prep, refund advance, document upload</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Store Customer</td>
                <td className="border p-3">Browse, purchase, download</td>
              </tr>
              <tr>
                <td className="border p-3">Partner/Delegate</td>
                <td className="border p-3">Student referral, reporting</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="onboarding" className="mb-12">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Information Collection:</strong> Minimal required fields (email, password,
              name)
            </li>
            <li>
              <strong>Email Verification:</strong> Confirmation email within 1 minute
            </li>
            <li>
              <strong>Profile Completion:</strong> Optional additional info, progressive disclosure
            </li>
            <li>
              <strong>Welcome:</strong> Personalized welcome screen with next steps
            </li>
          </ol>
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Onboarding Steps</th>
                <th className="border p-3 text-left">Time to Value</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border p-3">
                  Interest selection → Course recommendations → First lesson
                </td>
                <td className="border p-3">&lt;5 minutes</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Instructor</td>
                <td className="border p-3">
                  Credential verification → Platform training → First course draft
                </td>
              ...
              <tr>
                <td className="border p-3">Tax Client</td>
                <td className="border p-3">
                  Service selection → Document checklist → Appointment/upload
                </td>
                <td className="border p-3">&lt;10 minutes</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Store Customer</td>
                <td className="border p-3">Browse → Purchase → Download (no account required)</td>
                <td className="border p-3">&lt;3 minutes</td>
              </tr>
            </tbody>
          </table>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Quick Wins:</strong> Enable meaningful action within first session
            </li>
            <li>
              <strong>Guidance:</strong> Tooltips, walkthroughs for new features
            </li>
            <li>
              <strong>Recovery:</strong> Easy to resume if interrupted
            </li>
            <li>
              <strong>Personalization:</strong> Tailor experience based on stated goals
            </li>
          </ul>
        </section>
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border p-3">
                  4.5:1 contrast ratio, resizable text, no color-only indicators
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Auditory</td>
                <td className="border p-3">
                  Captions for video, transcripts for audio, visual alerts
                </td>
              </tr>
              <tr>
                <td className="border p-3">Motor</td>
                <td className="border p-3">
                  Keyboard navigation, large click targets (44x44px), no time limits
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Cognitive</td>
                <td className="border p-3">
                  Clear language, consistent navigation, error prevention
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="design" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Typography:</strong> Inter for UI, system fonts as fallback
            </li>
            <li>
              <strong>Spacing:</strong> 4px base unit, consistent padding/margins
            </li>
            <li>
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Standards</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Buttons</td>
                <td className="border p-3">
                  Clear hierarchy (primary, secondary, ghost), loading states
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Forms</td>
                <td className="border p-3">
                  Labels above inputs, inline validation, clear error messages
                </td>
              </tr>
              <tr>
                <td className="border p-3">Navigation</td>
                <td className="border p-3">Consistent placement, breadcrumbs for deep pages</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Cards</td>
                <td className="border p-3">Consistent padding, clear visual hierarchy</td>
              </tr>
              <tr>
                <td className="border p-3">Modals</td>
                <td className="border p-3">Focus trap, escape to close, clear actions</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="support" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Help Center (Self-Service)</td>
                <td className="border p-3">24/7</td>
                <td className="border p-3">Immediate</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Email Support</td>
                <td className="border p-3">24/7 submission</td>
                <td className="border p-3">&lt;24 hours</td>
              </tr>
              <tr>
                <td className="border p-3">Live Chat</td>
                <td className="border p-3">9am-6pm EST, Mon-Fri</td>
                <td className="border p-3">&lt;5 minutes</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Phone Support</td>
                <td className="border p-3">9am-5pm EST, Mon-Fri</td>
                <td className="border p-3">&lt;2 minutes wait</td>
              </tr>
              <tr>
                <td className="border p-3">Community Forum</td>
                <td className="border p-3">24/7</td>
                <td className="border p-3">Varies (peer support)</td>
              </tr>
            </tbody>
          </table>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Tier 2:</strong> Technical issues, billing disputes, complex problems
            </li>
            <li>
              <strong>Tier 3:</strong> Engineering escalation, security issues, executive escalation
            </li>
          </ul>
          ...
          <table className="w-full border-collapse border">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Resolution Target</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Critical</td>
                <td className="border p-3">Platform down, security breach</td>
                <td className="border p-3">4 hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">High</td>
                <td className="border p-3">Feature broken, payment issues</td>
                <td className="border p-3">24 hours</td>
              </tr>
              <tr>
                <td className="border p-3">Medium</td>
                <td className="border p-3">Non-blocking issues, questions</td>
                <td className="border p-3">48 hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Low</td>
                <td className="border p-3">Feature requests, minor issues</td>
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Opt-Out</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border p-3">
                  Order confirmations, password resets, security alerts
                </td>
                <td className="border p-3">Cannot opt out</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Service</td>
                <td className="border p-3">Course updates, deadline reminders, account changes</td>
                <td className="border p-3">Limited opt-out</td>
              </tr>
              <tr>
                <td className="border p-3">Marketing</td>
                <td className="border p-3">Promotions, new courses, newsletters</td>
                <td className="border p-3">Full opt-out</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="feedback" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>NPS Surveys:</strong> Quarterly Net Promoter Score surveys
            </li>
            <li>
              <strong>Course Ratings:</strong> Post-completion course and instructor ratings
            </li>
            <li>
              <strong>Support Feedback:</strong> Post-interaction satisfaction surveys
            </li>
            <li>
              <strong>User Research:</strong> Periodic interviews and usability testing
            </li>
          </ul>
          ...
          <table className="w-full border-collapse border">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Measurement</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">NPS Score</td>
                <td className="border p-3">&gt;50</td>
                <td className="border p-3">Quarterly survey</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">CSAT (Support)</td>
                <td className="border p-3">&gt;90%</td>
                <td className="border p-3">Post-interaction survey</td>
              </tr>
              <tr>
                <td className="border p-3">Onboarding Completion</td>
                <td className="border p-3">&gt;80%</td>
                <td className="border p-3">Analytics tracking</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Time to First Value</td>
                <td className="border p-3">&lt;5 minutes</td>
                <td className="border p-3">Analytics tracking</td>
              </tr>
              <tr>
                ...
                <td className="border p-3">Automated testing</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="responsibilities" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Director of Product</td>
                <td className="border p-3">Overall UX strategy, standards ownership, roadmap</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">UX Designer</td>
                <td className="border p-3">
                  Design system, user research, accessibility compliance
                </td>
              </tr>
              <tr>
                <td className="border p-3">Frontend Engineers</td>
                <td className="border p-3">Implementation, accessibility testing, performance</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Support Manager</td>
                <td className="border p-3">Support operations, SLA compliance, team training</td>
              </tr>
              <tr>
                <td className="border p-3">Content Team</td>
                <td className="border p-3">Help center content, communication templates</td>
              </tr>
            </tbody>
          </table>
        </section>
