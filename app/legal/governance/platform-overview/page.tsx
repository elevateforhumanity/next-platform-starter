    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          ...
          <a
            href="/docs/Platform_Overview_and_Governance.pdf"
            download
        ...
        <div className="bg-slate-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            ...
            <li>
              <a href="#components" className="text-brand-orange-600 hover:underline">
                2. Platform Components
              </a>
            </li>
            <li>
              <a href="#users" className="text-brand-orange-600 hover:underline">
                3. User Types and Roles
              </a>
            </li>
            <li>
              <a href="#governance" className="text-brand-orange-600 hover:underline">
                4. Governance Model
              </a>
            </li>
            <li>
              <a href="#content" className="text-brand-orange-600 hover:underline">
                5. Content and Language Controls
              </a>
            </li>
            <li>
              <a href="#versioning" className="text-brand-orange-600 hover:underline">
                6. Versioning and Review Cadence
              </a>
            </li>
          </ol>
        </div>
        ...
        <section id="purpose" className="mb-12">
          ...
          <p className="text-slate-700 mb-4">
            ...
            procedures must align with this document.
          </p>
        ...
        <footer className="mt-12 pt-8 border-t text-sm text-slate-500">
          ...
          <p>
            <strong>Classification:</strong> Internal / Shareable upon request
          </p>
          <p>
            <strong>Owner:</strong> Executive Leadership, Elevate For Humanity
          </p>
          <p>
            <strong>Contact:</strong> our contact form
          </p>
