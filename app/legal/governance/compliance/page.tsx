      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-brand-blue-700">
              Authoritative reference for regulatory compliance and required disclosures.
            </p>
          </div>
          <a
            href="/docs/Compliance_and_Disclosure_Framework.pdf"
            download
        ...
        <nav className="bg-gray-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <a href="#purpose" className="text-brand-blue-600 hover:underline">
                1. Purpose & Scope
              </a>
            </li>
            <li>
              <a href="#entity" className="text-brand-blue-600 hover:underline">
                2. Entity Structure & Registration
              </a>
            </li>
            <li>
              <a href="#regulatory" className="text-brand-blue-600 hover:underline">
                3. Regulatory Framework
              </a>
            </li>
            <li>
              <a href="#disclosures" className="text-brand-blue-600 hover:underline">
                4. Required Disclosures
              </a>
            </li>
            <li>
              <a href="#consumer" className="text-brand-blue-600 hover:underline">
                5. Consumer Protection
              </a>
            </li>
            <li>
              <a href="#accessibility" className="text-brand-blue-600 hover:underline">
                6. Accessibility Compliance
              </a>
            </li>
            <li>
              <a href="#responsibilities" className="text-brand-blue-600 hover:underline">
                7. Compliance Responsibilities
              </a>
            </li>
            <li>
              <a href="#monitoring" className="text-brand-blue-600 hover:underline">
                8. Monitoring & Reporting
              </a>
            </li>
            <li>
              <a href="#versioning" className="text-brand-blue-600 hover:underline">
                9. Versioning & Review
              </a>
            </li>
          </ol>
        ...
        <section id="entity" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Elevate For Humanity LLC</td>
                <td className="border p-3">LLC</td>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>IRS PTIN:</strong> Preparer Tax Identification Numbers for tax preparers
            </li>
            <li>
              <strong>EFIN:</strong> Electronic Filing Identification Number for e-filing
            </li>
          </ul>
        </section>
        ...
        <section id="regulatory" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-3 text-left">Our Compliance</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">FERPA</td>
                <td className="border p-3">Student record privacy</td>
                <td className="border p-3">Role-based access, consent management, audit logging</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">ADA/Section 508</td>
                <td className="border p-3">Accessibility</td>
                <td className="border p-3">WCAG 2.1 AA compliance, accessible content</td>
              </tr>
              <tr>
                <td className="border p-3">COPPA</td>
                <td className="border p-3">Children's privacy (under 13)</td>
                <td className="border p-3">Age verification, parental consent where required</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">IRS Circular 230</td>
                <td className="border p-3">Tax preparer standards</td>
                <td className="border p-3">Licensed preparers, continuing education</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">IRC Section 7216</td>
                <td className="border p-3">Taxpayer consent for disclosure</td>
                <td className="border p-3">Written consent before data sharing</td>
              </tr>
              <tr>
                <td className="border p-3">FTC Safeguards Rule</td>
                <td className="border p-3">Financial data protection</td>
                <td className="border p-3">Encryption, access controls, incident response</td>
              </tr>
            </tbody>
          </table>

          <h3 className="text-lg font-semibold mt-6 mb-3">
            3.3 Financial Products (Refund Advance)
          </h3>
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
            ...
            <tbody>
              <tr>
                <td className="border p-3">TILA</td>
                <td className="border p-3">Truth in Lending disclosures</td>
                <td className="border p-3">APR, fees, terms clearly disclosed</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">ECOA</td>
                <td className="border p-3">Equal credit opportunity</td>
                <td className="border p-3">Non-discriminatory lending criteria</td>
              </tr>
              <tr>
                <td className="border p-3">State Lending Laws</td>
                <td className="border p-3">State-specific requirements</td>
                <td className="border p-3">Compliance by state of residence</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                ...
                <td className="border p-3">Payment card security</td>
                <td className="border p-3">Stripe handles card data (Level 1 certified)</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Sales Tax</td>
                <td className="border p-3">State sales tax collection</td>
                <td className="border p-3">Automated calculation and remittance</td>
              </tr>
              <tr>
                <td className="border p-3">Digital Goods Laws</td>
                <td className="border p-3">Refund policies, licensing</td>
                <td className="border p-3">Clear terms, license agreements</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="disclosures" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Terms of Service:</strong> User obligations, platform rules, liability
              limitations
            </li>
            <li>
              <strong>Cookie Policy:</strong> Cookie usage and consent management
            </li>
            <li>
              <strong>Accessibility Statement:</strong> Commitment to accessibility, contact for
              issues
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Refund Advance Terms:</strong> APR, fees, repayment terms, risks
            </li>
            <li>
              <strong>Data Use Consent:</strong> IRC 7216 consent form before data sharing
            </li>
            <li>
              <strong>Bank Product Disclosures:</strong> Partner bank information, FDIC status
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Certification Value:</strong> What certifications represent and their
              limitations
            </li>
            <li>
              <strong>Outcome Data:</strong> Completion rates, employment outcomes where applicable
            </li>
          </ul>
        </section>
        ...
        <section id="consumer" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-gray-100">
                <th className="border p-3 text-left">Product/Service</th>
                <th className="border p-3 text-left">Refund Policy</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Digital Courses</td>
                <td className="border p-3">
                  14-day money-back guarantee if less than 20% completed
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Digital Products (Store)</td>
                <td className="border p-3">No refunds after download (disclosed at purchase)</td>
              </tr>
              <tr>
                <td className="border p-3">Tax Preparation</td>
                <td className="border p-3">
                  Full refund if return not filed; partial if filed with errors
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Subscriptions</td>
                <td className="border p-3">Cancel anytime, no refund for partial periods</td>
              </tr>
            </tbody>
          </table>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Escalation:</strong> Request supervisor review if unsatisfied
            </li>
            <li>
              <strong>Mediation:</strong> Third-party mediation available for unresolved disputes
            </li>
            <li>
              <strong>Arbitration:</strong> Binding arbitration per Terms of Service (with opt-out)
            </li>
          </ol>
        </section>
        ...
        <section id="responsibilities" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Chief Compliance Officer</td>
                <td className="border p-3">
                  Overall compliance program, regulatory relationships, policy approval
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Data Protection Officer</td>
                <td className="border p-3">
                  Privacy compliance, data subject requests, breach response
                </td>
              </tr>
              <tr>
                <td className="border p-3">Tax Operations Manager</td>
                <td className="border p-3">IRS compliance, preparer oversight, EFIN management</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border p-3">Content Managers</td>
                <td className="border p-3">Accessibility compliance, content accuracy</td>
              </tr>
              <tr>
                <td className="border p-3">All Staff</td>
                <td className="border p-3">
                  Report compliance concerns, complete required training
                </td>
              </tr>
            </tbody>
          </table>
