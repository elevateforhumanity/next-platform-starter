      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-brand-blue-700">
              Authoritative reference for e-commerce, payments, and licensing.
            </p>
          </div>
          <a
            href="/docs/Store_Payments_Licensing_Framework.pdf"
            download
        ...
        <nav className="bg-slate-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            ...
            <li>
              <a href="#products" className="text-brand-blue-600 hover:underline">
                2. Product Types & Catalog
              </a>
            </li>
            <li>
              <a href="#payments" className="text-brand-blue-600 hover:underline">
                3. Payment Processing
              </a>
            </li>
            <li>
              <a href="#licensing" className="text-brand-blue-600 hover:underline">
                4. Digital Licensing
              </a>
            </li>
            <li>
              <a href="#pricing" className="text-brand-blue-600 hover:underline">
                5. Pricing & Promotions
              </a>
            </li>
            <li>
              <a href="#refunds" className="text-brand-blue-600 hover:underline">
                6. Refunds & Disputes
              </a>
            </li>
            <li>
              <a href="#seller" className="text-brand-blue-600 hover:underline">
        ...
        <section id="products" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Digital Templates</td>
                <td className="border p-3">Spreadsheets, documents, planners</td>
                <td className="border p-3">Instant download</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">E-books & Guides</td>
                <td className="border p-3">PDF guides, workbooks</td>
                <td className="border p-3">Instant download</td>
              </tr>
              <tr>
                <td className="border p-3">Software Tools</td>
                <td className="border p-3">Calculators, apps, plugins</td>
                <td className="border p-3">Download or web access</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Courses</td>
                <td className="border p-3">Self-paced learning programs</td>
                <td className="border p-3">LMS access</td>
              </tr>
              <tr>
                <td className="border p-3">Bundles</td>
                <td className="border p-3">Combined products at discount</td>
                <td className="border p-3">Per component</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Subscriptions</td>
                <td className="border p-3">Recurring access to content/services</td>
                <td className="border p-3">Ongoing access</td>
              </tr>
            </tbody>
          </table>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Description:</strong> What's included, who it's for, how to use
            </li>
            <li>
              <strong>Preview:</strong> Screenshots, sample pages, or demo where applicable
            </li>
            <li>
              <strong>File Format:</strong> Clearly stated (PDF, XLSX, etc.)
            </li>
            <li>
              <strong>System Requirements:</strong> Software needed to use product
            </li>
            <li>
              <strong>License Type:</strong> Personal, commercial, or extended
            </li>
          </ul>
        </section>
        ...
        <section id="payments" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Sales Tax:</strong> Calculated and collected based on customer location
            </li>
            <li>
              <strong>Tax Remittance:</strong> Automated via Stripe Tax
            </li>
            <li>
              <strong>Invoices:</strong> Provided for all purchases via email
            </li>
          </ul>
        ...
        <section id="licensing" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-slate-100">
                <th className="border p-3 text-left">License</th>
                <th className="border p-3 text-left">Permitted Use</th>
                <th className="border p-3 text-left">Restrictions</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Personal</td>
                <td className="border p-3">Individual, non-commercial use</td>
                <td className="border p-3">No resale, no commercial use, single user</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Commercial</td>
                <td className="border p-3">Business use, client work</td>
                <td className="border p-3">No resale as-is, attribution may be required</td>
              </tr>
              <tr>
                <td className="border p-3">Extended</td>
                <td className="border p-3">Unlimited commercial use, derivative works</td>
                <td className="border p-3">No resale of original, per-product terms</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Team/Enterprise</td>
                <td className="border p-3">Multiple users within organization</td>
                <td className="border p-3">Named users or seat-based, no external sharing</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="pricing" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Sales:</strong> Clearly marked start/end dates, original price shown
            </li>
            <li>
              <strong>Bundles:</strong> Discount reflected in bundle price vs. individual items
            </li>
            <li>
              <strong>Scholarships:</strong> Available for qualifying individuals via Rise
              Foundation
            </li>
          </ul>
        ...
        <section id="refunds" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Digital Downloads</td>
                <td className="border p-3">No refunds after download (disclosed at purchase)</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Courses</td>
                <td className="border p-3">14 days if &lt;20% completed</td>
              </tr>
              <tr>
                <td className="border p-3">Subscriptions</td>
                <td className="border p-3">
                  No partial refunds; cancel anytime for future billing
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Bundles</td>
                <td className="border p-3">Per component policy; partial refunds possible</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="seller" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-slate-100">
                <th className="border p-3 text-left">Creator Type</th>
                <th className="border p-3 text-left">Creator Share</th>
                <th className="border p-3 text-left">Platform Share</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Standard Creator</td>
                <td className="border p-3">70%</td>
                <td className="border p-3">30%</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Premium Creator (high volume)</td>
                <td className="border p-3">80%</td>
                <td className="border p-3">20%</td>
              </tr>
              <tr>
                <td className="border p-3">Exclusive Content</td>
        ...
        <section id="responsibilities" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Director of Operations</td>
                <td className="border p-3">
                  Overall store governance, pricing strategy, vendor relationships
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Finance Team</td>
                <td className="border p-3">Payment processing, tax compliance, creator payouts</td>
              </tr>
              <tr>
                <td className="border p-3">Content Team</td>
                <td className="border p-3">
                  Product review, catalog management, quality assurance
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Customer Support</td>
                <td className="border p-3">Refund requests, purchase issues, dispute resolution</td>
              </tr>
              <tr>
                <td className="border p-3">Legal/Compliance</td>
                <td className="border p-3">
                  Licensing terms, regulatory compliance, dispute escalation
                </td>
              </tr>
            </tbody>
          </table>
