      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-green-50 border border-brand-green-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-brand-green-700">
              Authoritative reference for course creation and educational governance.
            </p>
          </div>
          <a
            href="/docs/LMS_Governance_and_Course_Standards.pdf"
            download
            className="flex items-center gap-2 px-4 py-2 bg-brand-green-600 text-white rounded-lg hover:bg-brand-green-700"
          >
        ...
        <nav className="bg-slate-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <a href="#purpose" className="text-brand-green-600 hover:underline">
                1. Purpose & Scope
              </a>
            </li>
            <li>
              <a href="#course-types" className="text-brand-green-600 hover:underline">
                2. Course Types & Structure
              </a>
            </li>
            <li>
              <a href="#creation" className="text-brand-green-600 hover:underline">
                3. Course Creation Standards
              </a>
            </li>
            <li>
              <a href="#instructors" className="text-brand-green-600 hover:underline">
                4. Instructor Requirements
              </a>
            </li>
            <li>
              <a href="#certification" className="text-brand-green-600 hover:underline">
                5. Certification & Credentials
              </a>
            </li>
            <li>
              <a href="#quality" className="text-brand-green-600 hover:underline">
                6. Quality Assurance
              </a>
            </li>
            <li>
              <a href="#student-policies" className="text-brand-green-600 hover:underline">
                7. Student Policies
              </a>
            </li>
            <li>
              <a href="#responsibilities" className="text-brand-green-600 hover:underline">
                8. Roles & Responsibilities
              </a>
            </li>
            <li>
              <a href="#versioning" className="text-brand-green-600 hover:underline">
                9. Versioning & Review
              </a>
            </li>
          </ol>
        ...
        <section id="course-types" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border p-3">IRS-compliant tax preparer training</td>
                <td className="border p-3">40-80 hours</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Financial Literacy</td>
                <td className="border p-3">Personal finance, budgeting, credit</td>
                <td className="border p-3">10-20 hours</td>
              </tr>
              <tr>
                <td className="border p-3">Professional Development</td>
                <td className="border p-3">Career skills, entrepreneurship</td>
                <td className="border p-3">5-40 hours</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Technology</td>
                <td className="border p-3">Digital skills, software training</td>
                <td className="border p-3">10-60 hours</td>
              </tr>
              <tr>
                <td className="border p-3">Continuing Education</td>
                <td className="border p-3">CE credits for licensed professionals</td>
                <td className="border p-3">2-16 hours</td>
              </tr>
            </tbody>
          </table>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Lessons:</strong> Each module contains 3-8 lessons (15-45 minutes each)
            </li>
            <li>
              <strong>Assessments:</strong> Minimum one quiz per module, final assessment required
            </li>
            <li>
              <strong>Resources:</strong> Downloadable materials, reference guides, supplementary
              content
            </li>
          </ul>
        </section>
        ...
        <section id="creation" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Accuracy:</strong> All content fact-checked and current
            </li>
            <li>
              <strong>Originality:</strong> Original content or properly licensed materials
            </li>
            <li>
              <strong>Accessibility:</strong> WCAG 2.1 AA compliant (captions, transcripts, alt
              text)
            </li>
            <li>
              <strong>Language:</strong> Clear, professional English; reading level appropriate to
              audience
            </li>
          </ul>
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-slate-100">
                <th className="border p-3 text-left">Media Type</th>
                <th className="border p-3 text-left">Requirements</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Video</td>
                <td className="border p-3">1080p minimum, clear audio, closed captions required</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Audio</td>
                <td className="border p-3">Clear quality, transcript provided</td>
              </tr>
              <tr>
                <td className="border p-3">Images</td>
                <td className="border p-3">High resolution, alt text required, proper licensing</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Documents</td>
                <td className="border p-3">PDF format, accessible (tagged), printable</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="instructors" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-slate-100">
                <th className="border p-3 text-left">Course Category</th>
                <th className="border p-3 text-left">Minimum Qualifications</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border p-3">
                  Active PTIN, 3+ years experience, IRS Annual Filing Season Program or EA/CPA
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Financial Literacy</td>
                <td className="border p-3">
                  Relevant certification (CFP, AFC) or 5+ years industry experience
                </td>
              </tr>
              <tr>
                <td className="border p-3">Professional Development</td>
                <td className="border p-3">
                  Demonstrated expertise, professional credentials in subject area
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Technology</td>
                <td className="border p-3">
                  Industry certifications or 3+ years professional experience
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="certification" className="mb-12">
          ...
          <table className="w-full border-collapse border mb-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Completion Certificate</td>
                <td className="border p-3">100% course completion</td>
                <td className="border p-3">Permanent</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Achievement Certificate</td>
                <td className="border p-3">Completion + 70% assessment score</td>
                <td className="border p-3">Permanent</td>
              </tr>
              <tr>
                <td className="border p-3">Professional Certification</td>
                <td className="border p-3">Completion + 80% assessment + practical component</td>
                <td className="border p-3">1-3 years (renewal required)</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">CE Credits</td>
                <td className="border p-3">Per accrediting body requirements</td>
                <td className="border p-3">Per accrediting body</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="quality" className="mb-12">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Technical Review:</strong> Media quality, accessibility compliance
            </li>
            <li>
              <strong>Pilot Testing:</strong> Beta testing with sample students
            </li>
            <li>
              <strong>Final Approval:</strong> Director of Education sign-off
            </li>
          </ol>
          ...
          <table className="w-full border-collapse border mb-4">
            <thead>
              <tr className="bg-slate-100">
                ...
                <th className="border p-3 text-left">Action if Below</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-3">Completion Rate</td>
                <td className="border p-3">&gt;60%</td>
                <td className="border p-3">Content review, engagement analysis</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Student Rating</td>
                <td className="border p-3">&gt;4.0/5.0</td>
                <td className="border p-3">Instructor coaching, content revision</td>
              </tr>
              <tr>
                <td className="border p-3">Assessment Pass Rate</td>
                <td className="border p-3">70-90%</td>
                <td className="border p-3">Question review (too easy/hard)</td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Support Tickets</td>
                <td className="border p-3">&lt;5% of enrollments</td>
                <td className="border p-3">UX review, content clarification</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="responsibilities" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Director of Education</td>
                <td className="border p-3">
                  Overall LMS governance, course approval, quality standards
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Content Manager</td>
                <td className="border p-3">
                  Course review, accessibility compliance, content updates
                </td>
              </tr>
              <tr>
                <td className="border p-3">Instructors</td>
                <td className="border p-3">
                  Course creation, student support, content maintenance
                </td>
              </tr>
              <tr className="bg-slate-50">
                <td className="border p-3">Student Support</td>
                <td className="border p-3">
                  Enrollment issues, technical support, refund processing
                </td>
              </tr>
              <tr>
                <td className="border p-3">Technical Team</td>
                <td className="border p-3">
                  Platform maintenance, feature development, integrations
                </td>
              </tr>
            </tbody>
          </table>
