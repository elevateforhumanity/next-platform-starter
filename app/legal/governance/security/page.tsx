    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          ...
          <a
            href="/docs/Security_and_Data_Protection_Statement.pdf"
            download
        ...
        <nav className="bg-slate-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <a href="#purpose" className="text-brand-orange-600 hover:underline">
                1. Security Purpose & Principles
              </a>
            </li>
            <li>
              <a href="#data-collected" className="text-brand-orange-600 hover:underline">
                2. Data Collected
              </a>
            </li>
            <li>
              <a href="#storage" className="text-brand-orange-600 hover:underline">
                3. Data Storage & Encryption
              </a>
            </li>
            <li>
              <a href="#access" className="text-brand-orange-600 hover:underline">
                4. Access Controls
              </a>
            </li>
            <li>
              <a href="#retention" className="text-brand-orange-600 hover:underline">
                5. Data Retention & Deletion
              </a>
            </li>
            <li>
              <a href="#incident" className="text-brand-orange-600 hover:underline">
                6. Incident Response
              </a>
            </li>
            <li>
              <a href="#user-responsibilities" className="text-brand-orange-600 hover:underline">
            ...
            <li>
              <a href="#versioning" className="text-brand-orange-600 hover:underline">
                9. Versioning & Review
              </a>
            </li>
          </ol>
        ...
        <section id="purpose" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Defense in Depth:</strong> Multiple security layers protect against single
              points of failure
            </li>
            <li>
              <strong>Data Minimization:</strong> We collect only data necessary for stated purposes
            </li>
            <li>
              <strong>Transparency:</strong> Users can understand what data we hold and why
            </li>
            <li>
              <strong>Accountability:</strong> All data access is logged and auditable
            </li>
          </ul>
        </section>
        ...
        <section id="data-collected" className="mb-12">
          ...
          <table className="w-full border-collapse border mt-4">
            ...
            <tbody>
              <tr>
                <td className="border p-3">SSN</td>
              ...
              <tr>
                <td className="border p-3">Tax Documents</td>
              ...
              <tr>
                <td className="border p-3">Contact Info</td>
                <td className="border p-3">Standard</td>
                <td className="border p-3">Standard encryption, access controls</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="storage" className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Application Hosting:</strong> Northflank-managed containers with automatic HTTPS
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>
              <strong>Passwords:</strong> bcrypt hashing with salt (never stored in plain text)
            </li>
            <li>
              <strong>Sensitive Fields:</strong> Application-level encryption for SSN, tax data
            </li>
          </ul>
        </section>
        ...
        <section id="retention" className="mb-12">
          ...
          <table className="w-full border-collapse border">
            ...
            <tbody>
              <tr>
                <td className="border p-3">Account Data</td>
        ...
        <section id="incident" className="mb-12">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <li>
              <strong>Containment:</strong> Isolate affected systems within 1 hour
            </li>
            <li>
              <strong>Assessment:</strong> Determine scope and impact within 4 hours
            </li>
            <li>
              <strong>Notification:</strong> Notify affected users within 72 hours if required
            </li>
            <li>
              <strong>Remediation:</strong> Fix vulnerability and restore services
            </li>
            <li>
              <strong>Review:</strong> Post-incident analysis and documentation
            </li>
          </ol>
        ...
        <section id="contact" className="mb-12">
          ...
          <div className="bg-slate-50 rounded-lg p-6">
            ...
            <p className="mb-2">
              <strong>Privacy Requests:</strong> our contact form
            </p>
            <p className="mb-2">
