  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-slate-900 px-6 py-4 flex items-center justify-between">
        <Link
          href="/"
          className="text-white font-bold text-sm hover:text-brand-red-300 transition-colors"
        >
          ← Elevate for Humanity
        </Link>
        <a
          href="tel:3173143757"
          className="flex items-center gap-2 text-white text-sm font-semibold hover:text-brand-red-300 transition-colors"
        >
        ...
        {!submitted ? (
          <>
            ...
            <p className="text-black text-sm mb-8">
              Fill in your info below. We&apos;ll reach out within 24 hours to walk you through your
              options and funding.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-xs text-black">
                ...
                <a href="tel:3173143757" className="text-black font-semibold">
                  (317) 314-3757
                </a>
              </p>
            </form>
          ...
          <div className="text-center">
            ...
            <p className="text-black mb-2">
              We&apos;ll reach out within 24 hours to walk you through your funding options and next
              steps.
            </p>
            <p className="text-black text-sm mb-8">
