...
export default function NextStepsPage({ programs = [] }: { programs?: Program[] }) {
  const [data, setData] = useState<Checklist | null>(null);
  const [loading, setLoading] = useState(true);
  const [saving, setSaving] = useState(false);
  const progress = useMemo(() => data?.progress || { percent: 0, done: 0, total: 9 }, [data]);
  ...
  if (loading) {
    return <div className="mx-auto max-w-3xl px-4 py-10">Loading your checklist…</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <p className="mt-2 text-sm text-black leading-relaxed">
          Complete each step so we can move you into the correct funding and enrollment pathway.
        </p>
        ...
        <div className="mt-6 space-y-4">
          <div className="rounded-2xl border bg-white p-5">
            ...
            <p className="mt-1 text-sm text-black leading-relaxed">
              Tell us which program you're applying for so we know exactly what you need.
            </p>
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div>
                <label className="text-xs font-semibold text-black">Program Code</label>
                <select
              ...
              <div>
                <label className="text-xs font-semibold text-black">Program Name (if Other)</label>
                <input
                  className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
          ...
          <div className="rounded-2xl border bg-white p-5">
            ...
            />
            <div className="mt-3">
              <label className="text-xs font-semibold text-black">Optional: ICC Username</label>
              <input
                className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
          ...
          <div className="rounded-2xl border bg-white p-5">
            <p className="text-sm font-semibold">Step 3: Track your WorkOne appointments</p>
            <p className="mt-1 text-sm text-black leading-relaxed">
              WorkOne will schedule 3-4 appointments. After EACH appointment, come back here and
              document what happened. We get notified when you update this.
            </p>
            <div className="mt-2 rounded-lg bg-yellow-50 border border-yellow-200 p-3">
              <p className="text-xs font-semibold text-yellow-900">
                <AlertTriangle className="w-5 h-5 inline-block" /> IMPORTANT: Report back after
                EVERY appointment
              </p>
              <p className="mt-1 text-xs text-yellow-800 leading-relaxed">
                Don't wait until all appointments are done. Update this checklist immediately after
                each appointment so we can track your progress and help if something gets stuck.
              </p>
            </div>
              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) => patch({ workone_appointment_1_completed: e.target.checked })}
                  />
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid gap-3 sm:grid-cols-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_1_date: e.target.value })}
                        />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-black">Time</label>
                        <input
                          className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
                          value={data.workone_appointment_1_time ?? ''}
                          onChange={(e) => patch({ workone_appointment_1_time: e.target.value })}
                    ...
                    <div className="mt-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) => patch({ workone_appointment_1_notes: e.target.value })}
              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) => patch({ workone_appointment_2_completed: e.target.checked })}
                  />
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid gap-3 sm:grid-cols-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_2_date: e.target.value })}
                        />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-black">Time</label>
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_2_time: e.target.value })}
                          placeholder="e.g., 10:30 AM"
                        />
                      </div>
                      <div>
                    ...
                    <div className="mt-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) => patch({ workone_appointment_2_notes: e.target.value })}
              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) => patch({ workone_appointment_3_completed: e.target.checked })}
                  />
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid gap-3 sm:grid-cols-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_3_date: e.target.value })}
                        />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-black">Time</label>
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_3_time: e.target.value })}
                          placeholder="e.g., 10:30 AM"
                        />
                      </div>
                      <div>
                    ...
                    <div className="mt-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) => patch({ workone_appointment_3_notes: e.target.value })}
              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) => patch({ workone_appointment_4_completed: e.target.checked })}
                  />
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid gap-3 sm:grid-cols-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_4_date: e.target.value })}
                        />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-black">Time</label>
                        <input
                          ...
                          onChange={(e) => patch({ workone_appointment_4_time: e.target.value })}
                          placeholder="e.g., 10:30 AM"
                        />
                      </div>
                      <div>
                    ...
                    <div className="mt-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) => patch({ workone_appointment_4_notes: e.target.value })}
          ...
          <div className="rounded-2xl border bg-white p-5">
            ...
            />
            <div className="mt-3">
              <label className="text-xs font-semibold text-black">Optional notes</label>
              <textarea
                className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
          ...
          <div className="rounded-2xl border bg-white p-5">
            <p className="text-sm font-semibold">Step 6: Funding determination received</p>
            <p className="mt-1 text-sm text-black leading-relaxed">
              Select what your advisor decided so we know your pathway.
            </p>
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div>
                <label className="text-xs font-semibold text-black">Funding status</label>
                <select
                  className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
              ...
              <div>
                <label className="text-xs font-semibold text-black">Funding type</label>
                <select
                  className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
                  value={data.funding_type ?? ''}
                  onChange={(e) => patch({ funding_type: e.target.value || null })}
                >
          ...
          <div className="rounded-2xl border bg-white p-5">
            ...
            />
            <div className="mt-3">
              <label className="text-xs font-semibold text-black">Onboarding call date</label>
              <input
                type="date"
                className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
                value={data.efh_onboarding_call_date ?? ''}
                onChange={(e) => patch({ efh_onboarding_call_date: e.target.value })}
              />
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-white p-5">
            ...
            />
            <div className="mt-3">
              <label className="text-xs font-semibold text-black">Program start date</label>
              <input
                type="date"
                className="mt-1 w-full rounded-xl border px-3 py-2 text-sm"
