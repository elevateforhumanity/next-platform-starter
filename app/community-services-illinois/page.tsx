...
export const metadata: Metadata = {
  title: 'Community Services & Support in Illinois | Elevate for Humanity',
  description: 'Trusted community services in Illinois. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: ['community services Illinois', 'job placement Illinois', 'family services Chicago', 'housing assistance Illinois'],
}

export default function CommunityServicesIllinoisPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Illinois families. We connect Illinoisans with resources
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {[
            ...
            { title: 'Transportation', desc: 'CTA/Metra passes, car repair assistance, rideshare programs' },
          ].map((service) => (
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <Link href="/career-training-illinois" className="text-blue-600 hover:underline block">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-1">
              <Link href="/community-services-indiana" className="text-green-600 hover:underline block">Indiana</Link>
