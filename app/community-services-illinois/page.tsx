...
export const metadata: Metadata = {
  ...
  description:
    'Trusted community services in Illinois. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: [
    'community services Illinois',
    'job placement Illinois',
    'family services Chicago',
    'housing assistance Illinois',
  ],
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <p className="text-xl text-slate-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Illinois families. We connect Illinoisans with resources for
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {[
            ...
            { title: 'Benefits Navigation', desc: 'SNAP, Medicaid, TANF application assistance' },
            {
              ...
              desc: 'CTA/Metra passes, car repair assistance, rideshare programs',
            },
          ].map((service) => (
            <div
              key={service.title}
