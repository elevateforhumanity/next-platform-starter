...
export const metadata: Metadata = {
  ...
  description:
    'Training providers, employers, workforce boards, and community organizations operating on the Elevate Workforce OS.',
...
const governmentPartners = [
  {
    name: 'EmployIndy',
    description:
      'Marion County workforce development board providing WIOA funding and career services.',
    type: 'Workforce Board',
  },
  {
    name: 'WorkOne Centers',
    description:
      "Indiana's one-stop career centers providing employment services and training referrals.",
    type: 'Career Services',
  },
  {
    name: 'Indiana Department of Workforce Development (DWD)',
    description:
      'State agency overseeing workforce programs, INTraining, and Workforce Ready Grant.',
    type: 'State Agency',
  },
  {
...
const credentialPartners = [
  {
    name: 'Certiport',
    description:
      'Authorized Testing Center for Microsoft Office Specialist, IC3 Digital Literacy, and Adobe certifications.',
    type: 'Certification Provider',
  },
  {
    name: 'Elevate LMS',
    description:
      'Industry-standard curriculum and certification for cosmetology and beauty professionals.',
...
const industryPartners = [
  {
    ...
    description:
      'Clinical training sites and hiring partners for CNA, Medical Assistant, and healthcare programs.',
    type: 'Employer Network',
  },
  {
    name: 'Skilled Trades Employers',
    description:
      'Apprenticeship sponsors and hiring partners for HVAC, electrical, and construction trades.',
    type: 'Employer Network',
  },
  {
    name: 'Beauty & Cosmetology Salons',
    description:
      'Apprenticeship sites and employment partners for barber and cosmetology graduates.',
    type: 'Employer Network',
  },
];
      ...
      <section className="">
        <div className="mx-auto max-w-6xl px-6 py-14 grid gap-10 md:grid-cols-2">
          <div className="relative h-[340px] w-full overflow-hidden rounded-lg border border-slate-200 bg-white">
            <Image
              src="/images/pages/platform-page-4.webp"
              ...
              <div className="rounded-md border border-slate-200 p-5">
                ...
                <div className="mt-5">
                  <Link
                    ...
                    className="rounded-md bg-brand-blue-600 px-5 py-2.5 text-white font-semibold hover:bg-brand-blue-700"
                  >
                    Employer Intake
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-14">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <Benefit
              ...
              text="Clear partner onboarding, expectations, and workflow alignment."
            />
            <Benefit
              title="Program Alignment"
              text="Pathways designed around real hiring demand and credential outcomes."
            />
            <Benefit
              title="Operational Visibility"
              text="Partners can see progress through the pipeline and reduce surprises."
            />
          </div>
          ...
          <div className="mt-12 text-center">
            <Link
              href="/contact"
              className="rounded-md bg-brand-blue-600 px-7 py-3 text-white font-semibold hover:bg-brand-blue-700"
            >
          ...
          <div className="space-y-4">
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                No. Employer partnerships are free. We are funded by workforce development grants,
                not employer fees. You receive pre-screened, trained candidates at no cost.
              </div>
            </details>
            ...
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                We partner with employers (any size), workforce development boards, government
                agencies, community organizations, training providers, and educational institutions.
              </div>
            </details>
            ...
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                Employer partners commit to: interviewing referred candidates in good faith,
                providing feedback on hires, and supporting new employee retention. No minimum
                hiring commitments required.
              </div>
            </details>
            ...
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                Most employer partners receive their first candidate referrals within 2 weeks of
                completing the partnership agreement. Timing depends on current program cohorts and
                your hiring needs.
              </div>
            </details>
            ...
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                Healthcare, skilled trades (HVAC, electrical, welding), technology,
                transportation/CDL, beauty/barbering, retail, and business services. We can discuss
                custom training pathways for other industries.
              </div>
            </details>
            ...
            <details className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden group">
              ...
              <div className="px-6 pb-6 text-black">
                Yes. Many of our participants are justice-involved individuals seeking second-chance
                employment. We provide additional support and can discuss your organization&apos;s
                hiring policies during onboarding.
              </div>
            </details>
          </div>
        </div>
      ...
      <section className="bg-brand-blue-700 text-white">
        <div className="mx-auto max-w-4xl px-6 py-16 text-center">
          ...
          <p className="text-xl text-white mb-8">
            Join our network of employers, training providers, and workforce organizations committed
            to creating pathways to sustainable careers.
          </p>
          ...
          <p className="mt-8 text-sm text-white">
            Questions?{' '}
            <Link href="/contact?topic=partnership" className="underline hover:text-white">
              Contact us
            </Link>
          </p>
        </div>
