  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Platform', href: '/platform' }, { label: 'Program Holders' }]}
        />
      ...
      <section className="bg-zinc-900    text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Join Our Program Holder Network</h1>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-black mb-4">Operate Under OUR Credentials</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <div className="font-semibold">DOL Registered Apprenticeship Sponsor</div>
                    <div className="text-black">RAPIDS ID: 2025-IN-132301</div>
                    <a
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-semibold">WIOA Eligible Training Provider</div>
                    <div className="text-black">Federal workforce funding approved</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-bold mb-3">Indiana State Approvals</h3>
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-black">INTraining Location ID: 10004621</div>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-semibold">Workforce Ready Grant (WRG) Approved</div>
                    <div className="text-black">Free state funding for students</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-green-600 flex-shrink-0 mt-0.5" />
                  <div className="font-semibold">WorkOne Centers Approved Provider</div>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-green-600 flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-zinc-900   rounded-xl p-6 shadow-lg text-white">
              ...
              <div className="text-sm">You get immediate access to all of these via MOU.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-black">Simple process. Clear requirements. Fast approval.</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-black">
                  Tell us about your organization, programs, and experience. Takes 15-20 minutes.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-black mb-2">We Review (2-3 Days)</h3>
                <p className="text-black">
                  We check references, verify compliance history, and assess program fit.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-black mb-2">Sign MOU</h3>
                <p className="text-black">
                  If approved, we generate your MOU. Review and sign electronically.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-black mb-2">Setup Payment</h3>
                <p className="text-black">
                  Set up your monthly license fee. First payment includes setup fee.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-black mb-2">Launch in 30 Days</h3>
                <p className="text-black">
                  Platform access granted. Onboarding scheduled. Start serving students.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="text-3xl font-bold text-black mb-1">$4,000</div>
              <div className="text-sm text-black mb-4">/month</div>
              <div className="text-sm text-black mb-4">Up to 500 students</div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-brand-blue-500">
              ...
              <div className="text-3xl font-bold text-black mb-1">$8,000</div>
              <div className="text-sm text-black mb-4">/month</div>
              <div className="text-sm text-black mb-4">Up to 2,500 students</div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="text-3xl font-bold text-black mb-1">$30,000</div>
              <div className="text-sm text-black mb-4">/month</div>
              <div className="text-sm text-black mb-4">Unlimited students</div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-black mb-4">Requirements</h2>
            <p className="text-xl text-black">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-brand-green-50 rounded-xl p-6 border-2 border-brand-green-200">
              ...
              <ul className="space-y-2 text-sm text-brand-green-800">
                <li>
                  <span className="text-black flex-shrink-0">•</span> Located in Indiana (for now -
                  expanding soon)
                </li>
                <li>
                  <span className="text-black flex-shrink-0">•</span> Clean compliance history
                </li>
                <li>
                  <span className="text-black flex-shrink-0">•</span> Quality training programs
                </li>
                <li>
                  <span className="text-black flex-shrink-0">•</span> Professional references
                </li>
                <li>
                  <span className="text-black flex-shrink-0">•</span> Financial stability
                </li>
                <li>
                  <span className="text-black flex-shrink-0">•</span> Programs align with our
                  approvals
                </li>
              </ul>
            </div>
            ...
            <div className="bg-brand-red-50 rounded-xl p-6 border-2 border-brand-red-200">
              ...
              <ul className="space-y-2 text-sm text-brand-red-800">
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Previous compliance violations
                </li>
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Bad references
                </li>
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Programs don't fit our approvals
                </li>
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Financial instability
                </li>
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Located outside Indiana (until we
                  expand)
                </li>
                <li>
                  <XCircle className="w-5 h-5 inline-block" /> Incomplete application
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-zinc-900   text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mt-6 text-white text-sm">
            Questions? Email us at our contact form or call (317) 314-3757
          </p>
        </div>
      </section>
    </div>
