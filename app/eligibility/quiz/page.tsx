      ...
      <div className="bg-brand-blue-600 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white max-w-2xl mx-auto">
            Take this 2-minute quiz to see if you're eligible for government-funded workforce
            training programs
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <details className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <p className="mt-3 text-slate-600">
                WIOA (Workforce Innovation and Opportunity Act) is federal funding that pays for job
                training for eligible adults. If you qualify, your training could be completely
                free.
              </p>
            </details>
            <details className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <p className="mt-3 text-slate-600">
                We offer affordable self-pay options and payment plans. Many programs are under
                $5,000 and can be completed in 8-16 weeks.
              </p>
            </details>
            <details className="bg-white rounded-xl p-6 border border-slate-200">
              <summary className="font-semibold text-slate-900 cursor-pointer">
              ...
              <p className="mt-3 text-slate-600">
                This quiz gives you a preliminary assessment. Final eligibility is determined by the
                funding agency after you submit a full application with documentation.
              </p>
            </details>
          </div>
        </div>
