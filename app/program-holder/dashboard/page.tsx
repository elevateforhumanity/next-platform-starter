  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-56 sm:h-72 w-full overflow-hidden">
        ...
        <Image src="/images/pages/program-holder-page-1.webp" alt="Program Holder Portal" fill className="object-cover object-center" priority sizes="100vw" placeholder="blur" />
          ...
          {[
            ...
            <Link key={s.label} href={s.href} className="group bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <div className="relative h-24 w-full">
                <Image src={s.img} alt={s.label} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="(max-width:768px) 50vw, 25vw" placeholder="blur" />
            ...
            {[
              ...
              <Link key={action.href} href={action.href} className="group flex items-center gap-4 bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <div className="relative w-16 h-16 flex-shrink-0">
                  <Image src={action.img} alt={action.label} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="64px" placeholder="blur" />
