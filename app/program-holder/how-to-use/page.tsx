  ...
  const guides = [
    {
      ...
      description: 'Learn the basics of the program holder dashboard',
      icon: '🚀',
    },
    { title: 'Managing Courses', description: 'Create, edit, and publish courses', icon: '📚' },
    {
      title: 'Tracking Participants',
      description: 'Monitor participant progress and outcomes',
      icon: '📊',
    },
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <nav className="text-sm mb-4">
            <ol className="flex items-center space-x-2 text-slate-700">
              ...
              <li>/</li>
              <li className="text-slate-900 font-medium">How to Use</li>
            </ol>
          </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {guides.map((guide, i) => (
            <div
              key={i}
              className="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md cursor-pointer"
            >
        ...
        <div className="mt-8 bg-brand-blue-50 rounded-lg p-6">
          ...
          <p className="text-sm text-slate-700 mb-4">
            Contact our support team for assistance with your program.
          </p>
          <Link
            href="/support"
