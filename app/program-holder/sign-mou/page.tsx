  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Program Holder', href: '/program-holder' }, { label: 'Sign MOU' }]}
        />
      </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200 mb-8">
          <div className="border-b border-slate-200 pb-6 mb-6">
            <p className="text-xs text-slate-500 uppercase tracking-wide font-semibold mb-1">
              Version 2.0 — Effective 2025
            </p>
            <h2 className="text-2xl font-bold text-black mb-1">
              Employer Training Site Memorandum of Understanding
            </h2>
          ...
          <div className="prose prose-slate max-w-none space-y-4 text-sm text-slate-800">
            <p>
              ...
              (RAPIDS: 2025-IN-132301), and the Employer Training Site identified below (
              <strong>&quot;Employer&quot;</strong>).
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">1. Purpose</h3>
            <p>
              This MOU establishes the terms under which the Employer will serve as a training site
              for the Sponsor&apos;s DOL Registered{' '}
              {mouKey === 'cosmetology' ? 'Cosmetology' : 'Barber'} Apprenticeship Program. This
              agreement is governed by the Standards of Apprenticeship registered with the U.S.
              Department of Labor, Office of Apprenticeship, pursuant to 29 CFR Parts 29 and 30.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Provide all Related Technical Instruction (RTI) — minimum 144 hours per year —
                through approved curriculum
              </li>
              <li>
                Register each apprentice with the U.S. DOL RAPIDS system within 30 days of
                enrollment
              </li>
              ...
              <li>
                Facilitate any available wage reimbursement or grant funding to the Employer where
                applicable
              </li>
            </ul>
            ...
            <p>
              The Employer must maintain a complete and current profile in the Sponsor&apos;s
              system, including:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              {mou.docRequirements.map((r, i) => (
                <li key={i}>{r}</li>
              ))}
            </ul>
            <p className="font-semibold text-red-700">
              Incomplete profiles will result in suspension of apprentice placements until all
              required documentation is on file.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">5. Term</h3>
            <p>
              This MOU shall remain in effect for <strong>one (1) year</strong> from the date of
              execution and shall automatically renew annually unless terminated by either party.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">6. Termination</h3>
            <p>
              Either party may terminate this MOU with{' '}
              <strong>thirty (30) days written notice</strong>. The Sponsor may terminate
              immediately for cause, including but not limited to: license revocation, failure to
              pay apprentice wages, unsafe working conditions, or material breach of DOL Standards
              of Apprenticeship.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">
              7. Confidentiality &amp; FERPA
            </h3>
            <p>
              Both parties agree to protect all student/apprentice personally identifiable
              information (PII) in accordance with the Family Educational Rights and Privacy Act
              (FERPA) and applicable state law. Apprentice records may not be shared with third
              parties without written consent.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">8. Equal Opportunity</h3>
            <p>
              The Employer agrees to provide equal opportunity in apprenticeship without
              discrimination based on race, color, religion, national origin, sex, sexual
              orientation, age, or disability, in accordance with 29 CFR Part 30 and all applicable
              federal and state laws.
            </p>

            <h3 className="text-base font-bold text-black mt-6 mb-2">9. Governing Law</h3>
            <p>
              This MOU shall be governed by the laws of the State of Indiana and applicable federal
              regulations, including 29 CFR Parts 29 and 30.
            </p>
            ...
            <div className="mt-6 p-4 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-600">
              ...
              <p className="mt-1">
                <strong>RAPIDS Program No.:</strong> 2025-IN-132301 &nbsp;|&nbsp;{' '}
                <strong>RTI Provider ID:</strong> 208029
              </p>
              <p className="mt-1">
                8888 Keystone Crossing, Suite 1300, Indianapolis, IN 46240 &nbsp;|&nbsp; (317)
                314-3757
              </p>
            </div>
          </div>
