        ...
        {programs.length > 0 ? (
                ...
                {programs.map((program) => (
                  <tr key={program.id} className="hover:bg-white">
                    ...
                    <td className="px-6 py-4 text-center">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${program.status === 'active' ? 'bg-brand-green-100 text-brand-green-700' : 'bg-white text-slate-900'}`}
                      >
                        {program.status}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <Link
                          ...
                          className="p-2 text-slate-700 hover:text-brand-blue-600 hover:bg-brand-blue-50 rounded"
                        >
                          <Eye className="w-4 h-4" />
                        </Link>
                        <Link
                          href={`/program-holder/programs/${program.id}/edit`}
                          className="p-2 text-slate-700 hover:text-brand-blue-600 hover:bg-brand-blue-50 rounded"
                        >
          ...
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <p className="text-slate-700 mb-6">
              Create your first program to start enrolling students.
            </p>
            <Link
              href="/program-holder/courses/create"
