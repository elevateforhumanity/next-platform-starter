...
export const metadata: Metadata = {
  ...
  description:
    'Enrollment agreement terms and conditions for students at Elevate for Humanity. Review before enrolling.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-6 mb-8">
          <p className="text-slate-900">
            ...
            2Exclusive LLC-S, DBA Elevate for Humanity Career &amp; Technical Institute (the
            &quot;School&quot;). By enrolling in a program, you agree to these terms.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <p className="text-slate-900">
              <strong>Student:</strong> As identified in the enrollment application
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900 mb-4">
            ...
            individual enrollment form and the{' '}
            <Link href="/tuition-fees" className="text-brand-orange-600 hover:underline">
          ...
          <p className="text-slate-900">
            ...
            coursework with in-person training. Specific delivery requirements are outlined in your
            program materials.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-slate-900 space-y-2">
            ...
            <li>
              Comply with the{' '}
              <Link href="/policies/attendance" className="text-brand-orange-600 hover:underline">
                Attendance Policy
              </Link>
            </li>
          ...
          <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-6 mt-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-slate-900">
                  Students are <strong>required to clock in and clock out</strong> for all training
                  sessions using the Student Portal. Failure to clock in/out will result in
                  unrecorded hours and may affect your program completion status.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-slate-900 space-y-1">
                  <li>
                    <strong>Related Technical Instruction (RTI):</strong> Minimum 8-10 hours per
                    week of online coursework and classroom instruction
                  </li>
                  <li>
                    <strong>On-the-Job Training (OJT):</strong> Minimum 20-32 hours per week at
                    approved training site (program dependent)
                  </li>
                  <li>
                    <strong>Total Weekly Commitment:</strong> 28-40 hours per week depending on
                    program
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-900">
                  All hours must be logged accurately in the Student Portal within 24 hours of
                  completion. Hours must be verified by your supervisor or instructor. Falsifying
                  time records is grounds for immediate termination.
                </p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4 mt-4">
                ...
                <ul className="list-disc list-inside text-slate-900 space-y-1">
                  <li>
                    <strong>Leaving the shop/training site for more than 15 minutes:</strong> You
                    MUST clock out. Failure to clock out when leaving will result in automatic time
                    adjustment and may be considered time falsification.
                  </li>
                  <li>
                    <strong>Lunch breaks:</strong> You MUST clock out for lunch. Lunch breaks are
                    unpaid time and must not be included in training hours.
                  </li>
                  <li>
                    <strong>Personal errands or appointments:</strong> Clock out before leaving and
                    clock back in upon return.
                  </li>
                  <li>
                    <strong>Smoke breaks:</strong> Breaks longer than 15 minutes require clocking
                    out.
                  </li>
                  <li>
                    <strong>End of day:</strong> Always clock out before leaving for the day.
                    Forgetting to clock out will result in your hours being adjusted to the last
                    verified activity.
                  </li>
                </ul>
                <p className="text-slate-900 mt-3 font-medium">
                  Repeated failure to follow clock in/out procedures will result in disciplinary
        ...
        <section className="mb-10">
          ...
          <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6">
            ...
            <p className="text-slate-900 mt-4">
              This policy applies regardless of whether you complete the program, withdraw
              voluntarily, or are terminated for any reason.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <p className="text-slate-900 mb-4">
              <strong>
                Elevate for Humanity reserves the right to terminate a student&apos;s enrollment at
                any time
              </strong>{' '}
              if the student fails to comply with school policies, rules, or the terms of this
              agreement. Grounds for termination include, but are not limited to:
            </p>
            <ul className="list-disc list-inside text-slate-900 space-y-2">
            ...
            <p className="text-slate-900 mt-4 font-semibold">
              In the event of termination, no refund of tuition or fees will be provided. All sales
              are final.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900 mb-4">
            ...
            <strong> Certificate of Completion</strong> from Elevate for Humanity Career &amp;
            Technical Institute.
          </p>
          <p className="text-slate-900">
            This certificate documents that the student has completed the training program. It is
            not a degree, diploma, or state-issued license. Any third-party certifications or
            licenses must be obtained separately from the issuing authority.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900 mb-4">
            Any disputes arising from this agreement shall first be addressed through the School's
            internal{' '}
          ...
          <p className="text-slate-900">
            If the dispute cannot be resolved internally, either party may file a complaint with the
            Indiana Commission for Higher Education or pursue other legal remedies available under
            Indiana law.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900">
            This agreement may not be modified except in writing signed by both parties. The School
            reserves the right to update policies referenced in this agreement; students will be
