  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-slate-900 mb-8">Workforce Training in Tennessee</h2>
          <p className="text-slate-600 mb-8">Programs typically emphasize:</p>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Participants and partners can explore how structured training programs operate
            statewide.
          </p>
      ...
      <p className="text-center text-slate-500 text-sm py-8">
        Last reviewed: January 2026 | Service scope: Statewide digital delivery
      </p>
    </div>
  );
}
