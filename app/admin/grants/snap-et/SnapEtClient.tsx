...
const DEFAULTS: FormState = {
  ...
  program_name: `${PLATFORM_DEFAULTS.orgName}  Multi-Track Credential Program`,
  ...
  j_salary_narrative: ' Case Manager, program coordination, community services director, authorized representative, placement specialist, and instructor stipends across credential tracks.',
    ...
    try {
      const res = await fetch('/api/admin/send-email', {
        ...
        body: JSON.stringify({
          ...
          subject: ` TPP Application - ${form.program_name}`,
