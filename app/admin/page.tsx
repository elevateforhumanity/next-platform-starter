...
const NAV_SECTIONS = [
  {
    ...
    icon: BarChart3,
    description: 'Dashboard, analytics, monitoring',
  ...
  },
  {
    ...
    href: '/admin/students',
    icon: Users,
    description: 'Applications, enrollments, progress',
  ...
  },
  {
    ...
    href: '/admin/programs',
    icon: BookOpen,
    description: 'Courses, curriculum, credentials',
  ...
  },
  {
    ...
    icon: Wrench,
    description: 'Course builder, media, content',
  ...
  },
  {
    ...
    icon: Brain,
    description: 'AI studio, copilot, automation',
  ...
  },
  {
    ...
    href: '/admin/funding',
    icon: DollarSign,
    description: 'Grants, WIOA, payroll, WOTC',
  ...
  },
  {
    ...
    icon: Briefcase,
    description: 'Employers, partners, providers',
  ...
  },
  {
    ...
    icon: Megaphone,
    description: 'CRM, campaigns, blog, store',
  ...
  },
  {
    ...
    icon: Shield,
    description: 'Audit, documents, governance',
  ...
  },
  {
    ...
    href: '/admin/settings',
    icon: Settings,
    description: 'Settings, users, integrations',
  ...
  const stats = [
    {
      ...
      value: fmtNum(data.counts.pendingApplications),
      href: '/admin/applications?status=submitted',
      urgent: data.counts.pendingApplications > 0,
    },
    {
      label: 'Active enrollments',
      value: fmtNum(data.counts.activeEnrollments),
    ...
    },
    {
      ...
      value: fmtNum(data.counts.certificatesIssued),
  ...
  return (
    <div className="bg-white min-h-screen">
          ...
          {stats.map((s) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`text-3xl sm:text-4xl font-black tabular-nums ${s.urgent ? 'text-amber-600' : 'text-slate-900'}`}
                >
                  {s.value}
                </span>
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-slate-100">
        ...
        <h2 className="text-3xl sm:text-5xl font-black text-slate-900 mb-8">
            ...
            {data.recentApplications.slice(0, 8).map((app) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0 ml-4">
                  <span
                    className={`text-xs font-semibold px-2.5 py-1 rounded-full ${app.urgent ? 'bg-amber-100 text-amber-800' : 'bg-slate-100 text-slate-600'}`}
                  >
                    {app.age_days === 0
                      ? 'Today'
                      : app.age_days === 1
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0 ml-4">
                  <span className="text-xs text-slate-400">
                    Enrolled {fmtDate(learner.enrolledAt)}
                  </span>
                  <ChevronRight className="w-4 h-4 text-slate-300 group-hover:text-slate-500 transition-colors" />
                </div>
              </Link>
