    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-14 border-b border-slate-100">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
                  <Image src={img} alt={alt} fill sizes="400px" className="object-cover" placeholder="blur" />
                </div>
            ...
            {STEPS.map(({ n, title, desc, img }) => (
              <div key={n} className="flex flex-col">
                <div className="relative h-40 rounded-xl overflow-hidden mb-3 flex-shrink-0">
                  <Image src={img} alt={title} fill sizes="300px" className="object-cover" placeholder="blur" />
