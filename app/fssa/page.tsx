...
export const metadata: Metadata = {
  ...
  description:
    'Elevate for Humanity provides workforce training through the Indiana FSSA IMPACT program. Review eligibility requirements before applying.',
      ...
      <section className="bg-slate-900 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-300 text-lg max-w-2xl leading-relaxed">
            Elevate for Humanity provides workforce training through the Indiana Family and Social
            Services Administration (FSSA) IMPACT program. This program moves eligible participants
            into sustainable employment through structured training, attendance requirements, and
          ...
          <div className="mt-6 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl max-w-2xl">
            <div className="flex gap-3 items-start">
              ...
              <p className="text-amber-200 text-sm leading-relaxed">
                <strong className="text-amber-100">Enrollment is not automatic.</strong> Enrollment
                is contingent on eligibility verification, funding approval, and program readiness.
                All applicants are screened before acceptance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 px-4 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 text-sm leading-relaxed mb-4">
            Elevate for Humanity is the training provider. We pre-screen applicants, verify
            readiness, coordinate with case managers, and deliver training. We are not the sole
            authority on funding eligibility — that determination involves your IMPACT case manager
            and FSSA. We are fully accountable for who enters our training program.
          </p>
                ...
                <ul className="space-y-1">
                  {col.items.map((item, j) => (
                    <li key={j} className="text-slate-600 text-xs flex gap-2 items-start">
                      <span className="text-brand-red-500 mt-0.5">→</span>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-2">
                {[
                  {
                    label: 'Currently receiving SNAP (food assistance)',
                    note: 'Active EBT card required',
                  },
                  { label: 'Currently receiving TANF', note: 'Active cash assistance required' },
                  {
                    label: 'Referred by a WorkOne / IMPACT case manager',
                    note: 'Case manager name and office required',
                  },
                  {
                    label: 'Approved for another qualifying funding source',
                    note: 'Must be recognized by the program',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-3 items-start p-3 bg-green-50 rounded-lg border border-green-100"
                  >
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-2">
                {['High school diploma', 'GED / HiSET'].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-3 items-center p-3 bg-green-50 rounded-lg border border-green-100"
                  >
                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-2">
                ...
                <p className="text-slate-500 text-xs pt-2 pl-1">
                  Certain criminal histories may require case-by-case review. Prior convictions do
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-2">
                {[
                  ...
                  <div
                    key={i}
                    className="flex gap-3 items-center p-3 bg-slate-50 rounded-lg border border-slate-100"
                  >
                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
                    <p className="text-slate-700 text-sm">{item}</p>
                  </div>
              ...
              <div className="p-6 space-y-2">
                ...
                <div className="mt-2 p-3 bg-red-50 border border-red-100 rounded-lg">
                  <p className="text-red-700 text-sm font-medium">
                    Failure to meet attendance or participation standards may result in removal from
                    the program.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  {
                    label: 'Not authorized to work in the U.S.',
                    note: 'Work authorization is required',
                  },
                  { label: 'Active warrant', note: 'Must be resolved before application' },
                  {
                    label: 'Cannot attend required training hours',
                    note: 'Schedule must be confirmed before enrollment',
                  },
                  {
                    label: 'Medicaid or HIP only — no SNAP/TANF/referral',
                    note: 'Health coverage alone does not qualify',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-2 items-start p-3 bg-white rounded-lg border border-red-100"
                  >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div
                key={i}
                className="flex gap-3 items-center p-3 bg-white rounded-lg border border-slate-200"
              >
            ...
            {[
              {
                ...
                desc: 'Complete the eligibility screening and application form. All fields are required.',
              },
              {
                step: '2',
                title: 'Eligibility & Readiness Review',
                desc: 'Our team reviews your application. You will be classified as Eligible, Conditional Review, or Not Eligible based on fixed criteria.',
              },
              {
                step: '3',
                title: 'Documentation Verification',
                desc: 'You may be contacted to provide proof of benefits, ID, residency, or education. Missing documents delay processing.',
              },
              {
                step: '4',
                title: 'Case Manager Coordination',
                desc: 'If you have a WorkOne or IMPACT case manager, we coordinate with them to confirm funding authorization before enrollment.',
              },
              {
                step: '5',
                title: 'Enrollment Decision',
                desc: 'Final decision: Enroll, Hold (pending documentation or case manager confirmation), or Do Not Enroll. You will be notified directly.',
              },
            ].map((item) => (
              <div
                key={item.step}
                className="flex gap-4 items-start p-5 rounded-xl border border-slate-100 bg-slate-50"
              >
      ...
      <section className="py-14 px-4 bg-blue-50 border-b border-blue-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 text-sm leading-relaxed mb-6">
            Eligible participants may qualify for supportive services through approved workforce
            funding or partner agencies. Depending on program rules and available funding, support
            may include:
          </p>
            ...
            {[
              {
                ...
                note: 'Coordination and referral support for eligible participants',
              },
              {
                label: 'Work supplies',
                note: 'Tools, uniforms, or materials required for training or employment',
              },
              {
                label: 'Childcare support',
                note: 'Referral to approved childcare assistance programs',
              },
              {
                label: 'Referral coordination',
                note: 'Connection to partner agencies for additional barrier-removal services',
              },
              {
                label: 'Other barrier-removal services',
                note: 'Services that help participants stay engaged in training and employment',
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex gap-3 items-start p-3 bg-white rounded-lg border border-blue-100"
              >
          ...
          <div className="p-4 bg-white border border-blue-200 rounded-xl">
            <p className="text-slate-600 text-sm leading-relaxed">
              <strong className="text-slate-900">Important:</strong> Supportive services are not
              guaranteed. Availability depends on program rules, funding authorization, and the
              applicable agency. Eligibility for support services is determined by your case manager
              and the funding agency — not by Elevate. If you have a transportation barrier or other
              need that may affect attendance, disclose it on your application so we can coordinate
              appropriately.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto flex gap-3 items-start">
          ...
          <div>
            ...
            <ul className="text-slate-700 text-sm space-y-1">
              ...
              <li>
                Final acceptance is based on eligibility, funding approval, readiness, and program
                capacity.
              </li>
              <li>
                Incomplete, inaccurate, or unverifiable information may result in denial or delayed
                processing.
              </li>
            </ul>
          </div>
      ...
      <section className="py-14 px-4 bg-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-3 max-w-xl mx-auto">
            If you meet the requirements above, proceed to the application. Do not apply if you do
            not meet the eligibility requirements.
          </p>
          <p className="text-slate-400 text-sm mb-8 max-w-xl mx-auto">
            A team member or case partner may contact you to verify eligibility before enrollment is
            approved.
          </p>
          <Link
      ...
      <section className="py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 text-sm leading-relaxed mb-8">
            Not sure if you qualify? Contact us before submitting. Do not submit an application if
            you are unsure.
          </p>
