      ...
      <div className="min-h-screen bg-white   py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-black mb-4">Thank You for Your Interest!</h1>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b border-slate-700">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Funding', href: '/funding' }, { label: 'FSSA Partnership Request' }]}
          />
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm text-black">Indiana DWD approved training provider</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm text-black">Registered Apprenticeship Sponsor</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm text-black">Automated compliance reporting</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Partnership Details */}
              <div>
                <h2 className="text-2xl font-bold text-black mb-6">Partnership Details</h2>
              ...
              <div className="flex items-center justify-between pt-6 border-t">
                <Link href="/fssa/snap-et" className="text-black hover:text-black font-semibold">
                  ← Back to SNAP E&T Info
                </Link>
                <button
                  type="submit"
          ...
          <div className="mt-8 text-center text-black">
            ...
            <p className="text-lg font-semibold text-black">317-314-3757 | our contact form</p>
          </div>
        </div>
      </div>
    </div>
