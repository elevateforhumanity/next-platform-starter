    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Funding', href: '/funding' }, { label: 'SNAP E&T / IMPACT' }]}
          />
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                label: 'WRG Approved Programs',
                detail: 'Workforce Ready Grant eligible programs on file with Indiana DWD',
              },
              {
                label: 'Job Ready Indy Partner',
                detail:
                  'Approved provider for justice-involved individuals through the Job Ready Indy initiative',
              },
              {
                label: 'SNAP E&T Participant',
                detail:
            ...
            {[
              {
                ...
                detail: 'Built into the Elevate LMS — hour-level tracking per participant per week',
              },
              {
              ...
              {
                title: 'SNAP recipient identification',
                detail:
                  'Intake forms collect benefit status — SNAP recipients identified at enrollment',
              },
              {
                title: 'Post-completion support',
                detail: 'Job placement follow-up and alumni support after credential attainment',
              },
              {
              ...
              {
                title: 'Non-federal funding sources',
                detail:
      ...
      <section className="py-14 px-4 bg-slate-50 border-b border-slate-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 text-sm mb-8">
            Elevate accepts both direct referrals from IMPACT and reverse referrals from SNAP
            recipients who self-identify.
          </p>

          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <p className="text-xs font-bold uppercase tracking-widest text-brand-blue-600 mb-3">
                Direct Referral
              </p>
              ...
              <ol className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-sm text-slate-700">
                    <span className="w-5 h-5 bg-brand-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                      {i + 1}
                    </span>
                    {step}
                  </li>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <ol className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-sm text-slate-700">
                    <span className="w-5 h-5 bg-brand-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                      {i + 1}
                    </span>
                    {step}
                  </li>
          ...
          <div className="mt-5 bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3 items-start">
            ...
            <p className="text-sm text-slate-800 leading-relaxed">
              <strong>Orientation first.</strong> The SNAP participant must complete an E&T
              orientation with IMPACT before entering the Elevate program. No costs can be incurred
              or billed prior to orientation completion.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-slate-50 rounded-xl border border-slate-200 p-5 flex gap-3 items-start">
              ...
              <div>
                ...
                <a
                  href="mailto:IMPACT50@fssa.IN.gov"
                  className="text-brand-blue-600 font-semibold text-sm hover:underline"
                >
