...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
          <Image
            src="/images/pages/store-courses-hero.jpg"
        ...
        <div className="bg-slate-900 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Get certified in Microsoft Office, Adobe Creative Suite, OSHA Safety, and more. Each
              course includes the certification exam voucher.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-brand-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-black text-slate-900 mb-4">Need Multiple Certifications?</h2>
