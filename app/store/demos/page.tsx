...
export const metadata: Metadata = {
  ...
  description:
    'Watch guided video walkthroughs of the Elevate platform — admin dashboard, student portal, and employer tools. No signup required.',
};
...
const demos = [
  {
    ...
    highlights: [
      ...
      'Application and intake pipeline management',
      'WIOA documentation and audit tools',
    ],
  },
  {
    id: 'employer',
    ...
    highlights: [
      'Apprenticeship hour and wage progression tracking',
      'OJT contract and incentive management',
      'MOU and compliance document signing',
      'WOTC credit visibility',
    ],
  },
  {
    id: 'learner',
    ...
    highlights: [
      ...
      'Log apprenticeship hours from their phone',
      'View earned certificates and credentials',
      'Access career services and job placement tools',
    ],
  },
  {
    id: 'workforce',
    ...
    highlights: [
      ...
      'Track WIOA, state, employer, and grant funding together',
      'Automated PIRL reporting and quarterly performance',
      'Manage your network of training providers and employers',
    ],
  },
];
      ...
      <section className="py-14 sm:py-18">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-700 max-w-2xl mx-auto mb-3">
            Guided video walkthroughs of each portal. See exactly how the platform works before you
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/store/trial"
              className="inline-flex items-center gap-2 border-2 border-slate-300 text-slate-700 px-6 py-3 rounded-lg font-bold hover:bg-white transition"
            >
              Start 14-Day Trial
            </Link>
          </div>
          ...
          <div className="space-y-16">
            {demos.map((demo, i) => (
              <div
                key={demo.id}
                id={demo.id}
                className={`flex flex-col animate-fade-in-up ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-8 items-center`}
              >
                {/* Image */}
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
                ...
                <div className="w-full md:w-1/2">
                  ...
                  <Link
                    href={demo.href}
                    className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-brand-red-700 transition-colors"
                  >
      ...
      <section className="py-14 border-t border-slate-200">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-700 mb-6">
            Start a 14-day trial and get your own branded instance with your real programs and
            students. No credit card required.
          </p>
          <div className="flex flex-col items-center gap-3">
            <Link
              href="/store/trial"
              className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-brand-red-700 transition"
            >
              Start Free Trial <ArrowRight className="w-5 h-5" />
            </Link>
            <div className="flex gap-4 text-sm text-slate-500">
              <Link href="/store/licensing" className="hover:underline">
                Compare licenses
              </Link>
              <span>·</span>
