...
export const metadata: Metadata = {
  ...
  description:
    'License a turnkey workforce development platform. Automated enrollment, WIOA compliance, credential tracking, employer matching, and reporting.',
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">
            Every license includes the full platform — three portals, all compliance tools,
            automated reporting, and white-label branding. Nothing is extra.
          </p>
            ...
            {[
              {
                ...
                desc: 'Online applications, automatic eligibility checks, document collection, and approval workflows. No paper. No re-keying.',
              },
              {
                icon: FileCheck,
                title: 'WIOA & Grant Compliance',
                desc: 'PIRL reporting, ITA tracking, eligibility documentation, and quarterly performance metrics — generated from enrollment data.',
              },
              {
                icon: GraduationCap,
                title: 'Credential Issuance',
                desc: 'When a student completes a program, credentials are issued automatically. Employers verify them with a link.',
              },
              {
                icon: Building2,
                title: 'Employer Portal',
                desc: 'Partners browse pre-screened candidates, track apprenticeship hours, manage OJT reimbursements, and sign MOUs.',
              },
              {
                icon: BarChart3,
                title: 'Automated Reporting',
                desc: 'WIOA performance, grant utilization, enrollment trends, outcome data. Generated on demand. No manual assembly.',
              },
              {
                icon: Zap,
                title: 'Your Brand, Your Domain',
                desc: 'Your logo, colors, and URL. Students and employers see your organization. The platform is invisible.',
              },
            ].map((item) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-3">
              Try the full platform. No signup. No time limit.
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Every screen is live and clickable. Search students, run reports, review applications,
              browse candidates.
            </p>
          </div>
            ...
            {[
              {
                ...
                href: '/demo/admin',
                desc: 'Enrollment, compliance, reporting',
              },
              {
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-center mb-10">
            Organizations that manage WIOA-funded training, registered apprenticeships, or employer
            partnerships.
          </p>
            ...
            {[
              {
                ...
                desc: 'WIOA eligibility determination, ITA management, PIRL reporting, provider network oversight, quarterly performance metrics. Replace your current patchwork of systems with one platform that does it all.',
                img: '/images/pages/wioa-meeting.jpg',
              },
              {
                title: 'Training Providers',
                desc: 'Student enrollment, attendance tracking, course delivery, credential issuance, outcome reporting to funders. Stop emailing spreadsheets to your workforce board.',
                img: '/images/pages/comp-home-highlight-health.jpg',
              },
              {
                title: 'Apprenticeship Sponsors',
                desc: 'DOL-registered program management. Apprentice hour logging, wage progression tracking, OJT reimbursement processing, completion documentation. All in one place.',
                img: '/images/pages/employer-handshake.jpg',
              },
            ].map((item) => (
              <div
                key={item.title}
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              {
                title: 'WIOA Title I',
                desc: 'Eligibility determination, ITA management, PIRL reporting, quarterly performance metrics.',
              },
              {
                title: 'FERPA',
                desc: 'Student data privacy controls, consent tracking, role-based access, audit logs.',
              },
              {
                title: 'DOL Apprenticeship',
                desc: 'Registered standards, hour tracking, wage schedules, completion documentation.',
              },
              {
                title: 'Grant Reporting',
                desc: 'Automated reports for WIOA, state workforce grants, and institutional funders.',
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="py-14 sm:py-20 bg-slate-900">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-brand-red-400 font-bold text-xs uppercase tracking-widest mb-2 text-center">
            Licensable Course Content
          </p>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white text-center mb-3">
            HVAC Technician — Full Course License
          </h2>
          <p className="text-slate-400 text-center mb-10 max-w-2xl mx-auto">
            License our complete 640-hour HVAC Technician course for your workforce program,
            community college, or training center. Includes all 16 modules, interactive diagrams,
            EPA 608 prep, OSHA 10, and CPR/AED.
          </p>
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs text-center mt-2">
                Module 1, Lesson 1 — live sample from the course
              </p>
            </div>
            {/* Course details + CTA */}
            <div className="bg-white rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-4">
                <span className="bg-brand-red-100 text-brand-red-700 text-xs font-bold px-3 py-1 rounded-full">
                  16 Modules · 94 Lessons
                </span>
                <span className="bg-white text-slate-600 text-xs font-bold px-3 py-1 rounded-full">
                  640 Hours
                </span>
              </div>
              ...
              <p className="text-slate-600 text-sm mb-5">
                Per-organization license. Minimum 10 students. Volume pricing available for
                workforce networks and state agencies.
              </p>
      ...
      <section id="pricing" className="py-14 sm:py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-center mb-10">
            Two deployment options. Both start with a 14-day free trial.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-brand-red-600 rounded-2xl p-8 relative">
              ...
              <p className="text-sm text-slate-500 mb-4">
                $18,000/year + one-time setup fee. Cancel anytime.
              </p>
              <p className="text-slate-600 text-sm mb-6">
                Full platform with your branding and domain. All three portals, compliance tools,
                reporting, and support. Onboarding included. Launch in two weeks.
              </p>
              <ul className="space-y-2 mb-6">
                {[
                  'Admin, Student & Employer portals',
                  'Your logo, colors, and domain',
                  'WIOA compliance & PIRL reporting',
              ...
              <Link
                href="/store/trial"
                className="block text-center bg-brand-red-600 text-white font-bold py-3 rounded-lg hover:bg-brand-red-700 transition"
              >
                Start 14-Day Free Trial
              </Link>
              <Link
                href="/store/licensing/managed"
                className="block text-center text-slate-600 text-sm font-medium mt-2 hover:underline"
              >
                View plans & purchase directly →
              </Link>
              <p className="text-xs text-slate-400 mt-3 text-center">
                Stripe, {BNPL_CHECKOUT_LABEL} at checkout
              </p>
            </div>
            {/* Enterprise */}
            <div className="border border-slate-200 rounded-2xl p-8">
              ...
              <p className="text-sm text-slate-500 mb-4">
                One-time license + $15,000/year maintenance. Includes source code.
              </p>
              <p className="text-slate-600 text-sm mb-6">
                Deploy on your infrastructure with full source access. For state agencies and large
                workforce networks that need complete control.
              </p>
              <ul className="space-y-2 mb-6">
                {[
              ...
              <Link
                ...
                className="block text-center border border-slate-300 text-slate-700 font-bold py-3 rounded-lg hover:bg-white transition"
              >
      ...
      <section className="py-14 sm:py-20 bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-400 mb-8">
            Your own branded instance, provisioned instantly. No credit card. Full platform access.
            Convert to a paid license when you&apos;re ready.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/store/trial"
              className="inline-flex items-center justify-center gap-2 bg-brand-red-600 hover:bg-brand-red-700 text-white font-semibold px-8 py-3.5 rounded-lg transition"
            >
              Start 14-Day Free Trial <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              href="/demo/admin"
              className="inline-flex items-center justify-center gap-2 bg-white text-slate-900 font-semibold px-8 py-3.5 rounded-lg hover:bg-white transition"
            >
              Try Full Demo First
            </Link>
          </div>
