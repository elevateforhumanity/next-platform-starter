          ...
          <div className="max-w-2xl mx-auto px-4 text-center">
            ...
            <div className="bg-white rounded-xl p-6 mb-6 text-left space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold text-slate-900">app.elevateforhumanity.org/admin?org={result.subdomain}</span>
              </div>
              <div className="flex justify-between text-sm">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-8 text-center lg:text-left space-y-3">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/store/licenses/managed-platform" className="text-brand-red-600 font-medium hover:underline">
                Purchase directly
              </Link>
            </p>
            <p className="text-sm text-slate-600">
