...
export const metadata: Metadata = {
  ...
  description:
    'Find and manage federal, state, and foundation grants. AI-powered grant matching, application tracking, deadline alerts, and compliance reporting.',
  keywords: [
    'grants',
    'grant management',
    'federal grants',
...
const features = [
  {
    ...
    desc: 'Smart algorithms find grants that match your organization',
  },
  { icon: Bell, title: 'Deadline Alerts', desc: 'Never miss a deadline with automated reminders' },
  {
    icon: FileText,
    title: 'Application Tracking',
    desc: 'Track all applications from draft to award',
  },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white mb-8">
                Find the right grants faster with AI-powered matching. Track applications, manage
                deadlines, and streamline compliance reporting.
              </p>
      ...
      <section className="py-16 px-4 bg-brand-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Watch a complete walkthrough of the grants discovery and management process
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricing.map((plan, i) => (
              <div
                key={i}
                className={`rounded-2xl p-8 ${plan.popular ? 'bg-brand-green-600 text-white ring-4 ring-brand-green-300' : 'bg-white border border-gray-200'}`}
              >
                {plan.popular && (
