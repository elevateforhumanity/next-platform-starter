...
export const metadata: Metadata = {
  ...
  description:
    'Build professional training provider websites in minutes. Pre-built templates, LMS integration, enrollment forms, and SEO optimization included.',
  keywords: [
    'website builder',
...
const features = [
  {
    ...
    desc: 'No coding required. Build pages visually with ease.',
  },
  {
    icon: Palette,
    title: 'Professional Templates',
    desc: '50+ templates designed for training providers',
  },
  ...
  { icon: Zap, title: 'LMS Integration', desc: 'Connect directly to Elevate LMS for enrollments' },
  {
    ...
    desc: 'Built-in compliance disclosures and accessibility',
  },
  {
    icon: BarChart,
    title: 'SEO Optimized',
    desc: 'Automatic meta tags, sitemaps, and schema markup',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <span className="bg-brand-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full">
                  WEBSITE
                </span>
              ...
              <p className="text-xl text-white mb-8">
                Launch a professional training website in minutes. Pre-built templates, LMS
                integration, enrollment forms, and SEO tools included.
              </p>
      ...
      <section className="py-16 px-4 bg-brand-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Watch how easy it is to create a professional training provider website
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricing.map((plan, i) => (
              <div
                key={i}
                className={`rounded-2xl p-8 ${plan.popular ? 'bg-brand-blue-600 text-white ring-4 ring-brand-blue-300' : 'bg-white border border-gray-200'}`}
              >
                {plan.popular && (
                ...
                <h3
                  className={`text-2xl font-bold mt-4 ${plan.popular ? 'text-slate-900' : 'text-gray-900'}`}
                >
                  {plan.name}
                </h3>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f, j) => (
                    <li key={j} className="flex items-center gap-2">
                      <Check
                        className={`w-5 h-5 ${plan.popular ? 'text-white' : 'text-brand-green-500'}`}
                      />
      ...
      <section className="py-16 px-4 text-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8">
            14-day free trial. Card required, not charged until trial ends.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="border border-slate-300 hover:bg-white text-slate-900 px-8 py-4 rounded-lg font-bold"
            >
              Request Demo
            </Link>
          </div>
