        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 mb-4 max-w-2xl mx-auto">
              This license grants limited internal use of source code only. Ownership, rebranding,
              resale, sublicensing, and credential use are expressly prohibited.
            </p>
            <p className="text-slate-600 max-w-2xl mx-auto mb-10">
              This is NOT our standard offering. Most organizations should use the Managed Platform
              instead.
            </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mb-3">
                The Enterprise Source-Use License starts at{' '}
                <strong className="text-slate-900">$75,000</strong>. It is designed for
                organizations that need to deploy on their own infrastructure.
              </p>
              <p className="text-slate-600 text-sm">
                Looking for a faster start?{' '}
                <Link
                  href="/store/licensing/managed"
                  className="text-brand-blue-600 font-semibold underline hover:text-brand-blue-700"
                >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-slate-200">
              ...
              <p className="text-slate-600 mb-6">
                This license grants source code access for internal deployment. The following are
                available through our Managed Platform license instead:
              </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    You may only use this software within your own organization for your own
                    workforce development operations. You may NOT offer it as a service to third
                    parties.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    All deployments must display "Powered by Elevate for Humanity™" in the footer,
                    about page, and login screen. Removal of attribution is a material breach and
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    This license does NOT grant ETPL listing, WIOA provider status, state board
                    recognition, or any compliance authority. You must obtain credentials
                    independently through proper channels.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    You may NOT sell, lease, sublicense, or distribute this software or any
                    derivative to any third party. Violation results in immediate termination and
                    legal action.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    Access to updates requires active compliance with license terms. Elevate for
                    Humanity may revoke update access for any breach.
                  </p>
                </div>
              </div>
            </div>
            ...
            {[
              {
                ...
                desc: 'License agreement review, NDA execution, payment processing, and executive sign-off.',
              },
              {
                week: 'Week 3-4',
                title: 'Repository Access',
                desc: 'Source code repository access granted. Architecture documentation and deployment guides delivered.',
              },
              {
                week: 'Week 5-8',
                title: 'Implementation Support',
                desc: '40 hours of implementation support. Infrastructure setup guidance, configuration review, and testing.',
              },
              {
                week: 'Ongoing',
                title: 'Annual Maintenance',
                desc: 'Quarterly security patches, annual compliance review, and email-based technical support.',
              },
            ].map((step) => (
              <div
                key={step.week}
              ...
              >
                <div className="text-brand-blue-600 text-xs font-bold uppercase tracking-wide mb-2">
                  {step.week}
                </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: 'Compliance',
                items: [
                  'WIOA reporting templates included',
                  'FERPA data handling procedures',
          ...
          <p className="text-center text-slate-600 text-sm mt-6">
            ...
            <Link
              href="/contact?subject=Security%20Documentation%20Request"
              className="text-brand-blue-600 hover:text-slate-700 underline"
            >
              Request access
            </Link>
          </p>
      ...
      <section className="py-12 border-t border-slate-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm mb-8">
            ...
            <p className="text-slate-600 text-sm">
              All deployments must retain &quot;Powered by Elevate for Humanity&quot; attribution
              and trademark notices in the footer, login screen, and about page. Removal of
              attribution is a material breach and results in immediate license termination.
            </p>
          </div>
          ...
          <div className="text-center text-slate-600 text-xs space-y-2">
            <p>Elevate for Humanity™ and the Elevate logo are trademarks of 2Exclusive LLC-S.</p>
            <p>
              Source-Use License is subject to full license agreement. Unauthorized use,
              distribution, rebranding, or credential misrepresentation will result in license
