...
export const metadata: Metadata = {
  ...
  description:
    'Complete WIOA compliance toolkit with participant tracking, performance metrics, PIRL exports, and automated quarterly reporting.',
  alternates: {
...
const features = [
  {
    ...
    items: [
      ...
      'Eligibility checklist automation',
      'Document management',
...
const wioaGuideSteps = [
  {
    title: 'What is WIOA?',
    message:
      "WIOA stands for Workforce Innovation and Opportunity Act. It's the federal law that governs workforce development programs. Our tools help you stay compliant with all requirements.",
    highlight: '#wioa-features',
  },
  {
    title: 'Track Performance',
    message:
      'WIOA requires tracking specific metrics like employment rates, median earnings, and credential attainment. Our dashboard tracks all of these automatically.',
    highlight: '#wioa-features',
  },
  {
    title: 'PIRL Exports',
    message:
      'Need to submit Participant Individual Record Layout data? We generate PIRL-compliant exports with one click - no manual data entry needed.',
    highlight: '#how-it-works',
  },
  {
    title: 'Choose Your Plan',
    message:
      'We have three pricing tiers based on your needs. The Professional plan is most popular - it includes automated PIRL exports and quarterly reporting.',
    highlight: '#pricing',
  },
];
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-12 text-sm">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400 mx-2" />
            <Link href="/store/compliance" className="text-gray-600 hover:text-black">
              Compliance
            </Link>
            <ChevronRight className="w-4 h-4 text-gray-400 mx-2" />
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
        ...
        <div className="bg-slate-900 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <span className="inline-block bg-brand-green-600 text-white text-sm font-bold px-4 py-1 rounded-full mb-4">
              Compliance Tools
            </span>
            ...
            <p className="text-lg text-slate-300 mb-6 max-w-3xl mx-auto">
              Complete toolkit for Workforce Innovation and Opportunity Act compliance. Automated
              tracking, reporting, and PIRL exports for workforce development programs.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="#pricing"
                className="inline-flex items-center gap-2 bg-white text-brand-green-700 px-6 py-3 rounded-lg font-bold hover:bg-brand-green-50 transition"
              >
                View Pricing <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                href="/store/demos"
                className="inline-flex items-center gap-2 bg-brand-green-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-brand-green-500 transition border border-brand-green-500"
              >
                Request Demo
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {metrics.map((metric) => (
              <div
                key={metric.label}
                className="bg-white rounded-lg p-4 border border-brand-green-200 text-center"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white rounded-2xl overflow-hidden border-2 border-gray-200 hover:border-brand-green-500 hover:shadow-xl transition-all group"
              >
                <div className="relative h-48 overflow-hidden">
                  <Image
                    ...
                    sizes="100vw"
                  />
                  <h3 className="absolute bottom-4 left-4 text-xl font-bold text-slate-900">
                    {feature.title}
                  </h3>
                </div>
                <div className="p-6">
            ...
            {[
              {
                step: '1',
                title: 'Setup',
                desc: 'Configure your program and eligibility criteria',
                image: '/images/pages/wioa-meeting.jpg',
              },
              {
                step: '2',
                title: 'Enroll',
                desc: 'Participants complete digital intake forms',
                image: '/images/pages/adult-learner.jpg',
              },
              {
                step: '3',
                title: 'Track',
                desc: 'Automatic performance metric tracking',
                image: '/images/pages/store-recommendations.jpg',
              },
              {
                step: '4',
                title: 'Report',
                desc: 'Generate PIRL exports and quarterly reports',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricing.map((plan) => (
              <div
                key={plan.name}
                className={`bg-white rounded-2xl overflow-hidden border-2 ${plan.popular ? 'border-brand-green-500 shadow-xl' : 'border-gray-200'} relative`}
              >
                {plan.popular && (
      ...
      <section className="py-16 bg-brand-green-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/store/demos"
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-green-700 px-8 py-4 rounded-lg font-bold hover:bg-brand-green-50 transition"
            >
              Schedule Demo
            </Link>
            <Link
