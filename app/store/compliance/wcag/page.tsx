...
export const metadata: Metadata = {
  ...
  description:
    'WCAG 2.1 Level AA compliance tools with screen reader support, keyboard navigation, and accessibility auditing.',
  alternates: {
...
const guideSteps = [
  {
    title: 'What is WCAG?',
    message:
      'WCAG stands for Web Content Accessibility Guidelines. It ensures your platform is usable by people with disabilities - including visual, auditory, motor, and cognitive impairments.',
    highlight: '#wcag-features',
  },
  {
    title: 'Level AA Compliance',
    message:
      'We meet WCAG 2.1 Level AA standards, which is required for federal contractors and recommended for all organizations. This covers screen readers, keyboard navigation, and more.',
    highlight: '#wcag-features',
  },
  {
    title: 'Automated Auditing',
    message:
      'Our tools automatically scan your content for accessibility issues and provide actionable fixes. No manual testing required.',
    highlight: '#pricing',
  },
];
        ...
        <div className="bg-slate-900 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Make your platform accessible to everyone with screen reader support, keyboard
              navigation, and automated accessibility auditing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white rounded-2xl overflow-hidden border-2 border-gray-200 hover:border-brand-blue-500 hover:shadow-xl transition-all group"
              >
            ...
            {[
              {
                name: 'Audit Only',
                price: '$499',
                features: ['One-time accessibility audit', 'Detailed report', 'Remediation guide'],
              },
              {
              ...
              <div
                key={plan.name}
                className={`bg-white rounded-2xl p-8 border-2 ${plan.popular ? 'border-brand-blue-500 shadow-xl' : 'border-gray-200'}`}
              >
                {plan.popular && (
                ...
                <Link
                  ...
                  className={`block text-center py-3 rounded-lg font-bold ${plan.popular ? 'bg-brand-blue-600 text-white' : 'bg-white text-black'}`}
                >
                  Get Started
                </Link>
              </div>
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8">
            Schedule a demo to see our accessibility tools in action.
          </p>
          <Link
            href="/store/demos"
