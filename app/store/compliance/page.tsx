...
export const metadata: Metadata = {
  ...
  description:
    'Complete compliance documentation for WIOA, FERPA, WCAG, and grant reporting. Enterprise-grade workforce training platform.',
  alternates: {
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
      ...
      <section className="text-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl font-black mb-6">Enterprise-Grade Compliance</h1>
          <p className="text-xl text-white max-w-3xl mx-auto">
            Built for workforce development with WIOA, FERPA, WCAG AA, and grant reporting
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <div className="relative w-full aspect-video" style={{ aspectRatio: '16/10' }}>
                <Image
                  src="/images/pages/admin-wioa-hero.jpg"
                  alt="WIOA compliance reporting dashboard"
                  fill
                  className="object-cover"
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 mb-4">
                  Workforce Innovation and Opportunity Act (WIOA) compliant data collection,
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <div className="relative w-full aspect-video" style={{ aspectRatio: '16/10' }}>
                <Image
                  src="/images/pages/admin-compliance-hero.jpg"
                  alt="FERPA student data protection dashboard"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 mb-4">
                  Family Educational Rights and Privacy Act (FERPA) compliant student data
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700 mb-4">
                Web Content Accessibility Guidelines (WCAG) 2.1 Level AA compliant for inclusive
                learning.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start gap-2">
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-slate-200">
            <div className="relative w-full aspect-video" style={{ aspectRatio: '16/10' }}>
              <Image
                ...
                alt="Grant reporting and compliance documentation"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
            ...
            <div className="p-8">
              ...
              <p className="text-gray-700 mb-4">
                Automated reporting for federal and state workforce grants with customizable
                templates.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Section 508',
                description: 'Federal accessibility standards',
                status: 'Compliant',
              },
              {
                title: 'COPPA',
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-2xl p-12 text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Get the full compliance documentation package including technical specifications,
              audit reports, and implementation guides.
            </p>
