...
export const metadata: Metadata = {
  ...
  description:
    'Automated grant reporting with customizable templates, outcome tracking, and one-click exports for federal and state workforce grants.',
  alternates: {
...
const guideSteps = [
  {
    ...
    message:
      "If you've ever spent days pulling data for a grant report, you know the pain. Our tools automate 90% of that work so you can focus on serving participants.",
    highlight: '#grant-features',
  },
  {
    title: 'Automatic Tracking',
    message:
      'As participants move through your program, we automatically track the metrics your funders care about - employment, wages, credentials, and more.',
    highlight: '#grant-features',
  },
  {
    title: 'One-Click Reports',
    message:
      "When it's time to report, just click a button. We generate the exact format your funder needs - DOL, state agencies, or private foundations.",
    highlight: '#pricing',
  },
];
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
          <Image
            src="/images/pages/store-page-1.jpg"
            alt="Grant Reporting"
            fill
        ...
        <div className="bg-slate-900 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Automated data collection, customizable templates, and one-click exports for all your
              federal and state grant reporting needs.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white rounded-2xl overflow-hidden border-2 border-gray-200 hover:border-brand-orange-500 hover:shadow-xl transition-all group"
              >
            ...
            {[
              {
                name: 'Starter',
                price: '$299',
                features: ['5 report templates', 'Basic outcome tracking', 'Excel exports'],
              },
              {
                name: 'Professional',
                price: '$999',
              ...
              <div
                key={plan.name}
                className={`bg-white rounded-2xl p-8 border-2 ${plan.popular ? 'border-brand-orange-500 shadow-xl' : 'border-gray-200'}`}
              >
                {plan.popular && (
                  <span className="bg-brand-red-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                    Most Popular
                  </span>
                )}
                ...
                <Link
                  ...
                  className={`block text-center py-3 rounded-lg font-bold ${plan.popular ? 'bg-brand-red-600 text-white' : 'bg-white text-black'}`}
                >
                  Get Started
                </Link>
              </div>
      ...
      <section className="py-16 bg-brand-red-600 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8">
            Schedule a demo to see how we can save you hours on every report.
          </p>
          <Link
            href="/store/demos"
            className="inline-flex items-center gap-2 bg-white text-brand-orange-600 px-8 py-4 rounded-lg font-bold hover:bg-brand-orange-50 transition"
          >
            Schedule Demo
          </Link>
        </div>
