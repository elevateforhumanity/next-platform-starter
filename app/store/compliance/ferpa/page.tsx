...
export const metadata: Metadata = {
  ...
  description:
    'Complete FERPA compliance toolkit with data encryption, access controls, audit logging, and consent management.',
  alternates: {
...
const guideSteps = [
  {
    title: 'What is FERPA?',
    message:
      "FERPA is the Family Educational Rights and Privacy Act. It protects student education records and gives parents rights over their children's information.",
    highlight: '#ferpa-features',
  },
  {
    title: 'Data Protection',
    message:
      'Our platform uses AES-256 encryption and role-based access controls to ensure only authorized staff can access student records.',
    highlight: '#ferpa-features',
  },
  {
    title: 'Audit Everything',
    message:
      'Every access to student data is logged. You can generate compliance reports showing who accessed what and when.',
    highlight: '#ferpa-features',
  },
];
        ...
        <div className="bg-slate-900 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Enterprise-grade student data protection with encryption, access controls, and
            ...
            {[
              {
                name: 'Basic',
                price: '$299',
                features: ['Encryption at rest', 'Basic access controls', 'Monthly audit reports'],
              },
              {
                name: 'Professional',
                price: '$999',
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8">
            Schedule a demo to see our FERPA compliance tools in action.
          </p>
          <Link
            href="/store/demos"
