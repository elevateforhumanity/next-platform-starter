...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        id: 'b',
        text: 'Listen, document the barrier, and connect them to supportive services while keeping them enrolled',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: "Decline and explain that adult student records require the student's written consent",
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Stay calm, acknowledge their frustration, and explain the formal grievance process',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'b',
        text: 'Connecting people to funded workforce training and career pathways at no cost to eligible participants',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Staff must collect and document eligibility evidence per program requirements',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Verify the request through official channels and obtain student consent before sharing any information',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Attempt outreach by phone, email, and emergency contact; document all attempts',
      },
          ...
          {passed ? (
            <>
              ...
              <p className="text-slate-500 mb-6">
                Excellent work. Our HR team will reach out within 2 business days to schedule your
                video interview.
              </p>
              <div className="bg-brand-green-50 border border-brand-green-200 rounded-xl p-4 text-sm text-brand-green-800 mb-6">
                Watch your email for an interview scheduling link from{' '}
                <strong>hr@elevateforhumanity.org</strong>
              </div>
              <button
            ...
            <>
              ...
              <p className="text-slate-500 mb-6">
                The passing score is {PASSING_SCORE}%. You're welcome to reapply in 30 days after
                reviewing our policies and mission.
              </p>
              <button
                onClick={() => router.push('/careers')}
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-10">
          ...
          <div className="bg-white rounded-xl p-4 text-sm text-slate-600 mb-6">
            Answer honestly — there are no trick questions. The assessment tests knowledge of
            student support, FERPA, WIOA, and Elevate's mission.
          </div>
          <button
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-2xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between text-sm text-slate-500 mb-2">
            ...
            <span className="flex items-center gap-1">
              <Clock className="w-3.5 h-3.5" /> {QUESTIONS.length - current - 1} remaining
            </span>
          </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl border p-8 mb-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-brand-blue-600 mb-3">
            Question {current + 1}
          </p>
          ...
          <div className="space-y-3">
            {q.options.map((opt) => (
              ...
              >
                <span
                  className={`w-7 h-7 rounded-full border-2 flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5 ${
                    answers[q.id] === opt.id
                ...
                <span
                  className={`text-sm leading-relaxed ${answers[q.id] === opt.id ? 'text-brand-blue-900 font-medium' : 'text-slate-700'}`}
                >
                  {opt.text}
                </span>
              </button>
