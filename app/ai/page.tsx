...
import { Brain, MessageSquare, Sparkles, Target, BookOpen, Briefcase } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="via-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-black text-black mb-6">Learn Faster with AI</h1>

          <p className="text-xl text-black max-w-3xl mx-auto">
            Get instant help, build courses automatically, match to jobs, and more. Our AI tools are
            available 24/7 to accelerate your learning journey.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Tutor</h3>
              <p className="text-black mb-4">
                Get instant answers to your questions. Available 24/7 to help you understand course
                material, solve problems, and learn faster.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Chat Assistant</h3>
              <p className="text-black mb-4">
                Have a conversation with AI about your career goals, training options, and next
                steps. Get personalized guidance instantly.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Course Builder</h3>
              <p className="text-black mb-4">
                Create complete training courses in minutes. AI generates outlines, lessons,
                quizzes, and materials automatically.
              </p>
              <div className="flex items-center gap-2 text-brand-blue-600 font-semibold group-hover:gap-4 transition-all">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Job Matcher</h3>
              <p className="text-black mb-4">
                Find jobs that match your skills and training. AI analyzes your profile and
                recommends the best opportunities.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Instructor</h3>
              <p className="text-black mb-4">
                Virtual instructor that teaches concepts, provides examples, and adapts to your
                learning style.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-3">AI Asset Generator</h3>
              <p className="text-black mb-4">
                Generate images, diagrams, and visual content for your courses and presentations
                automatically.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">How AI Helps You Learn</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Ask Questions</h3>
              <p className="text-black">
                Type your question in plain English. No need to search through materials.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Get Instant Answers</h3>
              <p className="text-black">
                AI analyzes your course content and provides accurate, helpful responses.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-black mb-2">Learn Faster</h3>
              <p className="text-black">
                Understand concepts quickly and move through your training with AI-assisted support
                between instructor sessions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-brand-blue-700   text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 mb-8">
            All AI tools are included with your enrollment. Start using them today.
          </p>
