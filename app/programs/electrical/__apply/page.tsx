...
export const metadata: Metadata = {
  title: 'Apply for Electrical Training | Elevate for Humanity',
  description: 'Apply for our Electrical Training program. Free training with WIOA funding available.',
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          <Breadcrumbs
            items={[
              ...
              { label: 'Electrical Training', href: '/programs/electrical' },
              { label: 'Apply' },
            ]}
            className="text-blue-200 mb-4"
          />
          <h1 className="text-3xl md:text-4xl font-bold">Apply for Electrical Training</h1>
