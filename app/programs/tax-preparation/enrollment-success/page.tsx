...
export default async function EnrollmentSuccessPage() {
  ...
  const programName =
    (enrollment.programs as { name?: string })?.name || 'Tax Preparation & Financial Services';
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-indigo-400 font-bold text-sm uppercase tracking-widest mb-2">
            IRS-Recognized Credential Pathway
          </p>
          <h1 className="text-4xl font-black text-white mb-2">You're officially enrolled.</h1>
          <p className="text-slate-400">
            Welcome to the Tax Preparation & Financial Services program.
          </p>
        </div>
        ...
        <div className="bg-slate-800 rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-3">
            {[
              {
                n: 1,
                title: 'Complete tax law fundamentals',
                desc: 'Federal income tax, deductions, credits — access via your learner dashboard',
              },
              {
                n: 2,
              ...
              {
                n: 3,
                title: 'Apply for your EFIN',
                desc: 'Electronic Filing Identification Number — required to e-file returns',
              },
              {
                n: 4,
        ...
        <Link
          href="/login"
          className="block w-full bg-indigo-500 hover:bg-indigo-600 text-white text-center py-5 rounded-xl font-bold text-lg transition-all hover:scale-[1.02] shadow-lg mb-3"
        >
        ...
        <div className="text-center space-y-1">
          ...
          <a
            ...
            className="text-indigo-400 hover:underline text-sm flex items-center justify-center gap-1"
          >
