    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-teal-400 font-bold text-sm uppercase tracking-widest mb-2">USDOL Registered Apprenticeship</p>
        ...
        <div className="bg-slate-800 rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-3">
            {[
              { n: 1, title: 'Complete orientation', desc: 'Sanitation, skin care protocols, and safety — required before hands-on training' },
              { n: 2, title: 'Apply for your Indiana Esthetician License', desc: '700 hours required for licensure — we guide you through the PLA application' },
        ...
        <Link href="/learner/dashboard" className="block w-full bg-teal-500 hover:bg-teal-600 text-white text-center py-5 rounded-xl font-bold text-lg transition-all hover:scale-[1.02] shadow-lg mb-3">
          Start Orientation →
        </Link>
        <Link href="/pwa/esthetician" className="block w-full bg-slate-700 hover:bg-slate-600 text-white text-center py-4 rounded-xl font-bold transition-all mb-6">
          <BookOpen className="inline w-4 h-4 mr-2" />Open Esthetician App
        </Link>
        ...
        <div className="text-center space-y-1">
          ...
          <a href="tel:317-314-3757" className="text-teal-400 hover:underline text-sm flex items-center justify-center gap-1">
