...
export const metadata: Metadata = {
  ...
  description: 'Apply for our Cybersecurity program. WIOA funding may be available for eligible participants.',
};
    ...
    <main className="min-h-screen bg-white">
      <div className="bg-blue-900 text-white py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          />
          <h1 className="text-3xl md:text-4xl font-bold">Apply for Cybersecurity</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/apply?program=cybersecurity-analyst"
