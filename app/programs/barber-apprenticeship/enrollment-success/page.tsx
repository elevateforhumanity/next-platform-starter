            ...
            {[
              {
                ...
                desc: 'Safety, tools, and shop protocols — required before hands-on training',
              },
              {
                n: 2,
                title: 'Apply for your Indiana Barber License',
                desc: 'We guide you through the PLA application process',
              },
              {
                n: 3,
                title: 'Log OJT hours weekly',
                desc: '3,000 hours required — track via your apprentice dashboard',
              },
            ].map(({ n, title, desc }) => (
