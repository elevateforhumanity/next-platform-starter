...
export const CURRICULUM = [
  {
    ...
    description:
      'Fades, tapers, lineups, and precision cutting under licensed supervision in a real shop environment.',
  },
  {
    title: 'Clipper & Shear Mastery',
    description:
      'Tool selection, maintenance, guard systems, and advanced clipper-over-comb and shear techniques.',
  },
  {
    title: 'Sanitation & Safety',
    description:
      'Indiana State Board sanitation standards, chemical safety, bloodborne pathogen protocols, and workstation compliance.',
  },
  {
    title: 'Shaving & Beard Grooming',
    description:
      'Straight razor safety, beard shaping, lining, skin protection, and hot towel service techniques.',
  },
  {
    title: 'Client Services & Professionalism',
    description:
      'Client consultation, communication, time management, and building a repeat client base.',
  },
  {
    title: 'Shop Operations & Business',
    description:
      'Booth rental basics, appointment management, business licensing, and shop ownership preparation.',
  },
  {
    title: 'License Exam Preparation',
    description:
      'Indiana barber license exam prep including written test review, practical exam practice, and State Board requirements.',
  },
  {
    title: 'Competency Evaluations',
    description:
      'Monthly rubric-based assessments, tri-party verification (RTI + Employer + Program), and documented skill progression.',
  },
];
...
export const ENROLLMENT_STEPS = [
  {
    ...
    description:
      'Submit the funding and eligibility intake form online. Answer questions about your background, work history, and payment preferences. No documents needed at this stage.',
  },
  {
    title: 'Get Matched',
    description:
      'Our team pairs you with a licensed barber instructor at a partner barbershop near you. Meet your instructor, tour the shop, and agree on a training schedule and employment model.',
  },
  {
    title: 'Earn While You Learn',
    description:
      'Complete 2,000 apprenticeship hours total — 1,500 OJT hours at your host shop and 500 RTI hours via Elevate LMS online coursework. You are a W-2 employee of your host shop throughout the apprenticeship — compensation is set by your employer and must meet or exceed applicable minimum wage laws.',
  },
  {
    title: 'Get Licensed',
    description:
      'After completing all required hours and coursework, sit for the Indiana State Board barber exam. We provide exam prep materials and practice tests. Pass and receive your Indiana barber license.',
  },
];
