  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-black mb-8">
                ...
                competencies. Career pathways include licensed barber positions, shop management,
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
            Transfer Hours &amp; Prior Training
          </h2>
          <p className="text-black mb-6 max-w-3xl">
            Participants with prior barber training, apprenticeship hours, or documented industry
            experience may be eligible for transfer hour evaluation.
          </p>
          ...
          <p className="mt-4 text-sm text-black">
            Approved transfer hours may be applied toward the 2,000-hour training requirement based
            on documented verification and program review standards. Final approval is determined
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
            Partnership Barbershops &amp; Training Sites
          </h2>
          <p className="text-black mb-8 max-w-3xl">
            The Barber Apprenticeship Program is delivered in collaboration with approved licensed
            barbershop partners that serve as official On-the-Job Training (OJT) sites. Apprentices
            are W-2 employees of their host shop for the duration of the apprenticeship.
          </p>
