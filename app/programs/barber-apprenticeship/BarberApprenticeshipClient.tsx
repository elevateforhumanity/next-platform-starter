      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <span className="flex-shrink-0 text-xs font-bold text-white px-3 py-1 rounded-full bg-brand-blue-600">
              DOL Registered
            </span>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-x-6 gap-y-2 text-sm text-black">
            ...
            <span>
              <strong>Cohort:</strong> {p.cohortSize}
            </span>
            <span>
              <strong>Tuition:</strong> $4,980. Payment plans available.
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-800 mt-1">
              This is a new DOL Registered Apprenticeship program currently rolling out in the
              Indianapolis metro area. We are actively seeking licensed barbershops to partner as
              host training sites. Apprentice spots are limited — there is a waiting list. Sign up
              below to reserve your place or{' '}
              <Link
                href="/partners/barbershop-apprenticeship/apply"
                className="underline font-medium"
              >
                apply as a partner barbershop
              </Link>
              .
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-slate-700 leading-relaxed">
              Start as a <strong>Barber Apprentice</strong> — a paid W-2 employee at your host shop
              — while you train under a licensed barber. After completing 2,000 hours and passing
              the Indiana state exam, you become a <strong>Licensed Barber</strong>{' '}
              ($30,000–$45,000). With 3–5 years of experience and an established clientele, you
              advance to <strong>Senior Barber</strong> ($45,000–$65,000). Many graduates go on to
              open their own shop as a <strong>Shop Owner / Master Barber</strong>{' '}
              ($65,000–$100,000+).
            </p>
          </div>
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-slate-700 leading-relaxed">
                By program completion, apprentices perform six standard haircut styles — fade,
                taper, buzz, scissor-over-comb, flat top, and shape-up — to client satisfaction. You
                will execute straight razor shaves following Indiana sanitation protocols, identify
                and treat common scalp conditions, and demonstrate proper disinfection procedures
                per Indiana Board standards. Each apprentice completes 2,000 apprenticeship hours
                total — 1,500 hours of on-the-job training at a licensed shop and 500 hours of
                related technical instruction (Elevate LMS) — builds a client portfolio of 50+
                documented services, and passes the Indiana Barber License written and practical
                exams.
              </p>
            </div>
          </div>
      ...
      <section className="bg-slate-50 border-y border-slate-200 py-10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-sm text-black mb-6">
            A look inside Lesson 1 — Introduction to Barbering.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              {
                src: '/images/programs/barber/lesson-1-scene-1.jpg',
                label: 'What barbers do every day',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-2.jpg',
                label: 'Barbering as a licensed profession',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-3.jpg',
                label: 'How the apprenticeship works',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-4.jpg',
                label: 'Professional standards from day one',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-5.jpg',
                label: 'Tools and their purpose',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-6.jpg',
                label: 'Client communication',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-7.jpg',
                label: 'What success looks like',
              },
              {
                src: '/images/programs/barber/lesson-1-scene-8.jpg',
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            {
              img: '/images/pages/barber-tools-closeup.jpg',
              alt: 'Barber tools and clippers',
              cred: p.credentials[0],
            },
            {
              img: '/images/pages/barber-client-consult.jpg',
              alt: 'Barber consulting with client',
              cred: p.credentials[1],
            },
            {
              img: '/images/pages/barber-shop-wide.jpg',
              alt: 'Professional barbershop interior',
              cred: p.credentials[2],
            },
          ]
            .filter((item) => item.cred)
            .map((item, i) => (
              <div
                key={i}
                className="border border-slate-200 rounded-xl overflow-hidden hover:border-brand-blue-300 transition-colors"
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-brand-blue-600 font-medium mt-1">
                    Issued by {item.cred.issuer}
                  </p>
                  <p className="text-sm text-black mt-2">{item.cred.description}</p>
                  {item.cred.validity && (
                    <p className="text-xs text-black mt-2">Valid: {item.cred.validity}</p>
                  )}
                </div>
              </div>
            ))}
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <p className="text-sm text-black leading-relaxed mb-4">
                Not sure if this program is right for you? Submit an inquiry and a career advisor
                will contact you to discuss eligibility, funding options, and next steps. No
                commitment required.{' '}
                <Link
                  href="/forms/barber-apprenticeship-inquiry"
                  className="underline font-medium text-brand-blue-600"
                >
      ...
      <section className="py-10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-xs text-black mt-3">
            Compensation is determined by each participating shop and must comply with applicable
            wage requirements. Elevate tracks training progress and hours.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Apprentice spots are limited and fill quickly. Join the waiting list to be notified
                when the next cohort opens. Barbershop owners can also sign up to be considered as a
                host training site.
              </p>
              <div
              ...
              {waitlistSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-black">
                    We&apos;ll contact you when the next cohort opens or when a host shop spot
                    becomes available.
                  </p>
                </div>
              ) : (
                    ...
                    try {
                      const res = await fetch('/api/waitlist', {
                        ...
                        body: JSON.stringify({
                          ...
                          notes:
                            waitlistType === 'shop'
                              ? 'Barbershop owner — interested as partner shop'
                              : undefined,
                        }),
                      });
                ...
                >
                  ...
                  <div className="flex gap-3">
                    <button
                      type="button"
                      onClick={() => setWaitlistType('apprentice')}
                  ...
                  >
                    {waitlistLoading
                      ? 'Submitting…'
                      : waitlistType === 'shop'
                        ? 'Sign Up as Partner Shop'
                        : 'Join Apprentice Waiting List'}
                  </button>
                </form>
              )}
            </div>
      ...
      <section className="border-t py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm text-black">
            <div>
              <h3 className="font-semibold text-slate-900 text-xs uppercase mb-2">
                Admission Requirements
              </h3>
              <ul className="space-y-1">
                {p.admissionRequirements.map((r, i) => (
                  <li key={i}>• {r}</li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1">
                {p.employerPartners.map((r, i) => (
                  <li key={i}>• {r}</li>
                ))}
              </ul>
              {p.bilingualSupport && (
                <p className="mt-3 text-xs text-black">{p.bilingualSupport}</p>
              )}
            </div>
          </div>
