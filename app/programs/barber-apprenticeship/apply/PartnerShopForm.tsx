  ...
  return (
    <div className="border border-slate-200 rounded-xl p-5 bg-slate-50 space-y-4">
      ...
      <div>
        ...
        <div className="flex items-center justify-between mt-1.5">
          ...
          <button
            type="button"
            onClick={onClear}
            className="text-xs text-black hover:text-slate-700 underline"
          >
            Clear
          </button>
        </div>
      ...
      <p className="text-xs text-black leading-relaxed">
        This electronic signature is legally binding under the Indiana Uniform Electronic
        Transactions Act (IC 26-2-8) and the federal ESIGN Act.
      </p>
    </div>
  );
}
...
export default function PartnerShopForm() {
  ...
  const handleMouDraw = useCallback(
    (e: React.MouseEvent | React.TouchEvent) => {
      mouSig.draw(e);
  ...
  const handleEmployerDraw = useCallback(
    (e: React.MouseEvent | React.TouchEvent) => {
      employerSig.draw(e);
  ...
  const handleConsentDraw = useCallback(
    (e: React.MouseEvent | React.TouchEvent) => {
      consentSig.draw(e);
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateField('shopLegalName', e.target.value)}
            ...
            <div>
              ...
              <input
                type="text"
                value={formData.shopDbaName}
                onChange={(e) => updateField('shopDbaName', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                type="text"
                required
                value={formData.indianaShopLicenseNumber}
                onChange={(e) => updateField('indianaShopLicenseNumber', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
              <p className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded px-3 py-2 mt-2 leading-relaxed">
                ⚠️ <strong>Full copy required.</strong> You must upload a complete copy of your
                Indiana barbershop license showing the license number, expiration date, licensee
                name, and shop address. Partial copies or photos that cut off any portion of the
            ...
            <div className="md:col-span-2 border-t border-slate-100 pt-4 mt-2">
              ...
              <p className="text-xs text-black mb-4">
                Required for DOL RAPIDS worksite registration. Enter your EIN and upload your IRS
                confirmation letter (CP-575 or 147C). The name on the EIN must match your shop legal
                name above.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-black mt-1">
                    IRS CP-575 or 147C letter — full document, no crops
                  </p>
                </div>
              </div>
              {/* EIN QA notes */}
            ...
            <div className="md:col-span-2 border-t border-slate-100 pt-4 mt-2">
              ...
              <p className="text-xs text-black mb-2">
                The street address where apprentices will perform on-the-job training. This is
                registered as the worksite in the federal RAPIDS system.
              </p>
              <input
                type="text"
                required
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateField('shopAddressLine1', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => updateField('shopAddressLine2', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
            </div>
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField('shopCity', e.target.value)}
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value="Indiana"
                  disabled
                  className="w-full px-4 py-2 border border-slate-200 rounded-lg bg-white text-black"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField('shopZip', e.target.value)}
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
                />
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateField('supervisorLicenseNumber', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => updateField('supervisorYearsLicensed', e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500"
              />
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-black mb-2">
                DOL Registered Apprenticeships require the apprentice to be an employee of the host
                shop, regardless of compensation model (hourly or hybrid). Sole commission is not
                permitted.
              </p>
              <div className="flex gap-4">
                <label className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:bg-white">
                  <input
                    type="radio"
                    name="apprenticesOnPayroll"
                    value="yes"
                    checked={formData.apprenticesOnPayroll === 'yes'}
                    onChange={(e) => updateField('apprenticesOnPayroll', e.target.value)}
                    required
              ...
              <p className="text-xs text-amber-700 mt-2">
                Shops that cannot add apprentices to payroll are not eligible to host registered
                apprenticeship OJL.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-3 gap-2">
                {compensationModels.map((model) => (
                  <label
                    key={model.value}
                    className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:bg-white"
                  >
                    <input
                      type="radio"
                      name="compensationModel"
                      value={model.value}
                      checked={formData.compensationModel === model.value}
                      onChange={(e) => updateField('compensationModel', e.target.value)}
                      required
                      className="text-brand-blue-600"
                    />
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    value="yes"
                    checked={formData.hasGeneralLiability === 'yes'}
                    onChange={(e) => updateField('hasGeneralLiability', e.target.value)}
                    required
                  />
                  <span>Yes</span>
                </label>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    name="hasGeneralLiability"
                    value="no"
                    checked={formData.hasGeneralLiability === 'no'}
                    onChange={(e) => updateField('hasGeneralLiability', e.target.value)}
                  />
                  <span>No</span>
                </label>
            ...
            <div>
              ...
              <div className="space-y-2">
                {workersCompOptions.map((opt) => (
                  <label
                    key={opt.value}
                    className="flex items-start gap-2 p-3 border rounded-lg cursor-pointer hover:bg-white"
                  >
                    <input
                      type="radio"
                      ...
                      onChange={(e) => updateField('workersCompStatus', e.target.value)}
                      required
                      className="mt-0.5 text-brand-blue-600"
                    />
              ...
              {formData.workersCompStatus === 'none' && (
                <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-sm text-red-700 font-medium">
                    Workers&apos; Compensation is required for shops with employees on payroll.
                  </p>
              ...
              {formData.workersCompStatus === 'exempt' && (
                <p className="text-sm text-amber-700 mt-2">
                  You will need to provide documentation of your state exemption during the
                  compliance review.
                </p>
              )}
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">
                Can you commit to supervising apprentices and verifying hours/competencies? *
              </label>
              <div className="flex gap-4">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    value="yes"
                    checked={formData.canSuperviseAndVerify === 'yes'}
                    onChange={(e) => updateField('canSuperviseAndVerify', e.target.value)}
                    required
                  />
                  <span>Yes</span>
                </label>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    name="canSuperviseAndVerify"
                    value="no"
                    checked={formData.canSuperviseAndVerify === 'no'}
                    onChange={(e) => updateField('canSuperviseAndVerify', e.target.value)}
                  />
                  <span>No</span>
                </label>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <p className="text-sm text-black mb-4">
            Review the MOU before signing. This document governs your responsibilities as a DOL
            Registered Apprenticeship partner shop.
          </p>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-slate-700">
                ...
                <Link
                  ...
                  className="text-brand-blue-600 underline font-medium"
                  target="_blank"
                >
                  Memorandum of Understanding (MOU)
                </Link>{' '}
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <p className="text-sm text-black mb-4">
            As the employing shop, you accept responsibility for the apprentice as an employee,
            agree to pay at least minimum wage, maintain required insurance, and comply with all DOL
            Registered Apprenticeship standards for the duration of the apprenticeship.
          </p>
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg mb-4 space-y-2 text-sm text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-slate-700 ml-1">
              ...
              <li>
                Notify Elevate for Humanity within 5 business days of any change in employment
                status
              </li>
            </ul>
          </div>
          <div className="p-4 bg-white border border-slate-200 rounded-lg mb-4">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <span className="text-sm text-slate-700">
                I accept the Employer Acceptance Agreement and confirm that I have the authority to
                bind this business to these obligations. *
              </span>
            </label>
          </div>
          <SignaturePad
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-slate-900 mb-2">
            Application Consent & Certification
          </h2>
          <p className="text-sm text-black mb-4">
          ...
          <div className="p-4 bg-white border border-slate-200 rounded-lg mb-4">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <span className="text-sm text-slate-700">
                I certify that all information provided in this application is true and accurate. I
                consent to be contacted regarding this application and acknowledge that my
                information will be handled per the{' '}
                <Link href="/privacy-policy" className="text-brand-blue-600 underline">
                  Privacy Policy
                </Link>
                . *
              </span>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            type="submit"
            disabled={loading}
            className="flex-1 inline-flex items-center justify-center px-8 py-4 bg-brand-blue-600 text-white rounded-lg font-bold hover:bg-brand-blue-700 disabled:opacity-50 transition-colors"
          >
            {loading ? (
              <>
