...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Tiered credential pathway: tax preparation, bookkeeping, payroll, and accounting. Nationally recognized credentials. Funded for eligible participants.',
    url: `${SITE_URL}/programs/finance-bookkeeping-accounting`,
    siteName: 'Elevate for Humanity',
    images: [
      {
        url: '/images/pages/bookkeeping-ledger.jpg',
        width: 1200,
        height: 630,
        alt: 'Finance credential pathway',
      },
    ],
    type: 'website',
  },
...
const credentials = [
  {
    ...
    desc: 'Required by law to prepare federal tax returns for compensation.',
  },
  {
    name: 'AFSP (Annual Filing Season Program)',
    issuer: 'Internal Revenue Service',
    desc: 'Voluntary IRS program demonstrating continuing education compliance.',
  },
  {
    name: 'IRS VITA Tax Law Certification',
    issuer: 'IRS VITA Program',
    desc: 'Tax law competency validation under the Volunteer Income Tax Assistance Program.',
  },
  {
    name: 'QuickBooks Certified User',
    issuer: 'Certiport / Pearson VUE',
    desc: 'Proctored on-site. Validates proficiency in QuickBooks Online accounting software.',
  },
  {
    name: 'ACT WorkKeys / NCRC',
    issuer: 'ACT, Inc.',
    desc: 'Workforce readiness validation — applied math, workplace documents, business writing.',
  },
  {
    name: 'Enrolled Agent (EA) Prep Track',
    issuer: 'IRS (SEE Exam)',
    desc: 'Advanced tier. Prepares for the Special Enrollment Examination to represent taxpayers before the IRS.',
  },
];
...
const tiers = [
  {
    ...
    credentials: [
      'IRS PTIN',
      'IRS VITA Tax Law Certification',
      'AFSP Eligibility',
      'WorkKeys NCRC',
    ],
    outcomes: [
      'Seasonal tax preparation positions (W-2)',
      'Bookkeeping assistant roles',
      'Administrative accounting support',
    ],
    tracks: [
      'Employment Placement (W-2) at local tax offices and accounting firms',
      'Seasonal & Contract placement at tax preparation firms',
    ],
  ...
  },
  {
    ...
    credentials: [
      ...
      'Applied Bookkeeping & Accounting Foundations',
      'WorkKeys NCRC',
    ],
    outcomes: [
      'Full-charge bookkeeper positions',
      'Payroll specialist roles',
      'Accounts payable/receivable clerk',
    ],
    tracks: [
      'Employment Placement (W-2) at accounting firms and business offices',
      'Structured internship with supervised work-based learning',
    ],
  ...
  },
  {
    ...
    credentials: [
      'SEE Exam Preparation (3-part IRS exam)',
      'Enrolled Agent designation (upon passing)',
    ],
    outcomes: [
      'Independent tax practice',
      'Senior tax preparer at accounting firms',
      'IRS representation services',
    ],
    tracks: [
      'Independent Revenue Services under structured mentorship',
      'Employment at CPA firms and tax advisory practices',
    ],
    href: '/programs/tax-preparation',
  },
];
...
const phases = [
  {
    phase: '1',
    title: 'Training',
    desc: 'Classroom instruction, IRS certification, and applied bookkeeping foundations. Credential exams proctored on-site.',
  },
  {
    phase: '2',
    title: 'Paid Internship / Work Experience',
    desc: 'Supervised placement within partner tax service environments, coordinated through WorkOne. Time-bound, documented, with defined learning objectives and evaluation per local board policy.',
  },
  {
    phase: '3',
    title: 'Employment Transition',
    desc: 'Transition to W-2 employment at partner firms, seasonal tax positions, or structured self-employment with income documentation.',
  },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="border-b border-slate-100 py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-black text-base sm:text-lg max-w-2xl leading-relaxed mb-6">
            A tiered credential pathway preparing participants for entry-level and growth-track
            roles in tax preparation, bookkeeping, payroll support, and small business financial
            services.
          </p>
        ...
        <section className="py-10 sm:py-14">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-3 mt-6 text-sm">
              <div>
                <span className="text-black">Structure</span>
                <span className="ml-1.5 font-semibold text-slate-900">
                  3 Tiers (Entry → Intermediate → Advanced)
                </span>
              </div>
              <div>
                <span className="text-black">Duration</span>
                <span className="ml-1.5 font-semibold text-slate-900">
                  6–20 weeks depending on tier
                </span>
              </div>
              <div>
                <span className="text-black">Funding</span>
                <span className="ml-1.5 font-semibold text-slate-900">
                  WIOA / WRG eligible (ETPL #10004627)
                </span>
              </div>
              <div>
                <span className="text-black">Testing</span>
                <span className="ml-1.5 font-semibold text-slate-900">
                  Certiport + WorkKeys on-site
                </span>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-2 mt-8">
              ...
              <Link
                ...
                className="text-center text-sm text-black hover:text-brand-red-600 transition-colors py-3.5 px-4"
              >
        ...
        <section className="py-10 sm:py-14 border-t border-slate-100">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-3">
              Training → Credential → Internship → Employment
            </h2>
            <p className="text-black leading-relaxed mb-8 max-w-3xl">
              Participants complete structured classroom instruction, earn nationally recognized
              credentials, and may transition into supervised internship placements within partner
              tax service environments. Paid work-based learning opportunities are available through
              workforce-aligned models and employer partnerships.
            </p>
            <div className="grid sm:grid-cols-3 gap-6">
              {phases.map((p) => (
                <div key={p.phase} className="bg-white rounded-xl p-6 border border-slate-200">
                  <div className="w-10 h-10 bg-brand-red-600 text-white rounded-full flex items-center justify-center text-lg font-bold mb-4">
                    {p.phase}
                  </div>
                ...
                >
                  <div className="p-6 sm:p-8">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      <span className="text-xs font-bold text-white px-3 py-1 rounded-full bg-slate-800">
                        {tier.level}
                      </span>
      ...
      <InView animation="fade-up">
        <section className="py-10 sm:py-14 border-t border-slate-100">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-3">
              Credential &amp; Validation Stack
            </h2>
            <p className="text-black mb-8 max-w-3xl">
              All credentials are issued by their respective certifying bodies — not by Elevate.
              Exams are proctored on-site at our authorized testing center where applicable.
            </p>
        ...
        <section className="py-10 sm:py-14 border-t border-slate-100">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-4">
              Structured Internship &amp; Employment Transition
            </h2>
            <p className="text-black leading-relaxed mb-4 max-w-3xl">
              Participants who complete credential requirements may transition into supervised, paid
              internship placements within partner tax service environments aligned to employment
              pathways. All internships are time-bound, documented, and evaluated.
            </p>
            <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mb-8 text-sm text-brand-blue-800">
              ...
              <p>
                Work-based learning placements for WIOA-funded participants are coordinated through
                WorkOne Indianapolis (Region 5). The assigned career advisor or case manager
                approves the placement, sets the reimbursement rate per local board policy, and
                receives weekly progress reports. Credential attainment and employment outcomes are
                reported to the local workforce development board for WIOA performance measures.
              </p>
            </div>
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-lg p-5 border border-slate-200">
                <h3 className="font-bold text-slate-900 text-sm mb-2">
                  Workforce-Funded Work Experience
                </h3>
                <p className="text-xs text-black">
                  WorkOne authorizes paid work experience. Workforce board pays stipend or wage per
                  local policy. Elevate supervises. Hours and learning objectives documented per
                  WIOA guidelines.
                </p>
              </div>
              <div className="bg-white rounded-lg p-5 border border-slate-200">
                ...
                <p className="text-xs text-black">
                  Participant hired as W-2 employee. WorkOne reimburses employer 50–75% of wages
                  during defined training period per local board policy. Formal OJT contract and
              ...
              <div className="bg-white rounded-lg p-5 border border-slate-200">
                ...
                <p className="text-xs text-black">
                  Partner employer pays wages directly. Training plan and evaluation documented. No
                  workforce reimbursement. Still reported to WorkOne for outcome tracking if
                  participant is WIOA-enrolled.
                </p>
              </div>
            </div>
      ...
      <InView animation="fade-up">
        <section className="py-10 sm:py-14 border-t border-slate-100">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-4">
              Defined Outcome Ladder
            </h2>
            <p className="text-black mb-8 max-w-3xl">
              For WIOA/WRG performance reporting through the local workforce development board, this
              pathway tracks measurable outcomes at each stage. All metrics are reported to the
              assigned WorkOne career advisor.
            </p>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                {
                  metric: 'Credential Attainment',
                  desc: 'QuickBooks Certified User (Certiport) + IRS PTIN + WorkKeys NCRC. Measurable, third-party validated.',
                  primary: true,
                },
                {
                  metric: 'Seasonal Employment',
                  desc: 'Tax season placement verification. W-2 or 1099 documentation of earned income.',
                  primary: false,
                },
                {
                  metric: 'Full-Time Placement',
                  desc: 'W-2 employment at accounting firms, payroll departments, or tax offices. Wage documentation.',
                  primary: false,
                },
                {
                  metric: 'Self-Employment',
                  desc: 'Documented income generation under structured mentorship. Viability and income verified per WIOA allowances.',
                  primary: false,
                },
              ].map((item) => (
                <div
                  key={item.metric}
                  className={`rounded-lg p-5 border ${item.primary ? 'bg-brand-green-50 border-brand-green-200' : 'bg-white border-slate-200'}`}
                >
                  <h3
                    className={`font-bold text-sm mb-2 ${item.primary ? 'text-brand-green-800' : 'text-slate-900'}`}
                  >
                    {item.metric}
                  </h3>
      ...
      <section className="py-8 border-t border-slate-100">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-center text-xs font-semibold text-black uppercase tracking-wider mb-4">
            Recognized By
          </p>
