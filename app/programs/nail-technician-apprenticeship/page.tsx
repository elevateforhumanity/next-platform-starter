      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-slate-600 text-sm mb-4">Start your nail technician apprenticeship today.</p>
            <Link href="/programs/nail-technician-apprenticeship/apply" className="text-brand-blue-600 hover:underline font-medium">
              Apply Now →
            </Link>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <h3 className="font-bold text-slate-900 mb-2">Find a Host Shop</h3>
            <p className="text-slate-600 text-sm mb-4">Connect with licensed nail salons.</p>
            <Link href="/programs/nail-technician-apprenticeship/host-shops" className="text-brand-blue-600 hover:underline font-medium">
              View Host Shops →
            </Link>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 p-6">
