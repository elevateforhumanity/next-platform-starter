...
export const metadata: Metadata = {
  ...
  description:
    'Explore funding options for the Nail Technician Apprenticeship — FSSA IMPACT for SNAP/TANF recipients, employer sponsorship, or self-pay with flexible payments.',
};
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeroVideo
        ...
        belowHeroSubheadline="The Nail Technician Apprenticeship is not on Indiana's ETPL and does not qualify for WIOA or Workforce Ready Grant. FSSA IMPACT (SNAP/TANF), employer sponsorship, and self-pay are all available."
        ctas={[
          {
      ...
      <section className="py-12 bg-slate-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <ProgramFundingGate
            ...
            selfPayCost="$5,000"
            depositAmount="$1,750"
            depositHref="https://buy.stripe.com/cNicN52UU4QS4NZ1AZgIo06"
            fullPayHref="https://buy.stripe.com/bJedR91QQgzAfsD0wVgIo05"
          />
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-600 mb-4">
            ...
            listed on Indiana&rsquo;s Eligible Training Provider List (ETPL). The Nail Technician
