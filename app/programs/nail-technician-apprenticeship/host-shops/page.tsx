...
export const metadata: Metadata = {
  ...
  description:
    'Partner with Elevate for Humanity as a host nail salon for our DOL-registered nail technician apprenticeship. Train the next generation of licensed nail technicians.',
  alternates: {
