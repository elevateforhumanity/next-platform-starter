...
export default async function EnrollmentSuccessPage() {
  ...
  const programName =
    (enrollment.programs as { name?: string })?.name || 'Tax Prep & Financial Services';
      ...
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-emerald-400 font-bold text-sm uppercase tracking-widest mb-2">
            Financial Services Career Track
          </p>
        ...
        <div className="bg-slate-800 rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-3">
            {[
              {
                n: 1,
                title: 'Start Tax Preparation track',
                desc: 'Federal tax law, 1040 preparation, deductions, and credits',
              },
              {
                n: 2,
                title: 'Start Bookkeeping & QuickBooks track',
                desc: 'Accounts payable/receivable, payroll, financial statements',
              },
              {
                n: 3,
                title: 'Obtain your IRS PTIN',
                desc: 'Required to prepare tax returns for compensation',
              },
              {
                n: 4,
                title: 'Earn QuickBooks Certification',
                desc: 'Intuit-recognized credential — included in your program',
              },
            ].map(({ n, title, desc }) => (
        ...
        <Link
          href="/login"
          className="block w-full bg-emerald-500 hover:bg-emerald-600 text-white text-center py-5 rounded-xl font-bold text-lg transition-all hover:scale-[1.02] shadow-lg mb-3"
        >
        ...
        <div className="text-center space-y-1">
          ...
          <a
            ...
            className="text-emerald-400 hover:underline text-sm flex items-center justify-center gap-1"
          >
