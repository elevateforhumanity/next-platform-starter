...
export const metadata: Metadata = {
  ...
  description: 'Apply for our Medical Assistant program. Free training with WIOA funding available.',
};
    ...
    <main className="min-h-screen bg-white">
      <div className="bg-blue-900 text-white py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          />
          <h1 className="text-3xl md:text-4xl font-bold">Apply for Medical Assistant</h1>
