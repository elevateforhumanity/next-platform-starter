    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12">
        <div className="max-w-2xl mx-auto px-4 space-y-4">
          <Link
            href="/programs/cosmetology-apprenticeship/apply/apprentice"
          ...
          >
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                I want to enroll in the cosmetology apprenticeship program as a student.
              </p>
            </div>
          </Link>

          <Link
            href="/programs/cosmetology-apprenticeship/apply/partner-salon"
