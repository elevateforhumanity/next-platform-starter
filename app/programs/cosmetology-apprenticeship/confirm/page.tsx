    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/programs/cosmetology-apprenticeship/apply" className="px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition">Try Again</Link>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Your deposit for the Cosmetology Apprenticeship has been received.</p>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <div className="w-6 h-6 bg-purple-100 text-purple-700 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold mt-0.5">{i + 1}</div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link href="/signup?role=apprentice&redirect=/programs/cosmetology-apprenticeship/orientation" className="flex-1 text-center py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition">Create Account &amp; Continue</Link>
...
export default function CosmetologyConfirmPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-purple-600" /></div>}><ConfirmContent /></Suspense>;
}
