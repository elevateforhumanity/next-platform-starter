...
import { Shield, Sparkles, BookOpen, Clock, Phone } from 'lucide-react';

export const dynamic = 'force-dynamic';

export const metadata: Metadata = {
  title: 'Enrolled | Cosmetology Apprenticeship | Elevate for Humanity',
  description: 'Your enrollment in the USDOL Registered Cosmetology Apprenticeship is confirmed.',
};
