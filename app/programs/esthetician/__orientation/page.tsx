...
export default function EstheticianOrientationPage() {
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 mt-4">
            <div className="bg-rose-50 p-4 rounded-lg">
              ...
              <p className="text-rose-800 text-sm">{config.ojtDescription}</p>
            </div>
            <div className="bg-rose-50 p-4 rounded-lg">
              <h4 className="font-bold text-rose-900">Related Technical Instruction (RTI)</h4>
              <p className="text-rose-800 text-sm">{config.rtiDescription}</p>
            </div>
          </div>
          <p className="text-sm text-black mt-4">
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      router.push('/programs/esthetician/documents');
    }
  };
          ...
          <div className="px-6 pb-6 flex items-center justify-between">
            ...
            {isLastSection ? (
              <button
                ...
                className="px-8 py-3 bg-rose-600 text-white font-bold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-rose-700 transition"
              >
