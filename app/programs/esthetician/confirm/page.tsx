    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/programs/esthetician/apply" className="px-6 py-3 bg-pink-600 text-white font-bold rounded-lg hover:bg-pink-700 transition">Try Again</Link>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-pink-600 rounded-full flex items-center justify-center mx-auto mb-5 shadow-lg">
            <CheckCircle2 className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-3xl font-black text-slate-900 mb-2">Payment Confirmed</h1>
          <p className="text-slate-600">Your deposit for the Esthetician Program has been received.</p>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <div className="w-6 h-6 bg-pink-100 text-pink-700 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold mt-0.5">{i + 1}</div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link href="/signup?role=apprentice&redirect=/programs/esthetician/orientation" className="flex-1 text-center py-3 bg-pink-600 text-white font-bold rounded-lg hover:bg-pink-700 transition">Create Account &amp; Continue</Link>
...
export default function EstheticianConfirmPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-pink-600" /></div>}><ConfirmContent /></Suspense>;
}
