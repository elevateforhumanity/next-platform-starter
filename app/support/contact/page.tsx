...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    desc: 'Issues with your student portal, login, or course access.',
    href: '/support',
  },
  {
    title: 'Program Information',
    desc: 'Details about specific training programs, schedules, or certifications.',
    href: '/programs',
  },
  {
  ...
  },
  {
    ...
    desc: 'Job placement, resume help, or employer connections.',
    href: '/career-services',
  },
  {
    title: 'Grievance or Complaint',
    desc: 'File a formal grievance or report a concern.',
    href: '/grievance',
  },
];
...
// IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback)
            ...
            {CONTACT_METHODS.map((m) => {
              ...
              return (
                <a
                  key={m.title}
                  href={m.href}
                  className="bg-white border border-slate-200 rounded-xl p-6 text-center hover:shadow-md hover:border-brand-blue-300 transition-all group"
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {HELP_TOPICS.map((t) => (
              <Link
                key={t.title}
                href={t.href}
                className="bg-white border border-slate-200 rounded-lg p-5 hover:shadow-sm hover:border-brand-blue-300 transition-all"
              >
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 inline-block">
