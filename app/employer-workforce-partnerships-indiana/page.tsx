...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og-default.jpg', width: 1200, height: 630, alt: 'Employer Workforce Partnerships Indiana' }],
    type: 'website',
  },
  twitter: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'DOL-registered apprenticeships are work-based learning programs that combine paid on-the-job training with related technical instruction. Apprentices earn wages while learning. Elevate for Humanity is a DOL-registered apprenticeship sponsor and can work with employers to develop or join apprenticeship programs.',
  },
  {
    question: 'What industries and occupations does Elevate for Humanity train in?',
    answer:
  ...
  },
  {
    ...
    answer:
      'There is no recruiting fee for employer partners accessing trained candidates from Elevate for Humanity programs. Some OJT and apprenticeship coordination services may have associated administrative steps — contact us for current details.',
  },
  {
      ...
      <SeoAuthorityHubPage
        ...
        pathways={[
          ...
          },
          {
            ...
            description:
              'DOL-registered apprenticeship programs combining paid employment with structured technical instruction. Elevate for Humanity is a registered apprenticeship sponsor.',
          ...
          },
          {
            ...
            description:
              'Host clinical hours, lab components, or OJT placements for healthcare and trades programs. Support Elevate for Humanity students while building your own workforce pipeline.',
            href: '/contact',
          },
          {
            name: 'Customized Training',
            description:
              'Work with Elevate for Humanity to design training programs tailored to your industry, occupation, and workforce development goals.',
            href: '/contact',
          },
        ]}
        faqs={faqs}
        ...
        complianceNotes={[
          'OJT wage reimbursement eligibility and rates are determined by the applicable WIOA local workforce board and WorkOne office, not by Elevate for Humanity. Contact your local WorkOne Business Services representative to determine eligibility.',
          'Work Opportunity Tax Credit (WOTC) eligibility and credit amounts are governed by federal tax law and administered by the Indiana Department of Workforce Development (DWD). Consult a qualified tax advisor or CPA for guidance on your specific situation. Elevate for Humanity does not provide tax advice.',
