...
export const metadata: Metadata = {
  ...
  description:
    'Step-by-step video tutorials to help you get the most out of the Elevate LMS platform.',
};
      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <p className="text-slate-500 text-sm">
            Apply migration{' '}
            <code className="bg-slate-100 px-1 rounded">20260528000001_tutorials_table.sql</code> in
            the Supabase Dashboard to enable this page.
          </p>
        </div>
      </div>
    );
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-slate-500">
            Step-by-step guides to help you get the most out of Elevate LMS.
          </p>
        </div>
      </div>
      <div className="max-w-6xl mx-auto px-4 py-10">
