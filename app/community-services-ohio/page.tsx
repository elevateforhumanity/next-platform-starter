...
export const metadata: Metadata = {
  ...
  description: 'Trusted community services in Ohio. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: ['community services Ohio', 'job placement Ohio', 'family services Columbus', 'housing assistance Cleveland'],
}

export default function CommunityServicesOhioPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">
          Community Services in Ohio
        </h1>
        <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Ohio families. We connect Ohioans with resources
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <Link href="/career-training-ohio" className="text-blue-600 hover:underline block">
