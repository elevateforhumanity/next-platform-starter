  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        ...
        <Image
          src="/images/pages/partner-page-10.jpg"
            ...
            <div className="bg-white rounded-lg p-6 text-left space-y-4 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Our team will review your application within 1-3 business days. We'll notify you
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Once approved, you'll receive a magic link to activate your Partner Dashboard
                    and start hosting apprentices.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Connect your bank account or Elevate Pay Card and submit your W-9 so you can
                    receive payroll deposits and program revenue.
                  </p>
                </div>
              </div>
            </div>
