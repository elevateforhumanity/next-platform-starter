      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-700 mt-1">Key metrics and organizational KPIs</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-700">Enrollment Rate</p>
                <p className="text-3xl font-bold text-slate-900 mt-1">{enrollmentRate}%</p>
                <p className="text-sm text-slate-700 mt-1">Lead to enrollment</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900 mt-1">{employerContacts || 0}</p>
                <p className="text-sm text-slate-700 mt-1">of {totalContacts || 0} contacts</p>
              </div>
              <div className="w-12 h-12 bg-brand-blue-100 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-700">WOTC Approval Rate</p>
                <p className="text-3xl font-bold text-slate-900 mt-1">{wotcApprovalRate}%</p>
                <p className="text-sm text-slate-700 mt-1">{approvedWotc || 0} of {wotcApplications || 0}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Course Stats */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">Course Overview</h2>
            <div className="flex items-center gap-8 mb-6">
              <div className="text-center">
                <p className="text-4xl font-bold text-slate-900">{totalCourses || 0}</p>
                <p className="text-sm text-slate-700">Total Courses</p>
              </div>
              <div className="text-center">
          ...
          {/* Program Performance */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">Courses by Category</h2>
            {Object.keys(categoryStats).length === 0 ? (
              <p className="text-slate-700 text-center py-4">No course data available.</p>
            ) : (
                ...
                {Object.entries(categoryStats).map(([category, stats]) => (
                  <div key={category}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm text-slate-700">{stats.published}/{stats.total} published</span>
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-slate-900">{totalLeads || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Enrolled</span>
                <span className="font-semibold text-slate-900">{enrolledLeads || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Conversion Rate</span>
                <span className="font-semibold text-slate-900">{enrollmentRate}%</span>
              </div>
            </div>
          ...
          {/* WOTC Metrics */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">WOTC Applications</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Total Applications</span>
                <span className="font-semibold text-slate-900">{wotcApplications || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Approved</span>
                <span className="font-semibold text-slate-900">{approvedWotc || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Approval Rate</span>
                <span className="font-semibold text-slate-900">{wotcApprovalRate}%</span>
              </div>
            </div>
          ...
          {/* Contact Stats */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">CRM Contacts</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Total Contacts</span>
                <span className="font-semibold text-slate-900">{totalContacts || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Employer Partners</span>
                <span className="font-semibold text-slate-900">{employerContacts || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-700">Partner Rate</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="font-medium text-slate-900">WOTC</span>
            </Link>
          </div>
        </div>
      </div>
