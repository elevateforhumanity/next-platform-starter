    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-700 mt-2">Manage all platform users</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-4">
          <p className="text-sm text-slate-700">Employers</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border mb-6">
        <div className="p-4 flex flex-wrap gap-4 items-center">
          ...
          <span className="text-sm text-slate-700">{filteredUsers.length} users</span>
        </div>
      </div>
            ...
            {filteredUsers.length > 0 ? (
              filteredUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-700">{user.id.slice(0, 8)}...</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      user.is_active !== false ? 'bg-brand-green-100 text-brand-green-700' : 'bg-gray-100 text-slate-700'
                    }`}>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-lg w-full mx-4">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                />
                {editingUser && <p className="text-xs text-slate-700 mt-1">Email cannot be changed</p>}
              </div>
              <div>
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="is_active" className="text-sm text-slate-900">Active user</label>
              </div>
