...
export const metadata: Metadata = generateResourceMetadata({
  ...
  description:
    'Understand the general process of filing a tax return, from preparation through submission and refund processing.',
  path: PAGE_PATH,
});
    ...
    <ResourcePageTemplate
      ...
      overview={
        <div className="space-y-4 text-slate-700">
          <p>
            ...
            completing required forms, and submitting them to the appropriate tax authority. The
            process can be completed electronically or by mail, with electronic filing being the
            most common method due to faster processing times.
          </p>
          <p>
            Understanding each step of the process can help you prepare effectively and reduce the
            likelihood of delays or errors during filing.
          </p>
        </div>
      }
      howItWorks={{
      ...
      timingAndVariability={{
        ...
        content: (
          <div className="space-y-4 text-slate-700">
            <p>
              Processing times can vary based on several factors. Electronic filing is generally
              processed faster than paper filing. Returns that require additional review may take
              longer to process.
            </p>
            <p>
              Peak filing periods, such as the weeks leading up to tax deadlines, may also affect
              processing times due to higher volume. Ensuring your return is complete and accurate
              before submission can help minimize delays.
            </p>
          </div>
        ),
      }}
      faqs={[
        {
          ...
          answer:
            'Common documents include income statements (W-2s, 1099s), identification information, and records of deductions or credits you plan to claim. The specific documents needed depend on your individual situation.',
        },
        {
          question: 'How long does it take to get a refund?',
          answer:
            'Refund timing varies based on filing method, completeness of the return, and processing requirements. Electronic filing with direct deposit is typically the fastest method.',
        },
        {
          question: 'What happens if there is an error on my return?',
          answer:
            'Errors may result in processing delays or requests for additional information. Reviewing your return carefully before submission can help reduce the likelihood of errors.',
        },
        {
          question: 'Can I file taxes electronically?',
          answer:
            'Yes, electronic filing is available and is the most common method used today. It allows for faster submission and confirmation compared to paper filing.',
        },
      ]}
      ...
      governanceLinks={[{ href: '/governance/security', label: 'Security & Data Protection' }]}
    />
  );
}
