...
export const metadata: Metadata = generateResourceMetadata({
  ...
  description:
    'Learn about general refund timelines after filing taxes and understand why processing times can vary.',
  path: PAGE_PATH,
});
      ...
      overview={
        <div className="space-y-4 text-slate-700">
          <p>
            ...
            whether all information was complete and accurate, and the current processing volume at
            the tax authority.
          </p>
          <p>
            Understanding these factors can help set realistic expectations about when a refund
            might be received. This page provides general information about the refund process and
            common reasons for variations in timing.
          </p>
        </div>
      }
      howItWorks={{
      ...
      timingAndVariability={{
        ...
        content: (
          <div className="space-y-4 text-slate-700">
            ...
            <p className="mt-4">
              Delays do not necessarily indicate a problem with the return. Many delays are routine
              and resolve without any action needed from the filer.
            </p>
          </div>
        ),
      }}
      faqs={[
        {
          ...
          answer:
            'Many tax authorities provide online tools to check refund status. Status updates typically reflect processing stages rather than exact payment dates. The IRS offers "Where\'s My Refund?" for federal returns.',
        },
        {
          question: 'Is direct deposit faster than a paper check?',
          answer:
            'Yes, direct deposit is generally faster because it eliminates mail delivery time. Once a refund is approved, direct deposit typically arrives within a few business days.',
        },
        {
          question: 'What if my refund is taking longer than expected?',
          answer:
            'Extended processing times can occur for various reasons. If significantly more time has passed than typical processing periods, you may want to check your refund status or contact the tax authority for more information.',
        },
        {
          question: 'Does filing early mean I get my refund faster?',
          answer:
            'Filing early can help avoid peak processing periods, but refund timing still depends on the completeness and accuracy of the return, as well as any review requirements.',
        },
      ]}
