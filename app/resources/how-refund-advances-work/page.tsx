...
} from '@/components/templates/ResourcePageTemplate';

const PAGE_PATH = '/resources/how-refund-advances-work';
const LAST_REVIEWED = new Date().toLocaleDateString('en-US', {
  year: 'numeric',
  month: 'long',
  day: 'numeric',
});
...
export const metadata: Metadata = generateResourceMetadata({
  ...
  description:
    'Understand how refund-based advances typically work, including eligibility, repayment, and the optional nature of these services.',
  path: PAGE_PATH,
});
    ...
    <ResourcePageTemplate
      ...
      overview={
        <div className="space-y-4 text-slate-700">
          <p>
            A refund-based advance is a financial product that allows eligible tax filers to receive
            a portion of their expected tax refund before the refund is officially processed and
            issued by the tax authority.
          </p>
          <p>
            These advances are typically offered after a tax return has been completed and are
            repaid directly from the tax refund when it is issued. Understanding how these products
            work can help individuals make informed decisions about whether to use them.
          </p>
        </div>
      }
      howItWorks={{
        ...
        content: (
          <div className="space-y-4 text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Eligibility varies:</strong> Not everyone who files a tax return will be
                eligible for an advance. Eligibility depends on multiple factors.
              </li>
              <li>
                <strong>Amounts vary:</strong> The amount available as an advance is typically a
                portion of the expected refund, not the full amount.
              </li>
              <li>
                <strong>Terms and conditions apply:</strong> Specific terms, including any fees or
                conditions, vary by provider and should be reviewed before accepting.
              </li>
              <li>
                <strong>Refund changes:</strong> If the actual refund amount differs from the
                estimate, this may affect the advance or repayment.
              </li>
            </ul>
          </div>
        ),
      ...
      faqs={[
        {
          ...
          answer:
            'No. Choosing to file a tax return does not require selecting a refund-based advance. Filing can be completed without using this option. The advance is an optional service.',
        },
        {
          question: 'How is the advance repaid?',
          answer:
            'If an advance is provided, it is typically repaid directly from the tax refund when the refund is issued by the tax authority. The filer does not make separate payments before the refund arrives.',
        },
        {
          question: 'What if my refund is less than expected?',
          answer:
            'If the actual refund amount differs from the estimate used for the advance, this may affect the repayment. Specific terms vary by provider and should be reviewed before accepting an advance.',
        },
        {
          question: 'Are there fees associated with refund advances?',
          answer:
            'Terms and conditions, including any fees, vary by provider. This information should be reviewed and understood before accepting any advance offer.',
        },
        {
          question: 'How quickly can I receive an advance?',
          answer:
            'Timing varies by provider and method of delivery. Specific timing information is typically provided when an advance offer is presented.',
        },
      ]}
      ...
      relatedResources={[
        { href: '/resources/how-tax-filing-works', label: 'How Tax Filing Works' },
        {
          ...
          label: 'Tax Refund Timelines: What to Expect',
        },
        {
          href: '/resources/understanding-tax-prep-fees',
          label: 'Understanding Tax Preparation Fees',
        },
      ]}
      governanceLinks={[
