    ...
    <>
      ...
      <div className="relative mb-8">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-lg text-slate-900 placeholder-slate-500 border border-slate-300 focus:ring-2 focus:ring-brand-blue-500 focus:border-brand-blue-500"
      ...
      <div className="space-y-4" role="list" aria-label="Frequently asked questions">
        {filteredFaqs.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-slate-600">No questions match your search.</p>
          </div>
        ) : (
            ...
            >
              ...
              >
                <div className="flex items-start gap-4">
                  <HelpCircle
                    className="w-6 h-6 text-brand-orange-500 flex-shrink-0 mt-0.5"
                    aria-hidden="true"
                  />
