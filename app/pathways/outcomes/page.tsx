...
export const metadata: Metadata = {
  ...
  description:
    'What each Elevate training program leads to: credentials, salaries, employers, day-to-day training, and funding coverage. Real data from real programs.',
...
const PROGRAMS = [
  {
    ...
    funding:
      'If you qualify for WIOA funding, the program is covered at no cost — tuition, materials, clinical placement, and the state exam fee. Job Ready Indy funding is also available for justice-impacted individuals.',
    nextStep:
  ...
  },
  {
    ...
    issuedBy:
      'Indiana Professional Licensing Agency (PLA) through a U.S. Department of Labor Registered Apprenticeship',
    whatItMeans:
    ...
    training:
      'You train at a real barbershop under a licensed barber instructor. You learn haircutting techniques (fades, tapers, lineups), clipper and shear mastery, shaving and beard grooming, sanitation and safety (Indiana State Board standards), client consultation, customer service, and business management. Elevate coordinates apprenticeship registration, compliance paperwork, classroom instruction, and completion documentation.',
    duration:
      'Approximately 18 months (1,500 on-the-job training hours plus required classroom instruction)',
    examDay:
  ...
  },
  {
    ...
    examDay:
      'AWS certification testing is administered by an AWS Authorized Test Facility (ATF) with a Certified Welding Inspector (CWI). Elevate coordinates scheduling. OSHA 10 is completed in the first weeks.',
    whoHires: [
  ...
  },
  {
    ...
    issuedBy: 'Certiport',
    whatItMeans:
      'The IT Specialist certification validates entry-level IT skills — hardware troubleshooting, software installation, device configuration, and end-user support. Recognized by employers as proof you can handle day-one help desk responsibilities. Elevate is a Certiport Authorized Testing Center, so you take the exam on-site.',
    training:
      'You learn PC hardware, Windows/macOS/Linux basics, software troubleshooting, remote support tools, networking fundamentals, and customer service. Includes hands-on labs and Certiport exam prep.',
    duration: '8 weeks',
    examDay:
      'You take the Certiport IT Specialist exam on-site at our Indianapolis Training Center. Practice tests are included in the program.',
    whoHires: [
    ...
    funding:
      'If you qualify for WIOA or Job Ready Indy funding, the program is covered for eligible participants. Remote work is available in many IT support roles.',
    nextStep:
      'IT Help Desk leads to Cybersecurity Analyst, Network Support Technician, or Software Development. This is a defined career ladder: help desk → systems administrator → network engineer → cybersecurity analyst.',
  },
  {
    ...
    issuedBy: 'Certiport',
    whatItMeans:
      'The IT Specialist — Cybersecurity certification validates your knowledge of threat detection, network security, incident response, and security operations. Information security analysts are a 4-star DWD Top Job in Indiana with an average salary of $91,749.',
    training:
      'You learn network security, threat analysis, malware detection, firewalls, IDS/IPS, SIEM tools, encryption, access control, and compliance frameworks. Includes hands-on labs and Certiport exam prep.',
    duration: '12 weeks',
    examDay:
      'You take the Certiport IT Specialist — Cybersecurity exam on-site at our Indianapolis Training Center. Practice tests are included.',
    whoHires: [
    ...
    funding:
      'If you qualify for WIOA or Job Ready Indy funding, the program is covered for eligible participants. Remote work is standard in cybersecurity.',
    nextStep:
      'Cybersecurity Analyst leads to advanced roles in penetration testing, security engineering, and security architecture. Senior cybersecurity professionals earn $100K+.',
  },
];
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[280px] sm:h-[360px] overflow-hidden">
        <Image
          src="/images/pages/pathways-page-1.jpg"
          alt="Graduates celebrating credential completion"
          fill
          sizes="100vw"
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-gray-700 space-y-4">
            <p>
              This page explains exactly what each Elevate training program leads to — in plain
              English. What credential you earn, who issues it, who hires you, what they pay, what
              your training looks like day to day, and what funding covers.
            </p>
            <p>
              Every credential listed below is issued by a recognized third-party authority — a
              government agency, a national certification body, or a federal department. Elevate
              prepares you for the exam. The credential itself comes from the issuing authority.
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                  ...
                  <Link
                    href="/funding"
                    className="bg-white hover:bg-white text-brand-blue-700 border-2 border-brand-blue-200 px-5 py-2.5 rounded-lg font-bold text-sm transition"
                  >
      ...
      <section className="py-14 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto">
            Not sure where to start? Check your eligibility — it takes about 5 minutes. We will help
            you find the right program and the right funding.
          </p>
