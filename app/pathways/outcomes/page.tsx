    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-blue-600 text-white py-16 mt-12">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 mb-8">Check your eligibility for free or funded training today.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/apply" className="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold hover:bg-blue-50 transition">
              Apply Now
            </Link>
            <Link href="/programs" className="bg-blue-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-blue-400 transition border-2 border-white/30">
              View All Programs
            </Link>
          </div>
        </div>
