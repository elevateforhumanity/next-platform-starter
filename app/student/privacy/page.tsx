          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-8">
              <p className="text-sm text-black">
                Manage your privacy preferences and data sharing consents. You can update these
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {item.required && (
                            <span className="text-xs bg-red-100 text-red-800 px-2 py-2 rounded">
                              Required
                            </span>
                          )}
                        </div>
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <p className="text-black mb-4">
                You have the right to request deletion of your personal data, subject to legal
