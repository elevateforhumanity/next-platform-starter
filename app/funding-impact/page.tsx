...
export const metadata: Metadata = {
  ...
  description:
    'See the measurable impact of WIOA, WRG, DOL, and FSSA workforce funding at Elevate for Humanity — credential attainment, job placement, and wage outcomes.',
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-4xl mx-auto px-4 pb-10 w-full">
            ...
            <p className="text-slate-200 text-lg max-w-2xl">
              Real outcomes from WIOA, WRG, DOL, and FSSA investment — credential attainment, job
              placement, and wage growth for Indiana workers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 px-4 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-slate-600 mb-8">
            Elevate for Humanity is approved to receive funding from multiple federal and state
            workforce programs.
          </p>
      ...
      <section className="py-14 px-4 bg-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-slate-300 mb-8">
            Most participants qualify for funded training through WIOA, WRG, or FSSA. Find out which
            programs you're eligible for.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/eligibility"
              className="rounded-lg bg-brand-red-600 px-6 py-3 font-semibold text-white hover:bg-brand-red-700 transition"
            >
              Check Eligibility
            </Link>
            <Link
              href="/funding"
              className="rounded-lg border border-white px-6 py-3 font-semibold text-white hover:bg-white/10 transition flex items-center gap-2"
            >
