          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-white/80 mt-2 max-w-xl">
                Connect with nurses, CNAs, medical assistants, and healthcare workers. Share
                clinical tips, certification advice, and career support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <GroupDiscussions
              ...
              accentClass="bg-brand-red-600 hover:bg-brand-red-700"
            />
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Certification Guides</div>
                    <div className="text-xs text-slate-700">CNA, MA, Phlebotomy prep</div>
                  </div>
                </Link>
                <Link
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Clinical Tips</div>
                    <div className="text-xs text-slate-700">Best practices from the field</div>
                  </div>
                </Link>
                <Link
                  href="/employer"
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Job Placement</div>
                    <div className="text-xs text-slate-700">Healthcare employer connections</div>
                  </div>
                </Link>
              </div>
            </div>
