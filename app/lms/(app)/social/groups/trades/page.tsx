          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-white/80 mt-2 max-w-xl">
                Connect with electricians, plumbers, HVAC techs, and construction professionals.
                Share tips, job leads, and industry knowledge.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <GroupDiscussions
              groupSlug="trades"
              accentClass="bg-brand-orange-600 hover:bg-brand-orange-700"
            />
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Apprenticeship Guide</div>
                    <div className="text-xs text-slate-700">How to start your trade career</div>
                  </div>
                </Link>
                <Link
                  href="/lms/dashboard"
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Tool Reviews</div>
                    <div className="text-xs text-slate-700">Community-recommended tools</div>
                  </div>
                </Link>
                <Link
                  href="/employer"
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Job Board</div>
                    <div className="text-xs text-slate-700">Local trade job listings</div>
                  </div>
                </Link>
              </div>
            </div>
