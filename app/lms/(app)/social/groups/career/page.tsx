            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Resume Templates</div>
                    <div className="text-xs text-slate-700">Career change resume examples</div>
                  </div>
                </Link>
                <Link
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Interview Prep</div>
                    <div className="text-xs text-slate-700">Common questions and tips</div>
                  </div>
                </Link>
                <Link
                  href="/events"
                ...
                >
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-slate-900 text-sm">Networking Events</div>
                    <div className="text-xs text-slate-700">Upcoming virtual meetups</div>
                  </div>
                </Link>
              </div>
            </div>
