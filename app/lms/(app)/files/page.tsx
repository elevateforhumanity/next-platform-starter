        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-slate-700 mt-2">Course materials and downloads</p>
            </div>
            <Link
              href="/lms/files"
              ...
              files.map((file: any) => (
                <div key={file.id} className="p-4 flex items-center justify-between hover:bg-white">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-brand-blue-100 rounded flex items-center justify-center">
                      <svg
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-700">
                        {file.file_size || 'N/A'} • {new Date(file.created_at).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                  {file.file_url ? (
