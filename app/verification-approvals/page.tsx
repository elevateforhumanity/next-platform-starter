...
export const metadata: Metadata = {
  ...
  description:
    'Elevate for Humanity Career & Technical Institute is committed to transparency in how we deliver training and track outcomes.',
      ...
      <section className="bg-slate-900 py-16 px-4 mt-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-300 text-lg max-w-2xl">
            Elevate for Humanity Career &amp; Technical Institute is committed to transparency in
            how we deliver training and track outcomes.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Programs are designed to prepare participants for nationally recognized certifications issued by the respective certifying organizations.',
              },
              {
                icon: <TrendingUp className="w-5 h-5 text-brand-red-600" />,
                title: 'Career Readiness Training',
                desc: 'Structured pathways that build job-ready skills aligned with high-demand industries.',
              },
              {
      ...
      <section className="py-14 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            Participants and partners can verify the following through our platform or by contacting
            us directly:
          </p>
          ...
          <p className="text-slate-500 text-sm mt-6">
            To submit a verification request, contact:{' '}
            <a
      ...
      <section className="py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            We work alongside employers, nonprofits, and workforce agencies to ensure training
            translates into employment opportunities. Program design is informed by real labor
            market demand and partner feedback.
          </p>
          <p className="text-slate-600 leading-relaxed">
            Our programs are designed to align with WIOA, Indiana Workforce Ready Grant, and DOL
            apprenticeship standards where applicable.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 px-4 bg-amber-50 border-y border-amber-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-700 leading-relaxed">
            We are actively expanding our partnerships and pursuing additional approvals and
            recognitions where appropriate. Elevate for Humanity Career &amp; Technical Institute is{' '}
            <strong>not currently approved as a postsecondary institution</strong> through the
            Indiana Department of Education. Our focus remains on delivering measurable outcomes and
        ...
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            <h2 className="text-xl font-bold text-white mb-2">
              Funders, Employers &amp; Agency Partners
            </h2>
            <p className="text-slate-500 text-sm">
              If you are seeking verification or partnership information, contact us directly.
            </p>
          </div>
          <Link
            href="mailto:support@elevateforhumanity.org"
