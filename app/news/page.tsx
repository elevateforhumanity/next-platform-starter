      ...
      <div className="relative h-56 sm:h-72 w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 max-w-6xl mx-auto px-4 pb-8">
          ...
          <p className="text-slate-600 mt-1 text-sm max-w-xl">
            Program announcements, success stories, and workforce development news from
            Indianapolis.
          </p>
        </div>
      </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {featured && (
                <Link
                  ...
                  className="group block mb-10 rounded-2xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-md transition-shadow"
                >
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {rest.map((post) => (
                    <Link
                      key={post.id}
                      href={`/news/${post.slug}`}
                      className="group block rounded-2xl border border-slate-200 overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all"
                    >
                      ...
                      <div className="p-4">
                        {post.category && (
                          <span className="text-[11px] font-semibold text-brand-blue-600 uppercase tracking-wide">
                            {post.category}
                          </span>
                        )}
            ...
            <aside className="w-full lg:w-64 flex-shrink-0 space-y-6">
                ...
                <div className="rounded-2xl border border-slate-200 p-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {categories.map((cat) => (
                      <span
                        key={cat}
                        className="inline-flex items-center gap-1 text-xs font-medium bg-white text-slate-700 px-3 py-1.5 rounded-full"
                      >
              ...
              <div className="rounded-2xl bg-brand-blue-50 border border-brand-blue-100 p-5">
                ...
                <p className="text-xs text-slate-600 mb-3">
                  Get program updates and workforce news delivered to your inbox.
                </p>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-1.5 text-sm font-semibold text-brand-blue-700 hover:underline"
                >
              ...
              <div className="rounded-2xl border border-slate-200 p-5">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    <Link href="/events" className="text-brand-blue-600 hover:underline">
                      Upcoming Events
                    </Link>
                  </li>
                  <li>
                    <Link href="/about" className="text-brand-blue-600 hover:underline">
                      About Elevate
                    </Link>
                  </li>
                  <li>
