...
export const metadata: Metadata = {
  ...
  description:
    'Short, focused training modules you can complete in hours, not weeks. Build skills quickly with micro-credentials.',
};
...
const CLASSES = [
  {
    ...
    duration: '4–6 hours',
    desc: 'American Heart Association aligned certification for healthcare and workplace safety. Free with WIOA.',
    href: '/programs/cpr-first-aid',
  },
  {
    title: 'Food Handler Certification',
    duration: '2–4 hours',
    desc: 'Required certification for food service workers in Indiana. Free with WIOA.',
    href: '/programs/food-handler',
  },
  {
    title: 'OSHA 10-Hour Safety',
    duration: '10 hours',
    desc: 'Workplace safety certification for construction and general industry. OSHA 10 card issued.',
    href: '/programs/osha-safety',
  },
  {
    title: 'OSHA 30-Hour Safety',
    duration: '30 hours',
    desc: 'Advanced workplace safety for supervisors and managers. OSHA 30 card issued.',
    href: '/programs/osha-30',
  },
  {
    title: 'Forklift Operator',
    duration: '4–8 hours',
    desc: 'OSHA-compliant forklift operator training and certification.',
    href: '/programs/forklift',
  },
  {
    title: 'Bloodborne Pathogens',
    duration: '2 hours',
    desc: 'Required training for healthcare workers on infection control. BBP certificate issued.',
    href: '/programs/bloodborne-pathogens',
  },
  {
    title: 'Microsoft Office Basics',
    duration: '6 hours',
    desc: 'Word, Excel, and Outlook fundamentals for the workplace.',
    href: '/programs',
  },
  {
    title: 'Customer Service Essentials',
    duration: '3 hours',
    desc: 'Communication, conflict resolution, and service skills.',
    href: '/programs',
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full">
        <div className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] lg:h-[65vh] min-h-[320px] w-full overflow-hidden">
          <Image
            src="/images/pages/micro-classes-hero.jpg"
            alt="Micro-classes"
            fill
        ...
        <div className="bg-white py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Short, focused training you can complete in hours — not weeks.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 text-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8 text-lg">
            Contact us to check availability and see if funding covers your micro-class.
          </p>
          <Link
            href="/contact"
