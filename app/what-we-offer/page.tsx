...
export default async function WhatWeOfferPage() {
  ...
  const { data: offerings } = (await supabase
    .from('offerings')
    .select(
      'id, title, description, category, icon, image_url, cta_label, cta_href, features, order_index',
    )
    .eq('status', 'active')
      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Training, credentials, apprenticeships, and career support — everything you need to
      ...
      {offerings && offerings.length > 0 ? (
                  ...
                  <div className="p-6">
                    ...
                    {offering.cta_label && offering.cta_href && (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-brand-blue-600 text-sm font-medium hover:text-brand-blue-800"
                      >
        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto px-4 text-center text-slate-500">
            <p>
              Offerings are being updated. Check back soon or{' '}
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8">
            Join learners who have launched careers through our programs.
          </p>
