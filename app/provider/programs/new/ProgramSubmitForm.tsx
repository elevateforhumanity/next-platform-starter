  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
        ...
        {inp('Program Title', 'title', {
          required: true,
          placeholder: 'HVAC Technician Certification',
        })}
        <div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
        ...
        <div className="flex gap-6">
          <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
            <input
              type="checkbox"
              checked={form.wioaApproved}
              onChange={(e) => set('wioaApproved', e.target.checked)}
          ...
          <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
            <input
              type="checkbox"
              checked={form.fundingEligible}
              onChange={(e) => set('fundingEligible', e.target.checked)}
              className="rounded border-slate-300 text-brand-blue-600 focus:ring-brand-blue-500"
            />
            Funding Eligible
          </label>
