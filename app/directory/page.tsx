...
const resources = [
  {
    ...
    desc: 'State job board and career services portal',
    url: 'https://www.indianacareerconnect.com',
  },
  {
    name: 'OSHA Training',
    desc: 'Workplace safety certification information',
    url: 'https://www.osha.gov',
  },
  {
    name: 'HSI (Health & Safety Institute)',
    desc: 'CPR/AED/First Aid certification',
    url: 'https://hsi.com',
  },
  {
    name: 'Indiana PLA',
    desc: 'Professional Licensing Agency — barber and cosmetology licensing',
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Workforce development partners, government agencies, and community resources.
          </p>
        </div>
      </section>
      {/* Partners */}
                  ...
                  <div className="w-14 h-14 rounded-lg bg-white flex items-center justify-center flex-shrink-0">
                    {p.logo ? (
                      <Image
                        ...
                        width={40}
                        height={40}
                        className="w-10 h-10 object-contain"  sizes="(max-width: 768px) 100vw, 50vw"
                      />
                    ) : (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      {p.url && (
                        <a
                          ...
                          className="text-sm text-brand-blue-600 hover:underline flex items-center gap-1 flex-shrink-0"
                        >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {resources.map((r) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block bg-white rounded-xl p-5 border border-slate-200 hover:border-brand-blue-300 hover:shadow-sm transition group"
              >
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-600 mb-8">
            Employers, workforce agencies, and community organizations — let&apos;s connect.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-brand-red-600 hover:bg-brand-red-700 text-white px-8 py-4 rounded-full font-bold transition"
            >
