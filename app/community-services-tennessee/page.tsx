...
export const metadata: Metadata = {
  title: 'Community Services & Support in Tennessee | Elevate for Humanity',
  description: 'Trusted community services in Tennessee. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: ['community services Tennessee', 'job placement Tennessee', 'family services Nashville', 'housing assistance Memphis'],
}

export default function CommunityServicesTennesseePage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Trusted support services for Tennessee families. We connect Tennesseans with resources
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {[
            ...
            { title: 'Benefits Navigation', desc: 'TennCare, SNAP, TANF application assistance' },
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <Link href="/career-training-tennessee" className="text-blue-600 hover:underline block">
