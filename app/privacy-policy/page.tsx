...
function Section({
  ...
  return (
    <section id={id} className="scroll-mt-24">
      ...
      <div className="text-slate-700 leading-relaxed space-y-4 pl-8">{children}</div>
    </section>
  );
}
            ...
            <div className="sticky top-24">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                ...
                <ul className="space-y-1.5 text-sm">
                  ...
                  <li>
                    <Link href="/accessibility" className="text-brand-blue-600 hover:underline">
                      Accessibility Statement
                    </Link>
                  </li>
                  <li>
                    <Link href="/disclosures" className="text-brand-blue-600 hover:underline">
                      Disclosures
                    </Link>
                  </li>
                </ul>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-xl p-6">
              <p className="text-slate-800 leading-relaxed">
                {ORG_FULL} (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
                is committed to protecting the privacy of students, applicants, employers, and
                visitors who use our website, learning management system, and workforce training
                services. {LEGAL_ENTITY} is the data controller and legal operator of all services
                provided under the {ORG_NAME} brand. This policy describes how we collect, use,
                share, and safeguard personal information in compliance with the Family Educational
            ...
            <Section id="scope" number="01" title="Scope">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  The website at <strong>www.elevateforhumanity.org</strong> and all subdomains
                </li>
            ...
            <Section id="info-collected" number="02" title="Information We Collect">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Full name, date of birth, Social Security Number (for funding eligibility and tax
                  services only)
                </li>
                ...
                <li>
                  Financial information for tuition payments (processed by Stripe; we do not store
                  card numbers)
                </li>
                <li>
                  Tax return information (for tax preparation clients only, stored encrypted and
                  governed by a separate addendum)
                </li>
            ...
            <Section id="how-we-use" number="03" title="How We Use Information">
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Prepare and file tax returns (tax preparation clients, governed by separate
                  addendum)
                </li>
            ...
            <Section id="info-sharing" number="04" title="Information Sharing & Disclosure">
              <p>
                We do <strong>not</strong> sell personal information to third parties. We may share
                information with:
              </p>
              ...
              <div className="bg-white rounded-lg p-5 space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    Indiana DWD, WorkOne, EmployIndy — as required for WIOA, WRG, and Job Ready Indy
                    funding compliance and outcome reporting.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">U.S. Department of Labor</p>
                  <p className="text-sm">
                    Registered Apprenticeship program data, completion rates, and wage outcomes as
                    required by 29 CFR Part 29.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">Employer Partners</p>
                  <p className="text-sm">
                    With your written consent only — name, certifications earned, and program
                    completion status for job placement.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">Certification Bodies</p>
                  <p className="text-sm">
                    OSHA, HSI, state licensing boards — to verify and issue industry credentials.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">Service Providers</p>
                  <p className="text-sm">
                    Supabase (database), Stripe (payments), Netlify (hosting), Cloudflare
                    (CDN/storage), Resend (email), Sentry (error monitoring), Google Analytics
                    (analytics), OpenAI (AI features) — bound by data processing agreements.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">
                    Rise Forward Foundation (Supportive Services)
                  </p>
                  <p className="text-sm">
                    We may share limited information with Selfish Inc. (d/b/a Rise Forward
                    Foundation) to coordinate supportive services, including mental wellness
                    programming (CurvatureBody Sculpting). We share the minimum necessary data and
                ...
                <div className="border-t border-slate-200 pt-3">
                  ...
                  <p className="text-sm">
                    We may share limited information with approved training partners when required
                    to deliver instruction, clinical components, attendance verification,
                    credentialing, or program administration.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  <p className="font-semibold text-slate-900">IRS</p>
                  <p className="text-sm">
                    Tax return data for tax preparation clients — transmitted via IRS Modernized
                    e-File (MeF) system with end-to-end encryption. Governed by a separate privacy
                    addendum.
                  </p>
                </div>
                <div className="border-t border-slate-200 pt-3">
                  ...
                  <p className="text-sm">
                    When required by law, subpoena, court order, or to protect the safety of
                    individuals.
                  </p>
                </div>
              </div>
            ...
            <Section id="wioa" number="06" title="WIOA & Workforce Reporting">
              <p>
                ...
                Incentive (Job Ready Indy) funding are subject to federal and state reporting
              ...
              <p>
                ...
                secure, authorized channels. It is used solely for program evaluation and
                compliance.
              </p>
            </Section>
            ...
            <Section id="data-security" number="08" title="Data Security">
              ...
              <p>
                ...
                us immediately at{' '}
                <a href={`mailto:${ORG_EMAIL}`} className="text-brand-blue-600 hover:underline">
                  {ORG_EMAIL}
                </a>
                .
              </p>
            ...
            <Section id="your-rights" number="10" title="Your Rights">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  <strong>Complaint</strong> — File a complaint with the U.S. Department of
                  Education (for FERPA) or the Indiana Attorney General
                </li>
              </ul>
              <p>
            ...
            <Section id="children" number="11" title="Children's Privacy">
              <p>
                ...
                child under 13 has provided us with personal information, contact us immediately and
                we will delete it.
              </p>
              <p>
            ...
            <Section id="changes" number="13" title="Changes to This Policy">
              <p>
                ...
                with an updated effective date. Continued use of our services after changes
