...
const programs = [
  ...
  },
  {
    ...
    price: '$4,980',
    image: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=400&h=250&fit=crop',
  },
  {
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {programs.map((program) => (
            <div
              key={program.name}
              className="flex flex-col rounded-3xl bg-slate-900/80 overflow-hidden ring-1 ring-slate-800"
            >
              {/* Program Image */}
