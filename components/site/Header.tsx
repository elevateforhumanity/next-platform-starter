...
export const NAV_ITEMS = [
  {
    ...
    href: '/login',
    subItems: [
      { name: '— Learner —', href: '/login', isHeader: true },
      { name: 'Student Portal', href: '/login?redirect=/learner/dashboard' },
      { name: '— Partners —', href: '/login', isHeader: true },
  ...
  },
  {
    ...
    href: '/partners',
    subItems: [
      { name: 'Apprenticeship Hosts', href: '/partners/barbershop-apprenticeship', isSectionLink: true },
      { name: 'Barbershop Partners', href: '/partners/barbershop-apprenticeship', nested: true },
      { name: 'Cosmetology & Salon Partners', href: '/partners/cosmetology-apprenticeship', nested: true },
      { name: 'Training Sites & Facilities', href: '/partners/training-sites', nested: true },
      { name: 'Workforce & Reentry', href: '/agencies', isSectionLink: true },
      { name: 'For Workforce Agencies', href: '/agencies', nested: true },
      { name: 'SNAP E&T / IMPACT Partners', href: '/snap-et-partner', nested: true },
      { name: 'WorkOne / WIOA Referrals', href: '/partners/workforce', nested: true },
      { name: 'Reentry Organizations', href: '/partners/reentry', nested: true },
      { name: 'Job Ready Indy (JRI)', href: '/jri', nested: true },
      { name: 'Employers', href: '/for-employers', isSectionLink: true },
      { name: 'Employer Portal & Hiring', href: '/for-employers', nested: true },
      { name: 'Post a Job / OJT', href: '/ojt-and-funding', nested: true },
      { name: 'Hire Our Graduates', href: '/hire-graduates', nested: true },
      { name: 'Training Providers', href: '/partners/training-provider', isSectionLink: true },
      { name: 'Become a Training Provider', href: '/partners/training-provider', nested: true },
      { name: 'Apply as a Provider', href: '/partners/apply', nested: true },
      { name: 'Program Holder Portal', href: '/program-holder', nested: true },
