...
const NAV = [
  ...
  },
  {
    ...
    children: [
      {
        label: 'Indiana',
        href: '/supersonic-fast-cash/tax-preparation-indiana',
        image: '/images/pages/supersonic-page-10.jpg',
        desc: 'Indianapolis and statewide',
      },
      {
        label: 'Illinois',
        href: '/supersonic-fast-cash/tax-preparation-illinois',
        image: '/images/pages/supersonic-page-11.jpg',
        desc: 'Chicago metro and statewide',
      },
      {
        label: 'Ohio',
        href: '/supersonic-fast-cash/tax-preparation-ohio',
        image: '/images/pages/supersonic-page-12.jpg',
        desc: 'Columbus, Cleveland, Cincinnati',
      },
      {
        label: 'Tennessee',
        href: '/supersonic-fast-cash/tax-preparation-tennessee',
        image: '/images/pages/supersonic-fast-cash-page-1.jpg',
        desc: 'Nashville and statewide',
      },
      {
        label: 'Texas',
        href: '/supersonic-fast-cash/tax-preparation-texas',
        image: '/images/pages/supersonic-tax.jpg',
        desc: 'Dallas, Houston, and statewide',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        desc: 'Open positions at Supersonic',
      },
      {
        label: 'Tax Preparer Training',
        href: '/supersonic-fast-cash/training',
        image: '/images/pages/admin-tax-training-hero.jpg',
        desc: 'Get PTIN-certified and start earning',
      },
      {
        label: 'Competency Test',
        href: '/supersonic-fast-cash/careers/competency-test',
        image: '/images/pages/competency-test-hero.jpg',
        desc: 'Assess your tax knowledge',
      },
      {
        label: 'Open a Sub-Office',
        href: '/supersonic-fast-cash/multi-site',
        image: '/images/pages/supersonic-page-6.jpg',
        desc: 'Franchise and sub-office opportunities',
      },
    ],
  },
];
...
export default function SupersonicNav() {
  ...
  return (
    <nav
      ...
      aria-label="Supersonic Fast Cash navigation"
    >
            ...
            {NAV.map((item) => (
              <div key={item.label}>
                ...
                >
                  {item.label}
                  <ChevronDown
                    className={`w-4 h-4 transition-transform ${openMobileSection === item.label ? 'rotate-180' : ''}`}
                  />
                </button>
