      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center space-y-1.5 text-xs text-slate-500 max-w-3xl mx-auto">
          {showEstimateDisclaimer && (
            <p>
              Refund estimates are not guarantees. Actual refund amounts depend on IRS validation of
              your complete tax information.
            </p>
          )}
          <p>
            Final refund depends on IRS acceptance and processing. Refund advance is not a loan — it
            is an advance on your actual refund with zero interest and zero fees when you file with
            Supersonic Fast Cash.
          </p>
          {showNoUpfrontFee && (
            <p>
              No upfront fees required to start your return. Preparation fees are deducted from your
              refund or due at time of filing.
            </p>
          )}
          <p>
            Your documents are handled securely and are never shared with third parties without your
            explicit consent.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          {[
            ...
            <Link key={href} href={href} className="text-xs text-brand-red-600 hover:underline">
              {label}
            </Link>
          ))}
        </div>
