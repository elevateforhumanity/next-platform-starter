        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              ...
              className="px-7 py-3 bg-emerald-700 text-white font-bold rounded-xl hover:bg-emerald-800 transition-colors text-sm"
            >
              Get Free Tax Help
            </Link>
            <Link
              href="/tax/rise-up-foundation/site-locator"
              className="px-7 py-3 bg-white border-2 border-emerald-700 text-emerald-700 font-bold rounded-xl hover:bg-emerald-50 transition-colors text-sm"
            >
              Find a VITA Site
            </Link>
          </div>
