  ...
  return (
    <div>
        ...
        <div className="space-y-2">
          {[5, 4, 3, 2, 1].map((rating, index) => (
            <div key={rating} className="flex items-center gap-3">
              ...
              <span className="text-sm text-black w-8">{ratingCounts[index]}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-bold text-black">{reviews.length} Reviews</h3>
        <select
          value={sortBy}
        ...
        {sortedReviews.map((review) => (
          <div key={review.id} className="p-6 bg-slate-50 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-black">{review.author}</span>
                    {review.verified && (
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <button className="text-black hover:text-black">Report</button>
            </div>
          </div>
        ))}
      </div>
