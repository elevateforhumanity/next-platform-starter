...
export const PROGRAMS: ProgramEntry[] = [
  ...
  // Additional Programs
  { slug: 'culinary-apprenticeship', name: 'Culinary Apprenticeship', category: 'Skilled Trades', formType: 'apply', active: true },

  // Programs added from data/programs/ — ensure all slugs resolve
  { slug: 'beauty-career-educator', name: 'Beauty & Career Educator Training', category: 'Barber & Beauty', formType: 'apply', active: true },
  { slug: 'business-administration', name: 'Business Administration', category: 'Business & Financial', formType: 'apply', active: true },
  { slug: 'cad-drafting', name: 'CAD / Drafting', category: 'Technology', formType: 'apply', active: true },
  { slug: 'cdl-training', name: 'CDL Training', category: 'Skilled Trades', formType: 'apply', active: true },
  { slug: 'construction-trades-certification', name: 'Construction Trades Certification', category: 'Skilled Trades', formType: 'apply', active: true },
  ...
  { slug: 'entrepreneurship', name: 'Entrepreneurship', category: 'Business & Financial', formType: 'apply', active: true },
  ...
  { slug: 'home-health-aide', name: 'Home Health Aide', category: 'Healthcare', formType: 'apply', active: true },
  { slug: 'hospitality', name: 'Hospitality & Customer Service', category: 'Business & Financial', formType: 'apply', active: true },
  ...
  { slug: 'office-administration', name: 'Office Administration', category: 'Business & Financial', formType: 'apply', active: true },
  { slug: 'peer-recovery-specialist', name: 'Peer Recovery Specialist', category: 'Human Services', formType: 'apply', active: true, dedicatedApplyPage: '/programs/peer-recovery-specialist/apply' },
  { slug: 'project-management', name: 'Project Management', category: 'Business & Financial', formType: 'apply', active: true },
  ...
  { slug: 'tax-preparation', name: 'Tax Preparation', category: 'Business & Financial', formType: 'apply', active: true },
  { slug: 'technology', name: 'Technology Career Training', category: 'Technology', formType: 'apply', active: true },
