...
/**
 * AI Studio Charter (formerly devint-container.ts)
 *
 * Institutional operating charter for Dev Studio chat/execute. Linked from
 * `.devcontainer/devcontainer.json` metadata and the Container tab UI.
 */
...
/** Canonical name for prompt injection — alias of getDevIntPromptContext */
