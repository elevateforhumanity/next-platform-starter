...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    description:
      'Train to become a beauty industry educator. Learn teaching methodologies, curriculum development, and industry best practices.',
    requirements: ['Current cosmetology or barber license', 'Minimum 2 years industry experience'],
    isFree: false,
    isWIOAEligible: true,
    isWorkforceReadyGrant: false,
