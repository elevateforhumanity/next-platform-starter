...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    cardImage: '/images/pages/nail-technician.webp',
  ...
  },
  {
    ...
    cardImage: '/images/pages/business-sector.webp',
  ...
  },
  {
    ...
    cardImage: '/images/pages/peer-recovery.webp',
    heroImage: '/images/pages/peer-recovery.webp',
    duration: 'Varies by cohort',
    cost: 'Funding may cover full cost',
    format: 'Hybrid / In-person',
    level: 'Entry',
  ...
  },
  {
    ...
    cardImage: '/images/pages/cna-nursing.webp',
    heroImage: '/images/pages/cna-nursing-real.webp',
    duration: '8-10 weeks',
    cost: 'Funding may cover full cost',
    format: 'Hybrid',
    level: 'Entry',
  ...
  },
  {
    ...
    cardImage: '/images/pages/cpr-mannequin.webp',
  ...
  },
  {
    ...
    cardImage: '/images/pages/cdl-truck-highway.webp',
    heroImage: '/images/pages/cdl-training.webp',
    duration: '4-6 weeks',
    cost: 'Funding may cover full cost',
    format: 'In-person',
    level: 'Entry',
