...
export const peerRecoverySpecialistBlueprint: CredentialBlueprint = {
  ...
  modules: [
    // MODULE 1 — PLACEHOLDER
    {
      ...
      competencies: [
        { competencyKey: 'recovery_principles', isCritical: true, minimumTouchpoints: 2, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
        ...
        },
        {
          ...
          order: 2,
          domainKey: 'foundations',
          objective: 'Describe the historical development of the recovery movement and the science behind addiction.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 3,
          domainKey: 'foundations',
          objective: 'Identify multiple pathways to recovery and apply person-centered principles in peer support.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 4,
          domainKey: 'foundations',
          objective: 'Apply SAMHSA\'s eight dimensions of wellness to support holistic recovery planning.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 5,
          domainKey: 'foundations',
          objective: 'Describe the PRS role within Indiana\'s behavioral health system and key partner agencies.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'foundations',
          objective: 'Demonstrate understanding of peer recovery foundations, history, and the PRS role.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              id: 'prs-f-q1',
              question: 'Which of the following best describes the role of a Peer Recovery Specialist?',
              options: ['Providing clinical therapy and diagnosis', 'Using lived experience to support others in recovery', 'Prescribing medication-assisted treatment', 'Managing inpatient treatment programs'],
              correctAnswer: 1,
              explanation: 'A PRS uses their own lived experience with recovery to support others — this is what distinguishes peer support from clinical treatment.',
            },
            {
              id: 'prs-f-q2',
              question: 'SAMHSA defines recovery as:',
              options: ['Complete abstinence from all substances', 'A process of change through which individuals improve health, live self-directed lives, and reach their full potential', 'Completion of a 28-day inpatient program', 'Attendance at 90 AA meetings in 90 days'],
              correctAnswer: 1,
              explanation: 'SAMHSA\'s definition is broad and inclusive — it does not require abstinence and recognizes multiple pathways.',
            },
            {
              id: 'prs-f-q3',
              question: 'Which of the following is NOT one of SAMHSA\'s eight dimensions of wellness?',
              options: ['Financial', 'Occupational', 'Political', 'Spiritual'],
              correctAnswer: 2,
              explanation: 'The eight dimensions are emotional, environmental, financial, intellectual, occupational, physical, social, and spiritual. Political is not included.',
            },
            {
              id: 'prs-f-q4',
              question: 'Person-centered care means:',
              options: ['The PRS sets goals for the individual', 'The individual drives their own recovery plan', 'The treatment team decides the best pathway', 'Recovery must follow a clinical protocol'],
              correctAnswer: 1,
              explanation: 'Person-centered care places the individual in the driver\'s seat — the PRS supports, not directs.',
            },
            {
              id: 'prs-f-q5',
              question: 'In Indiana, which agency oversees behavioral health services and PRS credentialing standards?',
              options: ['Department of Education', 'Division of Mental Health and Addiction (DMHA)', 'Department of Labor', 'Bureau of Motor Vehicles'],
              correctAnswer: 1,
              explanation: 'DMHA under FSSA oversees behavioral health services and sets standards for peer support in Indiana.',
            },
          ],
        },
      ],
    ...
    // MODULE 2 — PLACEHOLDER
    {
      ...
      requiredLessonTypes: [{ lessonType: 'checkpoint', requiredCount: 1 }],
      competencies: [
        { competencyKey: 'professional_ethics', isCritical: true, minimumTouchpoints: 2, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
          ...
          order: 1,
          domainKey: 'ethics',
          objective: 'Identify the core ethical principles governing peer recovery support practice.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 2,
          domainKey: 'ethics',
          objective: 'Define professional boundaries and identify boundary violations in peer support relationships.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 4,
          domainKey: 'ethics',
          objective: 'Identify mandatory reporting obligations and apply duty-to-warn principles correctly.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'ethics',
          objective: 'Demonstrate understanding of ethics, boundaries, confidentiality, and professional conduct.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              id: 'prs-e-q1',
              question: 'A person you support tells you they are planning to hurt a specific person. What is your first action?',
              options: ['Keep it confidential — they trusted you', 'Immediately notify your supervisor and follow crisis protocol', 'Ask them to promise they will not follow through', 'Wait to see if they bring it up again'],
              correctAnswer: 1,
              explanation: 'Duty to warn requires immediate action. Notify your supervisor and follow your organization\'s protocol — this is not a situation where confidentiality applies.',
            },
            {
              id: 'prs-e-q2',
              question: 'Which federal law provides the strictest protections for substance use disorder treatment records?',
              options: ['HIPAA', '42 CFR Part 2', 'ADA', 'FERPA'],
              correctAnswer: 1,
              explanation: '42 CFR Part 2 provides protections specifically for SUD records that are stricter than standard HIPAA — records cannot be shared without specific written consent.',
            },
            {
              id: 'prs-e-q3',
              question: 'Self-disclosure in peer support should be:',
              options: ['Avoided entirely to maintain professionalism', 'Intentional and purposeful — shared to benefit the person you support', 'As detailed as possible to build connection', 'Limited to your worst moments in addiction'],
              correctAnswer: 1,
              explanation: 'Self-disclosure is a tool, not a default. Always ask: "Am I sharing this to help them?" If the answer is no, don\'t share it.',
            },
            {
              id: 'prs-e-q4',
              question: 'In Indiana, suspected child abuse must be reported to:',
              options: ['Local police only', 'Your supervisor only', 'Indiana Department of Child Services at 1-800-800-5556', 'The child\'s school'],
              correctAnswer: 2,
              explanation: 'Indiana DCS is the mandatory reporting agency for child abuse and neglect. You do not need proof — reasonable suspicion is sufficient.',
            },
            {
              id: 'prs-e-q5',
              question: 'A dual relationship in peer support occurs when:',
              options: ['You support two people at the same time', 'You have both a professional and personal relationship with someone you support', 'You work for two different organizations', 'You support someone with both mental health and substance use challenges'],
              correctAnswer: 1,
              explanation: 'Dual relationships compromise the professional relationship. Disclose to your supervisor and refer if necessary.',
            },
          ],
        },
      ],
    ...
    // MODULE 3 — PLACEHOLDER
    {
      ...
      requiredLessonTypes: [{ lessonType: 'checkpoint', requiredCount: 1 }],
      competencies: [
        { competencyKey: 'advocacy_skills', isCritical: false, minimumTouchpoints: 1, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
          ...
          order: 1,
          domainKey: 'advocacy',
          objective: 'Define advocacy in the context of peer recovery and identify its core functions.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 2,
          domainKey: 'advocacy',
          objective: 'Apply the four core principles of motivational interviewing in peer support conversations.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 3,
          domainKey: 'advocacy',
          objective: 'Facilitate collaborative goal-setting using SMART goals and recovery planning tools.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 5,
          domainKey: 'advocacy',
          objective: 'Engage family members and natural supports in the recovery process appropriately.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'advocacy',
          objective: 'Demonstrate understanding of advocacy, motivational interviewing, and resource navigation.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              ...
              options: ['"I want to get better"', '"I will attend three NA meetings this week and call my sponsor after each one"', '"I will try to stay sober"', '"I want to find a job someday"'],
              correctAnswer: 1,
              explanation: 'SMART goals are Specific, Measurable, Achievable, Relevant, and Time-bound. Option B meets all five criteria.',
            },
            {
              id: 'prs-a-q2',
              question: 'In motivational interviewing, "rolling with resistance" means:',
              options: ['Arguing until the person agrees with you', 'Ignoring the person\'s concerns', 'Not arguing when someone pushes back — reflecting the resistance instead', 'Ending the session when resistance occurs'],
              correctAnswer: 2,
              explanation: 'Rolling with resistance means not fighting it. Reflect what you hear and let the person process at their own pace.',
            },
            {
              id: 'prs-a-q3',
              question: 'A warm referral is:',
              options: ['Giving someone a phone number and wishing them luck', 'Personally introducing the person to the resource and following up', 'Sending an email on the person\'s behalf', 'Scheduling the appointment for the person without their input'],
              correctAnswer: 1,
              explanation: 'A warm referral involves personal connection and follow-up — it is far more effective than a cold handoff.',
            },
            {
              id: 'prs-a-q4',
              ...
              correctAnswer: 2,
              explanation: '211 connects callers to local resources for housing, food, utilities, and more. It is a key tool for PRS resource navigation.',
            },
            {
              id: 'prs-a-q5',
              question: 'When can you share information about the person you support with their family members?',
              options: ['Whenever the family asks', 'Only with the person\'s explicit written consent', 'When you think it would help the family understand', 'Never — family is never involved in recovery'],
              correctAnswer: 1,
              explanation: 'Confidentiality rules apply to family members too. You need explicit consent before sharing any information.',
            },
          ],
        },
      ],
    ...
    // MODULE 4 — PLACEHOLDER
    {
      ...
      requiredLessonTypes: [{ lessonType: 'checkpoint', requiredCount: 1 }],
      competencies: [
        { competencyKey: 'cultural_humility', isCritical: false, minimumTouchpoints: 1, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
          ...
          order: 1,
          domainKey: 'cultural_competency',
          objective: 'Distinguish cultural humility from cultural competency and apply it in peer support practice.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 2,
          domainKey: 'cultural_competency',
          objective: 'Apply SAMHSA\'s six principles of trauma-informed care in peer support interactions.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 3,
          domainKey: 'cultural_competency',
          objective: 'Identify specific considerations for supporting LGBTQ+, justice-involved, and veteran populations.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 4,
          domainKey: 'cultural_competency',
          objective: 'Identify forms of stigma affecting people in recovery and use person-first language effectively.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'cultural_competency',
          objective: 'Demonstrate understanding of cultural humility, trauma-informed care, and self-care.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              ...
              options: ['Requires mastery of specific cultural facts', 'Is an ongoing process of self-reflection, not a destination', 'Applies only to racial and ethnic differences', 'Is only relevant in clinical settings'],
              correctAnswer: 1,
              explanation: 'Cultural humility is a lifelong process of learning and self-reflection — you never "arrive" at full competency in another person\'s culture.',
            },
            {
              id: 'prs-c-q2',
              question: 'Which of SAMHSA\'s trauma-informed care principles involves offering choices to restore a sense of agency?',
              options: ['Safety', 'Trustworthiness', 'Empowerment and Choice', 'Peer Support'],
              correctAnswer: 2,
              explanation: 'Empowerment and Choice directly addresses the powerlessness that trauma creates by offering meaningful choices in every interaction.',
            },
            {
              id: 'prs-c-q3',
              question: 'Person-first language means:',
              options: ['Always putting the person\'s name first in documentation', 'Using terms like "addict" to be direct and honest', 'Saying "person with a substance use disorder" rather than "addict"', 'Avoiding any mention of substance use'],
              correctAnswer: 2,
              explanation: 'Person-first language affirms the humanity of the individual by describing the condition they have, not defining them by it.',
            },
            {
              id: 'prs-c-q4',
              question: 'Compassion fatigue is best described as:',
              options: ['Feeling tired after a long shift', 'Emotional exhaustion from regular exposure to others\' trauma that reduces empathy', 'Disagreeing with a person\'s recovery choices', 'Being too emotionally invested in outcomes'],
              correctAnswer: 1,
              explanation: 'Compassion fatigue is a serious occupational hazard in peer support work — it requires intentional self-care and supervision to prevent and address.',
            },
            {
              id: 'prs-c-q5',
              question: 'When working with LGBTQ+ individuals, you should:',
              options: ['Assume their pronouns based on appearance', 'Ask about their pronouns and use affirming language', 'Avoid discussing identity to keep things professional', 'Refer them only to LGBTQ+-specific programs'],
              correctAnswer: 1,
              explanation: 'Asking about pronouns and using affirming language signals respect and creates safety. Never assume — always ask.',
            },
          ],
        },
      ],
    ...
    // MODULE 5 — PLACEHOLDER
    {
      ...
      requiredLessonTypes: [{ lessonType: 'checkpoint', requiredCount: 1 }],
      competencies: [
        { competencyKey: 'documentation_skills', isCritical: false, minimumTouchpoints: 1, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
          ...
          order: 1,
          domainKey: 'documentation',
          objective: 'Explain the purpose of documentation in peer support and its role in service quality.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 3,
          domainKey: 'documentation',
          objective: 'Coordinate services effectively with care team members while maintaining confidentiality.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 4,
          domainKey: 'documentation',
          objective: 'Identify Medicaid-reimbursable peer support services and documentation requirements in Indiana.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 5,
          domainKey: 'documentation',
          objective: 'Document crisis situations and complete incident reports accurately and promptly.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'documentation',
          objective: 'Demonstrate understanding of documentation standards, care coordination, and Medicaid billing.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              ...
              correctAnswer: 1,
              explanation: 'DAP stands for Data, Assessment, Plan. Data includes objective observations and direct quotes from the person.',
            },
            {
              id: 'prs-d-q2',
              question: 'If you make an error in a paper progress note, you should:',
              options: ['Use white-out to cover the error', 'Erase the error completely', 'Draw a single line through the error, write the correction, and initial and date it', 'Start a new note and discard the old one'],
              correctAnswer: 2,
              explanation: 'Proper error correction preserves the original entry while clearly marking the correction. Erasing or using white-out is never acceptable in professional records.',
            },
            {
              id: 'prs-d-q3',
              question: 'Before sharing information with a care team member, you must:',
              options: ['Get verbal permission from the person', 'Obtain written consent specifying who, what, and for how long', 'Notify your supervisor', 'Confirm the team member has a license'],
              correctAnswer: 1,
              explanation: 'Written consent is required before sharing any information. It must specify who can receive information, what can be shared, and the consent\'s duration.',
            },
            {
              id: 'prs-d-q4',
              question: 'For a peer support service to be Medicaid-reimbursable in Indiana, it must be:',
              options: ['Provided by a licensed clinician', 'Documented on the day of service by a credentialed PRS', 'Approved by the person\'s insurance company in advance', 'Conducted in a clinical setting only'],
              correctAnswer: 1,
              explanation: 'Reimbursable services must be provided by a credentialed PRS and documented on the day of service, among other requirements.',
            },
            {
              id: 'prs-d-q5',
              question: 'Incident reports should be submitted:',
              options: ['Within one week of the incident', 'Only if the incident resulted in harm', 'Within 24 hours, following your organization\'s protocol', 'Only when requested by a supervisor'],
              correctAnswer: 2,
              explanation: 'Incident reports are typically required within 24 hours. They are tools for organizational learning, not punishment.',
            },
          ],
        },
      ],
    ...
    // MODULE 6 — PLACEHOLDER
    {
      ...
      practicalRequired: false,
      isCritical: false,
      requiredLessonTypes: [{ lessonType: 'checkpoint', requiredCount: 1 }, { lessonType: 'exam', requiredCount: 1 }],
      competencies: [
        { competencyKey: 'career_skills', isCritical: false, minimumTouchpoints: 1, assessmentMethod: 'quiz' },
      ],
      lessons: [
        {
          ...
          order: 1,
          domainKey: 'career_readiness',
          objective: 'Identify career pathways, job titles, and salary expectations for credentialed PRS in Indiana.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 2,
          domainKey: 'career_readiness',
          objective: 'Create a professional resume that highlights PRS credentials and lived experience appropriately.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 4,
          domainKey: 'career_readiness',
          objective: 'Identify continuing education requirements for PRS credential renewal in Indiana.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 5,
          domainKey: 'career_readiness',
          objective: 'Develop a professional network strategy to support career growth in peer recovery.',
          durationMinutes: 10,
        ...
        },
        {
          ...
          order: 6,
          domainKey: 'career_readiness',
          objective: 'Demonstrate understanding of career pathways, credential maintenance, and professional development.',
          durationMinutes: 10,
          passingScore: 70,
          ...
          quizQuestions: [
            {
              ...
              options: ['Department of Motor Vehicles', 'Certified Community Behavioral Health Clinics (CCBHCs)', 'Indiana State Police', 'Department of Education'],
              correctAnswer: 1,
              explanation: 'CCBHCs are a primary employer of PRS in Indiana, along with community mental health centers, RCOs, and hospital systems.',
            },
            {
              id: 'prs-cr-q2',
              question: 'The STAR method in job interviews stands for:',
              options: ['Skills, Training, Attitude, Results', 'Situation, Task, Action, Result', 'Strengths, Talents, Abilities, Readiness', 'Support, Trust, Advocacy, Recovery'],
              correctAnswer: 1,
              explanation: 'STAR (Situation, Task, Action, Result) is a framework for answering behavioral interview questions with specific, structured stories.',
            },
            {
              id: 'prs-cr-q3',
              question: 'Disclosing your lived experience with recovery on a resume is:',
              options: ['Required for all PRS positions', 'A personal decision that is never required', 'Prohibited by HIPAA', 'Only appropriate for peer-run organizations'],
              correctAnswer: 1,
              explanation: 'Disclosing lived experience is a personal choice. Many PRS choose to include it as a differentiator, but it is never required.',
            },
            {
              id: 'prs-cr-q4',
              question: 'After a job interview, you should:',
              options: ['Wait for the employer to contact you', 'Send a thank-you email within 24 hours referencing something specific from the conversation', 'Call the employer every day until you hear back', 'Post about the interview on social media'],
              correctAnswer: 1,
              explanation: 'A timely, specific thank-you email demonstrates professionalism and sets you apart from candidates who do not follow up.',
            },
            {
              id: 'prs-cr-q5',
              question: 'Continuing education for PRS credential renewal in Indiana is:',
              options: ['Optional — only required if you want a promotion', 'Required — check with DMHA for current hour requirements', 'Only required after a disciplinary action', 'Provided automatically by your employer'],
              correctAnswer: 1,
              explanation: 'Continuing education is required for credential renewal. Requirements are set by DMHA and may change — always verify current requirements.',
            },
          ],
        },
        {
          ...
          quizQuestions: [
            {
              ...
              options: ['Health, Home, Purpose, Community', 'Sobriety, Employment, Housing, Family', 'Physical, Mental, Spiritual, Social', 'Treatment, Support, Maintenance, Wellness'],
              correctAnswer: 0,
              explanation: 'SAMHSA\'s four dimensions of recovery are Health, Home, Purpose, and Community.',
            },
            {
              id: 'prs-exam-q2',
              question: 'Which federal regulation provides the strictest protections for substance use disorder treatment records?',
              options: ['HIPAA', 'ADA', '42 CFR Part 2', 'FERPA'],
              correctAnswer: 2,
              explanation: '42 CFR Part 2 provides protections for SUD records that are stricter than standard HIPAA.',
            },
            {
              id: 'prs-exam-q3',
              question: 'A PRS\'s primary role is to:',
              options: ['Diagnose and treat substance use disorders', 'Use lived experience to support others in recovery', 'Prescribe medication-assisted treatment', 'Provide legal representation for people in recovery'],
              correctAnswer: 1,
              explanation: 'The PRS role is defined by lived experience and peer support — not clinical treatment or legal services.',
            },
            {
              id: 'prs-exam-q4',
              question: 'In motivational interviewing, expressing empathy means:',
              options: ['Agreeing with everything the person says', 'Reflecting back what you hear without judgment', 'Sharing your own recovery story to build connection', 'Telling the person what they need to do to recover'],
              correctAnswer: 1,
              explanation: 'Empathy in MI means reflective listening — hearing and reflecting without judgment or advice.',
            },
            {
              id: 'prs-exam-q5',
              ...
              options: ['Local police only', 'Your supervisor only', 'Indiana Department of Child Services at 1-800-800-5556', 'The child\'s school'],
              correctAnswer: 2,
              explanation: 'Indiana DCS is the mandatory reporting agency. Reasonable suspicion is sufficient — you do not need proof.',
            },
            {
              id: 'prs-exam-q6',
              question: 'Cultural humility requires:',
              options: ['Mastering the cultural practices of every group you work with', 'Ongoing self-reflection and acknowledging you will never fully understand another\'s cultural experience', 'Treating everyone exactly the same regardless of background', 'Avoiding discussions of race and culture to prevent discomfort'],
              correctAnswer: 1,
              explanation: 'Cultural humility is a lifelong process of learning and self-reflection — not a destination.',
            },
            {
              id: 'prs-exam-q7',
              question: 'A progress note should be:',
              options: ['Written at the end of the week for all sessions', 'Timely, accurate, objective, and complete', 'Written only when something significant happens', 'Focused on your clinical interpretation of the person\'s behavior'],
              correctAnswer: 1,
              explanation: 'Progress notes must be timely (same day), accurate, objective (observable facts), and complete.',
            },
            {
              id: 'prs-exam-q8',
              question: 'Self-stigma in recovery refers to:',
              options: ['Negative attitudes held by society toward people in recovery', 'Internalized shame that the person in recovery feels about themselves', 'Policies that discriminate against people with SUD history', 'Stigma experienced in the workplace'],
              correctAnswer: 1,
              explanation: 'Self-stigma is internalized shame — the person believes they are fundamentally broken or unworthy of recovery.',
            },
            {
              id: 'prs-exam-q9',
              question: 'Before sharing information with a care team member, you must:',
              options: ['Get verbal permission', 'Obtain written consent specifying who, what, and for how long', 'Notify your supervisor', 'Confirm the team member is licensed'],
              correctAnswer: 1,
              explanation: 'Written consent is required before sharing any information with care team members.',
            },
            {
              id: 'prs-exam-q10',
              question: 'SAMHSA\'s six principles of trauma-informed care include all of the following EXCEPT:',
              options: ['Safety', 'Empowerment and Choice', 'Abstinence Requirement', 'Trustworthiness and Transparency'],
              correctAnswer: 2,
              explanation: 'Abstinence Requirement is not a TIC principle. The six principles are Safety, Trustworthiness and Transparency, Peer Support, Collaboration and Mutuality, Empowerment and Choice, and Cultural/Historical/Gender Issues.',
            },
          ],
        },
      ],
