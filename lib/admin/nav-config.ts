...
export const DEFAULT_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Completions', href: '/admin/analytics/learning' },
      { label: 'Outcomes', href: '/admin/analytics' },
      { label: 'Progress', href: '/admin/analytics/learning' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Grants — Apply', href: '/admin/grants/applications' },
