...
export const DEFAULT_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Assessment Bank', href: '/admin/studio' },
      { label: 'Course Templates', href: '/admin/studio' },
      { label: 'Media Library', href: '/admin/studio' },
      ...
      { label: 'AI Workflows', href: '/admin/workflows' },
