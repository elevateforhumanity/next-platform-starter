...
export const NAV_ITEMS: NavItem[] = [
...

  {
    ...
    subItems: [
      { name: '— Learner Ecosystem —', href: '/learner/dashboard', isHeader: true },
      { name: 'Learner Dashboard', href: '/learner/dashboard' },
      { name: 'Apprentice Portal (GPS)', href: '/apprentice' },
      { name: 'Host Shop Portal', href: '/host-shop/dashboard' },
      
      { name: '— Enterprise & Agency —', href: '/employer/dashboard', isHeader: true },
      { name: 'Employer Dashboard', href: '/employer/dashboard' },
      { name: 'Workforce Board Portal', href: '/workforce-board/dashboard' },
      { name: 'Partner / Agency Portal', href: '/partner/dashboard' },
