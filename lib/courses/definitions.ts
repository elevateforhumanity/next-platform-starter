        ...
        lessons: [
          {
            ...
            durationMinutes: 15,
            description:
              'Introduction to the Medical Assistant program, schedule, and expectations',
          },
          {
            id: 'ma-01-02',
            ...
            type: 'reading',
            description:
              'Understanding WIOA funding, attendance requirements, and support services',
          },
          {
            id: 'ma-01-03',
      ...
      },
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            type: 'reading',
            description:
              'Proper use of personal protective equipment and infection control protocols',
          },
        ],
      },
      {
        ...
        description: 'Scheduling, patient intake, basic billing and working with EHR systems.',
        lessons: [
          {
            id: 'ma-04-01',
    ...
    credentialPathway: [
      {
        ...
        requirements: ['EPA 608 Universal', 'OSHA 10', 'CPR/AED', '480+ training hours'],
        typicalTimeline: '12 weeks (this program)',
      },
      {
        level: '2',
        title: 'HVAC Journeyman',
        requirements: ['2,000+ OJT hours', 'State journeyman exam', 'Employer sponsorship'],
        typicalTimeline: '1–2 years post-program',
      },
      {
        level: '3',
        title: 'HVAC Master Technician',
        requirements: ['4,000+ OJT hours', 'NATE certification', 'Advanced diagnostics'],
        typicalTimeline: '3–5 years',
      },
      {
        level: '4',
        title: 'HVAC Contractor',
        requirements: ['Master license', 'Business license', 'Insurance/bonding'],
        typicalTimeline: '5+ years',
      },
    ],
    outcomes: [
    ...
    modules: [
      {
        ...
        weekAssignment: {
          week: 1,
          weeklyCompetencyStatement:
            'Identify program credentials, explain the refrigeration cycle at a conceptual level, and demonstrate basic tool identification',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-01-co1',
            statement:
              'Identify the three credentials earned in this program and their industry value',
            credentialAlignment: 'Residential HVAC',
          },
          {
            id: 'hvac-01-co2',
            statement:
              'Explain WIOA funding requirements including attendance minimums and documentation deadlines',
          },
          {
            id: 'hvac-01-co3',
            statement:
              'Map the four-level career pathway: apprentice → journeyman → master → contractor',
          },
          {
            id: 'hvac-01-co4',
            statement: 'Identify 10 common HVAC hand tools and their purpose by name',
            standard: '10/10 correct on tool identification practical',
          },
        ],
        lessons: [
          {
          ...
          },
          {
            ...
            type: 'quiz',
            durationMinutes: 10,
            description: 'Confirm understanding of program requirements and expectations',
            passThreshold: 80,
            assessesObjectives: ['hvac-01-co1', 'hvac-01-co2', 'hvac-01-co3'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 2,
          weeklyCompetencyStatement:
            'Apply lockout/tagout procedure, identify electrical hazard classes, demonstrate PPE selection, and identify all five major system components on a live unit',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-02-co1',
            statement:
              'Diagram the heating cycle and cooling cycle showing direction of heat transfer',
          },
          {
            id: 'hvac-02-co2',
            statement:
              'Demonstrate proper connection of gauge manifold to a system with correct hose routing',
            standard: 'Zero cross-contamination, correct high/low side identification',
          },
          {
            id: 'hvac-02-co3',
            statement: 'Execute lockout/tagout procedure on a live disconnect per OSHA 1910.147',
            credentialAlignment: 'OSHA 10',
          },
          {
            id: 'hvac-02-co4',
            statement:
              'Identify compressor, condenser, evaporator, metering device, and air handler on a live split system',
            standard: '5/5 correct within 2 minutes',
          },
        ],
        lessons: [
          {
            ...
            type: 'video',
            durationMinutes: 40,
            description: 'Heating cycle, cooling cycle, ventilation, and air distribution basics',
          },
          {
            id: 'hvac-02-02',
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-02-co4'],
          },
          {
            id: 'hvac-02-05',
            ...
            type: 'quiz',
            durationMinutes: 15,
            description: 'Test knowledge of HVAC principles, components, and safety',
            passThreshold: 80,
            assessesObjectives: ['hvac-02-co1', 'hvac-02-co2', 'hvac-02-co3'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 3,
          weeklyCompetencyStatement:
            "Apply Ohm's Law to solve circuit problems, read ladder diagrams, and measure voltage/amperage/resistance within ±5% accuracy using a multimeter",
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-03-co1',
            statement:
              "Calculate voltage, current, and resistance using Ohm's Law for series and parallel circuits",
            standard: '4/5 correct on calculation worksheet',
          },
          {
            id: 'hvac-03-co2',
            statement:
              'Trace current flow through a ladder diagram and identify the energized component for a given switch state',
          },
          {
            id: 'hvac-03-co3',
            statement:
              'Measure AC voltage, DC voltage, amperage, resistance, and capacitance on a live HVAC system',
            standard: 'Readings within ±5% of instructor reference values',
          },
          {
            id: 'hvac-03-co4',
            statement:
              'Test a run capacitor and start capacitor using a multimeter and determine pass/fail',
            standard: 'Correct diagnosis on 3/3 test capacitors',
          },
        ],
        ...
        lessons: [
          {
            ...
            type: 'video',
            durationMinutes: 45,
            description: 'Fundamental electrical concepts every HVAC tech must know',
          },
          {
            id: 'hvac-03-02',
            ...
            type: 'video',
            durationMinutes: 35,
            description: 'Ladder diagrams, pictorial diagrams, and schematic symbols',
          },
          {
            id: 'hvac-03-03',
            ...
            assessesObjectives: ['hvac-03-co3', 'hvac-03-co4'],
          },
          {
            id: 'hvac-03-04',
            ...
            type: 'video',
            durationMinutes: 30,
            description: 'How electrical components control HVAC system operation',
          },
          {
            id: 'hvac-03-05',
            ...
            type: 'quiz',
            durationMinutes: 15,
            description: 'Assessment of electrical fundamentals for HVAC',
            passThreshold: 80,
            assessesObjectives: ['hvac-03-co1', 'hvac-03-co2'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 4,
          weeklyCompetencyStatement:
            'Perform combustion analysis with CO readings below 100 ppm, verify temperature rise within manufacturer range, and complete a full furnace safety inspection',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-04-co1',
            statement:
              'Identify ignition type (standing pilot, HSI, DSI) and verify proper flame characteristics on a live furnace',
          },
          {
            id: 'hvac-04-co2',
            statement:
              'Measure and verify temperature rise falls within manufacturer-specified range',
            standard: 'Within ±5°F of nameplate range',
          },
          {
            id: 'hvac-04-co3',
            statement:
              'Perform combustion analysis: measure CO in flue gas and verify below safe threshold',
            standard: 'CO reading below 100 ppm in undiluted flue gas',
          },
          {
            id: 'hvac-04-co4',
            statement:
              'Complete a 15-point furnace safety inspection checklist with zero missed items',
            standard: '15/15 checklist items documented',
          },
        ],
        lessons: [
          {
          ...
          },
          {
            ...
            type: 'video',
            durationMinutes: 25,
            description: 'Sequencers, heating elements, and electric furnace operation',
          },
          {
            id: 'hvac-04-03',
            ...
            type: 'video',
            durationMinutes: 35,
            description: 'Reversing valve, defrost cycle, auxiliary heat, and balance point',
          },
          {
            id: 'hvac-04-04',
            ...
            assessesObjectives: ['hvac-04-co2', 'hvac-04-co3'],
          },
          {
            id: 'hvac-04-05',
            ...
            assessesObjectives: ['hvac-04-co1', 'hvac-04-co4'],
          },
          {
            id: 'hvac-04-06',
            ...
            type: 'quiz',
            durationMinutes: 15,
            description: 'Test knowledge of heating system operation and maintenance',
            passThreshold: 80,
            assessesObjectives: ['hvac-04-co1', 'hvac-04-co2'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 5,
          weeklyCompetencyStatement:
            'Diagram a vapor-compression system, calculate superheat within ±2°F and subcooling within ±2°F from live gauge readings, and identify pressure/temperature relationships using a PT chart',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-05-co1',
            statement:
              'Diagram a complete vapor-compression refrigeration cycle labeling all four stages, state changes, and pressure zones',
          },
          {
            id: 'hvac-05-co2',
            statement:
              'Calculate superheat from suction pressure and suction line temperature on a live system',
            standard: 'Within ±2°F of instructor reference value',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-05-co3',
            statement:
              'Calculate subcooling from liquid line pressure and liquid line temperature on a live system',
            standard: 'Within ±2°F of instructor reference value',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-05-co4',
            statement:
              'Look up saturation temperature for R-410A and R-22 at given pressures using a PT chart',
            standard: 'Correct value within 5 seconds, 5/5 lookups',
          },
        ],
        ...
        lessons: [
          ...
          },
          {
            ...
            type: 'video',
            durationMinutes: 25,
            description: 'Reciprocating, scroll, and rotary compressors',
          },
          {
            id: 'hvac-05-04',
            ...
            type: 'video',
            durationMinutes: 25,
            description: 'TXV, fixed orifice, capillary tube — how each controls refrigerant flow',
          },
          {
            id: 'hvac-05-05',
            ...
            assessesObjectives: ['hvac-05-co2', 'hvac-05-co3', 'hvac-05-co4'],
          },
          {
            id: 'hvac-05-06',
            ...
            type: 'quiz',
            durationMinutes: 15,
            description: 'Test knowledge of refrigeration cycle and AC system operation',
            passThreshold: 85,
            assessesObjectives: ['hvac-05-co1', 'hvac-05-co4'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 6,
          weeklyCompetencyStatement:
            'State recovery requirements, classify refrigerants by type, and score 85% or higher on EPA 608 Core practice exam',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-06-co1',
            statement:
              'Classify 10 common refrigerants by type (CFC, HCFC, HFC, HFO) and state their ODP status',
            standard: '10/10 correct',
            credentialAlignment: 'EPA 608 Core',
          },
          {
            id: 'hvac-06-co2',
            statement:
              'State the maximum fine for knowingly venting refrigerant under the Clean Air Act',
            credentialAlignment: 'EPA 608 Core',
          },
          {
            id: 'hvac-06-co3',
            statement:
              'Distinguish between recovery, recycling, and reclamation and state when each is required',
            credentialAlignment: 'EPA 608 Core',
          },
          {
            id: 'hvac-06-co4',
            statement: 'Score 85% or higher on a timed 25-question EPA 608 Core practice exam',
            standard: '85% minimum (21/25)',
            credentialAlignment: 'EPA 608 Core',
          },
        ],
        lessons: [
          ...
          },
          {
            ...
            type: 'video',
            durationMinutes: 20,
            description: 'Saturation temperature, gauge vs absolute pressure, and PT chart usage',
          },
          {
            id: 'hvac-06-06',
            ...
            type: 'video',
            durationMinutes: 30,
            description: 'Definitions, equipment requirements, and when each is required by law',
          },
          {
            id: 'hvac-06-07',
          ...
          },
          {
            ...
            passThreshold: 85,
            assessesObjectives: ['hvac-06-co1', 'hvac-06-co2', 'hvac-06-co3', 'hvac-06-co4'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 7,
          weeklyCompetencyStatement:
            'Perform recovery simulation on a small appliance, state required recovery levels (90%/80%), and pass Type I mock exam at 85%',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-07-co1',
            statement:
              'State required recovery levels for small appliances: 90% operating, 80% non-operating, and conditions for 0%',
            credentialAlignment: 'EPA 608 Type I',
          },
          {
            id: 'hvac-07-co2',
            statement:
              'Demonstrate proper recovery procedure on a small appliance trainer using self-contained equipment',
            credentialAlignment: 'EPA 608 Type I',
          },
          {
            id: 'hvac-07-co3',
            statement: 'Score 85% or higher on Type I mock exam',
            standard: '85% minimum (21/25)',
            credentialAlignment: 'EPA 608 Type I',
          },
        ],
        lessons: [
          ...
          },
          {
            ...
            type: 'reading',
            description: 'Small appliance leak repair requirements and disposal procedures',
          },
          {
            id: 'hvac-07-05',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: '25-question practice test matching EPA 608 Type I exam format',
            passThreshold: 85,
            assessesObjectives: ['hvac-07-co1', 'hvac-07-co3'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 7,
          weeklyCompetencyStatement:
            'Perform charging procedures, calculate superheat within ±2°F, calculate subcooling within ±2°F, and pass Type II mock exam at 85%',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-08-co1',
            statement:
              'State required recovery levels for high-pressure systems: 0 psig (<200 lbs) and 10 in. Hg vacuum (>200 lbs)',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-08-co2',
            statement:
              'Evacuate a system to 500 microns using a vacuum pump and verify hold with micron gauge',
            standard: 'System holds below 500 microns for 10 minutes',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-08-co3',
            statement:
              'Perform electronic leak detection on a charged system and locate a planted leak',
            standard: 'Leak found within 5 minutes',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-08-co4',
            statement: 'Score 85% or higher on Type II mock exam',
            standard: '85% minimum (21/25)',
            credentialAlignment: 'EPA 608 Type II',
          },
        ],
        ...
        lessons: [
          ...
          },
          {
            ...
            type: 'video',
            durationMinutes: 25,
            description: 'Vacuum pump operation, micron gauge, triple evacuation, and dehydration',
          },
          {
            id: 'hvac-08-05',
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-08-co2', 'hvac-08-co3'],
          },
          {
            id: 'hvac-08-07',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: '25-question practice test matching EPA 608 Type II exam format',
            passThreshold: 85,
            assessesObjectives: ['hvac-08-co1', 'hvac-08-co4'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 8,
          weeklyCompetencyStatement:
            'Describe low-pressure recovery safety, state leak detection requirements for chillers, and pass Type III mock exam at 85%',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-09-co1',
            statement:
              'State Type III recovery requirements: 0 psig for <200 lbs, 25 mm Hg absolute for >=200 lbs',
            credentialAlignment: 'EPA 608 Type III',
          },
          {
            id: 'hvac-09-co2',
            statement:
              'Explain why low-pressure systems operate below atmospheric pressure and the role of the purge unit',
            credentialAlignment: 'EPA 608 Type III',
          },
          {
            id: 'hvac-09-co3',
            statement: 'Score 85% or higher on Type III mock exam',
            standard: '85% minimum (21/25)',
            credentialAlignment: 'EPA 608 Type III',
          },
        ],
        lessons: [
          ...
          },
          {
            ...
            type: 'reading',
            description: 'Freeze-up risks, hydrolysis, acid formation, and dehydration procedures',
          },
          {
            id: 'hvac-09-05',
            title: 'Rupture Disc & Pressure Relief',
            type: 'reading',
            description: 'Safety devices on low-pressure systems and when they activate',
          },
          {
            id: 'hvac-09-06',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: '25-question practice test matching EPA 608 Type III exam format',
            passThreshold: 85,
            assessesObjectives: ['hvac-09-co1', 'hvac-09-co2', 'hvac-09-co3'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 8,
          weeklyCompetencyStatement:
            'Score 70% or higher on each of the four EPA 608 sections in a timed 100-question Universal practice exam',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-10-co1',
            statement: 'Score 70% or higher on Core section under timed conditions',
            standard: '70% minimum (18/25)',
            credentialAlignment: 'EPA 608 Core',
          },
          {
            id: 'hvac-10-co2',
            statement: 'Score 70% or higher on Type I section under timed conditions',
            standard: '70% minimum (18/25)',
            credentialAlignment: 'EPA 608 Type I',
          },
          {
            id: 'hvac-10-co3',
            statement: 'Score 70% or higher on Type II section under timed conditions',
            standard: '70% minimum (18/25)',
            credentialAlignment: 'EPA 608 Type II',
          },
          {
            id: 'hvac-10-co4',
            statement: 'Score 70% or higher on Type III section under timed conditions',
            standard: '70% minimum (18/25)',
            credentialAlignment: 'EPA 608 Type III',
          },
        ],
        ...
        lessons: [
          {
            ...
            type: 'video',
            durationMinutes: 20,
            description: 'Quick review of key Core concepts, common exam traps, and memory aids',
          },
          {
            id: 'hvac-10-02',
          ...
          },
          {
            ...
            type: 'quiz',
            durationMinutes: 30,
            description: 'Timed 25-question Core practice exam under test conditions',
            passThreshold: 70,
            assessesObjectives: ['hvac-10-co1'],
          },
          {
            id: 'hvac-10-04',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: 'Timed 25-question Type I practice exam under test conditions',
            passThreshold: 70,
            assessesObjectives: ['hvac-10-co2'],
          },
          {
            id: 'hvac-10-05',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: 'Timed 25-question Type II practice exam under test conditions',
            passThreshold: 70,
            assessesObjectives: ['hvac-10-co3'],
          },
          {
            id: 'hvac-10-06',
            ...
            type: 'quiz',
            durationMinutes: 25,
            description: 'Timed 25-question Type III practice exam under test conditions',
            passThreshold: 70,
            assessesObjectives: ['hvac-10-co4'],
          },
          {
            id: 'hvac-10-07',
            ...
            passThreshold: 70,
            assessesObjectives: ['hvac-10-co1', 'hvac-10-co2', 'hvac-10-co3', 'hvac-10-co4'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 9,
          weeklyCompetencyStatement:
            'Charge a system to manufacturer spec using subcooling method within ±2°F, diagnose overcharge/undercharge from gauge readings, and evacuate to 500 microns',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-11-co1',
            statement:
              'Charge a residential split system to manufacturer specification using the subcooling method',
            standard: 'Subcooling within ±2°F of target',
            credentialAlignment: 'Residential HVAC',
          },
          {
            id: 'hvac-11-co2',
            statement:
              'Diagnose overcharge, undercharge, liquid-line restriction, and non-condensables from manifold gauge readings',
            standard: 'Correct diagnosis on 4/4 fault scenarios',
          },
          {
            id: 'hvac-11-co3',
            statement:
              'Evacuate a system to 500 microns and verify hold for 10 minutes without rise above 1000 microns',
            standard: '500 microns, 10-minute hold',
            credentialAlignment: 'Residential HVAC',
          },
          {
            id: 'hvac-11-co4',
            statement:
              'Locate a planted refrigerant leak using an electronic leak detector within 5 minutes',
            standard: 'Leak found within 5 minutes',
          },
        ],
        lessons: [
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-11-co4'],
          },
          {
            id: 'hvac-11-04',
            ...
            assessesObjectives: ['hvac-11-co1', 'hvac-11-co3'],
          },
          {
            id: 'hvac-11-05',
            ...
            type: 'quiz',
            durationMinutes: 20,
            description: 'Diagnose system problems from gauge readings and symptoms',
            passThreshold: 80,
            assessesObjectives: ['hvac-11-co2'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 10,
          weeklyCompetencyStatement:
            'Measure static pressure within ±0.02 in. w.c., identify airflow restrictions, vacuum a system to 500 microns, verify refrigerant charge, and complete a startup checklist',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-12-co1',
            statement:
              'Measure total external static pressure on a residential system and compare to equipment rating',
            standard: 'Reading within ±0.02 in. w.c. of instructor reference',
          },
          {
            id: 'hvac-12-co2',
            statement:
              'Braze a copper-to-copper joint with nitrogen purge that passes a 150 psi nitrogen pressure test',
            standard: 'Zero leaks at 150 psi for 15 minutes',
          },
          {
            id: 'hvac-12-co3',
            statement:
              'Complete a 20-point system commissioning checklist including charge verification, airflow, and temperature split',
            standard: '20/20 items documented, temperature split within manufacturer range',
          },
          {
            id: 'hvac-12-co4',
            statement: 'Vacuum a system to 500 microns and verify charge using subcooling method',
            standard: '500 microns hold, subcooling within ±2°F',
            credentialAlignment: 'Residential HVAC',
          },
        ],
        ...
        lessons: [
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-12-co2'],
          },
          {
            id: 'hvac-12-04',
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-12-co1', 'hvac-12-co3', 'hvac-12-co4'],
          },
          {
            id: 'hvac-12-06',
            ...
            type: 'quiz',
            durationMinutes: 15,
            description: 'Test knowledge of installation procedures and best practices',
            passThreshold: 80,
            assessesObjectives: ['hvac-12-co1'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 11,
          weeklyCompetencyStatement:
            'Apply the 6-step troubleshooting method to diagnose and repair 3 planted faults on training equipment within 30 minutes each, and communicate findings professionally',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-13-co1',
            statement:
              'Diagnose a planted fault on a cooling system using the 6-step method and correct it',
            standard: 'Correct diagnosis and repair within 30 minutes',
            credentialAlignment: 'Residential HVAC',
          },
          {
            id: 'hvac-13-co2',
            statement:
              'Diagnose a planted fault on a heating system using the 6-step method and correct it',
            standard: 'Correct diagnosis and repair within 30 minutes',
            credentialAlignment: 'Residential HVAC',
          },
          {
            id: 'hvac-13-co3',
            statement:
              'Present repair findings and cost estimate to a simulated customer using professional language',
            standard: 'Instructor evaluation: clear, accurate, professional',
          },
        ],
        lessons: [
          {
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-13-co1', 'hvac-13-co2'],
          },
          {
            id: 'hvac-13-05',
            ...
            assessesObjectives: ['hvac-13-co3'],
          },
          {
            id: 'hvac-13-06',
            ...
            type: 'quiz',
            durationMinutes: 20,
            description: 'Diagnose system problems from described symptoms and readings',
            passThreshold: 80,
            assessesObjectives: ['hvac-13-co1', 'hvac-13-co2'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 11,
          weeklyCompetencyStatement:
            'Pass OSHA 10 final exam and demonstrate lockout/tagout, fall protection selection, and GHS label reading',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-14-co1',
            statement:
              'Execute a lockout/tagout procedure on a simulated HVAC disconnect following OSHA 1910.147',
            credentialAlignment: 'OSHA 10',
          },
          {
            id: 'hvac-14-co2',
            statement: 'Select correct fall protection equipment for three given work scenarios',
            standard: '3/3 correct selections',
            credentialAlignment: 'OSHA 10',
          },
          {
            id: 'hvac-14-co3',
            statement:
              'Read a GHS label and Safety Data Sheet and identify hazard class, PPE required, and first aid measures',
            credentialAlignment: 'OSHA 10',
          },
          {
            id: 'hvac-14-co4',
            statement: 'Pass OSHA 10 final exam',
            standard: '70% minimum to earn OSHA 10-Hour card (issued by CareerSafe/DOL)',
            credentialAlignment: 'OSHA 10',
          },
        ],
        ...
        lessons: [
          {
            id: 'hvac-14-01',
            title: 'OSHA 10 Overview & Worker Rights (CareerSafe)',
            type: 'video',
            durationMinutes: 30,
            description:
          ...
          },
          {
            ...
            type: 'video',
            durationMinutes: 45,
            description: 'Ladder safety, scaffolding, guardrails, personal fall arrest systems',
          },
          {
            id: 'hvac-14-03',
          ...
          },
          {
            ...
            type: 'reading',
            description: 'GHS labels, Safety Data Sheets, chemical hazards, and right-to-know',
          },
          {
            id: 'hvac-14-05',
            ...
            type: 'video',
            durationMinutes: 20,
            description: 'Hard hats, safety glasses, gloves, respirators, and hearing protection',
          },
          {
            id: 'hvac-14-06',
            ...
            type: 'video',
            durationMinutes: 25,
            description: 'Permit-required confined spaces, atmospheric testing, and trench safety',
          },
          {
            id: 'hvac-14-07',
            title: 'Fire Prevention & Welding Safety',
            type: 'reading',
            description: 'Hot work permits, fire extinguisher types, and brazing safety for HVAC',
          },
          {
            id: 'hvac-14-08',
            title: 'OSHA 10 Final Exam (CareerSafe)',
            type: 'quiz',
            durationMinutes: 45,
            description: 'CareerSafe proctored OSHA 10 assessment — DOL card issued upon passing',
            passThreshold: 70,
            assessesObjectives: ['hvac-14-co1', 'hvac-14-co2', 'hvac-14-co3', 'hvac-14-co4'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 12,
          weeklyCompetencyStatement:
            'Perform adult CPR at correct depth and rate on a manikin, operate an AED, pass the proctored EPA 608 Universal exam, and complete employer mock interview',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-15-co1',
            statement:
              'Perform 2 minutes of adult CPR on a manikin with correct compression depth (2–2.4 inches) and rate (100–120/min)',
            standard: 'Manikin feedback confirms adequate depth and rate',
            credentialAlignment: 'CPR/AED',
          },
          {
            id: 'hvac-15-co2',
            statement:
              'Operate an AED on a training manikin: power on, attach pads, deliver shock when prompted',
            credentialAlignment: 'CPR/AED',
          },
          {
            id: 'hvac-15-co3',
            statement: 'Pass NRF Rise Up Retail Industry Fundamentals assessment',
            standard: '70% minimum',
          },
        ],
        ...
        lessons: [
          {
            ...
            type: 'video',
            durationMinutes: 30,
            description: 'Chest compressions, rescue breathing, AED operation for adults',
          },
          {
            id: 'hvac-15-02',
          ...
          },
          {
            ...
            type: 'lab',
            durationMinutes: 45,
            description: 'Hands-on CPR and AED practice on manikins — must demonstrate competency',
            assessesObjectives: ['hvac-15-co1', 'hvac-15-co2'],
          },
          {
            id: 'hvac-15-04',
          ...
          {
            id: 'hvac-15-05',
            title: 'Rise Up Assessment',
            type: 'quiz',
            durationMinutes: 30,
            description: 'NRF Rise Up certification exam',
            passThreshold: 70,
            assessesObjectives: ['hvac-15-co3'],
          },
        ],
      },
      {
        ...
        weekAssignment: {
          week: 12,
          weeklyCompetencyStatement:
            'Pass the proctored EPA 608 Universal exam (70% per section), complete a trade-specific resume, and demonstrate interview readiness in a mock employer interview',
        },
        objectives: [
        ...
        competencyObjectives: [
          {
            id: 'hvac-16-co1',
            statement: 'Pass the proctored EPA 608 Universal certification exam',
            standard: '70% minimum on each of 4 sections (Core, Type I, Type II, Type III)',
            credentialAlignment: 'EPA 608 Core',
          },
          {
            id: 'hvac-16-co2',
            statement:
              'Produce a trade-specific resume listing all earned credentials, training hours, and lab competencies',
            standard: 'Resume reviewed and approved by career services',
          },
          {
            id: 'hvac-16-co3',
            statement:
              'Complete a 15-minute mock interview with an employer partner or career coach',
            standard:
              'Satisfactory rating on professionalism, technical knowledge, and communication',
          },
          {
            id: 'hvac-16-co4',
            statement:
              'Verify all program credentials earned: EPA 608 Universal, OSHA 10, CPR/AED, Rise Up',
            standard: 'All 4 credentials documented in student file',
          },
        ],
        ...
        lessons: [
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-16-co2'],
          },
          {
            id: 'hvac-16-03',
          ...
          },
          {
            ...
            assessesObjectives: ['hvac-16-co3'],
          },
          {
            id: 'hvac-16-05',
            title: 'Program Completion Checklist',
            type: 'assignment',
            description: 'Verify all certifications earned, hours logged, and placement readiness',
            assessesObjectives: ['hvac-16-co4'],
          },
        ],
      },
    ],
    ...
    modules: [
      {
        ...
        description: 'Intro to CDL classes, career options, and exam overview.',
        lessons: [
          {
            id: 'cdl-01-01',
      ...
      },
      {
        ...
        description: 'Road safety, hours-of-service, and compliance basics.',
        lessons: [
          {
            id: 'cdl-02-01',
    ...
    modules: [
      {
        id: 'wr-01',
        title: 'Reset & Rebuild',
        description: 'Orientation focused on mindset, goals, and support systems.',
        lessons: [
          {
            id: 'wr-01-01',
