...
add('Peer Recovery Specialist Role', {
  ...
  concept:
    'A Peer Recovery Specialist (PRS) is a person with lived experience of addiction, mental health challenges, or both, who uses that experience to support others on their recovery journey. The PRS role is distinct from clinical roles: you are not a therapist, counselor, or case manager. You are a peer — someone who has walked a similar path and can offer hope, connection, and practical guidance that a clinician cannot. In Indiana, the Certified Peer Recovery Specialist (CPRS) credential is issued by the Division of Mental Health and Addiction (DMHA) and requires 46 hours of training, a supervised practicum, and a written exam. The PRS works in a wide range of settings: recovery community organizations, treatment centers, hospitals, jails and prisons, homeless shelters, and community health agencies. Your primary tools are your story, your empathy, and your knowledge of the recovery system. Employers value PRS staff because peer support has strong evidence behind it — studies consistently show that peer support reduces hospitalization, increases treatment engagement, and improves long-term recovery outcomes.',
  keyTerms: [
    {
      term: 'Peer Recovery Specialist (PRS)',
      definition:
        'A person with lived recovery experience trained to support others in their recovery. Not a clinical role.',
    },
    {
      term: 'CPRS',
      definition:
        'Certified Peer Recovery Specialist — the Indiana state credential issued by DMHA after completing required training, practicum, and exam.',
    },
    {
      term: 'Lived Experience',
      definition:
        'Personal, first-hand experience with addiction, mental health challenges, or both. The foundation of peer credibility.',
    },
    {
      term: 'DMHA',
      definition:
        'Indiana Division of Mental Health and Addiction — the state agency that oversees behavioral health services and the CPRS credential.',
    },
    {
      term: 'Recovery Community Organization (RCO)',
      definition:
        'A nonprofit organization led and governed by people in recovery that provides peer support and recovery services.',
    },
  ],
  jobApplication:
  ...
  reflectionPrompt:
    'What aspect of your lived experience do you believe will be most valuable to the people you support, and why?',
  summaryText:
    'The PRS role is built on lived experience, not clinical credentials. Understanding the scope, credential requirements, and evidence base for peer support is the foundation of effective practice.',
});
...
add('Recovery-Oriented Principles', {
  ...
  keyTerms: [
    {
      term: 'ROSC',
      definition:
        'Recovery-Oriented Systems of Care — a coordinated network of services built around recovery principles rather than just symptom management.',
    },
    {
      term: 'SAMHSA',
      definition:
        'Substance Abuse and Mental Health Services Administration — the federal agency that sets national standards for behavioral health.',
    },
    {
      term: 'Person-Centered Care',
      definition:
        "An approach where the individual's goals, preferences, and values drive the support plan — not the provider's agenda.",
    },
    {
      term: 'Harm Reduction',
      definition:
        'Strategies that reduce the negative consequences of substance use without requiring abstinence as a precondition for support.',
    },
    {
      term: 'MAT',
      definition:
        'Medication-Assisted Treatment — the use of FDA-approved medications (buprenorphine, methadone, naltrexone) combined with counseling to treat opioid or alcohol use disorder.',
    },
  ],
  jobApplication:
  ...
  reflectionPrompt:
    'Think of a time when someone met you where you were instead of where they thought you should be. How did that affect your willingness to engage?',
  summaryText:
    'Recovery-oriented principles — person-centered care, hope, self-determination, and strengths-based practice — are the operating framework for every peer interaction.',
});
...
add('History of Peer Support Movement', {
  ...
  concept:
    "The peer support movement grew out of two parallel traditions: the consumer/survivor movement in mental health and the 12-step recovery movement in addiction. Alcoholics Anonymous, founded in 1935, was the first large-scale peer support model — people with lived experience of alcoholism helping each other stay sober. The mental health consumer movement emerged in the 1970s as psychiatric patients began advocating for their own rights and creating alternatives to institutional care. By the 1990s, states began formally recognizing peer support as a billable Medicaid service, which transformed peer work from volunteer activity into a paid profession. In 2007, CMS (Centers for Medicare and Medicaid Services) issued guidance allowing states to bill Medicaid for peer support services, accelerating the professionalization of the field. Today, all 50 states have some form of peer specialist certification. Indiana's CPRS credential was established through DMHA and is recognized by most behavioral health employers in the state. Understanding this history matters because it explains why peer support is structured the way it is — and why the boundaries between peer and clinical roles are drawn where they are.",
  keyTerms: [
    {
      term: 'Consumer/Survivor Movement',
      definition:
        'A civil rights movement led by people with mental health diagnoses advocating for self-determination and alternatives to forced treatment.',
    },
    {
      term: 'CMS',
      definition:
        'Centers for Medicare and Medicaid Services — the federal agency that issued guidance in 2007 allowing states to bill Medicaid for peer support services.',
    },
    {
      term: 'Medicaid Billable',
      definition:
        'A service that can be reimbursed through Medicaid, making it financially sustainable for agencies to employ peer specialists.',
    },
    {
      term: 'Professionalization',
      definition:
        'The process by which peer support moved from informal volunteer work to a credentialed, paid profession with defined competencies and ethics.',
    },
  ],
  jobApplication:
    'When a client or colleague questions whether peer support is "real" work, you can explain the evidence base and the policy history. Peer support has been a Medicaid-billable service for nearly 20 years because research shows it works. Knowing this history gives you confidence and credibility.',
  watchFor: [
  ...
  reflectionPrompt:
    'How does knowing the history of the peer support movement change how you think about your role?',
  summaryText:
    'Peer support evolved from grassroots recovery communities into a credentialed profession. Understanding this history explains the structure of the role and the importance of maintaining peer authenticity.',
});
...
add('Professional Boundaries', {
  ...
  summaryText:
    'Professional boundaries protect the peer support relationship. Healthy self-disclosure, clear scope of practice, and early disclosure of dual relationships are the core boundary skills every PRS must develop.',
});
...
add('Introduction Quiz', {
  ...
  concept:
    'This quiz covers the foundational concepts of the Peer Recovery Specialist role: the definition and scope of the PRS, recovery-oriented principles, the history of peer support, and professional boundaries. You must score 70% or higher to proceed. Review the four SAMHSA dimensions of recovery, the distinction between peer support and clinical roles, and the key boundary concepts before attempting the quiz.',
  keyTerms: [],
  jobApplication:
    'Employers will test your knowledge of these fundamentals during interviews. Being able to articulate what a PRS does — and does not do — is a core competency.',
  watchFor: [
  ...
  summaryText:
    'Module 1 checkpoint covering PRS role definition, recovery-oriented principles, peer support history, and professional boundaries.',
});
...
add('Code of Ethics for Peer Specialists', {
  ...
  summaryText:
    'The Code of Ethics defines the professional standards that make peer support trustworthy. Integrity, competence, and accountability are the core obligations of every certified peer specialist.',
});
...
add('Confidentiality and HIPAA', {
  ...
  keyTerms: [
    ...
    },
    {
      term: 'PHI',
      definition:
        'Protected Health Information — any individually identifiable health information covered by HIPAA.',
    },
    {
      term: '42 CFR Part 2',
      definition:
        'Federal regulation providing extra confidentiality protections for substance use disorder treatment records, stricter than HIPAA.',
    },
    {
      term: 'Covered Entity',
      definition:
        'A healthcare provider, health plan, or clearinghouse that must comply with HIPAA.',
    },
    {
      term: 'Breach',
      definition:
        'An unauthorized use or disclosure of PHI. Must be reported to your supervisor and may require notification to the affected individual.',
    },
  ],
  jobApplication:
  ...
  reflectionPrompt:
    'A colleague asks you about a mutual acquaintance who is a client at your agency. How do you respond?',
  summaryText:
    'Confidentiality and HIPAA compliance are non-negotiable. Know the rules, know the exceptions, and when in doubt, say nothing and consult your supervisor.',
});
...
add('Dual Relationships and Boundaries', {
  ...
  keyTerms: [
    ...
    {
      term: 'Transfer of Care',
      definition:
        'Referring a client to another peer specialist when a dual relationship makes it impossible to maintain appropriate boundaries.',
    },
    {
      term: 'Exploitation',
      definition:
        'Using the power differential in the peer relationship for personal benefit. Always unethical.',
    },
  ],
  jobApplication:
  ...
  summaryText:
    'Dual relationships require immediate disclosure, documentation, and supervisor guidance. The question is always: who does this serve?',
});
...
add('Ethical Dilemmas Practice', {
  ...
  concept:
    'Ethical dilemmas are situations where two or more ethical principles conflict and there is no obviously correct answer. For example: a client tells you they are using again but begs you not to tell anyone — confidentiality says keep it private, but your duty of care says address the risk. Or: a client asks you to lie to their probation officer about their attendance — loyalty to the client conflicts with your obligation to be honest. The ethical decision-making process for peer specialists follows these steps: (1) Identify the ethical issue — what principles are in conflict? (2) Gather relevant information — what are the facts, the risks, the applicable rules? (3) Consider your options — what are the possible courses of action and their consequences? (4) Consult your supervisor or ethics resources — do not make hard calls alone. (5) Act and document — take the most ethical action available and record your reasoning. Practice scenarios in this lesson will walk through real-world dilemmas you are likely to face. The goal is not to find the "perfect" answer but to develop a consistent, principled decision-making process.',
  keyTerms: [
    {
      term: 'Ethical Dilemma',
      definition:
        'A situation where two or more ethical principles conflict, making the right course of action unclear.',
    },
    {
      term: 'Duty of Care',
      definition: 'The obligation to take reasonable steps to protect a client from harm.',
    },
    {
      term: 'Ethical Decision-Making Process',
      definition:
        'A structured approach to resolving ethical dilemmas: identify, gather, consider, consult, act, document.',
    },
    {
      term: 'Documentation',
      definition:
        "Recording your reasoning and actions in the client's file. Protects you and the client if questions arise later.",
    },
  ],
  jobApplication:
    'In practice, you will face ethical dilemmas regularly. The peer specialists who handle them well are not the ones who always know the right answer — they are the ones who have a process, consult their supervisor, and document their reasoning. Build that habit now.',
  watchFor: [
  ...
  summaryText:
    'Ethical dilemmas require a structured decision-making process, supervisor consultation, and documentation. The goal is principled consistency, not perfect answers.',
});
...
add('Ethics Quiz', {
  ...
  concept:
    'This quiz covers the ethics and professional conduct module: the code of ethics, HIPAA and 42 CFR Part 2 confidentiality rules, dual relationships, and ethical decision-making. You must score 70% or higher to proceed. Pay particular attention to the exceptions to confidentiality and the steps of the ethical decision-making process.',
  keyTerms: [],
  jobApplication:
  ...
  reflectionPrompt:
    'Which ethical principle do you find most challenging to apply in practice, and why?',
  summaryText:
