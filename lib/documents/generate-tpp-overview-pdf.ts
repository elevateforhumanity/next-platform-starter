...
export async function generateTppOverviewPdf(): Promise<Uint8Array> {
  ...
  const runHdr = (pg: PDFPage, pn: number, tot: number) => {
    ...
    pg.drawText('Elevate for Humanity  ·  FSSA SNAP E&T Program Overview & Capability Statement', { x: hx, y: H - 19, size: 7.5, font: bold, color: HTXT });
  ...
  const runFtr = (pg: PDFPage) => {
    ...
    pg.drawText('Elevate for Humanity Technical and Career Institute  ·  8888 Keystone Crossing, Suite 1300, Indianapolis, IN 46240  ·  (317) 314-3757', { x: ML, y: MB + 4, size: 6.5, font: reg, color: LGRAY });
  };
  ...
  t('Elevate for Humanity Technical and Career Institute', hx0, H - 30, bold, 11, HTXT);
  t('8888 Keystone Crossing, Suite 1300  ·  Indianapolis, IN 46240', hx0, H - 44, reg, 8, rgb(0.75, 0.85, 1));
  t('(317) 314-3757  ·  elevate4humanityedu@gmail.com  ·  elevateforhumanity.org', hx0, H - 57, reg, 8, rgb(0.75, 0.85, 1));
  ...
  ['Elevate for Humanity Technical and Career Institute (2Exclusive LLC-S, DBA) is a For-Profit workforce',
  ...
  lv('DBA:', 'Elevate for Humanity Technical and Career Institute');
  ...
  para('Elevate for Humanity operates four dedicated training facilities across Indianapolis, each serving a specific program track. All locations are accessible by IndyGo public transit.');
  y -= 2;
  ...
  para('Elizabeth Greene is a U.S. Army Veteran (Unit Supply Specialist, Honorably Discharged), IRS Enrolled Agent (EA) with active EFIN and PTIN, EPA 608 Certified Proctor, Indiana Substitute Teacher, Licensed Barber, DOL Registered Apprenticeship Sponsor (RAPIDS #2025-IN-132301), SAM.gov Registered Federal Government Contractor (CAGE: 0Q856), ByBlack Certified, EmployIndy Partner, WorkOne Partner, ETPL Provider, WIOA/WRG/JRI Approved, Job Ready Indy Partner, HSI Affiliate, CareerSafe OSHA Provider, Milady Partner, NRF Rise Up Provider, and Certiport CATC. She also operates SupersonicFastCash (tax preparation software company) and Selfish Inc., a 501(c)(3) nonprofit (DBA: The Rise Foundation) providing VITA free tax preparation and community services to underserved Indianapolis residents. Her personal experience navigating workforce barriers as a veteran and community member directly informs Elevate\'s participant-centered program design.');
  y -= 4;
  ...
  para('All locations are accessible by IndyGo public transit. Transportation assistance (bus passes and mileage reimbursement) is provided to all participants who require it to attend training. Online and hybrid program components are available statewide via Elevate\'s proprietary LMS platform at elevateforhumanity.org.');
  y -= 8;
  ...
  const svcs = [
    { name: 'Transportation Assistance', mandatory: true, max: '$150/participant/month',
      ...
      providers: 'Elevate for Humanity (direct); IndyGo (bus passes); Lyft/Uber (rideshare coordination)' },
    { name: 'Work Clothing / Uniforms', mandatory: false, max: '$200/participant (one-time)',
      ...
      providers: 'Elevate for Humanity (direct purchase or reimbursement)' },
  ...
  const currentStaff = [
    ...
    },
    {
      ...
      total: '$78,200',
      fte: '1.0',
      bio: 'Multi-licensed beauty professional holding Indiana Nail Technician License, Nail Instructor License, and Esthetician License. Oversees the nail program at Textures Institute of Cosmetology. Manages enrollment operations for Elevate for Humanity.',
