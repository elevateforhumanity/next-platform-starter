...
export const PAGE_AVATAR_CONFIGS: Record<string, AvatarContext> = {
  ...
  '/': {
    ...
    intent: 'orient',
    message:
      'Programs are grouped by career path. Pick one to see duration, outcomes, and funding options.',
    maxMessages: 1,
  },
  ...
  '/programs': {
    ...
    intent: 'explain',
    message:
      'Programs are grouped by career path. You can open any program to see outcomes, duration, and eligibility.',
    maxMessages: 1,
  },
  ...
  '/programs/cna': {
    ...
    intent: 'explain',
    message:
      'This page explains the CNA program — how long it takes, what certification you earn, and your funding options.',
    maxMessages: 1,
  },
  ...
  '/programs/healthcare': {
    ...
    intent: 'explain',
    message:
      'Healthcare programs include CNA, Medical Assistant, and Phlebotomy. Each has different timelines and certifications.',
    maxMessages: 1,
  },
  ...
  '/programs/phlebotomy': {
    ...
    intent: 'explain',
    message:
      'Phlebotomy training covers blood draw techniques and lab procedures. Certification included.',
    maxMessages: 1,
  },
  ...
  '/programs/medical-assistant': {
    ...
    intent: 'explain',
    message:
      'Medical Assistant training covers clinical and administrative skills. This page shows duration and certification details.',
    maxMessages: 1,
  },
  ...
  '/programs/barber-apprenticeship': {
    ...
    intent: 'explain',
    message:
      "This is a USDOL-registered apprenticeship. You'll train in a real shop while earning toward your license.",
    maxMessages: 1,
  },
  ...
  '/programs/barber': {
    ...
    intent: 'explain',
    message:
      'Barber training options include apprenticeship and traditional programs. This page compares both paths.',
    maxMessages: 1,
  },
  ...
  '/programs/esthetician-apprenticeship': {
    ...
    intent: 'explain',
    message:
      'Esthetician apprenticeship lets you train in a salon while earning hours toward licensure.',
    maxMessages: 1,
  },
  ...
  '/programs/cosmetology-apprenticeship': {
    ...
    intent: 'explain',
    message:
      "Cosmetology apprenticeship covers hair, skin, and nails. You'll train with a licensed professional.",
    maxMessages: 1,
  },
  ...
  '/programs/nail-technician-apprenticeship': {
    ...
    intent: 'explain',
    message:
      'Nail tech apprenticeship focuses on manicure, pedicure, and nail art. Shorter than full cosmetology.',
    maxMessages: 1,
  },
  ...
  '/programs/skilled-trades': {
    ...
    intent: 'explain',
    message:
      'Skilled trades include HVAC, CDL, welding, and electrical. High demand, good pay, hands-on work.',
    maxMessages: 1,
  },
  ...
  '/programs/cdl-training': {
    ...
    intent: 'explain',
    message:
      'CDL training takes 3-4 weeks. This page covers Class A vs Class B, endorsements, and job placement.',
    maxMessages: 1,
  },
  ...
  '/programs/hvac-technician': {
    ...
    intent: 'explain',
    message:
      'HVAC training covers heating, cooling, and refrigeration systems. EPA certification included.',
    maxMessages: 1,
  },
  ...
  '/programs/technology': {
    ...
    intent: 'explain',
    message:
      'Technology programs include IT Support, Cybersecurity, and Web Development. All lead to industry certifications.',
    maxMessages: 1,
  },
  ...
  '/programs/it-help-desk': {
    ...
    intent: 'explain',
    message:
      'IT Help Desk training prepares you for Certiport IT Specialist certification. 8 weeks, in-person at our Indianapolis Training Center.',
    maxMessages: 1,
  },
  ...
  '/programs/business': {
    ...
    intent: 'explain',
    message:
      'Business programs include tax preparation and entrepreneurship. Good for self-employment paths.',
    maxMessages: 1,
  },
  ...
  '/programs/tax-preparation': {
    ...
    intent: 'explain',
    message:
      'Tax prep training covers individual and small business returns. VITA certification included.',
    maxMessages: 1,
  },
  ...
  '/apply': {
    ...
    intent: 'assist',
    message:
      'This is the application page. Nothing is submitted until you complete all required steps.',
    maxMessages: 1,
  },
  ...
  '/wioa-eligibility': {
    ...
    intent: 'explain',
    message:
      "This checks if you qualify for free training. Answer honestly — it's confidential and takes 2 minutes.",
    maxMessages: 1,
  },
  ...
  '/student-portal': {
    ...
    intent: 'orient',
    message:
      'This dashboard shows your progress, required hours, and any tasks that need attention.',
    maxMessages: 1,
  },
  ...
  '/student-portal/progress': {
    ...
    intent: 'explain',
    message:
      'These hours count toward your program requirements. Green is complete, yellow is in progress, red is overdue.',
    maxMessages: 1,
  },
  ...
  '/student-portal/hours': {
    ...
    intent: 'explain',
    message:
      "Log your training hours here. I'll flag anything that doesn't match your program requirements.",
    maxMessages: 1,
  },
