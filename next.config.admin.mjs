...
const adminConfig = {
  ...
  serverExternalPackages: [
    ...
    '@sendgrid/mail', 'nodemailer', 'resend',
    '@sentry/nextjs', '@sentry/node', '@sentry/node-core', '@sentry/core',
    '@remotion/bundler', '@remotion/renderer', '@remotion/compositor-linux-x64-gnu', 'remotion',
    'puppeteer', 'puppeteer-core', 'jsdom', 'typescript',
    'canvas', 'tesseract.js', 'tesseract.js-core',
    'edge-tts', 'ffmpeg-static',
  ],
